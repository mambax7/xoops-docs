---
title: "ข้อตกลงเทมเพลต Smarty"
description: "XOOPS มาตรฐานการเข้ารหัสเทมเพลตอันชาญฉลาดและแนวทางปฏิบัติที่ดีที่สุด"
---
> XOOPS ใช้ Smarty สำหรับการสร้างเทมเพลต คู่มือนี้ครอบคลุมถึงแบบแผนและแนวทางปฏิบัติที่ดีที่สุดสำหรับการพัฒนาเทมเพลต Smarty

---

## ภาพรวม

XOOPS เทมเพลต Smarty มีดังนี้:

- **XOOPS โครงสร้างเทมเพลต** และการตั้งชื่อ
- **มาตรฐานการเข้าถึง** (WCAG)
- **มาร์กอัปความหมาย HTML5**
- **BEM-การตั้งชื่อคลาสสไตล์**
...
<{/if}>
```
### ส่วน (เลิกใช้แล้ว ใช้ foreach แทน)
```smarty
...
- ใช้ความหมาย HTML5
- รวมข้อความแสดงแทนสำหรับรูปภาพ
- ใช้ค่าคงที่ภาษาสำหรับข้อความ
- เอาต์พุต Escape (ค่าเริ่มต้น)
- รักษาตรรกะให้น้อยที่สุด
- ใช้ชื่อตัวแปรที่มีความหมาย
- รวมส่วนหัวของไฟล์
- ใช้ชื่อคลาสสไตล์ BEM
- ทดสอบกับโปรแกรมอ่านหน้าจอ

### อย่า

- อย่าผสมตรรกะและการนำเสนอ
- อย่าลืมข้อความแสดงแทน
- อย่าใช้ raw HTML โดยไม่ Escape
- อย่าสร้างตัวแปรร่วมในเทมเพลต
- อย่าใช้คุณสมบัติ Smarty ที่เลิกใช้แล้ว
- อย่าซ้อนเทมเพลตไว้ลึกเกินไป
- อย่าละเลยการเข้าถึง
- อย่าฮาร์ดโค้ดข้อความ (ใช้ค่าคงที่)

---

## ตัวอย่างเทมเพลต

### เทมเพลตโมดูลที่สมบูรณ์
```smarty
{*
...
#xoops #smarty #templates #conventions #แนวปฏิบัติที่ดีที่สุด