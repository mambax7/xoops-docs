---
title: "มาตรฐานการเข้ารหัสJavaScript"
description: "XOOPS มาตรฐานการเข้ารหัส JavaScript และแนวทางปฏิบัติที่ดีที่สุด"
---
# มาตรฐานJavaScript

> XOOPS เป็นไปตามมาตรฐาน JavaScript สมัยใหม่ (ES6+) โดยเน้นที่ความสามารถในการอ่านและการบำรุงรักษา

---

## ภาพรวม

XOOPS มาตรฐาน JavaScript ขึ้นอยู่กับ:

- **ECMAScript 2015+** (ES6 และฟีเจอร์สมัยใหม่)
- **คู่มือสไตล์ JavaScript ของ Airbnb** (ดัดแปลง)
- **XOOPS แบบแผน** เพื่อความสม่ำเสมอ
...
- ใช้ฟังก์ชั่นลูกศรสำหรับการโทรกลับ
- ใช้ async/await สำหรับสัญญา
- ฟังก์ชั่นที่ซับซ้อนของเอกสาร
- แคช DOM องค์ประกอบ
- ใช้การมอบหมายกิจกรรม
- เขียนฟังก์ชันล้วนๆ
- ให้ความสำคัญกับฟังก์ชั่นต่างๆ

### อย่า

- ใช้ var (ดั้งเดิม)
- ใช้ตัวแปรโกลบอล
- สร้างฟังก์ชั่นยาว (มากกว่า 50 บรรทัด)
- โค้ดซ้อนลึก
- ใช้ eval()
- ใช้ตัวจัดการเหตุการณ์แบบอินไลน์
- ออกจากคอนโซลlog() อยู่ในการใช้งานจริง
- สร้างหน่วยความจำรั่ว
- พารามิเตอร์ฟังก์ชันกลายพันธุ์
...
#xoops #javascript #es6 #มาตรฐานการเข้ารหัส #แนวปฏิบัติที่ดีที่สุด