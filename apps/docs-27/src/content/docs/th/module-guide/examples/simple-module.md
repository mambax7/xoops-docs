---
title: "ตัวอย่างโมดูลอย่างง่าย"
description: "สร้างโมดูลการทำงานให้สมบูรณ์พร้อมไฟล์ที่จำเป็นทั้งหมด"
---
# ตัวอย่างโมดูลอย่างง่าย - บล็อก

โมดูลที่เรียบง่ายและใช้งานได้จริงซึ่งสาธิตแนวคิดหลัก XOOPS
...
?>
```
## ส่วนต่อประสานผู้ดูแลระบบ (admin.php)
```php
<?php
require_once __DIR__ . '/../../mainfile.php';
...
- แสดงโพสต์บล็อกที่เผยแพร่พร้อมการแบ่งหน้า
- ดูแต่ละโพสต์
- อินเทอร์เฟซผู้ดูแลระบบสำหรับสร้าง แก้ไข ลบโพสต์
- สถานะฉบับร่าง/เผยแพร่แล้ว
- การประทับเวลา

## การทดสอบ

1. ติดตั้งโมดูลผ่านทางผู้ดูแลระบบ XOOPS
2. เข้าถึงส่วนหน้าที่ `modules/blog/`
3. ไปที่ผู้ดูแลระบบที่ `modules/blog/admin.php`
4. สร้างโพสต์ทดสอบและเผยแพร่

## เอกสารที่เกี่ยวข้อง

ดูเพิ่มเติมที่:
- ../Patterns/MVC-รูปแบบสำหรับรูปแบบ
- ../Patterns/Repository-Pattern สำหรับการเข้าถึงข้อมูล
- ../Best-Practices/Code-Organization สำหรับโครงสร้าง
