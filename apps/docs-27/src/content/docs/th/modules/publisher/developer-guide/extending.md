---
title: "ขยายสำนักพิมพ์"
description: "คู่มือนักพัฒนาสำหรับการขยายและปรับแต่งโมดูลผู้เผยแพร่"
---
> คู่มือนักพัฒนาในการปรับแต่งและขยายโมดูลผู้เผยแพร่
...
สร้างเทมเพลตแบบกำหนดเองในธีมของคุณ:
```
...
```
### ลงทะเบียนบล็อกใน xoops_version.php
```php
$modversion['blocks'][] = [
