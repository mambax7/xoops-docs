---
title: "XOOPS แบบฟอร์ม"
description: "คำแนะนำฉบับสมบูรณ์เกี่ยวกับระบบการสร้างแบบฟอร์ม XOOPS รวมถึงองค์ประกอบของแบบฟอร์ม การตรวจสอบความถูกต้อง และการเรนเดอร์ทั้งหมด"
---
# XOOPS ระบบแบบฟอร์ม

> การสร้างแบบฟอร์มที่ครอบคลุม การตรวจสอบ และการเรนเดอร์สำหรับโมดูล XOOPS

---

## ภาพรวม

ระบบแบบฟอร์ม XOOPS นำเสนอแนวทางเชิงวัตถุที่มีประสิทธิภาพในการสร้างแบบฟอร์ม HTML จัดการการสร้างแบบฟอร์ม การตรวจสอบ การป้องกัน CSRF และการเรนเดอร์ที่ยืดหยุ่น พร้อมการสนับสนุนเฟรมเวิร์ก CSS ต่างๆ
...
### XoopsForm (คลาสพื้นฐาน)

คลาสฐานนามธรรมสำหรับทุกรูปแบบ
```php
...
คลาสฟอร์มที่ใช้บ่อยที่สุด เรนเดอร์ด้วยการกำหนดสไตล์ของธีม
```php
...
- การตรวจสอบแบบฟอร์ม
- การเรนเดอร์แบบฟอร์มที่กำหนดเอง
- CSRF การป้องกัน
- การฆ่าเชื้ออินพุต
