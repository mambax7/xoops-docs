---
title: "ระบบการอนุญาต"
description: "คู่มือฉบับสมบูรณ์เกี่ยวกับระบบสิทธิ์ XOOPS ประเภท การตรวจสอบ ลำดับชั้น และการควบคุมการเข้าถึง"
---
# ระบบการอนุญาตใน XOOPS

XOOPS Permission System เป็นเฟรมเวิร์กการควบคุมการเข้าถึงแบบละเอียดที่จัดการว่าใครสามารถดำเนินการใดกับทรัพยากรใดได้บ้าง เอกสารนี้ครอบคลุมถึงประเภทสิทธิ์ กลไกการตรวจสอบ ลำดับชั้น และตัวอย่างการใช้งาน

## ประเภทการอนุญาต

### สิทธิ์ระดับโมดูล

สิทธิ์ระดับโมดูลควบคุมการเข้าถึงโมดูลทั้งหมดหรือฟังก์ชันโมดูล

**ชื่อสิทธิ์ทั่วไป:**
- `module_view` - ดูเนื้อหาโมดูล
- `module_read` - อ่านทรัพยากรโมดูล
- `module_submit` - ส่งเนื้อหาไปยังโมดูล
- `module_edit` - แก้ไขเนื้อหาโมดูล
- `module_admin` - โมดูลการจัดการ
```php
<?php
/**
...
สิทธิ์ระดับรายการควบคุมการเข้าถึงทรัพยากรเฉพาะภายในโมดูล

**ตัวอย่าง:**
- บทความ ID: กลุ่มสามารถดู/แก้ไขบทความเฉพาะเจาะจงได้หรือไม่
- หมวดหมู่ ID: กลุ่มสามารถเข้าถึงหมวดหมู่ได้หรือไม่
- หน้า ID: กลุ่มสามารถดู/แก้ไขหน้าเฉพาะเจาะจงได้หรือไม่
```php
<?php
/**
...
สิทธิ์การบล็อกจะควบคุมการมองเห็นและการโต้ตอบกับบล็อกที่แสดงบนเพจ
```php
<?php
/**
...
สิทธิ์การควบคุมการจัดการกลุ่มและการดูแลระบบ
```php
<?php
/**
...
คลาส `XoopsGroupPermHandler` มีวิธีการตรวจสอบและจัดการสิทธิ์
```php
<?php
/**
...
```
## การดำเนินการตรวจสอบการอนุญาต

### การตรวจสอบสิทธิ์ผู้ใช้คนเดียว
```php
<?php
/**
...
```
### การตรวจสอบสิทธิ์ของแผงผู้ดูแลระบบ
```php
<?php
/**
...
### การตรวจสอบสิทธิ์ที่ได้รับการปรับปรุงให้เหมาะสม
```php
<?php
/**
...
1. **หลักการของสิทธิพิเศษน้อยที่สุด**: มอบหมายสิทธิ์ที่จำเป็นเท่านั้น
2. **การเข้าถึงตามบทบาท**: ใช้กลุ่มสำหรับการอนุญาตตามบทบาท
3. **การตรวจสอบตามปกติ**: ตรวจสอบสิทธิ์เป็นระยะๆ
4. **การแยกหน้าที่**: แยกผู้ดูแลระบบออกจากสิทธิ์ของผู้ใช้
5. **ปฏิเสธอย่างชัดเจน**: ปฏิเสธโดยค่าเริ่มต้น อนุญาตอย่างชัดเจน
...
#สิทธิ์ #การควบคุมการเข้าถึง #ความปลอดภัย #การอนุญาต #acl #การตรวจสอบสิทธิ์