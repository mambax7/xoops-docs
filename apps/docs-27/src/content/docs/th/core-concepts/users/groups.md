---
title: "ระบบกลุ่ม"
description: "คู่มือที่ครอบคลุมเกี่ยวกับการจัดการกลุ่ม XOOPS กลุ่มเริ่มต้น กลุ่มที่กำหนดเอง และลำดับชั้นของกลุ่ม"
---
# ระบบกลุ่มใน XOOPS

ระบบกลุ่ม XOOPS มีกรอบการทำงานแบบลำดับชั้นสำหรับการจัดระเบียบผู้ใช้และการจัดการสิทธิ์โดยรวม เอกสารนี้ครอบคลุมถึงกลุ่มเริ่มต้น การสร้างกลุ่มแบบกำหนดเอง ลำดับชั้น และการใช้งานจริง

## กลุ่มเริ่มต้น

XOOPS ประกอบด้วยกลุ่มพื้นฐานสามกลุ่มที่สร้างขึ้นระหว่างการติดตั้งระบบ:

### กลุ่มผู้ดูแลเว็บ (ID: 1)

กลุ่มผู้ดูแลเว็บเป็นตัวแทนของผู้ดูแลไซต์ที่มีสิทธิ์เข้าถึงระบบเต็มรูปแบบ

**ลักษณะเฉพาะ:**
- กลุ่ม ID: 1
- ระดับสิทธิ์สูงสุด
- ไม่สามารถลบได้
- เข้าถึงโมดูลและฟังก์ชันทั้งหมดได้เต็มรูปแบบ
- การเข้าถึงแผงการบริหาร
```php
<?php
/**
...
```
### กลุ่มผู้ใช้ที่ลงทะเบียน (ID: 2)

กลุ่มผู้ใช้ที่ลงทะเบียนประกอบด้วยผู้ใช้ที่ได้รับการตรวจสอบสิทธิ์ทั้งหมดที่ไม่เปิดเผยชื่อ

**ลักษณะเฉพาะ:**
- กลุ่ม ID: 2
- กลุ่มเริ่มต้นสำหรับการลงทะเบียนใหม่
- สามารถเข้าถึงคุณสมบัติเฉพาะของผู้ใช้ได้
- ขึ้นอยู่กับการอนุญาตแบบกลุ่ม
- สามารถปรับแต่งให้เหมาะกับคุณสมบัติผู้ใช้มาตรฐานได้
```php
<?php
/**
...
กลุ่มนิรนามเป็นตัวแทนของผู้เยี่ยมชมเว็บไซต์ที่ไม่ได้รับการรับรองความถูกต้อง

**ลักษณะเฉพาะ:**
- กลุ่ม ID: 3
- กลุ่มเริ่มต้นสำหรับผู้ใช้ที่ไม่ได้เข้าสู่ระบบ
- โดยทั่วไปแล้วการเข้าถึงแบบอ่านอย่างเดียวจะจำกัด
- ไม่สามารถแก้ไขเนื้อหาได้
- สิทธิ์ในการดูสาธารณะ
```php
<?php
/**
...
```
## การสร้างกลุ่มที่กำหนดเอง

### ตัวจัดการการสร้างกลุ่ม
```php
<?php
/**
...
```
## การมอบหมายสิทธิ์ของกลุ่ม

### การกำหนดสิทธิ์ให้กับกลุ่ม
```php
<?php
/**
...
1. **การตั้งชื่อที่ชัดเจน**: ใช้ชื่อกลุ่มที่สื่อความหมายและชัดเจน
2. **เอกสารประกอบ**: วัตถุประสงค์และการอนุญาตของกลุ่มเอกสาร
3. **หลักการของสิทธิพิเศษน้อยที่สุด**: ให้สิทธิ์ที่จำเป็นขั้นต่ำ
4. **การตรวจสอบตามปกติ**: ตรวจสอบความเป็นสมาชิกกลุ่มและการอนุญาตเป็นระยะ
5. **กลุ่มเริ่มต้น**: รักษากลุ่มเริ่มต้น (เว็บมาสเตอร์, ลงทะเบียน, ไม่ระบุชื่อ)
...
#กลุ่ม #การจัดการกลุ่ม #สิทธิ์ #การควบคุมการเข้าถึง #องค์กรผู้ใช้ #ลำดับชั้น