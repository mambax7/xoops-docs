---
title: "XoopsModule API การอ้างอิง"
description: "กรอกการอ้างอิง API สำหรับ XoopsModule และคลาสระบบโมดูล"
---
> กรอกเอกสาร API สำหรับระบบโมดูล XOOPS ให้ครบถ้วน
...
|----------|-|-------------|
| `mid` | อินท์ | โมดูล ID |
| `name` | สตริง | ชื่อที่แสดง |
| `version` | สตริง | หมายเลขเวอร์ชัน |
| `dirname` | สตริง | ชื่อไดเร็กทอรี |
| `isactive` | อินท์ | สถานะใช้งานอยู่ (0/1) |
| `hasmain` | อินท์ | มีพื้นที่หลัก |
| `hasadmin` | อินท์ | มีพื้นที่ผู้ดูแลระบบ |
| `hassearch` | อินท์ | มีฟังก์ชั่นการค้นหา |
| `hasconfig` | อินท์ | มีการกำหนดค่า |
| `hascomments` | อินท์ | มีความคิดเห็น |
| `hasnotification` | อินท์ | มีการแจ้งเตือน |
