---
title: "เกณฑ์ API อ้างอิง"
description: "กรอกข้อมูลอ้างอิง API สำหรับระบบการสร้างคิวรีเกณฑ์ XOOPS"
---
> กรอกเอกสาร API สำหรับระบบการสร้างแบบสอบถามเกณฑ์ XOOPS

---

## สถาปัตยกรรมระบบเกณฑ์
```
mermaid
classDiagram
...
## ตัวอย่างแบบสอบถามที่ซับซ้อน

### ค้นหาด้วยเงื่อนไขหลายข้อ
```php
$criteria = new CriteriaCompo();
...
1. **ตั้งค่า LIMIT** เสมอสำหรับตารางขนาดใหญ่
2. **ใช้ดัชนี** ในคอลัมน์ที่ใช้ในเกณฑ์
3. **หลีกเลี่ยงการใช้ไวด์การ์ดนำหน้า** ใน LIKE (`'%term'` ช้า)
4. **กรองล่วงหน้าใน PHP** เมื่อเป็นไปได้สำหรับตรรกะที่ซับซ้อน
5. **ใช้ COUNT เท่าที่จำเป็น** - แคชผลลัพธ์เมื่อเป็นไปได้
