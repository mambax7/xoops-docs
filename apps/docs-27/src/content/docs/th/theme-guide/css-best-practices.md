---
title: "CSS แนวทางปฏิบัติที่ดีที่สุดสำหรับ XOOPS ธีม"
---
## ภาพรวม

คู่มือนี้ครอบคลุมถึง CSS การจัดระเบียบ เทคนิคการจัดวางสมัยใหม่ และการเพิ่มประสิทธิภาพสำหรับ XOOPS การพัฒนาธีม
...
1. **ลดความจำเพาะให้น้อยที่สุด** - หลีกเลี่ยงการทำรังลึก
2. **ใช้คุณสมบัติสมัยใหม่** - `gap` แทนระยะขอบ
3. **ลดการทาสีซ้ำ** - ใช้ `transform` สำหรับแอนิเมชั่น
4. **Lazy load** - โหลดโมดูล CSS เมื่อจำเป็นเท่านั้น
```css
...
- ธีม-โครงสร้าง - การจัดระเบียบไฟล์ธีม
- การพัฒนาธีม - คู่มือธีมฉบับสมบูรณ์
- ../Templates/Smarty-Templating - การรวมเทมเพลต
- ../../03-Module-Development/Block-Development - สไตล์บล็อก