---
title: "การพัฒนาธีม"
description: "การสร้างและปรับแต่งธีม XOOPS ด้วยการสืบทอดเทมเพลต Smarty"
---
<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

คู่มือนี้ครอบคลุมถึงวิธีการสร้างธีม XOOPS รวมถึงโครงสร้างธีม การสืบทอดเทมเพลต และแนวทางปฏิบัติที่ดีที่สุดสำหรับการสร้างธีมที่ทันสมัยและตอบสนองได้ดี
...
ธีม XOOPS ประกอบด้วยโครงสร้างไดเร็กทอรีต่อไปนี้:
```
themes/
  mytheme/
...
ไฟล์คอนฟิกูเรชันธีมกำหนดคุณสมบัติของธีม:
```php
<?php
$themeversion = [
    'name'        => 'My Theme',
...
การสืบทอดเทมเพลตของ Smarty ช่วยให้คุณสร้างธีมลูกที่สืบทอดมาจากธีมหลักได้

### ธีมผู้ปกครอง (base.tpl)
```smarty
<!DOCTYPE html>
<html>
<head>
...
{/block}
```
### การสร้างรูปแบบธีมต่างๆ

สร้างธีมที่หลากหลายจากธีมพื้นฐาน:
...
ไฟล์นี้จะดำเนินการโดยอัตโนมัติและสามารถใช้เพื่อเตรียมข้อมูลสำหรับเทมเพลต:
```php
<?php
...
```
## ม้าหมุน/สไลเดอร์แบบกำหนดเอง

ตัวอย่างภาพหมุนเนื้อหาแบบไดนามิก:
```smarty
...
<{/if}>
```
## เคล็ดลับการออกแบบที่ตอบสนองต่อ
