---
title: "การดีบักเทมเพลต Smarty"
description: "เทคนิคการแก้ไขข้อบกพร่องเทมเพลตขั้นสูงและการแก้ไขปัญหาสำหรับ XOOPS"
---
> เทคนิคขั้นสูงสำหรับการดีบักเทมเพลต Smarty ในธีมและโมดูล XOOPS
...
## เปิดใช้งานโหมดดีบัก Smarty

### วิธีที่ 1: แผงผู้ดูแลระบบ

XOOPS ผู้ดูแลระบบ > การตั้งค่า > ประสิทธิภาพ:
- เปิดใช้งาน "เอาต์พุตการแก้ไขข้อบกพร่อง"
- ตั้งค่า "ระดับการแก้ไขข้อบกพร่อง" เป็น 2

---

### วิธีที่ 2: การกำหนดค่ารหัส
```php
<?php
...
### วิธีที่ 3: แก้ไขข้อบกพร่องป๊อปอัปในเบราว์เซอร์
```smarty
{* Add to template to enable debug in footer *}
{debug}
```
นี่จะแสดงป๊อปอัปพร้อมตัวแปรที่กำหนดทั้งหมด

---

## เทคนิคการแก้ไขข้อบกพร่อง Smarty ทั่วไป
...
## ดูเทมเพลตที่คอมไพล์แล้ว

Smarty รวบรวมเทมเพลตเป็น PHP เพื่อประสิทธิภาพ แก้ไขข้อบกพร่องโดยการดูโค้ดที่คอมไพล์แล้ว:
```bash
...
### ฉบับที่ 1: ตัวแปรแสดงเป็นค่าว่าง
```php
<?php
$tpl = new XoopsTpl();
...
### ปัญหาที่ 3: ไม่พบปลั๊กอิน/ตัวแก้ไข
```php
<?php
...
### ฉบับที่ 4: การแสดงผลอาร์เรย์ที่ซ้อนกัน
```smarty
{* Debug nested arrays *}
...
### กระบวนการแก้ไขข้อบกพร่องทีละขั้นตอน
```
mermaid
graph TD
...
## ฟังก์ชั่นตัวช่วยแก้ไขข้อบกพร่อง
```php
<?php
