---
title: "หน้าจอสีขาวแห่งความตาย (WSOD)"
description: "การวินิจฉัยและแก้ไขจอขาวแห่งความตายใน XOOPS"
---
...
### ขั้นตอนที่ 1: เปิดใช้งานการแสดงข้อผิดพลาด PHP

เพิ่มใน `mainfile.php` ชั่วคราว:
```php
<?php
...
```
### ขั้นตอนที่ 2: ตรวจสอบบันทึกข้อผิดพลาด PHP
```bash
...
```
### ขั้นตอนที่ 3: เปิดใช้งาน XOOPS ดีบัก
```php
// In mainfile.php
...
ls -la class/
```
### 4. การเชื่อมต่อฐานข้อมูลล้มเหลว
...
```
1. **สำรองข้อมูลทุกครั้ง** ก่อนทำการเปลี่ยนแปลง
2. **ทดสอบในเครื่อง** ก่อนปรับใช้
3. **ตรวจสอบบันทึกข้อผิดพลาด** เป็นประจำ
4. **ใช้ git** เพื่อติดตามการเปลี่ยนแปลง
5. **อัปเดต PHP อยู่เสมอ** ภายในเวอร์ชันที่รองรับ
