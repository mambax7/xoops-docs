...
מסמך זה מתאר שיטות אבטחה מומלצות לפיתוח XOOPS, המכסים אימות קלט, קידוד פלט, אימות, הרשאה והגנה מפני פגיעויות אינטרנט נפוצות.
...
- [ ] כל קלט המשתמש אומת וחוטא
- [ ] שאילתות עם פרמטרים עבור כל פעולות מסד הנתונים
- [ ] קידוד פלט עבור כל התוכן שנוצר על ידי המשתמש
- [ ] CSRF אסימונים בכל הטפסים המשנים את המצב
- [ ] גיבוב סיסמה מאובטח (Argon2id)
- [ ] מוגדרת אבטחת הפעלה
- [ ] אימות העלאת קבצים
- [ ] כותרות אבטחה מוגדרות
- [ ] יושמה הגבלת תעריפים
- [ ] רישום ביקורת מופעל
- [ ] הודעות שגיאה אינן דולפות מידע רגיש
