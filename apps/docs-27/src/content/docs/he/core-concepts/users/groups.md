---
title: "מערכת קבוצתית"
description: "מדריך מקיף לניהול קבוצות XOOPS, קבוצות ברירת מחדל, קבוצות מותאמות אישית והיררכיית קבוצות"
---

# מערכת קבוצתית ב-XOOPS

מערכת XOOPS Group מספקת מסגרת היררכית לארגון משתמשים וניהול הרשאות קולקטיביות. מסמך זה מכסה קבוצות ברירת מחדל, יצירת קבוצות מותאמות אישית, היררכיה ויישום מעשי.

## קבוצות ברירת מחדל

XOOPS כולל שלוש קבוצות בסיסיות שנוצרות במהלך התקנת המערכת:

### קבוצת מנהלי אתרים (מזהה: 1)

קבוצת מנהלי האתרים מייצגת מנהלי אתרים עם גישה מלאה למערכת.

**מאפיינים:**
- מזהה קבוצה: 1
- רמת הפריבילגיה הגבוהה ביותר
- לא ניתן למחוק
- גישה מלאה לכל המודולים והפונקציות
- גישה לפאנל ניהול
...
### קבוצת משתמשים רשומים (מזהה: 2)

קבוצת המשתמשים הרשומים כוללת את כל המשתמשים המאומתים שאינם אנונימיים.

**מאפיינים:**
- מזהה קבוצה: 2
- קבוצת ברירת מחדל עבור הרשמות חדשות
- יכול לגשת לתכונות ספציפיות למשתמש
- בכפוף להרשאות מבוססות קבוצה
- ניתן להתאים אישית לתכונות משתמש סטנדרטיות
...
### קבוצה אנונימית (מזהה: 3)

קבוצת אנונימוס מייצגת מבקרים לא מאומתים באתר.

**מאפיינים:**
- מזהה קבוצה: 3
- קבוצת ברירת מחדל עבור משתמשים שאינם מחוברים
- גישה מוגבלת לקריאה בלבד בדרך כלל
- לא ניתן לשנות תוכן
- הרשאות צפייה ציבורית
...
1. **שם ברור**: השתמש בשמות קבוצות תיאוריים וברורים
2. **תיעוד**: מטרות והרשאות קבוצת מסמכים
3. **עקרון הרשאות הכי פחות**: הענק הרשאות מינימליות נדרשות
4. **ביקורות רגילות**: סקור מעת לעת את החברות וההרשאות בקבוצה
5. **קבוצות ברירת מחדל**: שמור קבוצות ברירת מחדל (מנהלי אתרים, רשומים, אנונימיים)
...
#קבוצות #ניהול קבוצות #הרשאות #בקרת גישה #ארגון משתמש #היררכיה
