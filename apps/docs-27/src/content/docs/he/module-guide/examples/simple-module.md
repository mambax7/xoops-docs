---
title: "דוגמה למודול פשוט"
description: "מודול עבודה מלא עם כל הקבצים הדרושים"
---
# דוגמה פשוטה למודול - בלוג

מודול פשוט שלם ועובד המדגים מושגי ליבה XOOPS.
...
- הצג פוסטים שפורסמו בבלוג עם עימוד
- הצג פוסטים בודדים
- ממשק ניהול ליצירה, עריכה, מחיקת פוסטים
- סטטוס Draft/Published
- חותמות זמן

## בדיקה

1. התקן מודול דרך XOOPS אדמין
2. גישה לחזית הקצה ב-`modules/blog/`
3. בקר ב-admin בכתובת `modules/blog/admin.php`
4. צור פוסט מבחן ופרסם אותו

## תיעוד קשור

ראה גם:
- ../Patterns/MVC-Pattern לתבניות
- ../Patterns/Repository-Pattern עבור גישה לנתונים
- ../Best-Practices/Code-Organization למבנה

---

תגיות: #examples #simple-module #complete-example #module-development