---
title: "Code Smells in XOOPS פיתוח"
---
## סקירה כללית

ריחות קוד הם אינדיקטורים לבעיות פוטנציאליות בקוד. הם לא בהכרח מתכוונים שהקוד מקולקל, אבל הם מציעים אזורים שיכולים להפיק תועלת מ-refactoring.
...
כאשר אתה מזהה ריח קוד:

1. **זהה** - איזה ריח זה?
2. **העריך** - עד כמה חמורה ההשפעה?
3. **תוכנית** - איזו טכניקת ריפאקטורינג חלה?
4. **בדיקה** - ודא שקיימות בדיקות לפני ביצוע מחדש
5. **Refactor** - בצע שינויים קטנים ומצטברים
6. **אמת** - הפעל בדיקות לאחר כל שינוי
