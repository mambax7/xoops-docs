---
title: "Publisher - API הפניה"
description: "השלם הפניה של API עבור מודול Publisher עם מחלקות, שיטות ודוגמאות קוד"
---
# Publisher API הפניה

> הפניה מלאה למחלקות, שיטות, פונקציות, ונקודות קצה API של מודול Publisher.
...
המחלקה `Item` מייצגת article/item בודדת ב-Publisher.
...
ה-`ItemHandler` מנהל פעולות CRUD עבור מאמרים.
...
המחלקה `Category` מייצגת קטגוריה או קטע.
...
## כיתת CategoryHandler

### סקירה כללית

`CategoryHandler` מנהלת את פעילות הקטגוריה CRUD.
...
מחלקת Helper מספקת פונקציות שירות:
...
### Frontend JavaScript פונקציות

הPublisher כולל JavaScript API עבור אינטראקציות מול קצה:
```javascript
...
```
### נקודות קצה של אייאקס

Publisher מספק AJAX נקודות קצה עבור אינטראקציות מול קצה:
```javascript
...
- [PHP תיעוד](https://www.php.net/docs.php)
