---
title: "Publisher - תבניות מותאמות אישית"
description: "מדריך להתאמה אישית של תבניות Publisher ויצירת ערכות נושא מותאמות אישית"
---
# תבניות מותאמות אישית ב-Publisher

> מדריך ליצירה והתאמה אישית של תבניות Publisher תוך שימוש בעקיפות Smarty, CSS ו-HTML.
...
תבניות שולטות כיצד Publisher מציג תוכן:
```
Templates render:
  ├── Article display
  ├── Category listings
...
```
### ערוך תבנית מותאמת אישית

פתח עותק ערכת נושא בעורך טקסט:
```
...
## Smarty יסודות התבנית

### Smarty משתנים

Publisher מספק משתנים לתבניות:
...
```
### תבנית בלוק מאמרים אחרונים

**קובץ: publisher_block_latest.tpl**
```smarty
<!-- Latest Articles Block -->
...
### קבצים מותאמים אישית CSS

צור CSS מותאם אישית בעיצוב:
```
...
עבור איתור באגים (הסר במהלך הייצור):
```smarty
{* Show variable value *}
...
ב-`/modules/publisher/xoops_version.php` או בהגדרות אדמין:
```php
// Enable debug
...
### מגרסה ישנה של Publisher

אם משדרגים מגרסה ישנה יותר:

1. השווה בין קבצי תבנית ישנים וחדשים
2. מיזוג שינויים מותאמים אישית
3. השתמש בשמות משתנים חדשים
4. בדוק היטב
5. גיבוי תבניות ישנות
...
- [Smarty תיעוד](https://www.smarty.net/documentation)
- [Publisher GitHub](https://github.com/XoopsModules25x/publisher)
- [XOOPS מדריך תבניות](../../02-Core-Concepts/Templates/Smarty-Basics.md)

---

#Publisher #תבניות #חכמה #התאמה אישית #ערכת נושא #XOOPS