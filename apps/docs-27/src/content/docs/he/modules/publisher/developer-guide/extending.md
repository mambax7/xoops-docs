---
title: "Publisher מרחיב"
description: "מדריך למפתחים להרחבה והתאמה אישית של מודול Publisher"
---
> מדריך למפתחים להתאמה אישית והרחבה של מודול Publisher.
...
צור תבניות מותאמות אישית בעיצוב שלך:
```
...
```
### רישום חסימה ב-xoops_version.php
```php
$modversion['blocks'][] = [
...
- מדריך למשתמש - תחילת העבודה
- MVC דפוס
- XoopsObject API

---

#xoops #Publisher #מפתח #הרחבת #API