---
title: "הפעל מצב ניפוי באגים"
description: "כיצד להפעיל ולהשתמש במצב ניפוי באגים XOOPS לצורך פתרון בעיות"
---

> מדריך מקיף לתכונות וכלים לאיתור באגים של XOOPS.

---

## ארכיטקטורת ניפוי באגים
...
| רמה | PHP שגיאות | SQL שאילתות | תבנית Vars | מומלץ עבור |
|-------|----------------------|--------------|----------------|
| 0 | מוסתר | לא | לא | הפקה |
| 1 | מוצג | לא | לא | בדיקות מהירות |
| 2 | מוצג | נרשם | לא | פיתוח |
| 3 | מוצג | נרשם | מוצג | איתור באגים עמוק |
...
## SQL ניפוי באגים בשאילתה

### הצג שאילתות במצב ניפוי באגים

כאשר `XOOPS_DEBUG_LEVEL` מוגדר ל-2 או 3, שאילתות SQL מופיעות בתחתית הדפים.
...
## ניפוי באגים בתבנית Smarty

### הפעל את מסוף ניפוי באגים Smarty
...
### ניפוי באגים בשאילתות מסד נתונים
...
#xoops #ניפוי באגים #פתרון בעיות #פיתוח #רישום
