---
title: "PHP תקני קידוד"
description: "XOOPS PHP תקני קידוד המבוססים על PSR-1, PSR-4 ו-PSR-12"
---
# PHP-סטנדרטים

> XOOPS עוקב אחר תקני הקידוד PSR-1, PSR-4 ו-PSR-12 עם מוסכמות ספציפיות ל-XOOPS.
...
#xoops #php #תקני קידוד #psr #שיטות עבודה מומלצות