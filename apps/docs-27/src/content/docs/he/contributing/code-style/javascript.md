---
title: "JavaScript תקני קידוד"
description: "XOOPS JavaScript תקני קידוד ושיטות עבודה מומלצות"
---
# JavaScript תקנים

> XOOPS עומדת בסטנדרטים המודרניים של JavaScript (ES6+) עם דגש על קריאה ותחזוקה.

---

## סקירה כללית

תקני XOOPS JavaScript מבוססים על:

- **ECMAScript 2015+** (ES6 ותכונות מודרניות)
- **Airbnb JavaScript מדריך סגנון** (מותאם)
- **XOOPS מוסכמות** לעקביות
- **תקני נגישות** (WCAG)
...
- השתמש ב-const כברירת מחדל
- השתמש בשמות תיאוריים
- השתמש בפונקציות חצים לcallback
- השתמש ב-async/await להבטחות
- תיעוד פונקציות מורכבות
- cache DOM אלמנטים
- השתמש בהאצלת אירועים
- כתוב פונקציות טהורות
- שמור על פונקציות ממוקדות

### אל תעשה

- השתמש ב-vari (מדור קודם)
- השתמש במשתנים גלובליים
- צור פונקציות ארוכות (מעל 50 שורות)
- קוד קן עמוק
- השתמש ב- eval()
- השתמש במטפלי אירועים מוטבעים
- עזוב את הקונסולה.log() בייצור
- יצירת דליפות זיכרון
- שינוי פרמטרים של פונקציות
...
#xoops #javascript #es6 #תקני קידוד #שיטות עבודה מומלצות