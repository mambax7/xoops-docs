---
title: "מוסכמות תבניות Smarty"
description: "XOOPS Smarty תקני קידוד ושיטות עבודה מומלצות"
---

> XOOPS משתמש ב-Smarty עבור תבנית. מדריך זה מכסה מוסכמות ושיטות עבודה מומלצות לפיתוח תבניות Smarty.
...
- **מבנה תבנית XOOPS** ושם
- **תקני נגישות** (WCAG)
- **סימון HTML5** סמנטי
- **שמות מחלקות בסגנון BEM**
...
### קטע (הוצא משימוש, השתמש ב-foreach במקום זאת)
...
- השתמש ב-HTML5 סמנטי
- כלול טקסט חלופי לתמונות
- השתמש בקבועי שפה עבור טקסט
- פלט בריחה (ברירת מחדל)
- שמור על היגיון מינימלי
- השתמש בשמות משתנים בעלי משמעות
- כלול כותרות קבצים
- השתמש בשמות מחלקות בסגנון BEM
- בדיקה עם קוראי מסך

### אל תעשה

- אל תערבבו היגיון ומצגת
- אל תשכח טקסט חלופי
- אל תשתמש ב-HTML הגולמי מבלי לברוח
- אל תיצור משתנים גלובליים בתבניות
- אל תשתמש בתכונות Smarty שהוצאו משימוש
- אל תקנן תבניות עמוק מדי
- אל תתעלם מנגישות
- אל תקוד טקסט קשה (השתמש בקבועים)
...
#xoops #חכם #תבניות #מוסכמות #שיטות מומלצות
