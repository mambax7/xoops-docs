---
title: "CSS ו-SCSS הנחיות"
description: "XOOPS CSS/SCSS תקני קידוד ושיטות עבודה מומלצות"
---
> XOOPS עומדת בסטנדרטים המודרניים של CSS עם עיבוד מקדים של SCSS, תוך התמקדות בתחזוקה וביצועים.

---

## סקירה כללית

תקני XOOPS CSS מדגישים:

- **SCSS עיבוד מקדים** לארגון
- **BEM מתודולוגיה** למתן שמות
- **עיצוב רספונסיבי ראשון לנייד**
- **נגישות וסמנטית HTML**
...
.card--loading { }
```
### מתן שמות של שיטות עבודה מומלצות
```scss
...
- השתמש במשתנים SCSS עבור צבעים, מרווחים, גופנים
- עקוב אחר מוסכמות השמות של BEM
- עיצוב רספונסיבי ראשון במובייל
- ארגן קבצים לפי מטרה
- כתוב מיקסים לשימוש חוזר
- שמור על בוררים פשוטים (מקסימום 3 רמות עמוקות)
- השתמש סמנטי HTML
- צמצם את הספציפיות
- הערה על סעיפים מורכבים

### אל תעשה

- השתמש בסגנונות מוטבעים
- השתמש ב-!important (כמעט אף פעם)
- צור בוררים ספציפיים מדי
- השתמש בבוררי זיהוי לסטיילינג
- קן עמוק מדי (מקסימום 3-4 רמות)
- השתמש ב-px עבור גדלי גופנים (השתמש ב-rem)
- צור מספרי קסם (השתמש במשתנים)
- השאר ללא שימוש CSS
- תשכחו מנגישות
...
#xoops #css #scss #סטיילינג #תקני קידוד #שיטות עבודה מומלצות