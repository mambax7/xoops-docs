---
title: "פיתוח נושא"
description: "יצירה והתאמה אישית של ערכות נושא של XOOPS עם ירושה של תבנית Smarty"
---

<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

מדריך זה מכסה כיצד ליצור ערכות נושא של XOOPS, כולל מבנה ערכת נושא, תורשה של תבניות ושיטות עבודה מומלצות לבניית ערכות נושא רספונסיביות ומודרניות.
...
ערכת נושא XOOPS מורכבת ממבנה הספריות הבא:
...
קובץ התצורה של ערכת הנושא מגדיר מאפייני ערכת נושא:
...
הירושה של התבנית של Smarty מאפשרת לך ליצור ערכות נושא צאצא שיורשות מנושא אב.
...
צור וריאציות מרובות של ערכת נושא מתוך ערכת נושא בסיסית:
...
קובץ זה מבוצע באופן אוטומטי וניתן להשתמש בו כדי להכין נתונים לתבניות:
...
## מותאם אישית Carousel/Slider

דוגמה לקרוסלת תוכן דינמית:
