---
title: "Шаблонизация Smarty в XOOPS"
---

## Обзор

XOOPS использует механизм шаблонов Smarty для разделения презентации и логики. Это руководство охватывает синтаксис Smarty, функции XOOPS и лучшие практики шаблонов.
