---
title: "Основы Smarty"
description: "Основы шаблонизации Smarty в XOOPS"
---

<span class="version-badge version-25x">2.5.x: Smarty 3</span> <span class="version-badge version-40x">4.0.x: Smarty 4</span>

:::note[Версия Smarty по выпуску XOOPS]
| Версия XOOPS | Версия Smarty | Ключевые различия |
|---------------|----------------|-----------------|
| 2.5.11 | Smarty 3.x | блоки `{php}` разрешены (но не рекомендуются) |
| 2.7.0+ | Smarty 3.x/4.x | Подготовка к совместимости с Smarty 4 |
| 4.0 | Smarty 4.x | блоки `{php}` удалены, более строгий синтаксис |

Смотрите Smarty-4-Migration для руководства миграции.
:::

Smarty - это механизм шаблонов для PHP, который позволяет разработчикам разделять презентацию (HTML/CSS) и логику приложения. XOOPS использует Smarty для всех своих потребностей шаблонизации, обеспечивая чистое разделение между кодом PHP и выводом HTML.
