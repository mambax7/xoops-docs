...
description: "Доступные переменные Smarty в шаблонах XOOPS"
---

XOOPS автоматически предоставляет множество переменных шаблонам Smarty. Этот справочник документирует доступные переменные для разработки тем и модульных шаблонов.

## Связанная документация

- Smarty-Basics - Основы Smarty в XOOPS
- Theme-Development - Создание тем XOOPS
- Smarty-4-Migration - Обновление с Smarty 3 на 4

## Глобальные переменные темы

Эти переменные доступны в шаблонах темы (`theme.tpl`):
