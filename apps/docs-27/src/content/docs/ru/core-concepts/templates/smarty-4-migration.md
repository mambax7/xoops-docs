---
title: "Миграция на Smarty 4"
description: "Руководство по обновлению шаблонов XOOPS с Smarty 3 на Smarty 4"
---

Это руководство охватывает изменения и шаги миграции, необходимые при обновлении с Smarty 3 на Smarty 4 в XOOPS. Понимание этих различий необходимо для обеспечения совместимости с современными установками XOOPS.

## Связанная документация

- Smarty-Basics - Основы Smarty в XOOPS
- Theme-Development - Создание тем XOOPS
- Template-Variables - Доступные переменные в шаблонах

## Обзор изменений

Smarty 4 внёс несколько критических изменений с Smarty 3:
