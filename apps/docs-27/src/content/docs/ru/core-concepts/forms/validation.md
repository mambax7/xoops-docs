...
XOOPS предоставляет валидацию как на стороне клиента, так и на стороне сервера для входных данных формы. Это руководство охватывает методы валидации, встроенные валидаторы и реализацию пользовательской валидации.
