---
title: "Расширенный пример модуля"
description: "Комплексный модуль с несколькими таблицами, отношениями, интерфейсом администратора и блоками"
---

# Расширенный пример модуля - Forum

Комплексный модуль "Forum", демонстрирующий продвинутые паттерны: несколько типов сущностей, отношения, комплексный интерфейс администратора и уведомления.
...
1. **Entity Relationships** - Forums содержат Topics, Topics содержат Posts
2. **Complex Queries** - Joins с информацией пользователя и статистикой
3. **Service Coordination** - Несколько сервисов, работающих вместе
4. **Data Aggregation** - Подсчеты постов, подсчеты просмотров
5. **Notifications** - Уведомления, управляемые событиями, для подписок
6. **Transaction-like Operations** - Создание темы с начальным постом
