...
Темы XOOPS контролируют визуальное представление вашего сайта. Понимание структуры темы необходимо для кастомизации и создания новых тем.
...
Основной шаблон макета, который обертывает весь контент:
...
| Переменная | Описание |
|----------|-------------|
| `$xoops_sitename` | Имя сайта |
| `$xoops_url` | URL сайта |
| `$xoops_theme` | Текущее имя темы |
| `$xoops_langcode` | Код языка |
| `$xoops_charset` | Кодировка символов |
| `$xoops_pagetitle` | Заголовок страницы |
| `$xoops_dirname` | Текущее имя модуля |

### Переменные пользователя

| Переменная | Описание |
|----------|-------------|
| `$xoops_isuser` | Вошли ли в систему |
| `$xoops_isadmin` | Является ли администратором |
| `$xoops_userid` | ID пользователя |
| `$xoops_uname` | Имя пользователя |

### Переменные макета

| Переменная | Описание |
|----------|-------------|
| `$xoops_showlblock` | Показывать левые блоки |
| `$xoops_showrblock` | Показывать правые блоки |
| `$xoops_showcblock` | Показывать центральные блоки |
| `$xoops_lblocks` | Массив левых блоков |
| `$xoops_rblocks` | Массив правых блоков |
| `$xoops_contents` | Основное содержимое страницы |

## Переопределение шаблонов модуля

Переопределите шаблоны модулей, поместив их в вашу тему:
