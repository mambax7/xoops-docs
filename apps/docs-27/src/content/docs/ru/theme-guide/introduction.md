...
description: "Создание и настройка тем XOOPS с наследованием шаблонов Smarty"
---

<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

Это руководство охватывает создание тем XOOPS, включая структуру тем, наследование шаблонов и лучшие практики для создания адаптивных, современных тем.
...
Тема XOOPS состоит из следующей структуры директорий:
...
Файл конфигурации темы определяет свойства темы:
...
Наследование шаблонов Smarty позволяет создавать дочерние темы, которые наследуют от родительской темы.

### Родительская тема (base.tpl)
...
### Создание вариаций тем

Создавайте несколько вариаций тем из базовой темы:
...
Этот файл выполняется автоматически и может использоваться для подготовки данных для шаблонов:
...
Создавайте пользовательские шаблоны блоков:
...
## Пользовательская карусель/слайдер

Пример динамической карусели контента:
...
### Мобильный CSS в первую очередь
