---
title: "Лучшие практики CSS для тем XOOPS"
---

## Обзор

Это руководство охватывает организацию CSS, современные методы макета и оптимизацию производительности при разработке темы XOOPS.
...
### Мобильный первый — точки останова
...
1. **Минимизируйте специфичность** - Избегайте глубокой вложенности
2. **Используйте современные свойства** - `gap` вместо маржинов
3. **Уменьшайте перерисовку** - Используйте `transform` для анимаций
4. **Ленивая загрузка** - Загружайте CSS модуля только когда необходимо
