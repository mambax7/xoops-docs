---
title: "Kriteriji API Referenca"
description: "Popolna referenca API za sistem gradnje poizvedb XOOPS Criteria"
---
> Popolna API dokumentacija za XOOPS sistem za gradnjo poizvedb Criteria.

---

## Merila Sistemska arhitektura
```mermaid
classDiagram
...
## Razred CriteriaCompo

### Konstruktor in metode
```php
// Create empty compo
...
```
### Razvrščanje in številčenje strani
```php
$criteria = new CriteriaCompo();
...
## Kriteriji do SQL Vizualizacija
```mermaid
graph LR
    subgraph "PHP Code"
...
1. **Vedno nastavite LIMIT** za velike mize
2. **Uporabite indekse** za stolpce, uporabljene v kriterijih
3. **Izogibajte se začetnim nadomestnim znakom** v LIKE (`'%term'` je počasen)
4. **Predfilter v PHP**, ko je to mogoče za kompleksno logiko
5. **Zmerno uporabljajte COUNT** – predpomnite rezultate, ko je to mogoče
