---
title: "Načela čiste kode za XOOPS"
---
## Pregled

Čista koda je koda, ki jo je enostavno brati, razumeti in vzdrževati. Ta priročnik pokriva načela čiste kode, posebej uporabljena za XOOPS razvoj modulov.
...
Funkcije naj bodo kratke - idealno manj kot 20 vrstic:
```php
...
```
## DRY Načelo (ne ponavljaj se)

### Izvleček skupne kode
```php
// Bad - repeated code
...
```
## Kontrolni seznam čiste kode

- [ ] Imena so smiselna in izgovorljiva
