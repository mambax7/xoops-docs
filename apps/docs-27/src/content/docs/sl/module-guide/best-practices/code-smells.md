---
title: "Koda diši v XOOPS razvoju"
---
## Pregled

Vonji kode so indikatorji morebitnih težav v kodi. Ne pomenijo nujno, da je koda pokvarjena, vendar predlagajo področja, ki bi jim lahko koristila refaktorizacija.
...
```
## Zlorabniki objektne usmerjenosti
...
```
## Preprečevalci sprememb

### Divergentna sprememba
```php
...
Ko opazite vonj kode:

1. **Prepoznajte** – kakšen vonj je?
2. **Oceni** - Kako močan je vpliv?
3. **Načrt** - Katera tehnika refaktoriranja se uporablja?
4. **Test** - Zagotovite, da obstajajo testi pred refaktoriranjem
5. **Refactor** - naredite majhne, postopne spremembe
6. **Preveri** - Zaženite teste po vsaki spremembi
