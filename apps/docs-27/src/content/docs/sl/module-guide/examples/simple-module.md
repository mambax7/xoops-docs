---
title: "Primer preprostega modula"
description: "Celoten delovni modul z vsemi potrebnimi datotekami"
---
# Primer preprostega modula - blog

Popoln, delujoč preprost modul, ki prikazuje temeljne XOOPS koncepte.
...
- Prikaz objavljenih objav v spletnem dnevniku s paginacijo
- Oglejte si posamezne objave
- Skrbniški vmesnik za ustvarjanje, urejanje, brisanje objav
- status Draft/Published
- Časovni žigi

## Testiranje

1. Namestite modul preko XOOPS admin
2. Dostopajte do vmesnika na `modules/blog/`
3. Obiščite skrbnika na `modules/blog/admin.php`
4. Ustvarite testno objavo in jo objavite

## Povezana dokumentacija

Glej tudi:
- ../Patterns/MVC-Vzorec za vzorce
- ../Patterns/Repository-Pattern za dostop do podatkov
- ../Best-Practices/Code-Organization za strukturo

---

Oznake: #primeri #preprost-modul #celoten-primer #razvoj-modula