---
title: "Migracije baz podatkov"
---
## Pregled

Migracije baz podatkov zagotavljajo reverzibilne spremembe sheme vaše baze podatkov z nadzorom različic. Zagotavljajo dosledna stanja baze podatkov v razvojnih, uprizoritvenih in produkcijskih okoljih.
...
1. **Ena sprememba na selitev** – osredotočite se na selitve
2. **Vedno zapiši metode** - Omogoči povrnitve
3. **Preizkusite obe smeri** - preverite up() in down()
4. **Uporabite transakcije** - Zavijte kompleksne migracije
5. **Ne spreminjajte starih migracij** – namesto tega ustvarite nove
6. **Izdelajte varnostno kopijo pred zagonom** – še posebej v proizvodnji

## Povezana dokumentacija

- Shema baze podatkov - Oblikovanje sheme
- Database-Operations - Izvedba poizvedbe
- ../xoops_version.php - Module manifest
- ../../07-XOOPS-4.0/XOOPS-4.0-Arhitektura - Moderna arhitektura