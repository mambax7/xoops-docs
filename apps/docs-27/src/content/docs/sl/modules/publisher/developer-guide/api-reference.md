---
title: "Založnik - API Referenca"
description: "Popolna referenca API za modul Publisher z razredi, metodami in primeri kode"
---
# Založnik API Referenca

> Popolna referenca za razrede, metode, funkcije in API končne točke modula Publisher.
...
Razred `Item` predstavlja en sam article/item v Publisherju.

**Imenski prostor:** `XoopsModules\Publisher\`

**Datoteka:** `modules/publisher/class/Item.php`
...
`ItemHandler` upravlja CRUD operacije za artikle.

**Datoteka:** `modules/publisher/class/ItemHandler.php`
...
Razred `Category` predstavlja kategorijo ali razdelek.

**Datoteka:** `modules/publisher/class/Category.php`
...
## Razred CategoryHandler

### Pregled

`CategoryHandler` upravlja poslovanje kategorije CRUD.

**Datoteka:** `modules/publisher/class/CategoryHandler.php`
...
Razred Helper nudi pomožne funkcije:

**Datoteka:** `modules/publisher/class/Helper.php`
```php
// Get helper instance
...
### Frontend JavaScript funkcije

Publisher vključuje JavaScript API za interakcije na sprednji strani:
```javascript
...
Publisher zagotavlja AJAX končnih točk za interakcije na sprednji strani:
```javascript
...
## REST API (če je omogočeno)

### API Končne točke

Če založnik razkrije REST API:
```
...
?>
```
### Pridobite članke po kategorijah
```php
<?php
...
- Trnki in dogodki
- Predloge po meri
- Analiza modula založnika
- Predloge in bloki v Publisherju
- Ustvarjanje članka
...
- [PHP Dokumentacija](https://www.php.net/docs.php)
