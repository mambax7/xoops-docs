...
description: "Priročnik za razvijalce za razširitev in prilagajanje modula Publisher"
---
> Priročnik za razvijalce za prilagajanje in razširitev modula Publisher.
...
### Napredne poizvedbe po predmetih
```php
<?php
...
### Preglasitev predloge

Ustvarite predloge po meri v svoji temi:
```
...
```
### Registrirajte blok v xoops_version.php
```php
$modversion['blocks'][] = [
...
- Uporabniški priročnik - Kako začeti
- MVC Vzorec
- XoopsObject API
