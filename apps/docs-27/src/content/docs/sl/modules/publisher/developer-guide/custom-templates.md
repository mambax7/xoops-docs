---
title: "Založnik – Predloge po meri"
description: "Vodnik za prilagajanje predlog Publisher in ustvarjanje tem po meri"
---
# Predloge po meri v Publisherju

> Vodnik za ustvarjanje in prilagajanje predlog Publisher z uporabo preglasitev Smarty, CSS in HTML.

---

## Pregled sistema predlog

### Kaj so predloge?

Predloge nadzorujejo, kako Publisher prikazuje vsebino:
```
Templates render:
  ├── Article display
  ├── Category listings
...
### Kopiraj predlogo v temo

**1. način: prek upravitelja datotek**
```
...
```
### Uredi predlogo po meri

Odprite kopijo teme v urejevalniku besedil:
```
...
## Osnove predloge Smarty

### Pametne spremenljivke

Publisher predlogam ponudi spremenljivke:
...
```
### Predloga bloka najnovejših člankov
...
### Datoteke po meri CSS

Ustvarite CSS po meri v temi:
```
/themes/yourtheme/modules/publisher/css/custom.css
```
### Struktura osnovne predloge

Razumeti strukturo HTML:
```html
<!-- Publisher Module -->
...
## Referenca spremenljivk predloge

### Postavka (članek) Objekt
```smarty
{* Article Properties *}
{$item->id()}              {* Article ID *}
...
```
### Dodelite spremenljivke v predlogi
```smarty
...
### Prikaži pametne spremenljivke

Za odpravljanje napak (odstrani v produkciji):
```smarty
{* Show variable value *}
...
V `/modules/publisher/xoops_version.php` ali skrbniških nastavitvah:
```php
// Enable debug
...
### Iz stare različice založnika

Če nadgrajujete s starejše različice:

1. Primerjajte stare in nove datoteke predlog
2. Spojite spremembe po meri
3. Uporabite nova imena spremenljivk
4. Temeljito preizkusite
5. Varnostno kopirajte stare predloge
...
- [Dokumentacija Smarty](https://www.Smarty.net/documentation)
- [Založnik GitHub](https://github.com/XoopsModules25x/publisher)
- [XOOPS Vodnik po predlogah](../../02-Core-Concepts/Templates/Smarty-Basics.md)
