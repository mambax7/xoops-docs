...
XOOPS tem nadzoruje vizualno predstavitev vašega spletnega mesta. Razumevanje strukture teme je bistveno za prilagajanje in ustvarjanje novih tem.
...
Glavna predloga postavitve, ki ovije vso vsebino:
```html
<!DOCTYPE html>
...
| Spremenljivka | Opis |
|----------|-------------|
| `$xoops_sitename` | Ime spletnega mesta |
| `$xoops_url` | Stran URL |
| `$xoops_theme` | Ime trenutne teme |
| `$xoops_langcode` | Koda jezika |
| `$xoops_charset` | Kodiranje znakov |
| `$xoops_pagetitle` | Naslov strani |
| `$xoops_dirname` | Trenutno ime modula |

### Uporabniške spremenljivke

| Spremenljivka | Opis |
|----------|-------------|
| `$xoops_isuser` | Je prijavljen |
| `$xoops_isadmin` | Je skrbnik |
| `$xoops_userid` | ID uporabnika |
| `$xoops_uname` | Uporabniško ime |

### Spremenljivke postavitve

| Spremenljivka | Opis |
|----------|-------------|
| `$xoops_showlblock` | Prikaži leve bloke |
| `$xoops_showrblock` | Pokaži desne bloke |
| `$xoops_showcblock` | Prikaži sredinske bloke |
| `$xoops_lblocks` | Levi niz blokov |
| `$xoops_rblocks` | Desni niz blokov |
| `$xoops_contents` | Vsebina glavne strani |

## Preglasitve predloge modula

Preglasite predloge modulov tako, da jih postavite v svojo temo:
```
...
- ../Templates/Smarty-Templating - Sintaksa predloge
- Razvoj teme - Celoten vodnik po temah
- CSS-Best-Practices - Smernice za oblikovanje 
- ../../03-Module-Development/Block-Development - Ustvarjanje blokov