---
title: "Razvoj teme"
description: "Ustvarjanje in prilagajanje XOOPS tem z dedovanjem predlog Smarty"
---
<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

Ta vodnik pokriva, kako ustvariti XOOPS tem, vključno s strukturo teme, dedovanjem predloge in najboljšimi praksami za ustvarjanje odzivnih, sodobnih tem.

## Povezana dokumentacija

- Smarty-Basics - Osnove Smarty v XOOPS
- Template-Variables - razpoložljive spremenljivke v predlogah
- Smarty-4-Migration - Nadgradnja s Smarty 3 na 4

## Struktura teme

Tema XOOPS je sestavljena iz naslednje strukture imenika:
```
themes/
  mytheme/
...
Dedovanje predloge Smarty vam omogoča ustvarjanje podrejenih tem, ki podedujejo nadrejeno temo.

### Nadrejena tema (base.tpl)
```smarty
<!DOCTYPE html>
<html>
<head>
...
{/block}
```
### Ustvarjanje različic tem

Ustvarite več različic teme iz osnovne teme:
...
Ustvarite predloge blokov po meri:
```smarty
...
```
## Po meri Carousel/Slider

Primer dinamičnega vsebinskega vrtiljaka:
```smarty
