---
title: "CSS Najboljše prakse za XOOPS teme"
---
## Pregled

Ta priročnik pokriva CSS organizacijo, sodobne tehnike postavitve in optimizacijo delovanja za XOOPS razvoj teme.
...
### CSS Mreža za postavitev strani
```css
/* _grid.css */
.page-container {
    display: grid;
...
1. **Zmanjšajte specifičnost** - Izogibajte se globokemu gnezdenju
2. **Uporabi moderne lastnosti** - `gap` namesto robov
3. **Zmanjšaj ponovno barvanje** - Uporabi `transform` za animacije
4. **Leno nalaganje** - Naloži modul CSS samo, ko je to potrebno
```css
