---
title: "Standardi kodiranja JavaScript"
description: "XOOPS Standardi kodiranja JavaScript in najboljše prakse"
---
# Standardi JavaScript

> XOOPS sledi sodobnim standardom JavaScript (ES6+) s poudarkom na berljivosti in vzdržljivosti.

---

## Pregled

XOOPS Standardi JavaScript temeljijo na:

- **ECMAScript 2015+** (ES6 in sodobne funkcije)
- **Airbnb JavaScript Style Guide** (prilagojeno)
- **XOOPS konvencije** za doslednost
...
- Privzeto uporabite const
- Uporabljajte opisna imena
- Uporabite puščične funkcije za povratne klice
- Za obljube uporabite async/await
- Dokumentirajte kompleksne funkcije
- Elementi predpomnilnika DOM
- Uporabite delegiranje dogodkov
- Napišite čiste funkcije
- Funkcije naj bodo osredotočene

### Ne

- Uporabi var (podedovano)
- Uporabite globalne spremenljivke
- Ustvarite dolge funkcije (več kot 50 vrstic)
- Koda globokega gnezda
- Uporabite eval()
- Uporabite vgrajene obdelovalce dogodkov
- Pusti konzolo.log() v proizvodnji
- Ustvarite puščanje spomina
- Spremenite parametre funkcije
...
#XOOPS #javascript #es6 #standardi kodiranja #najboljše prakse