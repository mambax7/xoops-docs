---
title: "Smernice CSS in SCSS"
description: "XOOPS CSS/SCSS standardi kodiranja in najboljše prakse"
---
> XOOPS sledi sodobnim standardom CSS s predprocesiranjem SCSS, s poudarkom na vzdržljivosti in zmogljivosti.

---

## Pregled

XOOPS CSS standardi poudarjajo:

- **SCSS predobdelava** za organizacijo
- **BEM metodologija** za poimenovanje
- **Mobile-prva odziven dizajn**
- **Dostopnost in semantika HTML**
...
BEM = Modifikator elementa bloka
```scss
...
- Uporabite SCSS spremenljivk za barve, razmike, pisave
- Upoštevajte konvencijo poimenovanja BEM
- Odzivna zasnova, ki je prva mobilna
- Organizirajte datoteke po namenu
- Napišite miksine za večkratno uporabo
- Izbirniki naj bodo preprosti (največ 3 ravni globoko)
- Uporabite semantiko HTML
- Zmanjšajte specifičnost
- Komentirajte zapletene razdelke

### Ne

- Uporabite vgrajene sloge
- Uporabite !important (skoraj nikoli)
- Ustvarite preveč specifične izbirnike
- Za oblikovanje uporabite izbirnike ID-jev
- Gnezdo pregloboko (največ 3-4 stopnje)
- Uporabite px za velikost pisave (uporabite rem)
- Ustvarite čarobne številke (uporabite spremenljivke)
- Pustite neuporabljeno CSS
- Pozabite na dostopnost
