---
title: "Konvencije predlog Smarty"
description: "XOOPS Standardi kodiranja predloge Smarty in najboljše prakse"
---
> XOOPS za predloge uporablja Smarty. Ta vodnik zajema konvencije in najboljše prakse za razvoj predlog Smarty.

---

## Pregled

XOOPS Sledijo predloge Smarty:

- **XOOPS struktura predloge** in poimenovanje
- **Standardi dostopnosti** (WCAG)
- **Semantična HTML5** oznaka
- poimenovanje razredov v slogu **BEM**
...
<{/if}>
```
### Razdelek (zastarelo, namesto tega uporabite foreach)
```smarty
...
- Uporabite semantično HTML5
- Vključite nadomestno besedilo za slike
- Uporabite jezikovne konstante za besedilo
- Escape izhod (privzeto)
- Ohranite minimalno logiko
- Uporabite smiselna imena spremenljivk
- Vključite glave datotek
- Uporabite imena razredov v slogu BEM
- Preizkusite z bralniki zaslona

### Ne

- Ne mešajte logike in predstavitve
- Ne pozabite na nadomestno besedilo
- Ne uporabljajte surovega HTML brez pobega
- Ne ustvarjajte globalnih spremenljivk v predlogah
- Ne uporabljajte zastarelih funkcij Smarty
- Predlog ne vgnezdite pregloboko
- Ne prezrite dostopnosti
- Ne vnašajte v kodo besedila (uporabite konstante)

---

## Primeri predlog

### Celotna predloga modula
```smarty
{*
