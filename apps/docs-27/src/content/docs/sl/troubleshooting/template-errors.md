---
title: "Napake predloge"
description: "Odpravljanje napak in popravljanje napak v predlogi Smarty v XOOPS"
---
# Napake predloge (pametno odpravljanje napak)

> Pogoste težave s predlogo Smarty in tehnike odpravljanja napak za XOOPS tem in modulov.
...
**Simptomi:**
- Sporočila "Napaka pametne sintakse".
- Predloge se ne prevedejo
- Prazna stran brez izpisa
...
```
### Pogoste sintaksne težave

**Manjka zaključna oznaka:**
```smarty
{* WRONG *}
{if $user}
User: {$user.name}
...
{/if}
```
**Nepravilna sintaksa spremenljivke:**
```smarty
{* WRONG *}
{$user->name}          {* Use . not -> *}
...
## 2. Napake nedefiniranih spremenljivk

**Simptomi:**
- Opozorila "Nedefinirana spremenljivka".
- Spremenljivka se prikaže kot prazna
- PHP obvestilo v dnevniku napak
...
## 3. Manjkajoči ali nepravilni modifikatorji

**Simptomi:**
- Podatki niso pravilno oblikovani
- Besedilo se prikaže kot HTML
- Napačno case/encoding

**Sporočila o napakah:**
```
Warning: undefined modifier 'stripslashes'
```
**Pogosti modifikatorji:**
```smarty
{* String operations *}
...
```
**Registracija modifikatorja po meri:**
```php
<?php
...
## 4. Težave s predpomnilnikom

**Simptomi:**
- Spremembe predloge se ne prikažejo
- Stara vsebina je še vedno prikazana
- Zastarele vključitve ali viri
...
## 5. Napake Plugin Not Found

**Simptomi:**
- "Neznan modifikator" ali "Neznan vtičnik"
- Funkcije po meri ne delujejo
- Napake pri kompilaciji z vtičniki
...
## 6. Predloga Include/Extends Težave

**Simptomi:**
- Vključene predloge se ne naložijo
- Nadrejena predloga ni bila najdena
- CSS/JS se ne nalaga
...
## 7. Spremenljivka Array/Object Dostop

**Simptomi:**
- Ni mogoče dostopati do vrednosti niza
- Lastnosti predmeta se ne prikažejo
- Kompleksne spremenljivke ne uspejo
...
## 8. Težave s kodiranjem znakov

**Simptomi:**
- Popačeno besedilo v predlogah
- Posebni znaki so prikazani nepravilno
- UTF-8 pokvarjenih znakov

**Rešitve:**

**Kodiranje datoteke predloge:**
```smarty
...
## Konfiguracija načina odpravljanja napak

**Omogoči odpravljanje napak v predlogi:**
```php
<?php
// In mainfile.php
...
?>
```
**Izhod konzole za odpravljanje napak:**
```php
<?php
...
## Kontrolni seznam za preverjanje veljavnosti predloge
```mermaid
graph TD
...
1. **Omogoči odpravljanje napak** med razvojem
2. **Preverite predloge** pred uvedbo
3. **Počisti predpomnilnik** po spremembah
4. **Uporabite git** za sledenje spremembam predloge
5. **Preizkusite težave s kodiranjem v več brskalnikih**
6. **Dokumentirajte vtičnike po meri** in modifikatorje
7. **Za doslednost uporabite dedovanje predloge**

---

## Povezana dokumentacija

- Smarty Vodnik za odpravljanje napak
- Smarty Templateing
...
#XOOPS #odpravljanje težav #predloge #pametno #odpravljanje napak