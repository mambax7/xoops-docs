---
title: "Omogoči način za odpravljanje napak"
description: "Kako omogočiti in uporabiti način odpravljanja napak XOOPS za odpravljanje težav"
---
> Obsežen vodnik po XOOPS funkcijah in orodjih za odpravljanje napak.

---

## Odpravljanje napak v arhitekturi
```mermaid
graph TB
...
## XOOPS Ravni odpravljanja napak

### Omogoči v mainfile.php
```php
<?php
...
| Stopnja | PHP Napake | SQL Poizvedbe | Predloga Vars | Priporočeno za |
|-------|------------|-------------|--------------|-----------------|
| 0 | Skrit | Ne | Ne | Proizvodnja |
| 1 | Prikazano | Ne | Ne | Hitri pregledi |
| 2 | Prikazano | Zabeleženo | Ne | Razvoj |
| 3 | Prikazano | Zabeleženo | Prikazano | Globoko odpravljanje napak |
...
## SQL Odpravljanje napak v poizvedbah

### Oglejte si poizvedbe v načinu za odpravljanje napak

Če je `XOOPS_DEBUG_LEVEL` nastavljen na 2 ali 3, se poizvedbe SQL prikažejo na dnu strani.

### Ročno beleženje poizvedb
```php
// Log specific query
...
ray()->pause();
```
### Odpravljanje poizvedb v bazi podatkov
```php
// Log all queries
ray()->showQueries();
...
## PHP Vrstica za odpravljanje napak
...
## Pomočnik za odpravljanje napak po meri
```php
<?php
// class/Debug.php
...
## Izhodni tok odpravljanja napak
```mermaid
sequenceDiagram
    participant Code
    participant Debug
...
#XOOPS #debugging #troubleshooting #development #belging