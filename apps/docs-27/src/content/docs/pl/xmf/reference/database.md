---
title: "Narzędzia bazodanowe"
description: "Narzędzia bazodanowe XMF do zarządzania schematem, migracji i ładowania danych"
---

Przestrzeń nazw `Xmf\Database` zapewnia klasy upraszczające zadania konserwacji bazy danych związane z instalacją i aktualizacją modułów XOOPS. Te narzędzia obsługują migracje schematów, modyfikacje tabel i początkowe ładowanie danych.
