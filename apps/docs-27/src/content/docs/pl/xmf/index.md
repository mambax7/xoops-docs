---
title: "Framework XMF"
description: "The XOOPS Module Framework - kompleksowa biblioteka do nowoczesnego tworzenia modułów XOOPS"
---

<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

:::tip[Most do nowoczesnego XOOPS]
XMF działa w **zarówno XOOPS 2.5.x jak i XOOPS 4.0.x**. To zalecany sposób na modernizację modułów dzisiaj, przygotowując się do XOOPS 4.0. XMF zapewnia autoloading PSR-4, przestrzenie nazw i helpery, które wygładzają przejście.
:::

**XOOPS Module Framework (XMF)** to potężna biblioteka zaprojektowana, aby uprościć i standaryzować tworzenie modułów XOOPS. XMF zapewnia nowoczesne praktyki PHP, w tym przestrzenie nazw, autoloading i kompleksowy zestaw klas helperów, które zmniejszają kod boilerplate i poprawiają łatwość konserwacji.
