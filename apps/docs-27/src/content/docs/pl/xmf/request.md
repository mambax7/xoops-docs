---
title: "Żądanie XMF"
description: 'Bezpieczna obsługa żądań HTTP i walidacja wejścia z klasą Xmf\Request'
---

Klasa `Xmf\Request` zapewnia kontrolowany dostęp do zmiennych żądań HTTP z wbudowaną sanityzacją i konwersją typów. Chroni przed potencjalnie szkodliwymi wstrzykiwaniami domyślnie, jednocześnie dostosowując wejście do określonych typów.
