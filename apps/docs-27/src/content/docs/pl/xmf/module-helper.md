---
title: "Helper modułu XMF"
description: 'Uproszczone operacje modułów z użyciem klasy Xmf\Module\Helper i powiązanych helperów'
---

Klasa `Xmf\Module\Helper` zapewnia łatwy sposób dostępu do informacji związanych z modułem, konfiguracji, handlerów i wielu więcej. Używanie helpera modułu upraszcza kod i zmniejsza boilerplate.
