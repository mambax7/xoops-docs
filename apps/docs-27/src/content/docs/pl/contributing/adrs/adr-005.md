---
title: "ADR-005 - Wzorzec middleware PSR-15"
description: "Rekord decyzji architektonicznej do przyjęcia middleware PSR-15 w XOOPS 4.0"
---

# ADR-005: Wzorzec middleware PSR-15 dla XOOPS 4.0

> Przyjmij obsługę żądań HTTP PSR-15 (middleware) dla ulepszonego potoku przetwarzania żądań.

:::caution[Propozycja XOOPS 4.0 — niedostępna w 2.5.x]
Ten ADR opisuje **proponowaną architekturę dla XOOPS 4.0**. Middleware PSR-15 **nie jest dostępne w XOOPS 2.5.x**. Aktualne moduły 2.5.x używają wzorca Page Controller z bootstrapem `mainfile.php`. Patrz XOOPS Architecture dla aktualnego cyklu życia żądania.
:::
...
### Problemy z bieżącym podejściem
...
### Przyjmij stos middleware PSR-15 dla XOOPS 4.0
