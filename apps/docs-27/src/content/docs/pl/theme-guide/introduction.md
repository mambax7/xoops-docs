...
description: "Tworzenie i dostosowywanie motywów XOOPS z dziedziczeniem szablonów Smarty"
---

<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

Ten przewodnik obejmuje sposób tworzenia motywów XOOPS, w tym strukturę motywu, dziedziczenie szablonów i najlepsze praktyki tworzenia responsywnych, nowoczesnych motywów.

## Powiązana dokumentacja

- Smarty-Basics - Podstawy Smarty w XOOPS
- Template-Variables - Dostępne zmienne w szablonach
- Smarty-4-Migration - Aktualizacja z Smarty 3 do 4

## Struktura motywu

Motyw XOOPS składa się z następującej struktury katalogów:
...
Plik konfiguracyjny motywu definiuje właściwości motywu:
...
## Podstawowa struktura theme.tpl
...
Dziedziczenie szablonów Smarty pozwala tworzyć motywy potomne, które dziedziczą od motywu macierzystego.

### Motyw macierzysty (base.tpl)
...
### Motyw potomny (theme.tpl)

```smarty
{extends file="db:parenttheme/theme.tpl"}

{block name=title}Mój niestandardowy tytuł{/block}

{block name=head_css}
    {$smarty.block.parent}  {* Dołącz CSS motywu macierzystego *}
...
Utwórz wiele wariantów motywu z motywu bazowego:
...
Ten plik jest wykonywany automatycznie i może być używany do przygotowania danych dla szablonów:
...
// Dołącz autoloader modułu, jeśli jest potrzebny
...
/**
 * Pobierz elementy do wyświetlenia w motywie
 */
...
Utwórz niestandardowe szablony bloków:
...
## Niestandardowy Carousel/Slider

Przykład dynamicznego karuzeli zawartości:
...
## Wskazówki dotyczące projektu responsywnego
...
### Warunkowe wyświetlanie bloków

```smarty
{* Ukryj bloki na urządzeniach mobilnych za pomocą klas CSS *}
<{if $xoops_showlblock}>
...
```smarty
{* Stosuj prawidłowe etykiety ARIA *}
...
{* Linki pomijające dla nawigacji za pomocą klawiatury *}
<a href="#main-content" class="skip-link">Przejdź do zawartości</a>
```
