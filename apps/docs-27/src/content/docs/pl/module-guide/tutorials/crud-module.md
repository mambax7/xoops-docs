---
title: "Budowa modułu CRUD"
description: "Kompletny samouczek do budowy modułu CRUD z operacjami na bazie danych, formularzami i interfejsem administracyjnym"
---

# Samouczek budowy modułu CRUD

Ten samouczek prowadzi cię przez tworzenie kompletnego modułu CRUD (Create, Read, Update, Delete) dla XOOPS. Utworzymy moduł "Notatki", który umożliwia użytkownikom zarządzanie osobistymi notatkami.

## Wymagania wstępne

- Ukończony samouczek Hello-World-Module
- Zrozumienie koncepcji PHP OOP
- Podstawowa wiedza SQL

## Przegląd modułu

**Funkcje modułu notatek:**
- Tworzenie, przeglądanie, edycja i usuwanie notatek
- Interfejs zarządzania administracyjnego
- Notatki specyficzne dla użytkownika
- Organizacja kategorii
- Funkcjonalność wyszukiwania

## Krok 1: Struktura katalogów

Utwórz następującą strukturę w `/modules/notes/`:
...
## Krok 2: Schemat bazy danych

Utwórz `sql/mysql.sql`:

```sql
-- Schemat bazy danych modułu notatek
...
## Krok 3: Definicja modułu

Utwórz `xoops_version.php`:

```php
<?php
/**
 * Notes Module - Definicja modułu
 */
...
// Funkcje instalacji/aktualizacji
$modversion['onInstall'] = 'include/install.php';
$modversion['onUpdate']  = 'include/update.php';
```

## Krok 4: Klasy jednostek

### Jednostka notatki

Utwórz `class/Note.php`:
