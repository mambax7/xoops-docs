---
title: "Przykład modułu zaawansowanego"
description: "Złożony moduł z wieloma tabelami, relacjami, interfejsem administracyjnym i blokami"
---

# Przykład modułu zaawansowanego - Forum

Kompleksowy moduł "Forum", który demonstruje zaawansowane wzorce: wiele typów jednostek, relacje, złożony interfejs administracyjny i powiadomienia.
