...
description: "Kontrola wersji zmian schematu bazy danych"
---

## Przegląd

Migracje bazy danych zapewniają kontrolę wersji, odwracalne zmiany w schemacie bazy danych. Zapewniają spójne stany bazy danych w środowiskach rozwojowych, przejściowych i produkcyjnych.
...
1. **Jedna zmiana na migrację** - Trzymaj migracje skoncentrowane
2. **Zawsze pisz metody Down** - Umożliwi cofanie
3. **Testuj obie kierunki** - Sprawdź up() i down()
4. **Używaj transakcji** - Zawiń złożone migracje
5. **Nie modyfikuj starych migracji** - Zamiast tego utwórz nowe
6. **Zrób kopię zapasową przed uruchomieniem** - Szczególnie w produkcji

## Powiązana dokumentacja

- Schemat bazy danych - Projektowanie schematu
- Operacje bazy danych - Wykonywanie zapytań
- ../xoops_version.php - Manifest modułu
- ../../07-XOOPS-4.0/XOOPS-4.0-Architecture - Nowoczesna architektura
