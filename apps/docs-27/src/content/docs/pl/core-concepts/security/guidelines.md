---
title: "Wytyczne dotyczące bezpieczeństwa"
---

## Przegląd

Niniejszy dokument zawiera wytyczne najlepszych praktyk bezpieczeństwa dla rozwoju XOOPS, obejmujące walidację danych wejściowych, kodowanie danych wyjściowych, uwierzytelnianie, autoryzację i ochronę przed powszechnie znanymi lukami bezpieczeństwa w sieci.
...
### Korzystanie z obiektów Criteria
...
- [ ] Sparametryzowane zapytania dla wszystkich operacji bazodanowych
- [ ] Kodowanie danych wyjściowych dla całej zawartości generowanej przez użytkowników
- [ ] Tokeny CSRF na wszystkich formularzach zmieniających stan
- [ ] Bezpieczne haszowanie haseł (Argon2id)
- [ ] Skonfigurowane bezpieczeństwo sesji
- [ ] Walidacja przesyłania plików
- [ ] Ustawione nagłówki bezpieczeństwa
- [ ] Wdrożone ograniczanie szybkości
- [ ] Włączone rejestrowanie audytu
- [ ] Komunikaty o błędach nie ujawniają poufnych informacji
