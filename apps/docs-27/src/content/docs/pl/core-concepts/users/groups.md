---
title: "System grup"
description: "Kompleksowy przewodnik do zarządzania grupami XOOPS, domyślne grupy, grupy niestandardowe i hierarchia grup"
---

# System grup w XOOPS

System grup XOOPS zapewnia hierarchiczną strukturę do organizowania użytkowników i zarządzania zbiorowymi uprawnieniami. Dokument obejmuje grupy domyślne, tworzenie grup niestandardowych, hierarchię i praktyczną implementację.

## Grupy domyślne

XOOPS zawiera trzy podstawowe grupy, które są tworzone podczas instalacji systemu:

### Grupa Webmasterów (ID: 1)

Grupa Webmasterów reprezentuje administratorów witryny z pełnym dostępem do systemu.

**Charakterystyka:**
- ID grupy: 1
- Najwyższy poziom uprawnień
- Nie można usunąć
- Pełny dostęp do wszystkich modułów i funkcji
...
### Grupa zarejestrowanych użytkowników (ID: 2)

Grupa Zarejestrowanych użytkowników obejmuje wszystkich uwierzytelnionych użytkowników, którzy nie są anonimowi.

**Charakterystyka:**
- ID grupy: 2
- Domyślna grupa dla nowych rejestracji
- Mogą uzyskiwać dostęp do funkcji specjalnych dla użytkowników
- Podlegają uprawnieniom opartym na grupach
- Można dostosować do standardowych funkcji użytkownika
...
### Grupa Anonimowa (ID: 3)

Grupa Anonimowa reprezentuje nieuwierzytelnionych odwiedzających witrynę.

**Charakterystyka:**
- ID grupy: 3
- Domyślna grupa dla niezalogowanych użytkowników
- Zazwyczaj ograniczony dostęp tylko do odczytu
- Nie mogą modyfikować zawartości
- Publiczne uprawnienia do przeglądania
...
### Konfiguracja grupy departamentu
...
1. **Jasne nazewnictwo**: Użyj opisowych, wyraźnych nazw grup
2. **Dokumentacja**: Dokumentuj cele grupy i uprawnienia
3. **Zasada najmniejszych uprawnień**: Przyznaj minimalne wymagane uprawnienia
4. **Regularne audyty**: Okresowo przeglądaj członkostwo w grupach i uprawnienia
5. **Grupy domyślne**: Zachowaj grupy domyślne (Webmasterów, Zarejestrowani, Anonimowi)
