---
title: "Publisher - 自訂範本"
description: "使用 Smarty、CSS 和 HTML 覆蓋來自訂和建立 Publisher 範本的指南"
---

# Publisher 中的自訂範本

> 使用 Smarty、CSS 和 HTML 覆蓋來建立和自訂 Publisher 範本的指南。
...
在 `/modules/publisher/xoops_version.php` 或管理設定中：
