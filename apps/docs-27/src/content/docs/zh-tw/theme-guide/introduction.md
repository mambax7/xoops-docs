---
title: "主題開發"
description: "使用 Smarty 範本繼承建立和自訂 XOOPS 主題"
---

<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

本指南涵蓋如何建立 XOOPS 主題，包括主題結構、範本繼承以及建立回應式現代主題的最佳實踐。

## 相關文件

- Smarty-Basics - XOOPS 中 Smarty 的基礎
- Template-Variables - 範本中的可用變數
- Smarty-4-Migration - 從 Smarty 3 升級到 4
