---
title: "XOOPS 主題的 CSS 最佳實踐"
---

## 概述

本指南涵蓋 XOOPS 主題開發的 CSS 組織、現代佈局技巧和效能最佳化。
...
1. **最小化特異性** - 避免深度嵌套
2. **使用現代屬性** - 使用 `gap` 代替邊界
3. **減少重新繪製** - 使用 `transform` 進行動畫
4. **延遲載入** - 僅在需要時載入模組 CSS
...
- Theme-Structure - 主題檔案組織
- Theme-Development - 完整主題指南
- ../Templates/Smarty-Templating - 範本整合
- ../../03-Module-Development/Block-Development - 區塊樣式
