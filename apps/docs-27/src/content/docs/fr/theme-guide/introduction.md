...
description: "Création et personnalisation de thèmes XOOPS avec héritage de modèles Smarty"
---

<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

Ce guide couvre la création de thèmes XOOPS, y compris la structure des thèmes, l'héritage de modèles et les meilleures pratiques pour construire des thèmes réactifs et modernes.

## Documentation connexe

- Smarty-Basics - Principes fondamentaux de Smarty dans XOOPS
- Template-Variables - Variables disponibles dans les modèles
- Smarty-4-Migration - Mise à niveau de Smarty 3 à 4

## Structure des thèmes

Un thème XOOPS se compose de la structure de répertoire suivante:

```
themes/
  mytheme/
    theme.tpl              # Modèle de thème principal
    theme_autorun.php      # PHP exécuté automatiquement (optionnel)
    XOOPS_version.php      # Configuration du thème
    css/
      style.css            # Feuille de style principale
      custom.css           # Styles personnalisés
    images/
      logo.png             # Images du thème
    js/
      custom.js            # JavaScript du thème
    language/
      english/
        main.php           # Chaînes de langue
```

## XOOPS_version.php

Le fichier de configuration du thème définit les propriétés du thème:
...
## Structure de base de theme.tpl
...
L'héritage de modèle Smarty vous permet de créer des thèmes enfants qui héritent d'un thème parent.

### Thème parent (base.tpl)
...
{block name=head_css}
    {$smarty.block.parent}  {* Inclure le CSS parent *}
...
### Création de variations de thème

Créez plusieurs variations de thème à partir d'un thème de base:
...
Ce fichier est exécuté automatiquement et peut être utilisé pour préparer les données pour les modèles:
...
Un exemple de thème Bootstrap 5:
...
Créez des modèles de bloc personnalisés:
...
## Carrousel/curseur personnalisé

Exemple d'un carrousel de contenu dynamique:
...
## Conseils de conception réactive
...
### Affichage conditionnel de bloc
