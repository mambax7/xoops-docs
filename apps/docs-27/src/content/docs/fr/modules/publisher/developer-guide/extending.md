---
title: "Étendre Publisher"
description: "Guide développeur pour étendre et personnaliser le module Publisher"
---

> Guide du développeur pour personnaliser et étendre le module Publisher.
...
classDiagram
    ...
    Item --> ItemHandler : géré par
    Category --> CategoryHandler : géré par
    ItemHandler --> Helper : utilise
    CategoryHandler --> Helper : utilise
```
...
```php
<?php
// Obtenir l'instance d'aide de Publisher
...
- Guide Utilisateur - Mise en Route
- Modèle MVC
- API XoopsObject

---

#xoops #publisher #développeur #étendre #api
