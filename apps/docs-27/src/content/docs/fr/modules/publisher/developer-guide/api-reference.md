---
title: "Publisher - Référence API"
description: "Référence API complète du module Publisher avec les classes, méthodes et exemples de code"
---

# Référence API Publisher

> Référence complète pour les classes du module Publisher, les méthodes, les fonctions et les points de terminaison de l'API.
...
La classe `Item` représente un seul article/élément dans Publisher.

**Espace de noms :** `XoopsModules\Publisher\`

**Fichier :** `modules/publisher/class/Item.php`
