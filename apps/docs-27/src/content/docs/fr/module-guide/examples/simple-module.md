---
title: "Exemple de module simple"
description: "Module complet fonctionnant avec tous les fichiers nécessaires"
---

# Exemple de module simple - Blog

Un module simple complet et fonctionnant qui démontre les concepts fondamentaux de XOOPS.
...
- Afficher les articles de blog publiés avec pagination
- Afficher les articles individuels
- Interface admin pour créer, modifier, supprimer les articles
- Statut Brouillon/Publié
- Horodatages

## Tests

1. Installer le module via l'admin XOOPS
2. Accéder au frontend à `modules/blog/`
3. Visiter l'admin à `modules/blog/admin.php`
4. Créer un article de test et le publier

## Documentation connexe

Voir aussi :
- ../Patterns/MVC-Pattern pour les modèles
- ../Patterns/Repository-Pattern pour l'accès aux données
- ../Best-Practices/Code-Organization pour la structure
