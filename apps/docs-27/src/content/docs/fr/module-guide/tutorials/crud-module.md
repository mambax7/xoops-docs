---
title: "Construire un module CRUD"
description: "Tutoriel complet pour construire un module CRUD avec des opérations de base de données, des formulaires et une interface admin"
---

# Tutoriel de construction d'un module CRUD

Ce tutoriel vous guide dans la construction d'un module CRUD complet (Create, Read, Update, Delete) pour XOOPS. Nous allons créer un module "Notes" qui permet aux utilisateurs de gérer des notes personnelles.

## Prérequis

- Tutoriel du module Hello World terminé
- Compréhension des concepts OOP de PHP
- Connaissances SQL de base

## Aperçu du module

**Fonctionnalités du module Notes :**
- Créer, afficher, modifier et supprimer des notes
- Interface de gestion admin
- Notes spécifiques à l'utilisateur
- Organisation par catégories
- Fonctionnalité de recherche

## Étape 1 : Structure des répertoires

Créez la structure suivante dans `/modules/notes/` :
...
## Étape 4 : Classes d'entités

### Entité Note

Créez `class/Note.php` :
...
Créez `class/CategoryHandler.php` :
...
## Étape 5 : Fichier d'inclusion commune

Créez `include/common.php` :
...
Créez `templates/notes_index.tpl` :
...
Créez `templates/notes_view.tpl` :
...
Créez `templates/notes_edit.tpl` :
...
Félicitations ! Vous avez construit un module CRUD complet. Concepts clés couverts :

1. **Conception de base de données** - Tables avec relations
2. **Classes d'entités** - XoopsObject avec propriétés typées
3. **Classes Handler** - XoopsPersistableObjectHandler avec méthodes personnalisées
4. **Pages Frontend** - Fonctionnalité de liste, affichage et modification
5. **Gestion de formulaires** - Protection CSRF et validation
6. **Interface Admin** - Écrans de gestion
7. **Modèles** - Modèles Smarty avec logique

## Prochaines étapes

- Ajouter des fonctionnalités plus avancées (commentaires, évaluations, partage)
- Implémenter le ../Patterns/Repository-Pattern pour un accès aux données plus propre
- Appliquer ../Patterns/MVC-Pattern pour une meilleure organisation du code
- Ajouter ../Best-Practices/Testing avec PHPUnit

Voir aussi : ../Module-Development | ../Patterns/MVC-Pattern | ../Patterns/Repository-Pattern
