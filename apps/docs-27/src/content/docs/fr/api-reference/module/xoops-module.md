---
title: "Référence API XoopsModule"
description: "Référence API complète pour la classe XoopsModule et les classes du système de modules"
---

> Documentation API complète pour le système de modules XOOPS.
...
|----------|------|-------------|
| `mid` | int | ID du module |
| `name` | string | Nom d'affichage |
| `version` | string | Numéro de version |
| `dirname` | string | Nom du répertoire |
| `isactive` | int | Statut actif (0/1) |
| `hasmain` | int | Possède zone principale |
| `hasadmin` | int | Possède zone admin |
| `hassearch` | int | Possède fonction de recherche |
| `hasconfig` | int | Possède configuration |
| `hascomments` | int | Possède commentaires |
| `hasnotification` | int | Possède notifications |
...
- API XoopsObject
- Guide de développement des modules
- Architecture XOOPS
