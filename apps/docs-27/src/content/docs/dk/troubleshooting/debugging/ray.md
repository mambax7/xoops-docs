---
title: "Brug af Ray Debugger"
description: "Fejlretning af XOOPS applikationer med Ray debugger"
---

# Brug af Ray Debugger til XOOPS

> Moderne fejlretning med Ray: undersøg variabler, logmeddelelser, spor SQL-forespørgsler og profilydelse i din XOOPS-applikation.

---

## Hvad er Ray?

Ray er et letvægtsfejlfindingsværktøj, der hjælper dig med at inspicere applikationstilstand uden at stoppe eksekveringen eller bruge brudpunkter. Det er perfekt til XOOPS udvikling.

**Funktioner:**
- Log beskeder og variabler
- Undersøg SQL-forespørgsler
- Spor ydeevne
- Profilkode
- Grupperelateret logs
- Visuel tidslinje

**Krav:**
- PHP 7.4+
- Ray-applikation (gratis version tilgængelig)
- Komponist
...
### Trin 2: Download Ray-appen

Download fra [ray.so](https://ray.so):
- Mac: Ray.app
- Windows: Ray.exe
- Linux: ray (AppImage)

### Trin 3: Konfigurer firewall (hvis nødvendigt)

Ray bruger port 23517 som standard:
...
### 4. Gruppering af relaterede logfiler
...
## Brugerdefinerede strålefunktioner
...
## Fejlretning af arbejdsgange

### Modul Installation Debugging
...
### Q: Ray modtager ikke beskeder

**A:**
1. Kontroller, at Ray-appen kører
2. Tjek, at firewall tillader port 23517
3. Bekræft, at Ray er installeret:
```bash
composer require spatie/ray
```

### Q: Kan ikke se SQL-forespørgsler
...
### Q: Ydeevnepåvirkning af Ray

**A:** Ray har minimal overhead. Til produktion skal du fjerne Ray-opkald eller deaktivere:
```php
<?php
...
#xoops #fejlretning #ray #profilering #overvågning
