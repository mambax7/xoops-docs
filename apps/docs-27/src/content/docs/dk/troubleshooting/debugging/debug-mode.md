---
title: "Aktiver fejlretningstilstand"
description: "Sådan aktiverer og bruger du XOOPS debug-tilstand til fejlfinding"
---

> Omfattende guide til XOOPS fejlfindingsfunktioner og værktøjer.
...
## XOOPS Fejlretningsniveauer

### Aktiver i mainfile.php
...
| Niveau | PHP Fejl | SQL Forespørgsler | Skabelon Vars | Anbefalet til |
|-------|---------------------------------------|
| 0 | Skjult | Nej | Nej | Produktion |
| 1 | Vist | Nej | Nej | Hurtig kontrol |
| 2 | Vist | Logget | Nej | Udvikling |
| 3 | Vist | Logget | Vist | Dyb debugging |
...
## SQL Forespørgselsfejlfinding

### Se forespørgsler i fejlretningstilstand

Med `XOOPS_DEBUG_LEVEL` indstillet til 2 eller 3, vises SQL-forespørgsler nederst på siderne.

### Manuel logføring af forespørgsler
...
## Smarty skabelonfejlfinding

### Aktiver Smarty Debug Console
...
#xoops #fejlfinding #fejlfinding #udvikling #logning
