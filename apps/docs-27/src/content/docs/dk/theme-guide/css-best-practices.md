---
title: "CSS bedste praksis for XOOPS-temaer"
---

## Oversigt

Denne vejledning dækker CSS-organisation, moderne layoutteknikker og ydeevneoptimering til XOOPS-temaudvikling.
...
## CSS Brugerdefinerede egenskaber
...
1. **Minimer specificitet** - Undgå dyb redebygning
2. **Brug moderne egenskaber** - `gap` i stedet for marginer
3. **Reducer genmaling** - Brug `transform` til animationer
4. **Lazy load** - Indlæs kun modulet CSS, når det er nødvendigt
...
- Tema-Struktur - Tema filorganisation
- Tema-udvikling - Komplet temaguide
- ../Templates/Smarty-Templating - Skabelonintegration
- ../../03-Module-Development/Block-Development - Blokstyling
