---
title: "Kriterier API Reference"
description: "Fuldfør API-reference for byggesystemet XOOPS Criteria-forespørgsel"
---

> Komplet API-dokumentation til XOOPS Criteria-forespørgselsbygningssystemet.

---

## Kriterier Systemarkitektur
...
## Eksempler på komplekse forespørgsler

### Søg med flere betingelser
...
## Kriterier til SQL visualisering
...
1. **Indstil altid LIMIT** for store borde
2. **Brug indekser** på kolonner, der bruges i kriterier
3. **Undgå førende jokertegn** i LIKE (`'%term'` er langsom)
4. **Forfilter i PHP** når det er muligt for kompleks logik
5. **Brug COUNT sparsomt** - cacheresultater, når det er muligt
...
#xoops #api #kriterier #database #forespørgsel #reference
