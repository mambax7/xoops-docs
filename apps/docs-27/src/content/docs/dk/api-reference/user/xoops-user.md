...
description: "Fuldfør API reference for XoopsUser og brugerstyringsklasser"
---

> Komplet API-dokumentation til XOOPS-brugersystemet.
...
|--------|------|------------|
| `uid` | int | Bruger-id (primær nøgle) |
| `uname` | streng | Brugernavn |
| `name` | streng | Rigtige navn |
| `email` | streng | E-mailadresse |
| `pass` | streng | Adgangskode hash |
| `url` | streng | Hjemmeside URL |
| `user_avatar` | streng | Avatar filnavn |
| `user_regdate` | int | Registreringstidsstempel |
| `user_from` | streng | Beliggenhed |
| `user_sig` | streng | Signatur |
| `user_occ` | streng | Beskæftigelse |
| `user_intrest` | streng | Interesser |
| `bio` | streng | Biografi |
| `posts` | int | Antal indlæg |
| `rank` | int | Brugerrangering |
| `level` | int | Brugerniveau (0=inaktiv, 1=aktiv) |
| `theme` | streng | Foretrukket tema |
| `timezone` | flyde | Tidszone offset |
| `last_login` | int | Sidste login tidsstempel |
...
| Gruppe-id | Navn | Beskrivelse |
|--------|------|------------|
| 1 | Webmastere | Fuld administrativ adgang |
| 2 | Registrerede brugere | Standard registrerede brugere |
| 3 | Anonym | Ikke-loggede besøgende |
...
- Brugerstyringsvejledning
- Tilladelsessystem
- Autentificering

---

#xoops #api #bruger #godkendelse #reference
