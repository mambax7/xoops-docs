---
title: "Kode lugter i XOOPS udvikling"
---

## Oversigt

Kode lugte er indikatorer for potentielle problemer i kode. De betyder ikke nødvendigvis, at koden er brudt, men de foreslår områder, der kunne drage fordel af refaktorisering.

## Almindelig kode lugter
...
## Misbrugere af objektorientering
...
## Refaktoreringstjekliste

Når du opdager en kodelugt:

1. **Identificer** - Hvilken lugt er det?
2. **Vurder** - Hvor alvorlig er påvirkningen?
3. **Plan** - Hvilken refactoring-teknik gælder?
4. **Test** - Sørg for, at der findes tests før refaktorisering
5. **Refactor** - Foretag små, trinvise ændringer
6. **Bekræft** - Kør test efter hver ændring
