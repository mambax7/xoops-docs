---
title: "Bloker udvikling"
---

## Oversigt

Blokke er genbrugelige indholdswidgets, der vises i temasidebjælker og indholdsområder. Denne vejledning dækker oprettelse, konfiguration og tilpasning af XOOPS-blokke.

## Blokstruktur

### Blokdefinition i xoops_version.php
...
|--------|-------------|
| `file` | PHP fil, der indeholder blokfunktioner |
| `name` | Sprogkonstant for bloktitel |
| `description` | Sprogkonstant til beskrivelse |
| `show_func` | Funktion til at gengive blokindhold |
| `edit_func` | Funktion til at gengive blokoptioner form |
| `template` | Smarty skabelonfil |
| `options` | Rør-separerede standardindstillinger |
...
## Bloker med klonunderstøttelse

Klonbare blokke tillader flere tilfælde:
...
1. **Cacheresultater** - Cache dyre forespørgsler
2. **Valider indstillinger** - Valider altid blokeringsmuligheder
3. **Escape Output** - Rengør alt brugerindhold
4. **Use Criteria** - Byg forespørgsler med Criteria-klassen
5. **Grænseforespørgsler** - Sæt rimelige grænser for ydeevne
6. **Responsive skabeloner** - Sørg for, at blokke fungerer på mobilen

## Relateret dokumentation

- Moduludvikling - Moduloprettelsesvejledning
- ../02-Core-Concepts/Templates/Smarty-Templating - Skabelonsyntaks
