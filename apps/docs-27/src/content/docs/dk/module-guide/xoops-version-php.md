...
| `author` | streng | Primært forfatternavn |
...
| formtype | værditype | Beskrivelse |
|--------|------------|-------------|
| `textbox` | `text`/`int` | Single-line input |
| `textarea` | `text` | Multi-line input |
| `yesno` | `int` | Ja/Nej radio |
| `select` | `text` | Dropdown vælg |
| `select_multi` | `array` | Multi-vælg |
| `group` | `int` | Gruppevælger |
| `group_multi` | `array` | Multigruppevælger |
| `user` | `int` | Brugervælger |
| `color` | `text` | Farvevælger |
...
- Database-Operations - Database opsætning
