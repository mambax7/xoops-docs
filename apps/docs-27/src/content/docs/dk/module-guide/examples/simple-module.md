---
title: "Simpelt moduleksempel"
description: "Fuldfør arbejdsmodul med alle nødvendige filer"
---

# Enkelt moduleksempel - blog

Et komplet, fungerende enkelt modul, der demonstrerer kerne-XOOPS-koncepter.
...
- Vis offentliggjorte blogindlæg med paginering
- Se individuelle indlæg
- Admin-grænseflade til at oprette, redigere, slette indlæg
- Udkast/Udgivet status
- Tidsstempler

## Test

1. Installer modulet via XOOPS admin
2. Få adgang til frontend på `modules/blog/`
3. Besøg admin på `modules/blog/admin.php`
4. Opret et testindlæg og udgiv det

## Relateret dokumentation

Se også:
- ../Patterns/MVC-Pattern til mønstre
- ../Patterns/Repository-Pattern for dataadgang
- ../Best-Practices/Code-Organization til struktur

---

Tags: #eksempler #simpelt-modul #fuldstændigt-eksempel #modul-udvikling
