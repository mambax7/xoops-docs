---
title: "Opbygning af et CRUD-modul"
description: "Komplet selvstudie til at bygge et CRUD-modul med databasehandlinger, formularer og admin-grænseflade"
---

# Opbygning af et CRUD-modulvejledning

Denne tutorial leder dig gennem opbygningen af et komplet CRUD (Opret, Læs, Opdater, Slet) modul til XOOPS. Vi vil oprette et "Noter"-modul, der giver brugerne mulighed for at administrere personlige noter.

## Forudsætninger

- Gennemført Hello-World-Module tutorial
- Forståelse af PHP OOP koncepter
- Grundlæggende SQL viden

## Moduloversigt

**Bemærkningsmodulets funktioner:**
- Opret, se, rediger og slet noter
- Admin management interface
- Brugerspecifikke noter
- Kategoriorganisation
- Søgefunktion

## Trin 1: Directory Struktur

Opret følgende struktur i `/modules/notes/`:
...
## Trin 4: Enhedsklasser

### Note Entity

Opret `class/Note.php`:
...
Opret `class/CategoryHandler.php`:
...
## Trin 5: Fælles Include File

Opret `include/common.php`:
...
Opret `templates/notes_index.tpl`:
...
Opret `templates/notes_view.tpl`:
...
Opret `templates/notes_edit.tpl`:
...
### Administration af administratornoter

Opret `admin/notes.php`:
...
Tillykke! Du har bygget et komplet CRUD-modul. Nøglebegreber dækket:

1. **Databasedesign** - Tabeller med relationer
2. **Enhedsklasser** - XoopsObject med indtastede egenskaber
3. **Behandlerklasser** - XoopsPersistableObjectHandler med brugerdefinerede metoder
4. **Frontend-sider** - Liste, se og redigere funktionalitet
5. **Formularhåndtering** - CSRF beskyttelse og validering
6. **Admin Interface** - Administrationsskærme
7. **Skabeloner** - Smarte skabeloner med logik

## Næste trin

- Tilføj flere avancerede funktioner (kommentarer, vurderinger, deling)
- Implementer ../Patterns/Repository-Pattern for renere dataadgang
- Anvend ../Patterns/MVC-Pattern for bedre kodeorganisering
- Tilføj ../Best-Practices/Testing med PHPUnit

Se også: ../Module-Development | ../Patterns/MVC-Pattern | ../Patterns/Repository-Pattern
