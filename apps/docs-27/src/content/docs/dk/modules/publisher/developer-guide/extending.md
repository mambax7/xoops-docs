---
title: "Udvidende udgiver"
description: "Udviklervejledning til udvidelse og tilpasning af Publisher-modulet"
---

> En udviklervejledning til tilpasning og udvidelse af Publisher-modulet.
...
### Brugerdefinerede SQL-forespørgsler
...
## Hooks og begivenheder

### Forudindlæser

Opret `preloads/core.php`:
...
### Skabelontilsidesættelse

Opret brugerdefinerede skabeloner i dit tema:
...
### Registrer blok i xoops_version.php
...
- Brugervejledning - Kom godt i gang
- MVC mønster
- XoopsObject API

---

#xoops #udgiver #udvikler #udvidelse #api
