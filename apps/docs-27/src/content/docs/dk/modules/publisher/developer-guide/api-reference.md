---
title: "Udgiver - API Reference"
description: "Fuldfør API reference for Publisher-modul med klasser, metoder og kodeeksempler"
---

# Publisher API Reference

> Komplet reference til Publisher-modulklasser, metoder, funktioner og API-endepunkter.
...
Klassen `Item` repræsenterer en enkelt artikel/genstand i Publisher.

**Navneområde:** `XoopsModules\Publisher\`

**Fil:** `modules/publisher/class/Item.php`
...
`ItemHandler` administrerer CRUD-operationer for artikler.

**Fil:** `modules/publisher/class/ItemHandler.php`
...
Klassen `Category` repræsenterer en kategori eller sektion.

**Fil:** `modules/publisher/class/Category.php`
...
`CategoryHandler` administrerer kategori CRUD operationer.

**Fil:** `modules/publisher/class/CategoryHandler.php`
...
Helper-klassen indeholder hjælpefunktioner:

**Fil:** `modules/publisher/class/Helper.php`
...
### Frontend JavaScript funktioner

Udgiver inkluderer JavaScript API til frontend-interaktioner:
...
Publisher leverer AJAX-slutpunkter til frontend-interaktioner:
...
## REST API (hvis aktiveret)

### API Slutpunkter

Hvis udgiveren afslører REST API:
...
- Publisher Modul Analyse
- Skabeloner og blokke i Publisher
...
#udgiver #api #reference #kode #klasser #metoder #xoops
