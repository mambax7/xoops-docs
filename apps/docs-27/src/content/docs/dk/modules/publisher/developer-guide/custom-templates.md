---
title: "Udgiver - Brugerdefinerede skabeloner"
description: "Guide til tilpasning af udgiverskabeloner og oprettelse af brugerdefinerede temaer"
---

# Brugerdefinerede skabeloner i Publisher

> Vejledning til oprettelse og tilpasning af Publisher-skabeloner ved hjælp af Smarty, CSS og HTML tilsidesættelser.

---

## Skabelonsystemoversigt

### Hvad er skabeloner?

Skabeloner styrer, hvordan Publisher viser indhold:
...
### Kopier skabelon til tema

**Metode 1: Via filhåndtering**
...
### Rediger brugerdefineret skabelon

Åbn temakopi i teksteditor:
...
## Grundlæggende om smarte skabeloner

### Smarte variabler

Publisher leverer variabler til skabeloner:
...
### Enkeltartikelskabelon

**Fil: publisher_item.tpl**
...
### Kategorilisteskabelon

**Fil: publisher_category.tpl**
...
### Seneste artikler Blokskabelon

**Fil: publisher_block_latest.tpl**
...
### Brugerdefinerede CSS-filer

Opret brugerdefineret CSS i tema:

```
/themes/yourtheme/modules/publisher/css/custom.css
```

### Basisskabelonstruktur
...
### Almindelige betingede kontroller
...
### Vis Smarty-variabler

Til fejlretning (fjern under produktion):
...
I `/modules/publisher/xoops_version.php` eller admin-indstillinger:
...
### Fra gammel udgiverversion

Hvis du opgraderer fra ældre version:

1. Sammenlign gamle og nye skabelonfiler
2. Flet tilpassede ændringer
3. Brug nye variabelnavne
4. Test grundigt
5. Sikkerhedskopier gamle skabeloner
...
- [XOOPS skabelonvejledning](../../02-Core-Concepts/Templates/Smarty-Basics.md)

---

#udgiver #skabeloner #smart #tilpasning #temaing #xoops
