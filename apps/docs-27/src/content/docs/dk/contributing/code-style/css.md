---
title: "CSS og SCSS retningslinjer"
description: "XOOPS CSS/SCSS kodningsstandarder og bedste praksis"
---

> XOOPS følger moderne CSS standarder med SCSS forbehandling, med fokus på vedligeholdelse og ydeevne.

---

## Oversigt

XOOPS CSS standarder understreger:

- **SCSS forbehandling** til organisation
- **BEM-metode** til navngivning
- **Mobil-først responsivt design**
- **Tilgængelighed og semantisk HTML**
- **Ydeevneoptimering**
...
- Brug SCSS variabler til farver, mellemrum, skrifttyper
- Følg BEM navngivningskonvention
- Mobile-first responsivt design
- Organiser filer efter formål
- Skriv genbrugelige mixins
- Hold vælgere enkle (maks. 3 niveauer dybe)
- Brug semantisk HTML
- Minimer specificitet
- Kommenter komplekse afsnit

### Lad være

- Brug inline stilarter
- Brug !important (næsten aldrig)
- Opret alt for specifikke vælgere
- Brug ID-vælgere til styling
- Reder for dybt (maks. 3-4 niveauer)
- Brug px til skriftstørrelser (brug rem)
- Opret magiske tal (brug variabler)
- Lad være ubrugt CSS
- Glem tilgængelighed
