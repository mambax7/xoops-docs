...
description: "XOOPS Smarty skabelonkodningsstandarder og bedste praksis"
---

> XOOPS bruger Smarty til skabeloner. Denne vejledning dækker konventioner og bedste praksis for udvikling af Smarty-skabeloner.

---

## Oversigt

XOOPS Smarty skabeloner følger:

- **XOOPS skabelonstruktur** og navngivning
- **Tilgængelighedsstandarder** (WCAG)
- **Semantisk HTML5** markup
- **BEM-stil klassenavngivning**
- **Ydeevneoptimering**
...
## Variabler og navngivning

### Variabel navngivningskonvention
...
### Sektion (forældet, brug foreach i stedet)
...
- Brug semantisk HTML5
- Inkluder alt-tekst til billeder
- Brug sprogkonstanter til tekst
- Escape output (standard)
- Hold logikken minimal
- Brug betydningsfulde variabelnavne
- Inkluder filoverskrifter
- Brug klassenavne i BEM-stil
- Test med skærmlæsere

### Lad være

- Bland ikke logik og præsentation
- Glem ikke alt-tekst
- Brug ikke rå HTML uden at undslippe
- Opret ikke globale variabler i skabeloner
- Brug ikke forældede Smarty-funktioner
- Indlejr ikke skabeloner for dybt
- Ignorer ikke tilgængelighed
- Undlad at hardkode tekst (brug konstanter)

---

## Skabeloneksempler

### Komplet modulskabelon
...
#xoops #smarty #skabeloner #konventioner #best-practices
