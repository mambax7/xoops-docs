---
title: "JavaScript kodningsstandarder"
description: "XOOPS JavaScript kodningsstandarder og bedste praksis"
---

# JavaScript Standarder

> XOOPS følger moderne JavaScript-standarder (ES6+) med vægt på læsbarhed og vedligeholdelse.

---

## Oversigt

XOOPS JavaScript standarder er baseret på:

- **ECMAScript 2015+** (ES6 og moderne funktioner)
- **Airbnb JavaScript Style Guide** (tilpasset)
- **XOOPS-konventioner** for konsistens
...
- Brug const som standard
- Brug beskrivende navne
- Brug pilefunktioner til tilbagekald
- Brug async/vent på løfter
- Dokumentere komplekse funktioner
- Cache DOM elementer
- Brug begivenhedsdelegation
- Skriv rene funktioner
- Hold fokus på funktionerne

### Lad være

- Brug var (legacy)
- Brug globale variabler
- Opret lange funktioner (over 50 linjer)
- Dybt rede kode
- Brug eval()
- Brug inline hændelseshandlere
- Lad console.log() være i produktion
- Lav hukommelseslækager
- Mutér funktionsparametre
...
#xoops #javascript #es6 #kodningsstandarder #bedste praksis
