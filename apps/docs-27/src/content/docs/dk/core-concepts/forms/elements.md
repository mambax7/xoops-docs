...
XOOPS giver et omfattende sæt af formularelementer gennem sit `XoopsFormElement` klassehierarki. Disse elementer håndterer gengivelse, validering og databehandling for webformularer.
...
Adgangskodeinput med maskering:
...
### Tilføjelse af brugerdefinerede attributter
