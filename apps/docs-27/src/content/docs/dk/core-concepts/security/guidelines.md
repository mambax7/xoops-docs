...
Dette dokument beskriver bedste praksis for sikkerhed for udvikling af XOOPS, der dækker inputvalidering, outputkodning, godkendelse, autorisation og beskyttelse mod almindelige websårbarheder.
...
- [ ] Alt brugerinput valideret og renset
- [ ] Parametriserede forespørgsler til alle databaseoperationer
- [ ] Outputkodning for alt brugergenereret indhold
- [ ] CSRF tokens på alle tilstandsændrende formularer
- [ ] Sikker hashing af adgangskode (Argon2id)
- [ ] Sessionssikkerhed konfigureret
- [ ] Godkendelse af filupload
- [ ] Sikkerhedsoverskrifter indstillet
- [ ] Takstbegrænsning implementeret
- [ ] Revisionslogning aktiveret
- [ ] Fejlmeddelelser lækker ikke følsomme oplysninger
