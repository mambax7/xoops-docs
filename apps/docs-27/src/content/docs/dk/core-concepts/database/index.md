---
title: "Databaselag"
description: "Omfattende guide til XOOPS databaseabstraktion, XoopsObject, handlere og kriteriesystemet"
---
...
> Forståelse af XOOPS-databaseabstraktion, objektpersistens og forespørgselsopbygning.

:::tip[Fremtidssikre din dataadgang]
Håndterings-/kriteriemønsteret fungerer i begge versioner. For at forberede sig til XOOPS 4.0, overveje at indpakke handlere i [Repository classes](../../03-Module-Development/Patterns/Repository-Pattern.md) for bedre testbarhed. Se [Valg af et dataadgangsmønster](../../03-Module-Development/Choosing-Data-Access-Pattern.md).
:::
...
XOOPS-databaselaget giver en robust abstraktion over MySQL/MariaDB, med:

- **Fabriksmønster** - Centraliseret databaseforbindelsesstyring
- **Objektrelationel kortlægning** - XoopsObject og behandlere
- **Forespørgselsbygning** - Kriteriesystem for komplekse forespørgsler
- **Genbrug af forbindelse** - Enkeltforbindelse via singleton-fabrik (ikke pooling)
...
Fabriksmønsteret sikrer, at en enkelt databaseforbindelse genbruges:
...
| Konstant | Skriv | Beskrivelse |
|--------|------|------------|
| `XOBJ_DTYPE_INT` | Heltal | Numeriske værdier |
| `XOBJ_DTYPE_TXTBOX` | String | Kort tekst (< 255 tegn) |
| `XOBJ_DTYPE_TXTAREA` | Tekst | Langt tekstindhold |
| `XOBJ_DTYPE_EMAIL` | E-mail | E-mailadresser |
| `XOBJ_DTYPE_URL` | URL | Webadresser |
| `XOBJ_DTYPE_FLOAT` | Flyde | Decimaltal |
| `XOBJ_DTYPE_ARRAY` | Array | Serialiserede arrays |
| `XOBJ_DTYPE_OTHER` | Blandet | Rådata |
...
Behandlerklassen administrerer CRUD-operationer for XoopsObject-forekomster.
...
Kriteriesystemet giver en kraftfuld, objektorienteret måde at bygge SQL WHERE-sætninger på.
...
### CriteriaCompo (Kombineringskriterier)
...
For komplekse forespørgsler, der ikke er mulige med Criteria, skal du bruge direkte SQL.

### Sikre forespørgsler (læs)
...
## ⚠️ Bedste praksis for sikkerhed

### Undslip altid brugerinput
...
### Brug parametriserede forespørgsler (XMF)
...
- [Designmønstre - Fabrik](../Architecture/Design-Patterns.md)
...
#xoops #database #orm #kriterier #handlere #mysql
