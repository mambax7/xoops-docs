---
title: "Kriterij API Referenca"
description: "Kompletna API referenca za sustav izgradnje upita XOOPS Criteria"
---
> Kompletna API dokumentacija za XOOPS sustav za izgradnju upita Criteria.

---

## Arhitektura sustava kriterija
...
### Sortiranje i označavanje stranica
...
## Primjeri složenih upita

### Pretraživanje s više uvjeta
...
## Kriteriji za vizualizaciju SQL
...
1. **Uvijek postavite LIMIT** za velike stolove
2. **Koristite indekse** na stupcima koji se koriste u kriterijima
3. **Izbjegavajte vodeće zamjenske znakove** u LIKE (`'%term'` je spor)
4. **Pretfilter u PHP** kada je to moguće za složenu logiku
5. **Umjereno koristite COUNT** - cache daje rezultate kada je to moguće
