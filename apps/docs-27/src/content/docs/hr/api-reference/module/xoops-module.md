---
title: "XoopsModule API Referenca"
description: "Kompletna API referenca za XoopsModule i sustav modula classes"
---
> Kompletna dokumentacija API za sustav modula XOOPS.

---

## Arhitektura sustava modula
...
|----------|------|-------------|
| `mid` | int | ID modula |
| `name` | niz | Ime za prikaz |
| `version` | niz | Broj verzije |
| `dirname` | niz | Naziv imenika |
| `isactive` | int | Aktivan status (0/1) |
| `hasmain` | int | Ima glavno područje |
| `hasadmin` | int | Ima područje admin |
| `hassearch` | int | Ima funkciju pretraživanja |
| `hasconfig` | int | Ima konfiguraciju |
| `hascomments` | int | Ima komentara |
| `hasnotification` | int | Ima obavijesti |
