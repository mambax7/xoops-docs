---
title: "Omogući način otklanjanja pogrešaka"
description: "Kako omogućiti i koristiti način rada za otklanjanje pogrešaka XOOPS za rješavanje problema"
---
> Sveobuhvatni vodič za značajke i alate za uklanjanje pogrešaka XOOPS.

---

## Arhitektura otklanjanja pogrešaka
...
## XOOPS Razine otklanjanja pogrešaka

### Omogući u mainfile.php
...
| Razina | PHP Pogreške | SQL Upiti | predložak Vars | Preporučeno za |
|-------|------------|-------------|--------------|-----------------|
| 0 | Skriven | Ne | Ne | Proizvodnja |
| 1 | Prikazano | Ne | Ne | Brze provjere |
| 2 | Prikazano | Zapisano | Ne | Razvoj |
| 3 | Prikazano | Zapisano | Prikazano | Duboko otklanjanje pogrešaka |
...
## SQL Otklanjanje pogrešaka upita

### Pregledajte upite u načinu otklanjanja pogrešaka

S `XOOPS_DEBUG_LEVEL` postavljenim na 2 ili 3, SQL upiti se pojavljuju na dnu stranica.

### Ručno bilježenje upita
...
### Pregled dodijeljenih varijabli
...
## PHP Traka za otklanjanje pogrešaka
