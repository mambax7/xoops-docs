---
title: "CSS i SCSS smjernice"
description: "XOOPS CSS/SCSS standardi kodiranja i najbolja praksa"
---
> XOOPS slijedi moderne standarde CSS sa SCSS predprocesiranjem, fokusirajući se na lakoću održavanja i performanse.

---

## Pregled

XOOPS CSS standardi naglašavaju:

- **SCSS pretprocesiranje** za organizaciju
- **BEM metodologija** za imenovanje
- **Mobile-first responsive design**
- **Pristupačnost i semantika HTML**
...
- Koristite SCSS varijable za boje, razmake, fontove
- Slijedite BEM konvenciju imenovanja
- Mobile-first responsive dizajn
- Organizirajte datoteke prema namjeni
- Napišite miksine za višekratnu upotrebu
- Selektori neka budu jednostavni (najviše 3 duboke razine)
- Koristite semantički HTML
- Smanjite specifičnost
- Komentirajte složene dijelove

### Nemoj

- Koristite ugrađene stilove
- Koristite !important (skoro nikad)
- Stvorite previše specifične selektore
- Koristite selektore ID-a za stiliziranje
- Preduboko gnijezdo (maksimalno 3-4 razine)
- Koristite px za veličinu fonta (koristite rem)
- Stvorite čarobne brojeve (koristite varijable)
- Ostavite neiskorišten CSS
- Zaboravite pristupačnost
