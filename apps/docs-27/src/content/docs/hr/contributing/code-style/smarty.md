---
title: "Konvencije predložaka Smarty"
description: "XOOPS Smarty standardi kodiranja predloška i najbolja praksa"
---
> XOOPS koristi Smarty za izradu šablona. Ovaj vodič pokriva konvencije i najbolje prakse za razvoj Smarty templates.

---

## Pregled

XOOPS Smarty templates slijedi:

- **XOOPS struktura predloška** i imenovanje
- **Standardi pristupačnosti** (WCAG)
- **Semantičko HTML5** označavanje
- **Imenovanje class u BEM stilu**
...
### Konvencija o imenovanju varijabli
...
### Odjeljak (zastarjelo, umjesto toga koristite foreach)
...
## HTML Najbolji primjeri iz prakse
...
- Koristite semantički HTML5
- Uključite zamjenski tekst za slike
- Koristite language konstante za tekst
- Escape izlaz (zadano)
- Neka logika bude minimalna
- Koristite smislena imena varijabli
- Uključite zaglavlja datoteka
- Koristite nazive class u stilu BEM
- Testirajte s čitačima zaslona

### Nemoj

- Ne miješajte logiku i prezentaciju
- Ne zaboravite alternativni tekst
- Nemojte koristiti neobrađeni HTML bez bježanja
- Nemojte stvarati globalne varijable u templates
- Nemojte koristiti zastarjele značajke Smarty
- Nemojte ugnijezditi templates preduboko
- Ne ignorirajte pristupačnost
- Nemojte kodirati tekst (koristite konstante)

---

## Primjeri predložaka

### Kompletan predložak modula
...
#xoops #pametno #templates #konvencije #najbolje prakse
