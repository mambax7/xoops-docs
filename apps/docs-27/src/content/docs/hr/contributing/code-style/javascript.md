---
title: "JavaScript Standardi kodiranja"
description: "XOOPS JavaScript standardi kodiranja i najbolja praksa"
---
# JavaScript Standardi

> XOOPS slijedi moderne standarde JavaScript (ES6+) s naglaskom na čitljivost i lakoću održavanja.

---

## Pregled

Standardi XOOPS JavaScript temelje se na:

- **ECMAScript 2015+** (ES6 i moderne značajke)
- **Airbnb JavaScript Stilski vodič** (prilagođeno)
- **XOOPS konvencije** za dosljednost
...
- Koristite const prema zadanim postavkama
- Koristite opisna imena
- Koristite funkcije strelica za povratne pozive
- Koristite async/await za obećanja
- Dokumentirajte složene funkcije
- predmemorija DOM elemenata
- Koristite delegiranje događaja
- Napišite čiste funkcije
- Držite funkcije usredotočene

### Nemoj

- Koristite var (naslijeđeno)
- Koristite globalne varijable
- Stvaranje dugih funkcija (preko 50 redaka)
- Kod dubokog gnijezda
- Koristite eval()
- Koristite ugrađene rukovatelje događajima
- Ostavite konzolu.log() u proizvodnji
- Stvaranje curenja memorije
- Mutirajte parametre funkcije
...
#xoops #javascript #es6 #standardi kodiranja #najbolje prakse
