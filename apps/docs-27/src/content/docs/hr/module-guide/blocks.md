---
title: "Razvoj blokova"
---
## Pregled

Blokovi su widgeti sadržaja za višekratnu upotrebu prikazani na bočnim trakama teme i područjima sadržaja. Ovaj vodič pokriva stvaranje, konfiguriranje i prilagodbu XOOPS blokova.

## Struktura blokova

### Definicija bloka u xoops_version.php
...
| Parametar | Opis |
|-----------|-------------|
| `file` | PHP datoteka koja sadrži blok funkcije |
| `name` | Jezična konstanta za naslov bloka |
| `description` | Jezična konstanta za opis |
| `show_func` | Funkcija za prikaz sadržaja bloka |
| `edit_func` | Funkcija za prikaz oblika opcija bloka |
| `template` | Smarty datoteka predloška |
| `options` | Zadane opcije odvojene cijevi |
...
## Blokiraj s podrškom za kloniranje

Blokovi koji se mogu klonirati dopuštaju više instanci:
...
## Sadržaj dinamičkog bloka

### AJAX-učitani blokovi
...
1. **Cache Results** - Predmemorirajte skupe upite
2. **Provjeri opcije** - Uvijek potvrdi opcije bloka
3. **Escape Output** - Dezinficirajte sav korisnički sadržaj
4. **Koristite kriterije** - Izgradite upite s kriterijima class
5. **Ograničite upite** - Postavite razumna ograničenja za performanse
6. **Responzivni predlošci** - Osigurajte da blokovi rade na mobitelu

## Povezana dokumentacija

- Module-Development - Vodič za izradu modula
- ../02-Core-Concepts/Templates/Smarty-Templating - Sintaksa predloška
