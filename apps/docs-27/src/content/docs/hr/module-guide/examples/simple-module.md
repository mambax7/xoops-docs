---
title: "Primjer jednostavnog modula"
description: "Kompletan radni modul sa svim potrebnim datotekama"
---
# Primjer jednostavnog modula - blog

Kompletan, funkcionalan jednostavan modul koji demonstrira temeljne koncepte XOOPS.
...
## Administratorsko sučelje (admin.php)
...
- Prikaz objavljenih postova na blogu s označavanjem stranica
- Pregledajte pojedinačne postove
- Administratorsko sučelje za stvaranje, uređivanje, brisanje postova
- Status nacrta/objavljeno
- Vremenske oznake

## Testiranje

1. Instalirajte modul putem XOOPS admin
2. Pristupite sučelju na `modules/blog/`
3. Posjetite admin na `modules/blog/admin.php`
4. Napravite probni post i objavite ga

## Povezana dokumentacija

Vidi također:
- ../Patterns/MVC-Uzorak za uzorke
- ../Patterns/Repository-Pattern za pristup podacima
- ../Best-Practices/Code-Organization for structure

---

Oznake: #primjeri #jednostavni-modul #potpuni-primjer #razvoj-modula
