---
title: "Migracije baze podataka"
---
## Pregled

Migracije baze podataka pružaju reverzibilne promjene u shemi vaše baze podataka kontrolirane verzijom. Oni osiguravaju dosljedna stanja baze podataka u razvojnim, scenskim i proizvodnim okruženjima.

## Migracijska struktura
...
1. **Jedna promjena po migraciji** - Fokusirajte migracije
2. **Always Write Down Methods** - Omogućite vraćanje
3. **Testirajte oba smjera** - Provjerite up() i down()
4. **Koristite transakcije** - Zaokružite složene migracije
5. **Nemojte mijenjati stare migracije** - umjesto toga stvorite nove
6. **Napravite sigurnosnu kopiju prije pokretanja** - Posebno u proizvodnji

## Povezana dokumentacija

- Shema baze podataka - Dizajn sheme
- Operacije baze podataka - Izvršenje upita
- ../xoops_version.php - Manifest modula
- ../../07-XOOPS-4.0/XOOPS-4.0-Architecture - Moderna arhitektura
