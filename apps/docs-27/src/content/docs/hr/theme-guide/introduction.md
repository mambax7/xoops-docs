---
title: "Razvoj teme"
description: "Stvaranje i prilagodba XOOPS themes s nasljeđivanjem predloška Smarty"
---
<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

Ovaj vodič pokriva kako izraditi XOOPS themes, uključujući strukturu teme, nasljeđivanje predložaka i najbolje prakse za izradu responzivnog, modernog themes.
...
tema XOOPS sastoji se od sljedeće strukture direktorija:
...
Nasljeđivanje predloška Smarty omogućuje vam stvaranje podređenog themes koji nasljeđuje nadređenu temu.

### Nadređena tema (base.tpl)
...
### Stvaranje varijacija teme

Stvorite više varijacija teme iz osnovne teme:
...
## Korištenje Bootstrapa

Primjer Bootstrap 5 teme:
...
Stvorite prilagođeni blok templates:
...
## Prilagođeni vrtuljak/klizač

Primjer karusela dinamičnog sadržaja:
