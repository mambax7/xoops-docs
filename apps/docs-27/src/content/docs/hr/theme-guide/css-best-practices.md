---
title: "CSS Najbolji primjeri iz prakse za XOOPS teme"
---
## Pregled

Ovaj vodič pokriva organizaciju CSS, moderne tehnike izgleda i optimizaciju performansi za razvoj teme XOOPS.
...
1. **Minimizirajte specifičnost** - Izbjegavajte duboko ugniježđivanje
2. **Koristite moderna svojstva** - `gap` umjesto margina
3. **Smanjite ponovno bojenje** - koristite `transform` za animacije
4. **Lijeno učitavanje** - Učitaj modul CSS samo kada je to potrebno
...
- Struktura teme - Organizacija datoteke teme
- Razvoj teme - Potpuni vodič za temu
- ../Templates/Smarty-Templating - Integracija predloška
