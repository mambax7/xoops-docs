...
description: "Vodič za razvojne programere za proširenje i prilagodbu modula Publisher"
---
> Razvojni vodič za prilagodbu i proširenje modula Publisher.
...
### Nadjačavanje predloška

Izradite prilagođeni templates u svojoj temi:
...
### Registrirajte blok u xoops_version.php
...
- Korisnički priručnik - Početak rada
- MVC uzorak
- XoopsObject API
