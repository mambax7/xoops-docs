---
title: "Izdavač - prilagođeni predlošci"
description: "Vodič za prilagodbu Publishera templates i stvaranje prilagođenog themes"
---
# Prilagođeni predlošci u Publisheru

> Vodič za stvaranje i prilagodbu Publishera templates korištenjem nadjačavanja Smarty, CSS i HTML.

---

## Pregled sustava predložaka

### Što su predlošci?

predlošci kontroliraju način na koji Publisher prikazuje sadržaj:
...
### Kopiraj predložak u temu

**Metoda 1: Putem upravitelja datoteka**
...
### Uredi prilagođeni predložak

Otvorite kopiju teme u uređivaču teksta:
...
## Smarty Osnove predloška

### Smarty Varijable

Izdavač daje varijable za templates:
...
### predložak jednog članka

**Datoteka: publisher_item.tpl**
...
### predložak popisa kategorija

**Datoteka: publisher_category.tpl**
...
### predložak bloka najnovijih članaka

**Datoteka: publisher_block_latest.tpl**
...
### Prilagođene datoteke CSS

Stvorite prilagođeni CSS u temi:

```
/themes/yourtheme/modules/publisher/css/custom.css
```

### Osnovna struktura predloška

Razumijevanje strukture HTML:
...
## Referenca varijabli predloška

### Stavka (članak) Objekt
...
## Napredne tehnike predložaka

### Uključi druge predloške
...
### Dodijelite varijable u predlošku
...
### Prikaz varijabli Smarty

Za otklanjanje pogrešaka (ukloni u produkciji):
...
U postavkama `/modules/publisher/xoops_version.php` ili admin:
...
### Iz stare verzije izdavača

Ako nadograđujete sa starije verzije:

1. Usporedite stare i nove datoteke predložaka
2. Spoji prilagođene promjene
3. Koristite nova imena varijabli
4. Temeljito testirajte
5. Sigurnosna kopija starog templates
...
- [Smarty Dokumentacija](https://www.smarty.net/documentation)
- [Izdavač GitHub](https://github.com/XoopsModules25x/publisher)
- [Vodič za predloške XOOPS](../../02-Core-Concepts/Templates/Smarty-Basics.md)

---

#izdavač #templates #smarty #customization #themeing #xoops
