---
title: "Izdavač - Referenca API"
description: "Kompletna API referenca za Publisher modul sa classes, metodama i primjerima koda"
---
# Referenca izdavača API

> Potpuna referenca za Publisher modul classes, metode, funkcije i krajnje točke API.
...
`Item` class predstavlja jedan članak/stavku u Publisheru.

**Prostor imena:** `XoopsModules\Publisher\`
...
`ItemHandler` upravlja CRUD operacijama za članke.
...
`Category` class predstavlja kategoriju ili odjeljak.
...
## Klasa rukovatelja kategorijom

### Pregled

`CategoryHandler` upravlja operacijama kategorije CRUD.
...
Helper class pruža uslužne funkcije:
...
### Funkcije sučelja JavaScript

Izdavač includes JavaScript API za interakcije sučelja:
...
Publisher pruža krajnje točke AJAX za interakcije sučelja:
...
## REST API (ako je omogućeno)

### API Krajnje točke

Ako Izdavač razotkrije REST API:
...
- Analiza modula izdavača
- predlošci i blokovi u Publisheru
- Izrada članka
