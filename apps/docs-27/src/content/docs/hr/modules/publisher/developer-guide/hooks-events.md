---
title: "Izdavač - udice i događaji"
description: "Vodič za proširenje Publishera pomoću kuka, događaja i sustava dodataka"
---
# Izdavačke kuke i događaji

> Potpuni vodič za proširenje funkcionalnosti Publishera pomoću događaja, spojnica i dodataka.

---

## Pregled sustava događaja

### Što su događaji?

Događaji omogućuju drugim modules da reagiraju na radnje izdavača:
...
### Stavka (članak) Događaji

#### publisher.item.created

Otpušta se kada se stvori novi članak.
...
Otpušta se kada se članak ažurira.
...
Otpušta se kada se članak izbriše.
...
Pokreće se kada se status članka promijeni u objavljen.
...
Otpušteno kada je članak na čekanju odobren.
...
Otpušta se kada je članak odbijen.
...
Pokreće se kada se stvori kategorija.
...
Pokreće se kada se kategorija ažurira.
...
Pokreće se kada se kategorija izbriše.
...
### Komentirajte događaje

#### publisher.comment.created

Otpaljeno kada je komentar objavljen.
...
Otpušta se kada je komentar odobren.
...
Otpaljuje se kada se komentar izbriše.
...
### Primjer 1: Slanje e-pošte o izradi članka
...
### Primjer 2: Ažuriranje indeksa pretraživanja
...
### Primjer 3: Automatska objava na društvenim medijima
...
### Primjer 4: Sinkronizacija s vanjskim sustavom
...
Kuke dopuštaju izmjene ponašanja izdavača:

#### publisher.view.article.start

Poziva se prije prikazivanja članka.
...
Poziva se nakon renderiranja članka.
...
Poziva se prilikom provjere dopuštenja.
...
Dodaci proširuju funkcionalnost izdavača:
...
Filtri mijenjaju podatke prije/nakon obrade:
...
Izvršite kod na određenim točkama:
...
## Proširenje pomoću dodataka

### Primjer dodatka: Povezani članci
...
## Događaji otklanjanja pogrešaka
...
- [Izdavač GitHub](https://github.com/XoopsModules25x/publisher)
- [XOOPS Sustav događaja](../../03-Module-Development/Module-Development.md)
- [Razvoj dodatka](../../03-Module-Development/Module-Development.md)
