---
title: "Smarty predložak u XOOPS"
---
## Pregled

XOOPS koristi mehanizam predložaka Smarty za odvajanje prezentacije od logike. Ovaj vodič pokriva sintaksu Smarty, značajke specifične za XOOPS i najbolje prakse predložaka.
...
1. **Escape Output** - Uvijek izbjegavajte korisnički generirani sadržaj
2. **Koristite modifikatore** - Primijenite odgovarajuće transformacije
3. **Zadrži minimalnu logiku** - Složena logika pripada PHP
4. **Koristi djelomične dijelove** - Ponovno upotrijebi uobičajene fragmente predloška
5. **Semantički HTML** - Koristite odgovarajuće HTML5 elemente
6. **Pristupačnost** - Uključite ARIA atribute gdje je potrebno

## Povezana dokumentacija

- Razvoj teme - Stvaranje teme
- ../../04-API-Reference/Template/Template-System - XOOPS predložak API
- ../../03-Razvoj-modula/Razvoj-bloka - Blok templates
- ../Forms/Form-Elements - Prikaz obrasca
