---
title: "XOOPS Obrasci"
description: "Kompletan vodič za XOOPS sustav za generiranje obrasca, uključujući sve elemente obrasca, provjeru valjanosti i renderiranje"
---
# 📝 XOOPS Sustav obrazaca

> Sveobuhvatno generiranje obrazaca, provjera valjanosti i prikazivanje za XOOPS modules.

---

## Pregled

Sustav obrazaca XOOPS pruža snažan, objektno orijentiran pristup stvaranju obrazaca HTML. Upravlja generiranjem obrasca, provjerom valjanosti, CSRF zaštitom i fleksibilnim renderiranjem uz podršku za različite okvire CSS.
...
### XoopsForm (osnovna klasa)

Apstraktna baza class za sve oblike.
...
Najčešće korišteni oblik class, renderira se sa stilom teme.
...
### Traka za elemente (Grupni elementi)
...
- Prilagođeni prikazivači obrazaca
- CSRF Zaštita
- Dezinfekcija ulaza
