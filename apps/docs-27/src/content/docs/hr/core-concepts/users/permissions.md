---
title: "Sustav dopuštenja"
description: "Cjeloviti vodič za XOOPS sustav dopuštenja, vrste, provjeru, hijerarhiju i kontrolu pristupa"
---
# Sustav dopuštenja u XOOPS

XOOPS Sustav dozvola je granularni okvir za kontrolu pristupa koji upravlja tko može izvršiti koje radnje na kojim resursima. Ovaj dokument pokriva vrste dopuštenja, mehanizme provjere, hijerarhiju i primjere implementacije.

## Vrste dopuštenja

### dozvole na razini modula

dozvole na razini modula kontroliraju pristup cjelokupnom modules ili funkcijama modula.

**Uobičajeni nazivi dopuštenja:**
- `module_view` - Pregled sadržaja modula
- `module_read` - Pročitajte resurse modula
- `module_submit` - Slanje sadržaja u modul
- `module_edit` - Uređivanje sadržaja modula
- `module_admin` - modul za administraciju
...
### Dopuštenja na razini stavke

Dopuštenja na razini stavke kontroliraju pristup određenim resursima unutar modula.

**Primjeri:**
- ID članka: Može li grupa pregledavati/uređivati određeni članak?
- ID kategorije: Može li grupa pristupiti kategoriji?
- ID stranice: Može li grupa pregledavati/mijenjati određenu stranicu?
...
### Dopuštenja za blokiranje

Dopuštenja za blokove kontroliraju vidljivost i interakciju s blokovima prikazanim na stranicama.
...
Dopuštenja koja kontroliraju upravljanje grupom i administration.
...
`XoopsGroupPermHandler` class pruža metode za provjeru i upravljanje dozvolama.
...
## Implementacija provjere dopuštenja

### Provjera dopuštenja jednog korisnika
...
### Provjera dopuštenja administratorske ploče
...
## predmemorija dopuštenja

### Optimizirana provjera dopuštenja
...
### Pravila dodjele dopuštenja

1. **Načelo najmanjih privilegija**: Dodijelite samo potrebna dopuštenja
2. **Pristup temeljen na ulogama**: Koristite grupe za dozvole temeljene na ulogama
3. **Redovne revizije**: Povremeno pregledajte dopuštenja
4. **Odvajanje dužnosti**: Odvojite admin od korisničkih dozvola
5. **Explicit Deny**: Zadani pristup odbijanja, eksplicitno dopuštanje
...
- Upravljanje korisnicima.md
- Group System.md
- Autentifikacija.md
- ../../Sigurnost/Sigurnosne-Smjernice.md

## Oznake

#dozvole #kontrola pristupa #sigurnost #autorizacija #acl #provjera dopuštenja
