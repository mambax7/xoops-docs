---
title: "Grupni sustav"
description: "Opsežni vodič za upravljanje grupama XOOPS, zadane grupe, prilagođene grupe i hijerarhiju grupa"
---
# Grupni sustav u XOOPS

Grupni sustav XOOPS pruža hijerarhijski okvir za organiziranje korisnika i upravljanje kolektivnim dozvolama. Ovaj dokument pokriva zadane grupe, kreiranje prilagođenih grupa, hijerarhiju i praktičnu primjenu.

## Zadane grupe

XOOPS includes tri temeljne grupe koje se stvaraju tijekom instalacije sustava:

### Grupa webmastera (ID: 1)

Grupa Webmasteri predstavlja stranicu administrators s punim pristupom sustavu.

**Karakteristike:**
- ID grupe: 1
- Najviša razina privilegija
- Ne može se izbrisati
- Potpuni pristup svim modules i funkcijama
- Pristup ploči administration
...
### Grupa registriranih korisnika (ID: 2)

Grupa registriranih korisnika includes svi autentificirani korisnici koji nisu anonimni.

**Karakteristike:**
- ID grupe: 2
- Zadana grupa za nove registracije
- Može pristupiti korisnički specifičnim značajkama
- Podložno grupnim dopuštenjima
- Može se prilagoditi za standardne korisničke značajke
...
Grupa Anonymous predstavlja neautorizirane posjetitelje stranice.

**Karakteristike:**
- ID grupe: 3
- Zadana grupa za neprijavljene korisnike
- Tipično ograničen pristup samo za čitanje
- Nije moguće mijenjati sadržaj
- Dopuštenja za javno gledanje
...
## Stvaranje prilagođenih grupa

### Rukovatelj stvaranjem grupe
...
## Dodjela dopuštenja grupe

### Dodjeljivanje dopuštenja grupama
...
1. **Jasno imenovanje**: Koristite opisne, jasne nazive grupa
2. **Dokumentacija**: Svrhe i dopuštenja grupe dokumenata
3. **Načelo najmanje privilegije**: Dodijelite minimalne potrebne dozvole
4. **Redovne revizije**: Povremeno pregledajte članstvo u grupi i dopuštenja
5. **Zadane grupe**: Očuvajte zadane grupe (webmasteri, registrirani, anonimni)
...
#groups #group-management #permissions #access-control #user-organizacija #hierarchy
