...
description: "Kompletan vodič za XOOPS sustav provjere autentičnosti, tijek prijave, upravljanje sesijom, sigurnost i napredne značajke"
---
# Autentifikacija u XOOPS

XOOPS Authentication sustav pruža sigurnu verifikaciju korisnika, upravljanje sesijom i napredne sigurnosne značajke uključujući dvofaktorsku autentifikaciju i OAuth integraciju. Ovaj dokument pokriva tijekove autentifikacije, implementaciju i najbolje prakse.

## Tijek provjere autentičnosti

### Dijagram redoslijeda prijave
...
### Implementacija rukovatelja sesijom
...
### Sigurnosni popis za provjeru autentičnosti
