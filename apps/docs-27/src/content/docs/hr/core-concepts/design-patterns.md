---
title: "Uzorci dizajna u XOOPS"
description: "Sveobuhvatni vodič za uzorke dizajna koji se koriste u razvoju XOOPS uključujući MVC, Singleton, Factory, Observer i više"
---
<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

Uzorci dizajna su rješenja za uobičajene probleme dizajna softvera koja se mogu ponovno koristiti. XOOPS koristi nekoliko dobro uspostavljenih obrazaca koji pomažu u održavanju kvalitete koda, poboljšavaju mogućnost testiranja i povećavaju fleksibilnost sustava.

:::note[Brzi odabir uzorka]
Niste sigurni koji uzorak koristiti? vidi:
- [Odabir uzorka pristupa podacima](../../03-Module-Development/Choosing-Data-Access-Pattern.md) — rukovatelji vs repozitorij vs usluga vs CQRS
- [Odabir sustava događaja](../Choosing-Event-System.md) — predučitavanja u odnosu na događaje PSR-14
:::

## Pregled

Razumijevanje i pravilna implementacija dizajnerskih uzoraka presudno je za stvaranje XOOPS modules koji se može održavati. Ovaj vodič pokriva najčešće korištene obrasce u razvoju XOOPS.

| Uzorak | Svrha | Uobičajeni slučajevi upotrebe |
|---------|---------|----------------|
| MVC | Razdvajanje koncerna | Struktura modula |
| Samac | Jedinstveno jamstvo | Veze s bazom podataka |
| Tvornica | Apstrakcija stvaranja objekta | Rukovatelji, baza podataka |
| Promatrač | Obavijest o događaju | Predučitavanja, obavijesti |
| Dekorater | Proširenje dinamičkog ponašanja | Elementi obrasca, filtri |
| Strategija | Razmjena algoritama | Autentifikacija, validacija |
| Adapter | Kompatibilnost sučelja | Integracija naslijeđenog koda |
| Spremište | Apstrakcija pristupa podacima | Postojanost podataka |

## Model-View-Controller (MVC)

Uzorak MVC odvaja aplikaciju u tri međusobno povezane komponente, čineći bazu koda organiziranijom i testiranijom.
...
Singleton obrazac osigurava da class ima samo jednu instancu i pruža joj globalni pristup.
...
Tvornički uzorak stvara objekte bez navođenja njihovog točnog class, što omogućuje fleksibilno stvaranje objekata.

### Kada koristiti

- Dinamičko stvaranje rukovatelja
- Veze baza podataka za različite baze podataka
- Davatelji autentifikacije
- Izrada elemenata obrasca
...
Uzorak promatrača omogućuje objektima da budu obaviješteni o promjenama u subjektovom stanju, omogućujući ponašanje vođeno događajima.
...
### XOOPS Predučitavanja (Implementacija promatrača)
...
Uzorak Decorator dinamički dodaje ponašanje objektima bez utjecaja na druge objekte istog class.

### Kada koristiti

- Prilagodba elemenata obrasca
- Oblikovanje izlaza
- Provjera dopuštenja
- Slojevi za predmemoriju
...
### Kada koristiti- Višestruke metode provjere autentičnosti
- Različiti algoritmi sortiranja
- Razni izvozni formati
- Fleksibilna pravila provjere valjanosti
...
Uzorak repozitorija pruža sloj apstrakcije između logike pristupa podacima i poslovne logike.

### Kada koristiti

- Složeni zahtjevi za pristup podacima
- Više izvora podataka
- Slojevi podataka koji se mogu testirati
...
Dependency Injection (DI) omogućuje konstrukciju objekata s njihovim ovisnostima umjesto da ih stvara interno.
...
### Smjernice za odabir uzorka

1. **Odaberite uzorke na temelju stvarnih potreba**, a ne onih predviđenih
2. **Implementacije neka budu jednostavne** - nemojte pretjerivati u inženjeringu
3. **Korištenje uzorka dokumenta** za razumijevanje tima
4. **Kombinirajte uzorke** kada je to prikladno (npr. Tvornica + Singleton)
5. **Razmotrite mogućnost provjere** pri odabiru uzoraka

### Uobičajeni anti-obrasci koje treba izbjegavati

| Anti-uzorak | Problem | Rješenje |
|--------------|---------|----------|
| Božji objekt | Razred čini previše | Jedinstvena odgovornost |
| Šifra špageta | Nema jasne strukture | Koristite uzorak MVC |
| Kopiraj-Zalijepi | Dupliciranje koda | Ekstrakt zajedničkog koda |
| Čarobni brojevi | Nejasne konstante | Koristite imenovane konstante |
| Čvrsto spajanje | Teško za testiranje/održavanje | Koristite Dependency Injection |
...
- [XOOPS-Arhitektura](XOOPS-Architecture.md) - Sveukupna arhitektura sustava
- [Sloj baze podataka](../Database/Database-Layer.md) - Obrasci postojanosti podataka
- [Najbolje sigurnosne prakse](../Security/Security-Best-Practices.md) - Implementacija sigurnog uzorka
