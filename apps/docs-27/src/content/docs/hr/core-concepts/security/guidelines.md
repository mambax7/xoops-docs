---
title: "Sigurnosne smjernice"
---
## Pregled

Ovaj dokument opisuje najbolju sigurnosnu praksu za razvoj XOOPS, pokrivajući provjeru valjanosti ulaza, izlazno kodiranje, autentifikaciju, autorizaciju i zaštitu od uobičajenih web ranjivosti.
...
- [ ] Svi korisnički unosi potvrđeni i sanirani
- [ ] Parametrizirani upiti za sve operacije baze podataka
- [ ] Izlazno kodiranje za sav korisnički generirani sadržaj
- [ ] CSRF tokeni na svim obrascima koji mijenjaju stanje
- [] Sigurno raspršivanje lozinki (Argon2id)
- [ ] Sigurnost sesije konfigurirana
- [ ] Provjera valjanosti učitavanja datoteke
- [ ] Sigurnosna zaglavlja postavljena
- [ ] Ograničenje brzine implementirano
- [] Revizijsko bilježenje omogućeno
- [ ] Poruke o pogrešci ne otkrivaju osjetljive informacije
