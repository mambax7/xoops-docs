---
title: "Ayudante de módulo XMF"
description: 'Operaciones de módulo simplificadas usando la clase Xmf\Module\Helper y ayudantes relacionados'
---
...
El ayudante de módulo proporciona:
...
### Desde el módulo actual

Si no especifica un nombre de módulo, usa el módulo activo actual:
...
### Manera tradicional de XOOPS

Obtener la configuración del módulo de la manera antigua es verboso:
...
Con el ayudante de módulo, la misma tarea se vuelve simple:
...
## Métodos del ayudante

### getModule()

Devuelve el objeto XoopsModule para el módulo del ayudante.
...
Devuelve un valor de configuración de módulo o todas las configuraciones.
...
Devuelve un controlador de objeto para el módulo.
...
Carga un archivo de idioma para el módulo.
...
Verifica si este módulo es el módulo activo actual.
...
Verifica si el usuario actual tiene derechos de administrador para este módulo.
...
## Métodos de ruta y URL

### url($url)

Devuelve una URL absoluta para una ruta relativa a módulo.
...
Devuelve una ruta absoluta de sistema de archivos para una ruta relativa a módulo.
...
Devuelve una URL absoluta para archivos cargados del módulo.
...
Devuelve una ruta absoluta de sistema de archivos para archivos cargados del módulo.
...
Redirige dentro del módulo a una URL relativa a módulo.
...
Habilitar o deshabilitar modo de depuración para el ayudante.
...
Agregue un mensaje al registro del módulo.
...
## Clases de ayudante relacionadas

XMF proporciona ayudantes especializados que extienden `Xmf\Module\Helper\AbstractHelper`:

### Ayudante de permisos

Vea ../Recipes/Permission-Helper para documentación detallada.
...
Almacenamiento de sesión consciente del módulo con prefijación automática de claves.
...
Almacenamiento en caché consciente del módulo con prefijación automática de claves.
...
Aquí hay un ejemplo completo usando el ayudante de módulo:
...
## Clase base AbstractHelper

Todas las clases auxiliares de XMF extienden `Xmf\Module\Helper\AbstractHelper`, que proporciona:
...
Instancia con un nombre de directorio de módulo. Si está vacío, usa el módulo actual.

### dirname()

Devuelve el nombre del directorio del módulo asociado con el ayudante.
...
Llamado por el constructor después de que se carga el módulo. Anule en ayudantes personalizados para lógica de inicialización.

## Creando ayudantes personalizados

Puede extender el ayudante para funcionalidad específica del módulo:
