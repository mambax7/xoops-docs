---
title: "Referencia de la API de XoopsForm"
description: "Referencia completa de la API para clases de XoopsForm y elementos de formulario"
---

> Documentación completa de la API para el sistema de generación de formularios de XOOPS.
