---
title: "Constructor de Consultas XOOPS"
description: "API moderna de constructor fluida para construir consultas SELECT, INSERT, UPDATE, DELETE con una interfaz encadenable"
---

El Constructor de Consultas XOOPS proporciona una interfaz moderna y fluida para construir consultas SQL. Ayuda a prevenir la inyección SQL, mejora la legibilidad y proporciona abstracción de base de datos para múltiples sistemas de bases de datos.
