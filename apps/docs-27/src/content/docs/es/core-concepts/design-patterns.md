---
title: "Patrones de diseño en XOOPS"
description: "Guía completa de patrones de diseño utilizados en el desarrollo de XOOPS incluyendo MVC, Singleton, Factory, Observer y más"
---
...
:::note[Selección rápida de patrones]
¿No está seguro de qué patrón usar? Consulte:
- [Elegir un patrón de acceso a datos](../../03-Module-Development/Choosing-Data-Access-Pattern.md) — controladores vs repositorio vs servicio vs CQRS
- [Elegir un sistema de eventos](../Choosing-Event-System.md) — precargas vs eventos PSR-14
:::
...
| Patrón | Propósito | Casos de uso comunes |
|---------|---------|------------------|
| MVC | Separación de preocupaciones | Estructura del módulo |
| Singleton | Garantía de instancia única | Conexiones de base de datos |
| Factory | Abstracción de creación de objetos | Controladores, base de datos |
| Observer | Notificación de eventos | Precargas, notificaciones |
| Decorator | Extensión de comportamiento dinámico | Elementos de formulario, filtros |
| Strategy | Intercambio de algoritmos | Autenticación, validación |
| Adapter | Compatibilidad de interfaz | Integración de código heredado |
| Repository | Abstracción de acceso a datos | Persistencia de datos |
