---
title: "Plantillas Smarty en XOOPS"
---

## Descripción General

XOOPS utiliza el motor de plantillas Smarty para separar la presentación de la lógica. Esta guía cubre la sintaxis de Smarty, características específicas de XOOPS y mejores prácticas de plantillas.
...
## Características Específicas de XOOPS
...
1. **Escapar Salida** - Siempre escapar contenido generado por el usuario
2. **Usar Modificadores** - Aplicar transformaciones apropiadas
3. **Mantener la Lógica Mínima** - La lógica compleja pertenece en PHP
4. **Usar Parciales** - Reutilizar fragmentos de plantilla comunes
5. **HTML Semántico** - Usar elementos HTML5 apropiados
6. **Accesibilidad** - Incluir atributos ARIA donde sea necesario

## Documentación Relacionada

- Theme-Development - Creación de temas
