...
description: "Guía completa de gestión de grupos de XOOPS, grupos predeterminados, grupos personalizados y jerarquía de grupos"
---

# Sistema de Grupos en XOOPS

El Sistema de Grupos de XOOPS proporciona un marco jerárquico para organizar usuarios y administrar permisos colectivos. Este documento cubre grupos predeterminados, creación de grupos personalizados, jerarquía e implementación práctica.

## Grupos Predeterminados

XOOPS incluye tres grupos fundamentales que se crean durante la instalación del sistema:

### Grupo Webmasters (ID: 1)

El grupo Webmasters representa administradores del sitio con acceso completo del sistema.

**Características:**
- Group ID: 1
- Nivel de privilegio más alto
...
### Grupo Usuarios Registrados (ID: 2)

El grupo Usuarios Registrados incluye todos los usuarios autenticados que no son anónimos.

**Características:**
- Group ID: 2
- Grupo predeterminado para nuevos registros
- Puede acceder a características específicas del usuario
- Sujeto a permisos basados en grupos
- Puede personalizarse para características de usuario estándar
...
El grupo Anónimo representa visitantes no autenticados al sitio.

**Características:**
- Group ID: 3
- Grupo predeterminado para usuarios no registrados
- Acceso típicamente limitado de solo lectura
- No se puede modificar contenido
- Permisos de visualización pública
...
### Propiedades de la Clase XoopsGroup
...
### Manejador de Creación de Grupos
...
### Configuración de Grupo de Departamento
...
### Asignación de Múltiples Grupos
...
1. **Nombres Claros**: Usar nombres de grupos descriptivos y claros
2. **Documentación**: Documentar propósitos de grupos y permisos
3. **Principio de Menor Privilegio**: Otorgar permisos mínimos requeridos
4. **Auditorías Regulares**: Revisar periódicamente pertenencias de grupos y permisos
5. **Grupos Predeterminados**: Preservar grupos predeterminados (Webmasters, Registrados, Anónimos)
