---
title: "Elegir un patrón de acceso a datos"
description: "Árbol de decisión para seleccionar el patrón de acceso a datos adecuado para su módulo XOOPS"
---

<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

> **¿Qué patrón debo usar?** Este árbol de decisión lo ayuda a elegir entre controladores directos, patrón de repositorio, capa de servicio y CQRS.
