...
Las migraciones de base de datos proporcionan cambios versionados y reversibles a su esquema de base de datos. Garantizan estados consistentes de la base de datos en todos los entornos de desarrollo, ensayo y producción.
