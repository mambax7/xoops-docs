---
title: "Patrón DTO en XOOPS"
description: "Objetos de transferencia de datos para el manejo limpio de datos"
---

# Patrón DTO (Objetos de transferencia de datos) en XOOPS

<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

:::tip[Funciona en ambas versiones]
Los DTO son objetos PHP simples sin dependencias de marco. Funcionan idénticamente en XOOPS 2.5.x y XOOPS 4.0.x. Para PHP 8.2+, use la promoción de propiedades del constructor y clases de solo lectura para una sintaxis más limpia.
:::

Los objetos de transferencia de datos (DTO) son objetos simples utilizados para transferir datos entre diferentes capas de una aplicación. Los DTO ayudan a mantener límites claros entre capas y reducir dependencias en objetos de entidad.
