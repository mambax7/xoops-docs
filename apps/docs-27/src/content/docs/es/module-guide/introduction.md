...
description: "Guía completa para desarrollar módulos XOOPS usando prácticas modernas de PHP"
---

Esta sección proporciona documentación completa para desarrollar módulos XOOPS utilizando prácticas modernas de PHP, patrones de diseño y mejores prácticas.

## Descripción general

El desarrollo de módulos XOOPS ha evolucionado significativamente a lo largo de los años. Los módulos modernos aprovechan:
