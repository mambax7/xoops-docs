---
title: "xoops_version.php - Manifiesto del módulo"
---

## Descripción general

El archivo `xoops_version.php` es el corazón de cada módulo XOOPS. Define metadatos del módulo, tablas de base de datos, plantillas, bloques, opciones de configuración y enlaces de instalación.
