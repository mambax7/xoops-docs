---
title: "Crear un módulo CRUD"
description: "Tutorial completo para crear un módulo CRUD con operaciones de base de datos, formularios e interfaz de administrador"
---

# Tutorial para crear un módulo CRUD

Este tutorial lo guía a través de la creación de un módulo CRUD completo (Crear, Leer, Actualizar, Eliminar) para XOOPS. Crearemos un módulo "Notas" que permite a los usuarios gestionar notas personales.

## Requisitos previos

- Tutorial de Hello-World-Module completado
- Comprensión de conceptos OOP de PHP
- Conocimiento SQL básico
