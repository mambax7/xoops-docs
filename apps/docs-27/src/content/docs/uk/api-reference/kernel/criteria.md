---
title: "Критерії API Посилання"
description: "Повний довідник API для системи створення запитів XOOPS Criteria"
---
> Повна документація API для системи створення запитів XOOPS Criteria.

---

## Архітектура системи критеріїв
```mermaid
classDiagram
...
1. **Завжди встановлюйте LIMIT** для великих таблиць
2. **Використовуйте індекси** для стовпців, які використовуються в критеріях
3. **Уникайте початкових символів підстановки** в LIKE (`'%term'` повільний)
4. **Попередній фільтр у PHP**, коли це можливо для складної логіки
5. **Використовуйте COUNT економно** - кешуйте результати, коли це можливо
