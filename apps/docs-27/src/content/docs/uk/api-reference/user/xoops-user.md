---
title: "Довідка XoopsUser API"
description: "Повний довідник API для XoopsUser і класів керування користувачами"
---
> Повна документація API для системи користувача XOOPS.
...
| Власність | Тип | Опис |
|----------|------|-------------|
| `uid` | int | ID користувача (первинний ключ) |
| `uname` | рядок | Ім'я користувача |
| `name` | рядок | Справжнє ім'я |
| `email` | рядок | Адреса електронної пошти |
| `pass` | рядок | Хеш пароля |
| `url` | рядок | Веб-сайт URL |
| `user_avatar` | рядок | Назва файлу аватара |
| `user_regdate` | int | Час реєстрації |
| `user_from` | рядок | Розташування |
| `user_sig` | рядок | Підпис |
| `user_occ` | рядок | Професія |
| `user_intrest` | рядок | Інтереси |
| `bio` | рядок | Біографія |
| `posts` | int | Кількість дописів |
| `rank` | int | Рейтинг користувача |
| `level` | int | Рівень користувача (0=неактивний, 1=активний) |
| `theme` | рядок | Бажана тема |
| `timezone` | плавати | Зсув часового поясу |
| `last_login` | int | Мітка часу останнього входу |
...
| ID групи | Ім'я | Опис |
|----------|------|-------------|
| 1 | Веб-майстри | Повний адміністративний доступ |
| 2 | Зареєстровані користувачі | Стандартні зареєстровані користувачі |
| 3 | Анонім | Відвідувачі, які не ввійшли в систему |
...
#xoops #api #користувач #автентифікація #посилання