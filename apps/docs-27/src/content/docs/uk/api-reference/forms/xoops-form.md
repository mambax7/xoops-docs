---
title: "Довідка XoopsForm API"
description: "Повний довідник API для XoopsForm і класів елементів форми"
---
> Повна документація API для системи створення форм XOOPS.
...
|--------|------------|---------|-------------|
| `addElement` | `XoopsFormElement $element, bool $required = false` | `void` | Додати елемент до форми |
| `getElements` | - | `array` | Отримати всі елементи |
| `getElement` | `string $name` | `XoopsFormElement|null` | Отримати елемент за назвою |
| `setExtra` | `string $extra` | `void` | Установіть додаткові атрибути HTML |
| `getExtra` | - | `string` | Отримати додаткові атрибути |
| `getTitle` | - | `string` | Отримати назву форми |
| `setTitle` | `string $title` | `void` | Встановити назву форми |
| `getName` | - | `string` | Отримати назву форми |
| `getAction` | - | `string` | Отримати дію URL |
| `render` | - | `string` | Відобразити форму HTML |
| `display` | - | `void` | Ехо відтвореної форми |
| `insertBreak` | `string $extra = ''` | `void` | Вставити візуальний розрив |
| `setRequired` | `XoopsFormElement $element` | `void` | Позначте необхідний елемент |

---

## XoopsThemeForm

Клас форми, який найчастіше використовується, відображається за допомогою тематичного стилю.
...
Розкривний список або вибір кількох варіантів.
```php
...
Надіслати, скинути або спеціальна кнопка.
```php
...
Мітка лише для відображення (не введення).
```php
