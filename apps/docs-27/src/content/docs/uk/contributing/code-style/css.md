---
title: "CSS і рекомендації SCSS"
description: "XOOPS CSS/SCSS Стандарти кодування та найкращі практики"
---
> XOOPS відповідає сучасним стандартам CSS із попередньою обробкою SCSS, зосереджуючись на ремонтопридатності та продуктивності.

---

## Огляд

Стандарти XOOPS CSS підкреслюють:

- **Попередня обробка SCSS** для організації
- **БЕМ методологія** для іменування
- **Мобільний адаптивний дизайн**
- **Доступність і семантика HTML**
...
BEM = Модифікатор блокового елемента
```scss
...
- Використовуйте змінні SCSS для кольорів, інтервалів, шрифтів
- Дотримуйтеся правил іменування BEM
- Мобільний адаптивний дизайн
- Упорядковуйте файли за призначенням
- Напишіть багаторазові міксини
- Зберігайте селектори простими (максимум 3 рівні глибини)
- Використовуйте семантичний HTML
- Зведіть до мінімуму конкретичність
- Коментуйте складні розділи

### Не треба

- Використовуйте вбудовані стилі
- Використовуйте !important (майже ніколи)
- Створюйте надто специфічні селектори
- Використовуйте селектори ID для стилізації
- Занадто глибоке гніздо (макс. 3-4 рівні)
- Використовуйте px для розміру шрифту (використовуйте rem)
- Створення магічних чисел (використання змінних)
- Залишити невикористаний CSS
- Забудьте про доступність
