---
title: "Умовні позначення шаблонів Smarty"
description: "XOOPS Smarty стандарти кодування шаблону та найкращі практики"
---
> XOOPS використовує Smarty для створення шаблонів. Цей посібник охоплює умовності та найкращі методи розробки шаблонів Smarty.

---

## Огляд

Наступні шаблони XOOPS Smarty:

- **Структура шаблону XOOPS** і іменування
- **Стандарти доступності** (WCAG)
- **Семантична розмітка HTML5**
- **Іменування класів у стилі BEM**
...
<{/if}>
```
### Розділ (застаріло, замість нього використовуйте foreach)
```smarty
...
- Використовуйте семантичний HTML5
- Додайте альтернативний текст для зображень
- Використовуйте константи мови для тексту
- Вихід Escape (за замовчуванням)
- Дотримуйтеся мінімуму логіки
- Використовуйте змістовні назви змінних
- Включати заголовки файлів
- Використовуйте імена класів у стилі БЕМ
- Тест за допомогою програм зчитування з екрана

### Не треба

- Не змішуйте логіку та виклад
- Не забудьте альтернативний текст
- Не використовуйте необроблений HTML без екранування
- Не створюйте глобальні змінні в шаблонах
- Не використовуйте застарілі функції Smarty
- Не вкладайте шаблони занадто глибоко
- Не ігноруйте доступність
- Не закодуйте текст (використовуйте константи)

---

## Приклади шаблонів

### Повний шаблон модуля
```smarty
{*
