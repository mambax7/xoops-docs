---
title: "Стандарти кодування PHP"
description: "Стандарти кодування XOOPS PHP на основі PSR-1, PSR-4 та PSR-12"
---
# PHP-стандарти

> XOOPS відповідає стандартам кодування PSR-1, PSR-4 і PSR-12 із специфічними умовностями XOOPS.
...
#xoops #php #стандарти кодування #psr #найкращі практики