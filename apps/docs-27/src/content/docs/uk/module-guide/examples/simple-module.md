---
title: "Приклад простого модуля"
description: "Повний робочий модуль з усіма необхідними файлами"
---
# Приклад простого модуля - блог

Повний робочий простий модуль, який демонструє основні концепції XOOPS.
...
?>
```
## Інтерфейс адміністратора (admin.php)
```php
<?php
require_once __DIR__ . '/../../mainfile.php';
...
- Відображення опублікованих публікацій блогу з розбивкою на сторінки
- Перегляд окремих публікацій
- Інтерфейс адміністратора для створення, редагування та видалення дописів
- Статус Draft/Published
- Мітки часу

## Тестування

1. Встановіть модуль через XOOPS admin
2. Отримайте доступ до інтерфейсу за адресою `modules/blog/`
3. Відвідайте адміністратора за адресою `modules/blog/admin.php`
4. Створіть тестовий пост і опублікуйте його

## Пов'язана документація

Дивіться також:
- ../Patterns/MVC-Pattern для шаблонів
- ../Patterns/Repository-Pattern для доступу до даних
- ../Best-Practices/Code-Organization для структури

---

Теги: #приклади #простий-модуль #повний-приклад #модульна-розробка