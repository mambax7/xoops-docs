...
| Параметр | Опис |
|-----------|-------------|
| `file` | Файл PHP, що містить функції блоку |
| `name` | Константа мови для заголовка блоку |
| `description` | Константа мови для опису |
| `show_func` | Функція відтворення вмісту блоку |
| `edit_func` | Функція відтворення форми параметрів блоку |
| `template` | Файл шаблону Smarty |
| `options` | Параметри за замовчуванням із розділеними вертикальними лініями |
