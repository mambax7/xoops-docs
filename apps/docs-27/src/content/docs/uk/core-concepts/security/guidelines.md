...
У цьому документі описано найкращі методи безпеки для розробки XOOPS, охоплюючи перевірку вхідних даних, кодування вихідних даних, автентифікацію, авторизацію та захист від поширених веб-уразливостей.
...
```
### Використання об'єктів критеріїв
```php
use Criteria;
use CriteriaCompo;
...
- [ ] Усі введені користувачами перевірені та дезінфіковані
- [ ] Параметризовані запити для всіх операцій з базою даних
- [ ] Вихідне кодування для всього створеного користувачами вмісту
- [] Жетони CSRF на всіх формах, що змінюють стан
- [ ] Захищене хешування паролів (Argon2id)
- [ ] Безпека сеансу налаштована
- [ ] Перевірка завантаження файлу
- [ ] Встановлено заголовки безпеки
- [ ] Впроваджено обмеження швидкості
- [ ] Журнал аудиту ввімкнено
- [ ] Повідомлення про помилки не містять конфіденційної інформації
