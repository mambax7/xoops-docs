---
title: "Розробка теми"
description: "Створення та налаштування тем XOOPS за допомогою успадкування шаблону Smarty"
---
<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

У цьому посібнику описано, як створювати теми XOOPS, зокрема структуру теми, успадкування шаблонів і найкращі методи створення адаптивних сучасних тем.
...
Тема XOOPS складається з такої структури каталогів:
```
themes/
  mytheme/
...
Файл конфігурації теми визначає властивості теми:
```php
<?php
$themeversion = [
    'name'        => 'My Theme',
...
Успадкування шаблону Smarty дозволяє створювати дочірні теми, які успадковуються від батьківської теми.

### Батьківська тема (base.tpl)
```smarty
<!DOCTYPE html>
<html>
<head>
...
Створіть кілька варіантів теми з базової теми:
...
Цей файл виконується автоматично і може бути використаний для підготовки даних для шаблонів:
```php
<?php
...
Створення власних шаблонів блоків:
```smarty
...
```
## Спеціальний Carousel/Slider

Приклад каруселі динамічного вмісту:
```smarty
