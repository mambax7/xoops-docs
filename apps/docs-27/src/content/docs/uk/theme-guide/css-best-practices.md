---
title: "CSS Найкращі методи для тем XOOPS"
---
## Огляд

Цей посібник охоплює організацію CSS, сучасні методи компонування та оптимізацію продуктивності для розробки теми XOOPS.
...
1. **Зведіть до мінімуму специфічність** – уникайте глибокого вкладення
2. **Використовуйте сучасні властивості** - `gap` замість полів
3. **Зменшити перемальовування** - Використовуйте `transform` для анімації
4. **Відкладене завантаження** - завантажувати модуль CSS лише за потреби
```css
...
- Theme-Structure - Організація файлу теми
- Розробка теми - Повний посібник з теми
- ../Templates/Smarty-Templating - Інтеграція шаблону
- ../../03-Module-Development/Block-Development - Стиль блоку