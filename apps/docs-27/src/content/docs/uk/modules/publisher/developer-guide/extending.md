---
title: "Видавець розширення"
description: "Посібник розробника для розширення та налаштування модуля Publisher"
---
> Посібник розробника щодо налаштування та розширення модуля Publisher.
...
Створіть власні шаблони у своїй темі:
```
...
```
### Реєстрація блоку в xoops_version.php
```php
$modversion['blocks'][] = [
...
- Посібник користувача - Початок роботи
- Шаблон MVC
- XoopsObject API
