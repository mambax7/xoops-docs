---
title: "Видавець – користувацькі шаблони"
description: "Посібник із налаштування шаблонів Publisher і створення власних тем"
---
# Спеціальні шаблони в Publisher

> Посібник зі створення та налаштування шаблонів Publisher за допомогою замін Smarty, CSS і HTML.

---

## Огляд системи шаблонів

### Що таке шаблони?

Шаблони керують тим, як Publisher відображає вміст:
```
Templates render:
  ├── Article display
  ├── Category listings
...
### Копіювати шаблон до теми

**Спосіб 1: через файловий менеджер**
```
...
```
### Редагувати спеціальний шаблон

Відкрийте копію теми в текстовому редакторі:
```
...
## Smarty Основи шаблону

### Smarty Змінні

Publisher надає змінні для шаблонів:
...
### Шаблон однієї статті

**Файл: publisher_item.tpl**
```smarty
<!-- Article Detail View -->
...
{/if}
```
### Шаблон списку категорій

**Файл: publisher_category.tpl**
```smarty
<!-- Category Page -->
...
```
### Шаблон блоку останніх статей

**Файл: publisher_block_latest.tpl**
```smarty
<!-- Latest Articles Block -->
...
## Розширені методи шаблонів

### Включити інші шаблони
```smarty
...
### Відображення змінних Smarty

Для налагодження (вилучити у виробництві):
```smarty
{* Show variable value *}
...
У налаштуваннях `/modules/publisher/xoops_version.php` або адміністратора:
```php
// Enable debug
...
### Зі старої версії видавця

У разі оновлення зі старішої версії:

1. Порівняйте старі та нові файли шаблонів
2. Об’єднати користувацькі зміни
3. Використовуйте нові імена змінних
4. Ретельно перевірте
5. Резервне копіювання старих шаблонів
...
- [Документація Smarty](https://www.smarty.net/documentation)
- [Видавець GitHub](https://github.com/XoopsModules25x/publisher)
- [Посібник із шаблонів XOOPS](../../02-Core-Concepts/Templates/Smarty-Basics.md)
