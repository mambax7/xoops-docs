---
title: "Увімкніть режим налагодження"
description: "Як увімкнути та використовувати режим налагодження XOOPS для усунення несправностей"
---
> Вичерпний посібник із функцій та інструментів налагодження XOOPS.

---

## Архітектура налагодження
```mermaid
graph TB
...
## XOOPS Рівні налагодження

### Увімкнути в mainfile.php
```php
<?php
...
| Рівень | PHP Помилки | SQL Запити | Шаблон Vars | Рекомендовано для |
|-------|------------|-------------|--------------|-----------------|
| 0 | Прихований | Ні | Ні | Виробництво |
| 1 | Відображається | Ні | Ні | Швидкі перевірки |
| 2 | Відображається | Зареєстровано | Ні | Розвиток |
| 3 | Відображається | Зареєстровано | Відображається | Глибоке налагодження |

---

## PHP Відображення помилок
...
## SQL Налагодження запиту

### Перегляд запитів у режимі налагодження

Якщо для `XOOPS_DEBUG_LEVEL` встановлено значення 2 або 3, запити SQL відображатимуться внизу сторінок.

### Ручне журналювання запитів
```php
// Log specific query
...
## Smarty Налагодження шаблону

### Увімкнути Smarty Debug Console
```php
...
## Спеціальний помічник з налагодження
```php
<?php
// class/Debug.php
