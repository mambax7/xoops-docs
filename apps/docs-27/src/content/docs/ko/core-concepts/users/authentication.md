---
title: "인증"
description: "XOOPS 인증 시스템, 로그인 흐름, 세션 관리, 보안 및 고급 기능에 대한 완벽한 가이드"
---

# XOOPS에서 인증

XOOPS 인증 시스템은 안전한 사용자 확인, 세션 관리, 2단계 인증 및 OAuth 통합을 포함한 고급 보안 기능을 제공합니다. 이 문서에서는 인증 흐름, 구현 및 모범 사례를 다룹니다.
