---
title: "간단한 모듈 예"
description: "필요한 모든 파일이 포함된 완전한 작업 모듈"
---

# 간단한 모듈 예제 - 블로그

핵심 XOOPS 개념을 보여주는 완전하고 작동하는 간단한 모듈입니다.
...
- 게시된 블로그 게시물을 페이지 매김으로 표시
- 개별 게시물 보기
- 게시물을 생성, 편집, 삭제하는 관리 인터페이스
- 초안/게시 상태
- 타임스탬프

## 테스트

1. XOOPS 관리자를 통해 모듈 설치
2. `modules/blog/`에서 프런트엔드에 액세스합니다.
3. `modules/blog/admin.php` 관리자를 방문하세요.
4. 테스트 게시물 작성 및 게시

## 관련 문서

참조:
- 패턴에 대한../Patterns/MVC-Pattern
- 데이터 액세스를 위한../Patterns/Repository-Pattern
-../모범 사례/구조에 대한 코드 구성

---

태그: #예제 #단순 모듈 #완전한 예 #모듈 개발
