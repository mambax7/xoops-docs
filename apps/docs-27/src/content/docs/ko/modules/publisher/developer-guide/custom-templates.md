---
title: "게시자 - 맞춤 템플릿"
description: "게시자 템플릿 사용자 정의 및 사용자 정의 테마 생성 가이드"
---

# 게시자의 사용자 정의 템플릿

> Smarty, CSS 및 HTML 재정의를 사용하여 게시자 템플릿을 만들고 사용자 정의하는 방법에 대한 안내입니다.
...
템플릿은 Publisher에서 콘텐츠를 표시하는 방법을 제어합니다.
...
`/modules/publisher/xoops_version.php` 또는 관리자 설정에서:
...
- [Smarty 문서](https://www.smarty.net/documentation)
- [출판사 GitHub](https://github.com/XoopsModules25x/publisher)
- [XOOPS 템플릿 가이드](../../02-Core-Concepts/Templates/Smarty-Basics.md)

---

#출판사 #템플릿 #smarty #customization #themeing #xoops
