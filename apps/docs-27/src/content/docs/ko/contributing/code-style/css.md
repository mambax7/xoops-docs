---
title: "CSS 및 SCSS 지침"
description: "XOOPS CSS/SCSS 코딩 표준 및 모범 사례"
---

> XOOPS는 SCSS 전처리를 통해 최신 CSS 표준을 따르며 유지 관리성과 성능에 중점을 둡니다.

---

## 개요

XOOPS CSS 표준은 다음을 강조합니다.
...
- 색상, 간격, 글꼴에 SCSS 변수 사용
- BEM 명명 규칙을 따릅니다.
- 모바일 우선 반응형 디자인
- 목적에 따라 파일을 정리
- 재사용 가능한 믹스인 작성
- 선택기를 단순하게 유지하세요(최대 3레벨 깊이).
- 의미론적 HTML을 사용하라
- 특이성을 최소화
- 복잡한 섹션에 댓글 달기
...
- 인라인 스타일 사용
- !important를 사용하세요(거의 절대 안함)
- 지나치게 구체적인 선택자를 만듭니다.
- 스타일링을 위해 ID 선택기를 사용하세요.
- 중첩이 너무 깊음(최대 3~4레벨)
- 글꼴 크기는 px 사용(rem 사용)
- 매직 넘버 생성(변수 사용)
- 사용하지 않는 CSS는 남겨두세요
...
#xoops #css #scss #스타일링 #코딩 표준 #모범 사례
