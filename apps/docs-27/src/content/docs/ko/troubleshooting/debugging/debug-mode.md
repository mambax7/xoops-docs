---
title: "디버그 모드 활성화"
description: "문제 해결을 위해 XOOPS 디버그 모드를 활성화하고 사용하는 방법"
---

> XOOPS 디버깅 기능 및 도구에 대한 종합 가이드입니다.
...
| 레벨 | PHP 오류 | SQL 쿼리 | 템플릿 변수 | 추천 대상 |
|-------|------------|-------------|---------------|-----------------|
| 0 | 숨겨진 | 아니요 | 아니요 | 생산 |
| 1 | 표시됨 | 아니요 | 아니요 | 빠른 점검 |
| 2 | 표시됨 | 기록됨 | 아니요 | 개발 |
| 3 | 표시됨 | 기록됨 | 표시됨 | 심층 디버깅 |
...
`XOOPS_DEBUG_LEVEL`을 2 또는 3으로 설정하면 SQL 쿼리가 페이지 하단에 나타납니다.
