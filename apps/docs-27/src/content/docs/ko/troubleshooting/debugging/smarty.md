---
title: "Smarty 템플릿 디버깅"
description: "XOOPS에 대한 고급 템플릿 디버깅 및 문제 해결 기술"
---

> XOOPS 테마 및 모듈에서 Smarty 템플릿을 디버깅하기 위한 고급 기술입니다.
...
Smarty은 성능을 위해 템플릿을 PHP로 컴파일합니다. 컴파일된 코드를 보고 디버그합니다.
