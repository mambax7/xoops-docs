---
title: "테마 개발"
description: "Smarty 템플릿 상속으로 XOOPS 테마 생성 및 사용자 정의"
---

<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

이 가이드에서는 테마 구조, 템플릿 상속, 반응형 최신 테마 구축을 위한 모범 사례를 포함하여 XOOPS 테마를 만드는 방법을 다룹니다.
...
Smarty의 템플릿 상속을 사용하면 상위 테마에서 상속되는 하위 테마를 만들 수 있습니다.
...
이 파일은 자동으로 실행되며 템플릿용 데이터를 준비하는 데 사용할 수 있습니다.
