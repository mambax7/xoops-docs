---
title: "テーマ開発"
description: "Smarty テンプレートの継承を使用した XOOPS テーマの作成とカスタマイズ"
---

<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

このガイドでは、テーマ構造、テンプレート継承、レスポンシブで最新のテーマを構築するためのベストプラクティスなど、XOOPS テーマの作成方法について説明します。

## 関連ドキュメント

- Smarty-Basics - XOOPS の Smarty の基礎
- Template-Variables - テンプレートで利用可能な変数
- Smarty-4-Migration - Smarty 3 から 4 へのアップグレード

## テーマ構造

XOOPS テーマは以下のディレクトリ構造で構成されます。

```
themes/
  mytheme/
    theme.tpl              # メインテーマテンプレート
    theme_autorun.php      # 自動実行 PHP (オプション)
    XOOPS_version.php      # テーマ設定
    css/
...
Smarty のテンプレート継承を使用すると、親テーマから継承する子テーマを作成できます。
...
このファイルは自動的に実行され、テンプレート用のデータを準備するために使用できます。
...
<div class="owl-carousel owl-theme">
    ...
    <div class="owl-carousel-info-wrap item">
        ...
        <div class="owl-carousel-info">
            ...
            <span class="badge">閲覧数: <{$item.counter}></span>
            <span class="badge">投票: <{$item.votes}></span>
        </div>
    </div>
    <{/foreach}>
</div>
