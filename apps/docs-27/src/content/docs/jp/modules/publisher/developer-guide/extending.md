---
title: "Publisherを拡張"
description: "Publisherモジュールのカスタマイズと拡張についての開発者ガイド"
---

> Publisherモジュールをカスタマイズおよび拡張するための開発者ガイド。
