---
title: "متغيرات القوالب"
description: "متغيرات Smarty المتاحة في قوالب XOOPS"
dir: rtl
lang: ar
---

يوفر XOOPS تلقائياً العديد من المتغيرات لقوالب Smarty. توثق هذه المرجعية المتغيرات المتاحة لتطوير قوالب المظهر والوحدة.
