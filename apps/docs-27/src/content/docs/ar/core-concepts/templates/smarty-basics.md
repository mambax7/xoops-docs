---
title: "أساسيات Smarty"
description: "أساسيات قوالب Smarty في XOOPS"
dir: rtl
lang: ar
---
...
:::note[إصدار Smarty حسب إطلاق XOOPS]
| إصدار XOOPS | إصدار Smarty | الفروقات الرئيسية |
|---------------|----------------|-----------------|
| 2.5.11 | Smarty 3.x | كتل `{php}` مسموح بها (لكن غير موصى بها) |
| 2.7.0+ | Smarty 3.x/4.x | الاستعداد لتوافق Smarty 4 |
| 4.0 | Smarty 4.x | تم إزالة كتل `{php}`، بناء جملة أصارم |

راجع Smarty-4-Migration للحصول على إرشادات الهجرة.
:::

Smarty هو محرك قوالب PHP يسمح للمطورين بفصل العرض (HTML/CSS) عن منطق التطبيق. يستخدم XOOPS Smarty لجميع احتياجات قوالبه، مما يتيح فصل نظيف بين كود PHP وإخراج HTML.
