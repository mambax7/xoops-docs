...
description: "دليل شامل لنظام المستخدمين في XOOPS والتسجيل والمصادقة وإدارة الملف الشخصي"
dir: rtl
lang: ar
---
...
يوفر نظام إدارة المستخدمين في XOOPS إطار عمل كامل للتعامل مع تسجيل المستخدمين والمصادقة وإدارة الملف الشخصي وتفضيلات المستخدم. تغطي هذه الوثيقة هيكل كائن المستخدم وتدفقات التسجيل وأمثلة التنفيذ العملي.

## هيكل كائن المستخدم

كائن المستخدم الأساسي في XOOPS هو فئة `XoopsUser`، والتي تحيط بجميع بيانات المستخدم والطرق.
