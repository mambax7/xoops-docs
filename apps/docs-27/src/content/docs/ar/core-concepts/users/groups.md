---
title: "نظام المجموعات"
description: "دليل شامل لإدارة مجموعات XOOPS، المجموعات الافتراضية، المجموعات المخصصة، والهرمية"
dir: rtl
lang: ar
---

# نظام المجموعات في XOOPS

يوفر نظام مجموعات XOOPS إطار عمل هرمي لتنظيم المستخدمين وإدارة الأذونات الجماعية. تغطي هذه الوثيقة المجموعات الافتراضية وإنشاء المجموعات المخصصة والهرمية والتنفيذ العملي.
