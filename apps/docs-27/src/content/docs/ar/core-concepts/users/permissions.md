---
title: "نظام الأذونات"
description: "دليل شامل لنظام الأذونات في XOOPS والأنواع والتحقق والهرمية والتحكم في الوصول"
dir: rtl
lang: ar
---

# نظام الأذونات في XOOPS

نظام الأذونات في XOOPS هو إطار عمل للتحكم في الوصول الدقيق يدير من يمكنه تنفيذ الإجراءات على الموارد. تغطي هذه الوثيقة أنواع الأذونات وآليات التحقق والهرمية وأمثلة التنفيذ.

## أنواع الأذونات

### أذونات مستوى الوحدة

تتحكم أذونات مستوى الوحدة في الوصول إلى الوحدات الكاملة أو وظائف الوحدة.

**أسماء الأذونات الشائعة:**
- `module_view` - عرض محتوى الوحدة
- `module_read` - قراءة موارد الوحدة
- `module_submit` - إرسال محتوى إلى الوحدة
- `module_edit` - تحرير محتوى الوحدة
