---
title: "مساعد الأذونات"
description: "إدارة أذونات مجموعة XOOPS باستخدام مساعد الأذونات XMF"
dir: rtl
lang: ar
---
...
يربط نظام الأذونات في XOOPS المجموعات مع:
- معرف الوحدة
- اسم الإذن
- معرف العنصر
...
يستخدم المساعد تلقائياً مجموعات المستخدم الحالية ومعرف الوحدة المحدد.

## فحص الأذونات

### هل يمتلك المستخدم الإذن؟

تحقق من ما إذا كان المستخدم الحالي يمتلك إذن محدد لعنصر ما:
...
### التحقق مع إعادة التوجيه

إعادة توجيه المستخدمين الذين لا يملكون الإذن تلقائياً:
...
افتراضياً، يتمتع مستخدمو الإدارة دائماً بالإذن. للتحقق حتى من المسؤولين:
...
### الحصول على معرفات العناصر المسموح بها

استرجع جميع معرفات العناصر التي لها أذونات مجموعات محددة:
...
### الحصول على المجموعات لعنصر

ابحث عن المجموعات التي لها إذن محدد:
...
إزالة جميع الأذونات لعنصر ما (عادة عند حذف العنصر):
...
### إضافة اختيار الأذونات إلى النماذج

يمكن للمساعد إنشاء عنصر نموذج لاختيار المجموعات:
...
## مثال كامل: عناصر محمية بالأذونات
