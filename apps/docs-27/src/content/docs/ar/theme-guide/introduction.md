---
title: "تطوير المواضيع"
description: "إنشاء وتخصيص مواضيع XOOPS مع وراثة قالب Smarty"
dir: rtl
lang: ar
---
...
يغطي هذا الدليل كيفية إنشاء مواضيع XOOPS، بما في ذلك هيكل المواضيع والوراثة للقالب وأفضل الممارسات لبناء مواضيع حديثة سريعة الاستجابة.

## الوثائق ذات الصلة

- أساسيات Smarty - أساسيات Smarty في XOOPS
- متغيرات القالب - المتغيرات المتاحة في القوالب
- هجرة Smarty 4 - الترقية من Smarty 3 إلى 4

## هيكل المواضيع

يتكون موضوع XOOPS من هيكل الدليل التالي:

```
themes/
  mytheme/
    theme.tpl              # قالب المواضيع الرئيسي
    theme_autorun.php      # PHP الذي يعمل بشكل تلقائي (اختياري)
    XOOPS_version.php      # تكوين المواضيع
    css/
      style.css            # ورقة الأنماط الرئيسية
      custom.css           # أنماط مخصصة
    images/
      logo.png             # صور المواضيع
    js/
      custom.js            # جافا سكريبت مخصص
    language/
      english/
        main.php           # سلاسل اللغة
```

## XOOPS_version.php

يحدد ملف تكوين المواضيع خصائص المواضيع:
...
يسمح وراثة قالب Smarty بإنشاء مواضيع فرعية ترث من موضوع أب.

### موضوع الوالدين (base.tpl)
...
### إنشاء اختلافات المواضيع

أنشئ اختلافات مواضيع متعددة من موضوع أساسي:
...
يتم تنفيذ هذا الملف تلقائيا ويمكن استخدامه لتحضير البيانات للقوالب:
...
## نصائح التصميم سريع الاستجابة

### CSS موجه للهاتف أولا
