---
title: "تصحيح قاعدة البيانات"
description: "تصحيح استعلامات SQL ومشاكل قاعدة البيانات في XOOPS"
dir: rtl
lang: ar
---
...
> الطرق والأدوات لتصحيح استعلامات SQL ومشاكل قاعدة البيانات في تطبيقات XOOPS.
...
## تفعيل تسجيل الاستعلام

### الطريقة 1: وضع تصحيح XOOPS
...
### الطريقة 2: سجل استعلامات MySQL البطيء
...
### الطريقة 3: سجل الاستعلام العام

فعّل لجميع الاستعلامات (حذر: ملفات السجل كبيرة):
...
استخدم EXPLAIN لتحليل تنفيذ الاستعلام:
...
### المشكلة: الاستعلام يعيد نتائج خاطئة
