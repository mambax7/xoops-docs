...
description: "كيفية تفعيل واستخدام وضع تصحيح XOOPS لاستكشاف الأخطاء"
dir: rtl
lang: ar
---

> دليل شامل لميزات وأدوات تصحيح XOOPS.
...
### عرض الاستعلامات في وضع التصحيح

مع تعيين `XOOPS_DEBUG_LEVEL` إلى 2 أو 3، تظهر استعلامات SQL في أسفل الصفحات.

### تسجيل الاستعلام اليدوي
