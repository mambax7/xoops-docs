---
title: "Piawaian Pengekodan JavaScript"
description: "XOOPS piawaian pengekodan JavaScript dan amalan terbaik"
---
# Piawaian JavaScript> XOOPS mengikut piawaian JavaScript moden (ES6+) dengan penekanan pada kebolehbacaan dan kebolehselenggaraan.---

## Gambaran KeseluruhanPiawaian JavaScript XOOPS adalah berdasarkan:- **ECMAScript 2015+** (ES6 dan ciri moden)
- **Panduan Gaya JavaScript Airbnb** (disesuaikan)
- **XOOPS konvensyen** untuk konsistensi
- **Piawaian kebolehaksesan** (WCAG)---

## Struktur Fail### Organisasi Fail
```
javascript
...
## Pembolehubah dan Pemalar### Pengisytiharan Pembolehubah
```
javascript
...
## Kelas dan Objek### Definisi Kelas
```
javascript
/**
...
## Tatasusunan### Kaedah Tatasusunan
```
javascript
...
## Komen dan Dokumentasi### Komen Sebaris
```
javascript
...
## Ringkasan Amalan Terbaik### Lakukan- Gunakan const secara lalai
- Gunakan nama deskriptif
- Gunakan fungsi anak panah untuk panggilan balik
- Gunakan async/await untuk janji
- Dokumen fungsi kompleks
- Cache elemen DOM
- Gunakan delegasi acara
- Tulis fungsi tulen
- Pastikan fungsi fokus### Jangan- Gunakan var (warisan)
- Gunakan pembolehubah global
- Buat fungsi panjang (lebih 50 baris)
- Kod sarang dalam
- Gunakan eval()
- Gunakan pengendali acara sebaris
- Tinggalkan console.log() dalam pengeluaran
- Buat kebocoran memori
- Mutasi parameter fungsi---

## Alat dan Linting### Konfigurasi ESLint
```
javascript
// .eslintrc.json
{
...
## Dokumentasi Berkaitan- Garis Panduan CSS
- Tatakelakuan
- Aliran Kerja Sumbangan
- Piawaian PHP---

#XOOPS #javascript #es6 #coding-standard #best-practices