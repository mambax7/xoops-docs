---
title: "Piawaian Pengekodan PHP"
description: "XOOPS Piawaian pengekodan PHP berdasarkan PSR-1, PSR-4 dan PSR-12"
---
# PHP-Standard> XOOPS mengikut piawaian pengekodan PSR-1, PSR-4 dan PSR-12 dengan konvensyen khusus XOOPS.---

## Gambaran Keseluruhan Standard
```
mermaid
graph TB
...
## Peraturan Pemformatan### Lekukan dan Jarak
```
php
...
#XOOPS #php #coding-standard #psr #best-practices