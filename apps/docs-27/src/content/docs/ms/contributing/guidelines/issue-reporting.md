---
title: "Garis Panduan Pelaporan Isu"
description: "Cara melaporkan pepijat, permintaan ciri dan isu lain dengan berkesan"
---
...
## Sebelum Melapor### Semak Isu Sedia Ada**Sentiasa cari dahulu:**1. Pergi ke [Isu GitHub](https://github.com/XOOPS/XoopsCore27/issues)
2. Cari kata kunci yang berkaitan dengan isu anda
3. Semak isu tertutup - mungkin sudah diselesaikan
4. Lihat permintaan tarik - mungkin sedang dijalankanGunakan penapis carian:
- `is:issue is:open label:bug` - Buka pepijat
- `is:issue is:open label:feature` - Buka permintaan ciri
- `is:issue sort:updated` - Isu terkini yang dikemas kini### Adakah Ia Benar-benar Isu?Pertimbangkan dahulu:- **Isu konfigurasi?** - Semak dokumentasi
- **Soalan penggunaan?** - Tanya di forum atau komuniti Discord
...
```
### Contoh Laporan Pepijat yang Baik
```
markdown
## Description
...
## Melaporkan Permintaan Ciri### Templat Permintaan Ciri
```
markdown
## Description
...
```
### Contoh Permintaan Ciri yang Baik
```
markdown
## Description
...
## Isu Keselamatan### JANGAN Laporkan Secara Umum**Jangan sekali-kali mencipta isu awam untuk kelemahan keselamatan.**### Laporkan Secara Persendirian1. **E-mel kepada pasukan keselamatan:** security@XOOPS.org
2. **Sertakan:**
...
## Amalan Terbaik Tajuk Isu### Tajuk Baik
```
...
❌ Error
```
### Garis Panduan Tajuk- **Be specific** - Sebut apa dan di mana
- **Singkatkan** - Bawah 75 aksara
...
2. **Di mana** - Halaman, modul atau ciri yang mana
3. **Bila** - Langkah untuk membiak
4. **Persekitaran** - Versi, OS, penyemak imbas, PHP
5. **Mengapa** - Mengapa ini penting### Gunakan Pemformatan Kod
```
markdown
