---
title: "Migrasi Pangkalan Data"
---
## Gambaran KeseluruhanPenghijrahan pangkalan data menyediakan perubahan yang dikawal versi dan boleh diterbalikkan kepada skema pangkalan data anda. Mereka memastikan keadaan pangkalan data yang konsisten merentas pembangunan, pementasan dan persekitaran pengeluaran.## Struktur Migrasi### Penamaan Fail
```
migrations/
...
```
## Pelari Migrasi### Menjalankan Migrasi
```
php
...
```
## Amalan Terbaik1. **Satu Perubahan Setiap Migrasi** - Pastikan migrasi fokus
2. **Sentiasa Tuliskan Kaedah** - Dayakan pemulangan semula
3. **Uji Kedua-dua Arah** - Sahkan atas() dan bawah()
4. **Gunakan Transaksi** - Balut migrasi kompleks
5. **Jangan Ubah Suai Migrasi Lama** - Buat yang baharu sebaliknya
6. **Back Up Sebelum Lari** - Terutamanya dalam pengeluaran## Dokumentasi Berkaitan- Pangkalan Data-Skema - Reka bentuk skema
- Operasi Pangkalan Data - Pelaksanaan pertanyaan
- ../xoops_version.php - Manifes modul
- ../../07-XOOPS-4.0/XOOPS-4.0-Architecture - Seni bina moden