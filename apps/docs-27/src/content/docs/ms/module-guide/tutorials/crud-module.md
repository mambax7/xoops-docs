---
title: "Membina Modul CRUD"
description: "Tutorial lengkap untuk membina modul CRUD dengan operasi pangkalan data, borang dan antara muka pentadbir"
---
# Membina Tutorial Modul CRUD

Tutorial ini membimbing anda membina modul CRUD (Buat, Baca, Kemas Kini, Padam) yang lengkap untuk XOOPS. Kami akan membuat modul "Nota" yang membolehkan pengguna mengurus nota peribadi.

## Prasyarat

- Melengkapkan tutorial Hello-World-Module
- Memahami konsep PHP OOP
- Pengetahuan asas SQL

## Gambaran Keseluruhan Modul

**Ciri Modul Nota:**
- Buat, lihat, edit dan padam nota
- Antara muka pengurusan pentadbir
- Nota khusus pengguna
- Organisasi kategori
- Fungsi carian

## Langkah 1: Struktur Direktori

Cipta struktur berikut dalam `/modules/notes/`:
```
/modules/notes/
    /admin/
        admin_header.php
    ...
    xoops_version.php
```
## Langkah 2: Skema Pangkalan Data
...
Buat `class/CategoryHandler.php`:
```php
<?php
/**
...
```
## Langkah 5: Biasa Sertakan Fail

Buat `include/common.php`:
```php
<?php
/**
 * Common Include File
...
Buat `templates/notes_index.tpl`:
```smarty
...
```
## Langkah 9: Antara Muka Pentadbir
...
```
### Pengurusan Nota Pentadbir

Buat `admin/notes.php`:
```php
<?php
/**
...
tahniah! Anda telah membina modul CRUD yang lengkap. Konsep utama yang diliputi:

1. **Reka Bentuk Pangkalan Data** - Jadual dengan perhubungan
2. **Kelas Entiti** - XoopsObject dengan sifat ditaip
3. **Kelas Pengendali** - XoopsPersistableObjectHandler dengan kaedah tersuai
4. **Halaman Depan** - Senarai, lihat dan edit fungsi
5. **Pengendalian Borang** - CSRF perlindungan dan pengesahan
6. **Antaramuka Pentadbir** - Skrin pengurusan
7. **Templat** - Templat Smarty dengan logik

## Langkah Seterusnya

- Tambahkan lebih banyak ciri lanjutan (ulasan, penilaian, perkongsian)
- Laksanakan ../Patterns/Repository-Pattern untuk capaian data yang lebih bersih
- Gunakan ../Corak/MVC-Corak untuk organisasi kod yang lebih baik
- Tambahkan ../Best-Practices/Testing dengan PHPUnit

Lihat juga: ../Module-Development | ../Corak/MVC-Corak | ../Patterns/Repository-Pattern