---
title: "Unit Corak Kerja"
---
## Gambaran Keseluruhan

Corak Unit Kerja mengekalkan senarai objek yang terjejas oleh transaksi perniagaan dan menyelaraskan menulis perubahan. Ia memastikan semua perubahan yang berkaitan dilakukan bersama-sama atau dibatalkan apabila kegagalan.

## Tujuan

1. **Pengurusan Transaksi** - Operasi berkaitan kumpulan
2. **Tukar Penjejakan** - Jejaki entiti yang diubah suai
3. **Operasi Kelompok** - Optimumkan penulisan pangkalan data
4. **Ketekalan** - Pastikan integriti data

## Pelaksanaan

### Unit Antara Muka Kerja
```php
<?php
...
1. **Transaksi Pendek** - Pastikan transaksi ringkas
2. **Tanggungjawab Tunggal** - Satu unit kerja bagi setiap operasi perniagaan
3. **Clear Boundaries** - Tentukan skop transaksi dengan jelas
4. **Pengendalian Ralat** - Sentiasa kendalikan senario rollback
5. **Elakkan Bersarang** - Jangan sarangkan unit kerja

## Dokumentasi Berkaitan

- Lapisan Repositori - Corak repositori
