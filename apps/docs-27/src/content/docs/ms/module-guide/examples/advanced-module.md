---
title: "Contoh Modul Lanjutan"
description: "Modul kompleks dengan berbilang jadual, perhubungan, antara muka pentadbir dan blok"
---
# Contoh Modul Lanjutan - Forum

Modul "Forum" komprehensif yang menunjukkan corak lanjutan: berbilang jenis entiti, perhubungan, antara muka pentadbir yang kompleks dan pemberitahuan.
...
1. **Hubungan Entiti** - Forum mengandungi Topik, Topik mengandungi Catatan
2. **Pertanyaan Kompleks** - Menyertai dengan maklumat dan statistik pengguna
3. **Penyelarasan Perkhidmatan** - Pelbagai perkhidmatan bekerjasama
4. **Pengagregatan Data** - Kiraan siaran, kiraan tontonan
5. **Pemberitahuan** - Pemberitahuan dipacu acara untuk langganan
6. **Operasi seperti Transaksi** - Mencipta topik dengan catatan awal

## Corak Berkaitan

Lihat juga:
- ../Patterns/Repository-Pattern untuk pertanyaan kompleks
- ../Patterns/Service-Layer untuk penyelarasan perkhidmatan
- ../Corak/DTO-Corak untuk pemindahan data

---

Tag: #contoh #modul lanjutan #contoh-kompleks #hubungan #pembangunan-modul