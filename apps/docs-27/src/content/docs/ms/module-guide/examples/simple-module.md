---
title: "Contoh Modul Mudah"
description: "Modul kerja lengkap dengan semua fail yang diperlukan"
---
# Contoh Modul Mudah - Blog

Modul ringkas yang lengkap dan berfungsi yang menunjukkan konsep teras XOOPS.
...
?>
```
## Antara Muka Pentadbir (admin.php)
```php
<?php
require_once __DIR__ . '/../../mainfile.php';
...
- Paparkan catatan blog yang diterbitkan dengan penomboran
- Lihat siaran individu
- Antara muka pentadbir untuk membuat, mengedit, memadam siaran
- Draft/Published status
- Cap masa

## Ujian

1. Pasang modul melalui XOOPS admin
2. Akses bahagian hadapan pada `modules/blog/`
3. Lawati admin di `modules/blog/admin.php`
4. Buat siaran ujian dan terbitkannya

## Dokumentasi Berkaitan

Lihat juga:
- ../Corak/MVC-Corak untuk corak
- ../Patterns/Repository-Pattern untuk capaian data
- ../Best-Practices/Code-Organization untuk struktur

---

Tag: #contoh #modul-mudah #contoh-lengkap #pembangunan-modul