---
title: "Rujukan API Kriteria"
description: "Rujukan API lengkap untuk sistem pembinaan pertanyaan Kriteria XOOPS"
---
> Lengkapkan dokumentasi API untuk sistem pembinaan pertanyaan Kriteria XOOPS.---

## Senibina Sistem Kriteria
```
mermaid
classDiagram
...
| `BETWEEN` | `new Criteria('created', '1000 AND 2000', 'BETWEEN')` | `created BETWEEN 1000 AND 2000` |### Contoh Penggunaan
```
php
// Simple equality
...
## Kelas KriteriaKompo### Pembina & Kaedah
```
php
// Create empty compo
...
## Contoh Pertanyaan Kompleks### Cari dengan Berbilang Syarat
```
php
$criteria = new CriteriaCompo();
...
## Kriteria kepada Visualisasi SQL
```
mermaid
graph LR
    subgraph "PHP Code"
...
```
### Amalan Terbaik1. **Sentiasa tetapkan LIMIT** untuk meja besar
2. **Gunakan indeks** pada lajur yang digunakan dalam kriteria
3. **Elakkan kad bebas terkemuka** dalam LIKE (`'%term'` perlahan)
4. **Pra-tapis dalam PHP** apabila boleh untuk logik yang kompleks
5. **Gunakan COUNT dengan berhati-hati** - keputusan cache apabila boleh---

## Dokumentasi Berkaitan- Lapisan Pangkalan Data
