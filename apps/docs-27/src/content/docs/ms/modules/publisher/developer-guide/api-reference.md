---
title: "Penerbit - API Rujukan"
description: "Rujukan API lengkap untuk modul Penerbit dengan kelas, kaedah dan contoh kod"
---
# Penerbit API Rujukan

> Rujukan lengkap untuk kelas modul Penerbit, kaedah, fungsi dan API titik akhir.
...
Kelas `Item` mewakili satu article/item dalam Penerbit.

**Ruang nama:** `XoopsModules\Publisher\`

**Fail:** `modules/publisher/class/Item.php`
...
`ItemHandler` menguruskan CRUD operasi untuk artikel.

**Fail:** `modules/publisher/class/ItemHandler.php`
...
Kelas `Category` mewakili kategori atau bahagian.

**Fail:** `modules/publisher/class/Category.php`
...
## Kelas Pengendali Kategori

### Gambaran Keseluruhan

`CategoryHandler` menguruskan operasi kategori CRUD.

**Fail:** `modules/publisher/class/CategoryHandler.php`
...
Kelas Helper menyediakan fungsi utiliti:

**Fail:** `modules/publisher/class/Helper.php`
```php
// Get helper instance
...
### Fungsi JavaScript Bahagian Depan

Penerbit menyertakan JavaScript API untuk interaksi bahagian hadapan:
```javascript
...
Penerbit menyediakan AJAX titik akhir untuk interaksi bahagian hadapan:
```javascript
...
## REST API (Jika Didayakan)

### API Titik tamat

Jika Penerbit mendedahkan REST API:
```
...
?>
```
### Cipta Artikel Secara Pemrograman
```php
<?php
// Create article
$itemHandler = xoops_getModuleHandler('Item', 'publisher');
...
?>
```
### Dapatkan Artikel mengikut Kategori
```php
<?php
...
- Cangkuk dan Acara
- Templat Tersuai
- Analisis Modul Penerbit
- Templat dan Blok dalam Penerbit
- Penciptaan Artikel
- Pengurusan Kategori
...
- [PHP Dokumentasi](https://www.php.net/docs.php)

---

#penerbit #api #rujukan #kod #kelas #kaedah #XOOPS