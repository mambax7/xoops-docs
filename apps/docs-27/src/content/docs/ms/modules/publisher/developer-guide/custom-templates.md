---
title: "Penerbit - Templat Tersuai"
description: "Panduan untuk menyesuaikan templat Penerbit dan mencipta tema tersuai"
---
# Templat Tersuai dalam Penerbit

> Panduan untuk mencipta dan menyesuaikan templat Penerbit menggunakan Smarty, CSS dan HTML mengatasi.

---

## Gambaran Keseluruhan Sistem Templat

### Apakah Templat?

Templat mengawal cara Penerbit memaparkan kandungan:
```
Templates render:
  ├── Article display
  ├── Category listings
...
### Salin Templat ke Tema

**Kaedah 1: Melalui Pengurus Fail**
```
...
```
### Edit Templat Tersuai

Buka salinan tema dalam editor teks:
```
...
Penerbit menyediakan pembolehubah kepada templat:
...
### Templat Artikel Tunggal

**Fail: publisher_item.tpl**
```smarty
<!-- Article Detail View -->
...
{/if}
```
### Templat Penyenaraian Kategori

**Fail: publisher_category.tpl**
```smarty
<!-- Category Page -->
...
```
### Templat Sekat Artikel Terkini

**Fail: publisher_block_latest.tpl**
```smarty
<!-- Latest Articles Block -->
...
Buat CSS tersuai dalam tema:
```
/themes/yourtheme/modules/publisher/css/custom.css
```
### Struktur Templat Asas

Fahami struktur HTML:
```html
<!-- Publisher Module -->
...
## Templat Penyahpepijatan

### Paparkan Pembolehubah Pintar

Untuk penyahpepijatan (alih keluar dalam pengeluaran):
```smarty
{* Show variable value *}
...
Dalam `/modules/publisher/xoops_version.php` atau tetapan pentadbir:
```php
// Enable debug
...
### Daripada Versi Penerbit Lama

Jika menaik taraf daripada versi lama:

1. Bandingkan fail templat lama dan baharu
2. Gabungkan perubahan tersuai
3. Gunakan nama pembolehubah baharu
4. Uji dengan teliti
5. Sandarkan templat lama
...
- [Dokumentasi Pintar](https://www.Smarty.net/documentation)
- [GitHub Penerbit](https://github.com/XoopsModules25x/publisher)
- [XOOPS Panduan Templat](../../02-Core-Concepts/Templates/Smarty-Basics.md)

---

#penerbit #template #bijak #penyesuaian #tema #XOOPS