---
title: "Penyahpepijatan Templat Smarty"
description: "Penyahpepijatan templat lanjutan dan teknik penyelesaian masalah untuk XOOPS"
---
> Teknik lanjutan untuk menyahpepijat templat Smarty dalam XOOPS tema dan modul.
...
## Dayakan Mod Nyahpepijat Pintar

### Kaedah 1: Panel Pentadbiran

XOOPS Pentadbir > Tetapan > Prestasi:
- Dayakan "Output Nyahpepijat"
- Tetapkan "Tahap Nyahpepijat" kepada 2

---

### Kaedah 2: Konfigurasi Kod
```php
<?php
...
### Kaedah 3: Nyahpepijat Pop Timbul dalam Penyemak Imbas
```smarty
{* Add to template to enable debug in footer *}
{debug}
```
Ini menunjukkan pop timbul dengan semua pembolehubah yang ditetapkan.

---

## Teknik Nyahpepijat Pintar Biasa

### Buang Semua Pembolehubah
```php
<?php
// In PHP code
$tpl = new XoopsTpl();
...
### Semak Pembolehubah dalam Templat
```smarty
...
## Lihat Templat Tersusun

Smarty menyusun templat kepada PHP untuk prestasi. Nyahpepijat dengan melihat kod yang disusun:
```bash
...
## Nyahpepijat Isu Khusus

### Isu 1: Pembolehubah Ditunjukkan sebagai Kosong
```php
<?php
$tpl = new XoopsTpl();
...
### Isu 2: Kunci Tatasusunan Tidak Ditemui
```smarty
...
### Isu 3: Plugin/Modifier Tidak Ditemui
```php
<?php
...
### Isu 4: Paparan Tatasusunan Bersarang
```smarty
{* Debug nested arrays *}
...
## Aliran Kerja Penyahpepijatan

### Proses Nyahpepijat Langkah demi Langkah
```mermaid
graph TD
