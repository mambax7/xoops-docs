---
title: "Dayakan Mod Nyahpepijat"
description: "Cara mendayakan dan menggunakan XOOPS mod nyahpepijat untuk menyelesaikan masalah"
---
> Panduan komprehensif untuk XOOPS ciri dan alatan penyahpepijatan.

---

## Seni Bina Nyahpepijat
```mermaid
graph TB
...
## XOOPS Tahap Nyahpepijat

### Dayakan dalam mainfile.php
```php
<?php
...
| Tahap | PHP Ralat | SQL Pertanyaan | Templat Vars | Disyorkan Untuk |
|-------|------------|-------------|----------------|----------------|
| 0 | Tersembunyi | Tidak | Tidak | Pengeluaran |
| 1 | Dipaparkan | Tidak | Tidak | Semakan pantas |
| 2 | Dipaparkan | Dilog | Tidak | Pembangunan |
| 3 | Dipaparkan | Dilog | Dipaparkan | Penyahpepijatan mendalam |
...
## SQL Penyahpepijatan Pertanyaan

### Lihat Pertanyaan dalam Mod Nyahpepijat

Dengan `XOOPS_DEBUG_LEVEL` ditetapkan kepada 2 atau 3, SQL pertanyaan muncul di bahagian bawah halaman.

### Pengelogan Pertanyaan Manual
```php
// Log specific query
...
## Penyahpepijatan Templat Pintar

### Dayakan Smarty Debug Console
```php
...
ray()->pause();
```
### Nyahpepijat Pertanyaan Pangkalan Data
```php
// Log all queries
ray()->showQueries();
...
#XOOPS #debugging #penyelesaianmasalah #pembangunan #pembalakan