...
description: "Menyahpepijat XOOPS aplikasi dengan penyahpepijat Ray"
---
# Menggunakan Ray Debugger untuk XOOPS

> Penyahpepijatan moden dengan Ray: periksa pembolehubah, log mesej, jejak SQL pertanyaan dan prestasi profil dalam aplikasi XOOPS anda.

---

## Apakah Ray?

Ray ialah alat penyahpepijatan ringan yang membantu anda memeriksa keadaan aplikasi tanpa menghentikan pelaksanaan atau menggunakan titik putus. Ia sesuai untuk pembangunan XOOPS.
...
```
### Langkah 2: Muat turun Apl Ray

Muat turun daripada [ray.so](https://ray.so):
- Mac: Ray.app
- Windows: Ray.exe
- Linux: ray (AppImage)
...
Ray menggunakan port 23517 secara lalai:
```bash
# UFW
...
?>
```
### 4. Mengelompokkan Log Berkaitan
```php
<?php
$ray = ray();
...
## XOOPS-Penyahpepijatan Khusus

### Penyahpepijatan Modul
```php
<?php
...
### Penyahpepijatan Pemasangan Modul
```php
<?php
...
### S: Ray tidak menerima mesej

**J:**
1. Apl Semak Ray sedang berjalan
2. Semak firewall membenarkan port 23517
3. Sahkan Ray dipasang:
```bash
composer require spatie/ray
```
### S: Tidak dapat melihat SQL pertanyaan
...
?>
```
### S: Kesan prestasi Ray

**J:** Ray mempunyai overhed minimum. Untuk pengeluaran, alih keluar panggilan Ray atau lumpuhkan:
```php
<?php
