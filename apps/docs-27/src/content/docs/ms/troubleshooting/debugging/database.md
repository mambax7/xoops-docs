---
title: "Penyahpepijatan Pangkalan Data"
description: "Menyahpepijat SQL dan isu pangkalan data dalam XOOPS"
---
# Teknik Nyahpepijat Pangkalan Data

> Kaedah dan alatan untuk menyahpepijat SQL pertanyaan dan isu pangkalan data dalam XOOPS aplikasi.
...
### Kaedah 1: XOOPS Mod Nyahpepijat
```php
<?php
// In mainfile.php
...
### Kaedah 2: Log Pertanyaan Perlahan MySQL

Dayakan dalam `/etc/mysql/my.cnf`:
```ini
[mysqld]
...
### Kaedah 3: Log Pertanyaan Umum

Dayakan untuk semua pertanyaan (berhati-hati: fail log besar):
```sql
-- Enable
...
## Nyahpepijat SQL dalam Kod

### Log Perlaksanaan Pertanyaan
```php
<?php
...
Gunakan EXPLAIN untuk menganalisis pelaksanaan pertanyaan:
```sql
-- Analyze a query
...
## Menyahpepijat Isu Khusus

### Isu: Pertanyaan Mengembalikan Keputusan Yang Salah
```php
<?php
$ray = ray();
...
## Cipta Log Pertanyaan Nyahpepijat
```php
<?php
...
## Senarai Semak Pengoptimuman Pangkalan Data
```mermaid
graph TD
