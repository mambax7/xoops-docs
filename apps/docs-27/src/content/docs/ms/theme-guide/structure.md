...
XOOPS tema mengawal persembahan visual tapak anda. Memahami struktur tema adalah penting untuk penyesuaian dan mencipta tema baharu.
...
Templat reka letak utama yang membungkus semua kandungan:
```html
<!DOCTYPE html>
...
|----------|-------------|
| `$xoops_sitename` | Nama tapak |
| `$xoops_url` | Tapak URL |
| `$xoops_theme` | Nama tema semasa |
| `$xoops_langcode` | Kod bahasa |
| `$xoops_charset` | Pengekodan aksara |
| `$xoops_pagetitle` | Tajuk halaman |
| `$xoops_dirname` | Nama modul semasa |

### Pembolehubah Pengguna

| Pembolehubah | Penerangan |
|----------|-------------|
| `$xoops_isuser` | Telah log masuk |
| `$xoops_isadmin` | Adakah pentadbir |
| `$xoops_userid` | ID Pengguna |
| `$xoops_uname` | Nama pengguna |

### Pembolehubah Reka Letak

| Pembolehubah | Penerangan |
|----------|-------------|
| `$xoops_showlblock` | Tunjukkan blok kiri |
| `$xoops_showrblock` | Tunjukkan blok kanan |
| `$xoops_showcblock` | Tunjukkan blok tengah |
| `$xoops_lblocks` | Tatasusunan blok kiri |
| `$xoops_rblocks` | Tatasusunan blok kanan |
| `$xoops_contents` | Kandungan halaman utama |

## Templat Modul Menggantikan

Gantikan templat modul dengan meletakkannya dalam tema anda:
```
...
- ../Templates/Smarty-Templating - Sintaks templat
- Tema-Pembangunan - Panduan tema lengkap
- CSS-Amalan-Terbaik - Garis panduan penggayaan 
- ../../03-Module-Development/Block-Development - Mencipta blok