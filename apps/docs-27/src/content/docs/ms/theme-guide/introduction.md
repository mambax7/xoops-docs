---
title: "Pembangunan Tema"
description: "Mencipta dan menyesuaikan XOOPS tema dengan warisan templat Smarty"
---
<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

Panduan ini merangkumi cara mencipta XOOPS tema, termasuk struktur tema, warisan templat dan amalan terbaik untuk membina tema moden yang responsif.

## Dokumentasi Berkaitan

- Smarty-Basics - Asas Smarty dalam XOOPS
- Pembolehubah-Templat - Pembolehubah yang tersedia dalam templat
- Smarty-4-Migration - Menaik taraf daripada Smarty 3 kepada 4

## Struktur Tema

Tema XOOPS terdiri daripada struktur direktori berikut:
```
themes/
  mytheme/
...
Warisan templat Smarty membolehkan anda mencipta tema anak yang diwarisi daripada tema induk.
...
{/block}
```
### Mencipta Variasi Tema

Buat berbilang variasi tema daripada tema asas:
...
```
## Tersuai Carousel/Slider

Contoh karusel kandungan dinamik:
```smarty
...
#themes #Smarty #XOOPS #css #design #responsif