---
title: "Sistem Kumpulan"
description: "Panduan komprehensif untuk pengurusan kumpulan XOOPS, kumpulan lalai, kumpulan tersuai dan hierarki kumpulan"
---
# Sistem Kumpulan dalam XOOPSSistem Kumpulan XOOPS menyediakan rangka kerja hierarki untuk mengatur pengguna dan mengurus kebenaran kolektif. Dokumen ini merangkumi kumpulan lalai, penciptaan kumpulan tersuai, hierarki dan pelaksanaan praktikal.## Kumpulan LalaiXOOPS termasuk tiga kumpulan asas yang dibuat semasa pemasangan sistem:### Kumpulan Juruweb (ID: 1)Kumpulan Webmasters mewakili pentadbir tapak dengan akses sistem penuh.**Ciri-ciri:**
- ID Kumpulan: 1
- Tahap keistimewaan tertinggi
- Tidak boleh dipadamkan
- Akses penuh kepada semua modul dan fungsi
- Akses kepada panel pentadbiran
```
php
<?php
/**
...
```
### Kumpulan Pengguna Berdaftar (ID: 2)Kumpulan Pengguna Berdaftar termasuk semua pengguna yang disahkan yang bukan tanpa nama.**Ciri-ciri:**
- ID Kumpulan: 2
- Kumpulan lalai untuk pendaftaran baharu
- Boleh mengakses ciri khusus pengguna
- Tertakluk kepada kebenaran berasaskan kumpulan
- Boleh disesuaikan untuk ciri pengguna standard
```
php
<?php
/**
...
```
### Kumpulan Tanpa Nama (ID: 3)Kumpulan Tanpa Nama mewakili pelawat yang tidak disahkan ke tapak tersebut.**Ciri-ciri:**
- ID Kumpulan: 3
- Kumpulan lalai untuk pengguna yang tidak log masuk
- Akses baca sahaja terhad biasanya
- Tidak boleh mengubah suai kandungan
- Kebenaran tontonan awam
```
php
<?php
/**
...
```
## Struktur Kumpulan### Skema Pangkalan Data
```
sql
...
```
## Hierarki Kumpulan### Rajah Hierarki
```
mermaid
graph TD
    ROOT["XOOPS System"]
...
```
## Membuat Kumpulan Tersuai### Pengendali Penciptaan Kumpulan
```
php
<?php
/**
...
```
## Tugasan Kebenaran Kumpulan### Memberikan Kebenaran kepada Kumpulan
```
php
<?php
/**
...
```
## Contoh Praktikal### Persediaan Kumpulan Jabatan
```
php
<?php
/**
...
```
## Amalan Terbaik### Organisasi Kumpulan1. **Penamaan Jelas**: Gunakan nama kumpulan yang deskriptif dan jelas
2. **Dokumentasi**: Dokumen tujuan dan kebenaran kumpulan
3. **Prinsip Keistimewaan Paling Rendah**: Berikan kebenaran minimum yang diperlukan
4. **Audit Berkala**: Semak keahlian dan kebenaran kumpulan secara berkala
5. **Kumpulan Lalai**: Kekalkan kumpulan lalai (Juru Web, Berdaftar, Tanpa Nama)### Pengurusan Kebenaran
```
php
<?php
/**
...
- Kebenaran System.md
- Authentication.md
- ../../Security/Security-Guidelines.md## Tag#kumpulan #pengurusan-kumpulan #kebenaran #kawalan-akses #organisasi-pengguna #hierarki