---
title: "Sistem Kebenaran"
description: "Panduan lengkap untuk sistem kebenaran XOOPS, jenis, semakan, hierarki dan kawalan akses"
---
# Sistem Kebenaran dalam XOOPSSistem Kebenaran XOOPS ialah rangka kerja kawalan akses berbutir yang mengurus siapa yang boleh melakukan tindakan pada sumber mana. Dokumen ini merangkumi jenis kebenaran, mekanisme semakan, hierarki dan contoh pelaksanaan.## Jenis Kebenaran### Kebenaran Tahap ModulKebenaran peringkat modul mengawal akses kepada keseluruhan modul atau fungsi modul.**Nama Kebenaran Biasa:**
- `module_view` - Lihat kandungan modul
- `module_read` - Baca sumber modul
- `module_submit` - Serahkan kandungan ke modul
- `module_edit` - Edit kandungan modul
- `module_admin` - Mentadbir modul
```
php
<?php
/**
...
```
### Kebenaran Tahap ItemKebenaran peringkat item mengawal akses kepada sumber tertentu dalam modul.**Contoh:**
- ID Artikel: Bolehkah kumpulan artikel khusus view/edit?
- ID Kategori: Bolehkah kumpulan mengakses kategori?
- ID Halaman: Bolehkah kumpulan halaman khusus view/modify?
```
php
<?php
/**
...
```
### Sekat KebenaranKebenaran sekat mengawal keterlihatan dan interaksi dengan blok yang dipaparkan pada halaman.
```
php
<?php
/**
...
```
### Kebenaran KumpulanKebenaran mengawal pengurusan dan pentadbiran kumpulan.
```
php
<?php
/**
...
```
## Hierarki Kebenaran### Gambarajah Struktur Kebenaran
```
mermaid
graph TB
...
```
## Semakan Kebenaran### XoopsGroupPermHandlerKelas `XoopsGroupPermHandler` menyediakan kaedah untuk menyemak dan mengurus kebenaran.
```
php
<?php
/**
...
```
## Pelaksanaan Semakan Kebenaran### Semakan Kebenaran Pengguna Tunggal
```
php
<?php
/**
...
```
## Contoh Perlaksanaan Praktikal### Kawalan Akses Modul
```
php
<?php
/**
...
```
### Semakan Kebenaran Panel Pentadbir
```
php
<?php
/**
...
```
## Kebenaran Caching### Semakan Kebenaran Dioptimumkan
```
php
<?php
/**
...
```
## Amalan Terbaik Keselamatan### Peraturan Tugasan Kebenaran1. **Prinsip Keistimewaan Paling Rendah**: Berikan hanya kebenaran yang diperlukan
2. **Akses Berasaskan Peranan**: Gunakan kumpulan untuk kebenaran berasaskan peranan
3. **Audit Biasa**: Semak kebenaran secara berkala
4. **Pengasingan Tugas**: Asingkan pentadbir daripada kebenaran pengguna
5. **Penolakan Eksplisit**: Penafian lalai, pendekatan membenarkan eksplisit### Pengesahan Kebenaran
```
php
<?php
/**
...
```
## Pautan Berkaitan- Pengguna Management.md
- Kumpulan System.md
- Authentication.md
- ../../Security/Security-Guidelines.md## Tag#permissions #access-control #security #authorization #acl #permission-checking