---
title: "Pengesahan"
description: "Panduan lengkap untuk sistem pengesahan XOOPS, aliran log masuk, pengurusan sesi, keselamatan dan ciri lanjutan"
---
# Pengesahan dalam XOOPSSistem Pengesahan XOOPS menyediakan pengesahan pengguna yang selamat, pengurusan sesi dan ciri keselamatan lanjutan termasuk pengesahan dua faktor dan penyepaduan OAuth. Dokumen ini merangkumi aliran pengesahan, pelaksanaan dan amalan terbaik.## Aliran Pengesahan### Rajah Jujukan Log Masuk
```
mermaid
sequenceDiagram
...
graph TD
    ...
    X --> Y
```
## Pengurusan Sesi### Konfigurasi Sesi
```
php
<?php
/**
...
```
## Fungsi Ingat Saya### Pelaksanaan Log Masuk Berterusan
```
php
<?php
/**
...
```
## Pencincangan Kata Laluan### Pengendalian Kata Laluan Selamat
```
php
<?php
/**
...
```
## Pengesahan Dua Faktor### Gambaran Keseluruhan Pelaksanaan 2FA
```
php
<?php
/**
...
```
## Integrasi OAuth### Aliran Log Masuk OAuth2
```
php
<?php
/**
...
```
## Amalan Terbaik Keselamatan### Senarai Semak Keselamatan Pengesahan
```
php
<?php
/**
...
- Kumpulan System.md
- Kebenaran System.md
- ../../Security/Security-Guidelines.md## Tag#authentication #login #sessions #security #password-hashing #2fa #oauth #session-management