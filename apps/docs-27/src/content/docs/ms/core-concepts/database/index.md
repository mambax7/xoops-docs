...
description: "Panduan komprehensif untuk abstraksi pangkalan data XOOPS, XoopsObject, pengendali dan sistem Kriteria"
---
# 🗄️ Lapisan Pangkalan Data<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>> Memahami pengabstrakan pangkalan data XOOPS, kegigihan objek dan pembinaan pertanyaan.:::tip[Bukti Masa Depan Akses Data Anda]
Corak handler/Criteria berfungsi dalam kedua-dua versi. Untuk menyediakan XOOPS 4.0, pertimbangkan untuk membalut pengendali dalam [Kelas repositori](../../03-Module-Development/Patterns/Repository-Pattern.md) untuk kebolehujian yang lebih baik. Lihat [Memilih Corak Akses Data](../../03-Module-Development/Choosing-Data-Access-Pattern.md).
:::---

## Gambaran KeseluruhanLapisan pangkalan data XOOPS menyediakan abstraksi yang mantap ke atas MySQL/MariaDB, yang menampilkan:- **Corak Kilang** - Pengurusan sambungan pangkalan data berpusat
- **Pemetaan Perkaitan Objek** - XoopsObject dan pengendali
- **Pembinaan Pertanyaan** - Sistem kriteria untuk pertanyaan kompleks
- **Penggunaan Semula Sambungan** - Sambungan tunggal melalui kilang tunggal (bukan pengumpulan)---
...
## 🔌 Sambungan Pangkalan Data### Mendapatkan Sambungan
```
php
...
global $xoopsDB;
```
### XoopsDatabaseFactoryCorak kilang memastikan sambungan pangkalan data tunggal digunakan semula:
```
php
<?php
...
## 📦 XoopsObjectKelas asas untuk semua objek data dalam XOOPS.### Mentakrifkan Objek
```
php
<?php
...
```
### Jenis Data| Malar | Taip | Penerangan |
|----------|------|-------------|
| `XOBJ_DTYPE_INT` | Integer | Nilai angka |
| `XOBJ_DTYPE_TXTBOX` | Rentetan | Teks pendek (< 255 aksara) |
| `XOBJ_DTYPE_TXTAREA` | Teks | Kandungan teks panjang |
| `XOBJ_DTYPE_EMAIL` | E-mel | Alamat e-mel |
| `XOBJ_DTYPE_URL` | URL | Alamat web |
| `XOBJ_DTYPE_FLOAT` | Terapung | Nombor perpuluhan |
| `XOBJ_DTYPE_ARRAY` | Susunan | Tatasusunan bersiri |
| `XOBJ_DTYPE_OTHER` | Bercampur | Data mentah |### Bekerja dengan Objek
```
php
// Create new object
$article = new Article();
...
## 🔧 Pengendali Objek### XoopsPersistableObjectHandlerKelas pengendali menguruskan operasi CRUD untuk kejadian XoopsObject.
```
php
<?php
...
## 🔍 Sistem KriteriaSistem Kriteria menyediakan cara berorientasikan objek yang berkuasa untuk membina klausa SQL WHERE.### Kriteria Asas
```
php
// Simple equality
...
```
### CriteriaCompo (Menggabungkan Kriteria)
```
php
$criteria = new \CriteriaCompo();
...
```
### Operator| Operator | Contoh | Output SQL |
|----------|---------|------------|
...
| `NOT IN` | `new Criteria('id', '(1,2,3)', 'NOT IN')` | `id NOT IN (1,2,3)` |### Contoh Kompleks
```
php
...
## 📝 Pertanyaan TerusUntuk pertanyaan kompleks yang tidak boleh dilakukan dengan Kriteria, gunakan SQL langsung.### Pertanyaan Selamat (Baca)
```
php
$db = \XoopsDatabaseFactory::getDatabaseConnection();
...
## ⚠️ Amalan Terbaik Keselamatan### Sentiasa Melarikan Diri Input Pengguna
```
php
// NEVER do this
...
```
### Gunakan Pertanyaan Berparameter (XMF)
```
php
...
## 🔗 Dokumentasi Berkaitan- [Selam Dalam Sistem Kriteria](../../04-API-Reference/Kernel/Criteria.md)
- [Corak Reka Bentuk - Kilang](../Architecture/Design-Patterns.md)
- [Pencegahan Suntikan SQL](../Security/SQL-Injection-Prevention.md)
- [Rujukan API XoopsDatabase](../../04-API-Reference/Database/XoopsDatabase.md)---
