---
title: "Templat Pintar dalam XOOPS"
---
## Gambaran KeseluruhanXOOPS menggunakan enjin templat Smarty untuk memisahkan pembentangan daripada logik. Panduan ini merangkumi sintaks Smarty, ciri khusus XOOPS dan amalan terbaik templat.## Sintaks Asas### Pembolehubah
```
Smarty
{* Scalar variables *}
<{$variable}>
...
<{/section}>
```
## XOOPS-Ciri Khusus### Pembolehubah Global
```
Smarty
{* Site info *}
<{$xoops_sitename}>
...
```
## Fungsi Tersuai### Didaftarkan oleh XOOPS
```
Smarty
{* XoopsFormLoader *}
...
```
## Organisasi Templat### Struktur Disyorkan
```
templates/
├── admin/
│   ├── index.tpl
...
```
## Amalan Terbaik1. **Escape Output** - Sentiasa melarikan diri daripada kandungan yang dijana pengguna
2. **Gunakan Pengubahsuai** - Gunakan transformasi yang sesuai
3. **Kekalkan Logik Minimum** - Logik kompleks tergolong dalam PHP
4. **Gunakan Separa** - Guna semula serpihan templat biasa
5. **Semantik HTML** - Gunakan elemen HTML5 yang betul
6. **Kebolehaksesan** - Sertakan atribut ARIA jika perlu## Dokumentasi Berkaitan- Pembangunan Tema - Penciptaan tema
- ../../04-API-Reference/Template/Template-System - API templat XOOPS
- ../../03-Module-Development/Block-Development - Templat blok
- ../Forms/Form-Elements - Penyampaian borang