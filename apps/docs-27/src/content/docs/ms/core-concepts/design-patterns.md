---
title: "Corak Reka Bentuk dalam XOOPS"
description: "Panduan komprehensif untuk reka bentuk corak yang digunakan dalam pembangunan XOOPS termasuk MVC, Singleton, Kilang, Pemerhati dan banyak lagi"
---
<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>Corak reka bentuk ialah penyelesaian yang boleh digunakan semula untuk masalah reka bentuk perisian biasa. XOOPS menggunakan beberapa corak mantap yang membantu mengekalkan kualiti kod, meningkatkan kebolehujian dan meningkatkan fleksibiliti sistem.:::nota[Pemilihan Corak Pantas]
Tidak pasti corak mana yang hendak digunakan? Lihat:
- [Memilih Corak Akses Data](../../03-Module-Development/Choosing-Data-Access-Pattern.md) — pengendali lwn repositori lwn perkhidmatan lwn CQRS
- [Memilih Sistem Acara](../Choosing-Event-System.md) — pramuat lwn acara PSR-14
:::## Gambaran KeseluruhanMemahami dan melaksanakan corak reka bentuk dengan betul adalah penting untuk mencipta modul XOOPS yang boleh diselenggara. Panduan ini merangkumi corak yang paling biasa digunakan dalam pembangunan XOOPS.| Corak | Tujuan | Kes Penggunaan Biasa |
|---------|---------|------------------|
| MVC | Pengasingan kebimbangan | Struktur modul |
| Singleton | Jaminan contoh tunggal | Sambungan pangkalan data |
| Kilang | Abstraksi penciptaan objek | Pengendali, pangkalan data |
| Pemerhati | Pemberitahuan acara | Pramuat, pemberitahuan |
| Penghias | Sambungan tingkah laku dinamik | Elemen bentuk, penapis |
| Strategi | Pertukaran algoritma | Pengesahan, pengesahan |
| Penyesuai | Keserasian antara muka | Penyepaduan kod warisan |
| Repositori | Abstraksi capaian data | Kegigihan data |## Model-View-Controller (MVC)Corak MVC memisahkan aplikasi kepada tiga komponen yang saling berkaitan, menjadikan pangkalan kod lebih teratur dan boleh diuji.### Seni bina
```
mermaid
flowchart TB
...
```
## Corak SingletonCorak Singleton memastikan kelas hanya mempunyai satu contoh dan menyediakan akses global kepadanya.### Bila Perlu Digunakan- Sambungan pangkalan data
- Pengurus konfigurasi
- Kejadian pembalak
- Pengurus cache### Pelaksanaan
```
php
<?php
namespace XoopsModules\MyModule;
...
```
## Corak KilangCorak Kilang mencipta objek tanpa menyatakan kelas tepatnya, membenarkan penciptaan objek yang fleksibel.### Bila Perlu Digunakan- Mencipta pengendali secara dinamik
- Sambungan pangkalan data untuk pangkalan data yang berbeza
- Pembekal pengesahan
- Penciptaan unsur bentuk### Pelaksanaan
```
php
<?php
namespace XoopsModules\MyModule;
...
```
## Corak PemerhatiCorak Pemerhati membenarkan objek dimaklumkan tentang perubahan pada keadaan subjek, yang membolehkan tingkah laku dipacu peristiwa.### Bila Perlu Digunakan- Pengendalian acara
- Sistem pemberitahuan
- Seni bina plugin
- Pembalakan dan pengauditan### Pelaksanaan
```
php
<?php
namespace XoopsModules\MyModule;
...
```
### XOOPS Pramuat (Pelaksanaan Pemerhati)
```
php
<?php
...
```
## Corak PenghiasCorak Penghias menambah gelagat kepada objek secara dinamik tanpa menjejaskan objek lain dalam kelas yang sama.### Bila Perlu Digunakan- Penyesuaian unsur bentuk
- Pemformatan output
- Semakan kebenaran
- Caching lapisan### Pelaksanaan
```
php
<?php
namespace XoopsModules\MyModule;
...
```
## Corak StrategiCorak Strategi mentakrifkan keluarga algoritma, merangkum setiap satu, dan menjadikannya boleh ditukar ganti.### Bila Perlu Digunakan- Pelbagai kaedah pengesahan
- Algoritma pengisihan yang berbeza
- Pelbagai format eksport
- Peraturan pengesahan yang fleksibel### Pelaksanaan
```
php
<?php
namespace XoopsModules\MyModule;
...
```
## Corak RepositoriCorak Repositori menyediakan lapisan abstraksi antara logik akses data dan logik perniagaan.### Bila Perlu Digunakan- Keperluan capaian data yang kompleks
- Pelbagai sumber data
- Lapisan data yang boleh diuji
- Reka Bentuk Didorong Domain### Pelaksanaan
```
php
<?php
...
```
## Suntikan KetergantunganSuntikan Ketergantungan (DI) membenarkan objek dibina dengan kebergantungan mereka dan bukannya menciptanya secara dalaman.### Faedah- Kebolehujian yang lebih baik
- Gandingan longgar
- Konfigurasi fleksibel
- Organisasi kod yang lebih baik### Pelaksanaan
```
php
<?php
namespace XoopsModules\MyModule;
...
```
## Amalan Terbaik### Garis Panduan Pemilihan Corak1. **Pilih corak berdasarkan keperluan sebenar**, bukan yang dijangka
2. **Pastikan pelaksanaan mudah** - jangan terlalu kejuruteraan
3. **Penggunaan corak dokumen** untuk pemahaman pasukan
4. **Gabungkan corak** apabila sesuai (cth., Kilang + Singleton)
5. **Pertimbangkan kebolehujian** semasa memilih corak### Anti-Corak Biasa untuk Dielakkan| Anti-Corak | Masalah | Penyelesaian |
|--------------|---------|----------|
| Objek Tuhan | Kelas melakukan terlalu banyak | Tanggungjawab Tunggal |
| Kod Spaghetti | Tiada struktur yang jelas | Gunakan corak MVC |
| Salin-Tampal | Penduaan kod | Ekstrak kod biasa |
| Nombor Ajaib | Pemalar tidak jelas | Gunakan pemalar bernama |
| Gandingan Ketat | Sukar untuk test/maintain | Gunakan Suntikan Ketergantungan |### Corak Pengujian
```
php
<?php
...
```
## Dokumentasi Berkaitan- [XOOPS-Architecture](XOOPS-Architecture.md) - Keseluruhan seni bina sistem
- [Lapisan Pangkalan Data](../Database/Database-Layer.md) - Corak kegigihan data
- [Amalan Terbaik Keselamatan](../Security/Security-Best-Practices.md) - Pelaksanaan corak selamat---

#XOOPS #corak-rekaan #senibina #mvc #singleton #kilang #pemerhati