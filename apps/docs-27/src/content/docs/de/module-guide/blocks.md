---
title: "Block-Entwicklung"
---

## Überblick

Blöcke sind wiederverwendbare Inhalts-Widgets, die in Theme-Seitenleisten und Inhaltsbereichen angezeigt werden. Dieser Leitfaden behandelt das Erstellen, Konfigurieren und Anpassen von XOOPS-Blöcken.
...
$modversion['blocks'][] = [
    ...
    'options'     => '10|0|date',  // Standardoptionen: limit|category|sort
];
```
...
## Block mit Clone-Unterstützung

Klonbare Blöcke ermöglichen mehrere Instanzen:
...
$modversion['blocks'][] = [
    ...
    'options'     => '0',
    'can_clone'   => true,  // Klonen aktivieren
];
```

## Dynamischer Block-Inhalt

### AJAX-geladene Blöcke
...
function mymodule_ajax_show(array $options): array
{
    $block = [
        ...
        'interval'  => (int) ($options[0] ?? 30),  // Aktualisierungsintervall in Sekunden
    ];
...
```smarty
{* Template mit AJAX-Aktualisierung *}
...
1. **Cache-Ergebnisse** - Cache teure Queries
2. **Validiere Optionen** - Validiere immer Block-Optionen
3. **Escape-Ausgabe** - Sanitize allen Benutzerinhalt
4. **Verwende Criteria** - Erstelle Queries mit Criteria-Klasse
5. **Begrenzte Queries** - Setze angemessene Limits für die Leistung
6. **Responsive Templates** - Stelle sicher, dass Blöcke auf Mobilgeräten funktionieren

## Verwandte Dokumentation

- Module-Development - Leitfaden zur Modul-Erstellung
