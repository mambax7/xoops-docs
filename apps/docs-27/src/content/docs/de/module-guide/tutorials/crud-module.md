---
title: "Erstellung eines CRUD-Moduls"
description: "Vollständiges Tutorial zum Erstellen eines CRUD-Moduls mit Datenbankoperationen, Formularen und Admin-Interface"
---

# Tutorial zum Erstellen eines CRUD-Moduls

Dieses Tutorial zeigt dir Schritt für Schritt, wie du ein vollständiges CRUD-Modul (Create, Read, Update, Delete) für XOOPS erstellst. Wir werden ein "Notes"-Modul erstellen, das es Benutzern ermöglicht, persönliche Notizen zu verwalten.

## Voraussetzungen

- Abgeschlossenes Hello-World-Module-Tutorial
- Verständnis von PHP-OOP-Konzepten
- Grundlegende SQL-Kenntnisse

## Modulübersicht

**Features des Notes-Moduls:**
- Notizen erstellen, anzeigen, bearbeiten und löschen
- Admin-Verwaltungsoberfläche
- Benutzerspezifische Notizen
- Kategorieorganisation
- Suchfunktionalität

## Schritt 1: Verzeichnisstruktur

Erstelle die folgende Struktur in `/modules/notes/`:
...
## Schritt 4: Entity-Klassen

### Note-Entity

Erstelle `class/Note.php`:
...
Erstelle `class/NoteHandler.php`:
...
Erstelle `class/CategoryHandler.php`:
...
## Schritt 5: Allgemeine Include-Datei

Erstelle `include/common.php`:
...
### Bearbeitungsseite (Erstellen/Aktualisieren)
...
Erstelle `templates/notes_index.tpl`:
...
Erstelle `templates/notes_view.tpl`:
...
Erstelle `templates/notes_edit.tpl`:
...
### Admin-Notizen-Verwaltung

Erstelle `admin/notes.php`:
...
Gratuliere! Du hast ein vollständiges CRUD-Modul gebaut. Wichtige Konzepte, die behandelt wurden:

1. **Datenbankdesign** - Tabellen mit Beziehungen
2. **Entity-Klassen** - XoopsObject mit typisierten Eigenschaften
3. **Handler-Klassen** - XoopsPersistableObjectHandler mit benutzerdefinierten Methoden
4. **Frontend-Seiten** - Listen-, Anzeigeund Bearbeitungsfunktionalität
5. **Formularverarbeitung** - CSRF-Schutz und Validierung
6. **Admin-Interface** - Verwaltungsoberflächen
7. **Templates** - Smarty-Templates mit Logik

## Nächste Schritte

- Weitere erweiterte Features hinzufügen (Kommentare, Bewertungen, Teilen)
- Das ../Patterns/Repository-Pattern für saubereren Datenzugriff implementieren
- ../Patterns/MVC-Pattern für bessere Codeorganisation anwenden
- ../Best-Practices/Testing mit PHPUnit hinzufügen

Siehe auch: ../Module-Development | ../Patterns/MVC-Pattern | ../Patterns/Repository-Pattern
