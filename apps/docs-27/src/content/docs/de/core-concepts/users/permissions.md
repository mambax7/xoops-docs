...
description: "Vollständiger Leitfaden zum XOOPS-Berechtigungssystem, Typen, Überprüfung, Hierarchie und Zugriffskontrollen"
---

# Berechtigungssystem in XOOPS

Das XOOPS-Berechtigungssystem ist ein granulares Zugriffskontrollframework, das verwaltet, wer welche Aktionen für welche Ressourcen durchführen kann. Dieses Dokument behandelt Berechtigungstypen, Überprüfungsmechanismen, Hierarchie und Implementierungsbeispiele.
