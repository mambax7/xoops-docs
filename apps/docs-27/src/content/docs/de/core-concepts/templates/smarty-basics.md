---
title: "Smarty-Grundlagen"
description: "Grundlagen von Smarty-Vorlagen in XOOPS"
---

<span class="version-badge version-25x">2.5.x: Smarty 3</span> <span class="version-badge version-40x">4.0.x: Smarty 4</span>

:::note[Smarty-Version nach XOOPS-Veröffentlichung]
| XOOPS Version | Smarty Version | Wichtige Unterschiede |
|---------------|----------------|-----------------|
| 2.5.11 | Smarty 3.x | `{php}` Blöcke erlaubt (aber nicht empfohlen) |
| 2.7.0+ | Smarty 3.x/4.x | Vorbereitung auf Smarty 4 Kompatibilität |
| 4.0 | Smarty 4.x | `{php}` Blöcke entfernt, strengere Syntax |

Siehe Smarty-4-Migration für Migrationsleitfaden.
:::

Smarty ist eine Template-Engine für PHP, die es Entwicklern ermöglicht, Präsentation (HTML/CSS) von Anwendungslogik zu trennen. XOOPS verwendet Smarty für alle Vorlagenerfordernisse und ermöglicht eine saubere Trennung zwischen PHP-Code und HTML-Ausgabe.
