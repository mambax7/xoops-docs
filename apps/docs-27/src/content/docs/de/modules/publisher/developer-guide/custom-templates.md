---
title: "Publisher - Benutzerdefinierte Templates"
description: "Anleitung zum Anpassen von Publisher-Templates und zum Erstellen benutzerdefinierter Designs"
---

# Benutzerdefinierte Templates im Publisher

> Anleitung zum Erstellen und Anpassen von Publisher-Templates mit Smarty, CSS und HTML-Überschreibungen.

---

## Template-Systemübersicht

### Was sind Templates?

Templates steuern, wie der Publisher Inhalte anzeigt:
...
```
Basis-Templates:
  ├── publisher_index.tpl (ModultStartseite)
  ├── publisher_item.tpl (einzelner Artikel)
  ├── publisher_category.tpl (Kategorieseite)
  └── publisher_archive.tpl (Archivansicht)
