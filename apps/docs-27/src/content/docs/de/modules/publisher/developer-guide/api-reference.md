---
title: "Publisher - API-Referenz"
description: "Vollständige API-Referenz für das Publisher-Modul mit Klassen, Methoden und Codebeispielen"
---

# Publisher API-Referenz

> Vollständige Referenz für Publisher-Modulklassen, -methoden, -funktionen und API-Endpunkte.
...
Die `Item`-Klasse stellt einen einzelnen Artikel/Eintrag im Publisher dar.

**Namespace:** `XoopsModules\Publisher\`

**Datei:** `modules/publisher/class/Item.php`
...
Der `ItemHandler` verwaltet CRUD-Operationen für Artikel.

**Datei:** `modules/publisher/class/ItemHandler.php`
...
Die `Category`-Klasse stellt eine Kategorie oder einen Bereich dar.

**Datei:** `modules/publisher/class/Category.php`
...
Der `CategoryHandler` verwaltet Kategorie-CRUD-Operationen.

**Datei:** `modules/publisher/class/CategoryHandler.php`
...
Die Helper-Klasse bietet Hilfsfunktionen:

**Datei:** `modules/publisher/class/Helper.php`
...
Publisher umfasst JavaScript-API für Frontend-Interaktionen:
...
### Artikel programmgesteuert erstellen
