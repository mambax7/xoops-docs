...
description: "Meta-Tag-Generierung und SEO-Helfer im XMF-Framework"
---

Die `Metagen`-Klasse im XMF-Framework bietet ein umfassendes Toolkit zum Generieren und Verwalten von HTML-Meta-Tags, Open Graph-Tags und anderen SEO-bezogenen Metadaten.
