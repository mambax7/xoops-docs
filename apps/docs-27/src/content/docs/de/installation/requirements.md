...
## Software-Umgebung (der Stack)

Die meisten XOOPS-Produktionsseiten laufen auf einem _LAMP_-Stack (a **L**inux-System mit **A**pache, **M**ySQL und **P**HP), aber es gibt viele verschiedene mögliche Stacks.

Es ist oft am einfachsten, einen neuen Standort auf einem lokalen Computer zu prototypisieren. In diesem Fall wählen viele XOOPS-Benutzer einen _WAMP_-Stack (mit **W**indows als Betriebssystem), während andere _LAMP_- oder _MAMP_- (**M**AC) Stacks verwenden.
