...
description: "Häufig gestellte Fragen zur XOOPS-Leistungsoptimierung"
---

# Performance - Häufig gestellte Fragen

> Allgemeine Fragen und Antworten zur Optimierung der XOOPS-Leistung und zur Diagnose langsamer Seiten.

---

## Allgemeine Leistung

### F: Wie kann ich feststellen, ob meine XOOPS-Site langsam ist?

**A:** Verwenden Sie diese Tools und Metriken:
...
### F: Wo sollte ich meine Optimierungsbemühungen konzentrieren?

**A:** Folgen Sie der Optimierungspriorität:
...
### F: Wie aktiviere ich Caching in XOOPS?

**A:** XOOPS hat eingebautes Caching. Konfigurieren Sie unter Admin > Einstellungen > Leistung:
...
### F: Welche Art von Zwischenspeicherung sollte ich verwenden?

**A:**
- **File Cache**: Standard, einfach, kein zusätzliches Setup. Gut für kleine Websites.
- **Memcache**: Schneller, speicherbasiert. Besser für stark frequentierte Websites.
- **Redis**: Mächtigster, unterstützt mehr Datentypen. Beste Skalierbarkeit.
...
### F: Wie lösche ich den XOOPS-Cache?
...
### F: Wie lange sollte ich Daten zwischenspeichern?

**A:** Hängt von den Anforderungen der Datenafrischheit ab:
...
### F: Wie kann ich langsame Datenbankabfragen finden?

**A:** Abfrage-Protokollierung aktivieren:
...
### F: Wie optimiere ich Datenbankabfragen?
...
### F: Wie reduziere ich die Datenbankbelastung?
...
### F: Wie optimiere ich CSS und JavaScript?
...
### F: Wie überprüfe ich die Serverleistung?
...
### F: Wie optimiere ich PHP für XOOPS?

**A:** Bearbeiten Sie `/etc/php/8.x/fpm/php.ini`:
...
### F: Wie aktiviere ich HTTP/2 und Komprimierung?

**A:** Für Apache (.htaccess):
```apache
...
### F: Wie überwache ich die XOOPS-Leistung im Laufe der Zeit?
...
### F: Wie identifiziere ich Speicherlecks?
