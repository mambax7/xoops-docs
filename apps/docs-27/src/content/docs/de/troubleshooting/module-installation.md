---
title: "Modull-Installationsfehler"
description: "Diagnose und Behebung von Modul-Installationsproblemen in XOOPS"
---

> Häufige Probleme und Lösungen zur Behebung von Modul-Installationsproblemen in XOOPS.
...
## 1. Dateiupload Permission Denied

**Symptome:**
- Upload schlägt mit "Permission denied" fehl
- Modul-Ordner nicht erstellt
- Kann nicht in modules-Verzeichnis schreiben
...
## 2. Fehlende xoopsversion.php

**Symptome:**
- Modul erscheint in Liste, wird aber nicht aktiviert
- Installation startet, stoppt dann
- Keine Admin-Seite erstellt
...
Überprüfen Sie die Modul-Paketstruktur:
...
**Gültige xoopsversion.php-Struktur:**
...
## 3. Datenbank-SQL-Ausführungsfehler

**Symptome:**
- Upload erfolgreich, aber Datenbanktabellen nicht erstellt
- Admin-Seite wird nicht geladen
...
### Überprüfen Sie die SQL-Datei-Syntax
...
## 4. Beschädigter Modul-Upload

**Symptome:**
- Dateien teilweise hochgeladen
- Zufällige .php-Dateien fehlen
- Modul wird nach Installation instabil
...
## 5. PHP-Versionskompatibilität

**Symptome:**
- Installation schlägt sofort fehl
- Parse-Fehler in xoopsversion.php
...
**Testen Sie die Modul-Kompatibilität:**
...
## 6. Modul-Verzeichnis existiert bereits

**Symptome:**
- Installation schlägt fehl, wenn Modul-Verzeichnis existiert
- Kann Modul nicht neu installieren oder aktualisieren
- "Directory exists" Fehler
...
## 7. Admin-Seite-Generierung fehlgeschlagen

**Symptome:**
- Modul wird installiert, aber Admin-Seite fehlt
- Admin-Panel zeigt Modul nicht
- Kann auf Modul-Einstellungen nicht zugreifen
...
## 8. Sprach-Dateien fehlen

**Symptome:**
- Modul zeigt Variablennamen statt Text
- Admin-Seiten zeigen "[LANG_CONSTANT]"-Stil Text
- Installation abgeschlossen, aber Interface kaputt
...
Erstellen Sie `modules/mymodule/debug_install.php`:
...
1. **Sichern Sie immer** vor der Installation neuer Module
2. **Testen Sie lokal** bevor Sie in Production deployen
3. **Überprüfen Sie die Modul-Struktur** vor dem Upload
4. **Überprüfen Sie Berechtigungen** unmittelbar nach dem Upload
5. **Überprüfen Sie die xoops_log-Tabelle** auf Installationsfehler
6. **Behalten Sie Backups** von funktionierenden Modul-Versionen
