...
description: "Diagnose und Behebung des White Screen of Death in XOOPS"
---
...
### Schritt 1: Aktivieren Sie die PHP-Fehleranzeige

Fügen Sie zu `mainfile.php` temporär hinzu:
...
### Schritt 2: Überprüfen Sie das PHP-Fehler-Log
...
### Schritt 3: Aktivieren Sie den XOOPS-Debug
...
### 3. Fehlende erforderliche Datei
...
Erstellen Sie `debug.php` in XOOPS-Root:
...
1. **Sichern Sie immer** bevor Sie Änderungen vornehmen
2. **Testen Sie lokal** bevor Sie deployen
3. **Überwachen Sie Fehler-Logs** regelmäßig
4. **Verwenden Sie Git** zum Tracking von Änderungen
5. **Halten Sie PHP aktuell** innerhalb unterstützter Versionen
