---
title: "JavaScript-Codierungsstandards"
description: "XOOPS JavaScript-Codierungsstandards und Best Practices"
---

# JavaScript Standards

> XOOPS folgt modernen JavaScript-Standards (ES6+) mit Schwerpunkt auf Lesbarkeit und Wartbarkeit.

---

## Übersicht

XOOPS JavaScript-Standards basieren auf:

- **ECMAScript 2015+** (ES6 und moderne Funktionen)
- **Airbnb JavaScript Style Guide** (angepasst)
- **XOOPS-Konventionen** für Konsistenz
...
- const als Standard verwenden
- Beschreibende Namen verwenden
- Arrow-Funktionen für Callbacks verwenden
- async/await für Promises verwenden
...
- var verwenden (veraltet)
- Globale Variablen verwenden
- Lange Funktionen erstellen (über 50 Zeilen)
- Code zu tief verschachteln
- eval() verwenden
- Inline Event Handler verwenden
- console.log() in der Produktion hinterlassen
- Memory Leaks erstellen
- Funktionsparameter mutieren

---

## Werkzeuge und Linting
