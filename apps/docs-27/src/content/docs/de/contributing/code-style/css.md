---
title: "CSS- und SCSS-Richtlinien"
description: "XOOPS CSS/SCSS-Codierungsstandards und Best Practices"
---

> XOOPS folgt modernen CSS-Standards mit SCSS-Vorverarbeitung und konzentriert sich auf Wartbarkeit und Leistung.

---

## Übersicht

XOOPS CSS-Standards betonen:

- **SCSS-Vorverarbeitung** zur Organisation
- **BEM-Methode** für die Benennung
...
### Best Practices bei der Benennung
...
- SCSS-Variablen für Farben, Abstände, Schriftarten verwenden
- BEM-Namenskonvention befolgen
- Mobile-first responsives Design
- Dateien nach Zweck organisieren
- Wiederverwendbare Mixins schreiben
- Selektoren einfach halten (max. 3 Ebenen tief)
...
- !important verwenden (fast nie)
- Übermäßig spezifische Selektoren erstellen
- ID-Selektoren zum Styling verwenden
- Zu tiefe Verschachtelung (max. 3-4 Ebenen)
- px für Schriftgrößen verwenden (rem verwenden)
- Magische Zahlen verwenden (Variablen verwenden)
- Unbenutzte CSS hinterlassen
