---
title: "Smarty-Template-Konventionen"
description: "XOOPS Smarty Template Codierungsstandards und Best Practices"
---

> XOOPS nutzt Smarty für Templating. Dieser Leitfaden behandelt Konventionen und Best Practices für die Entwicklung von Smarty Templates.

---

## Übersicht

XOOPS Smarty Templates folgen:

- **XOOPS Template Struktur** und Benennung
- **Barrierefreiheitsstandards** (WCAG)
- **Semantisches HTML5 Markup**
- **BEM-ähnliche Klassenbenamung**
...
## Variablen und Benamung

### Variablenbenamungs-Konvention
...
### Section (veraltet, use foreach stattdessen)
...
- Sprachkonstanten für Text verwenden
- Ausgabe escapen (Standard)
- Logik minimal halten
- Aussagekräftige Variablennamen verwenden
- Datei-Header einschließen
- BEM-ähnliche Klassenamen verwenden
- Mit Screen Readern testen

### Nicht tun

- Logik und Präsentation nicht vermischen
- Alt-Text nicht vergessen
- Raw HTML ohne Escaping nicht verwenden
- Keine globalen Variablen in Templates erstellen
- Keine veralteten Smarty Funktionen verwenden
- Templates nicht zu tief verschachteln
- Barrierefreiheit nicht ignorieren
- Text nicht hardcoden (Konstanten verwenden)

---

## Template-Beispiele

### Vollständiges Modul-Template
