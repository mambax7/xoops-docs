...
XOOPS组系统提供了用于组织用户和管理集体权限的分层框架。本文档涵盖默认组、自定义组创建、层次结构和实际实现。

## 默认组

XOOPS 包括在系统安装过程中创建的三个基本组：

### 网站管理员组（ID：1）

网站管理员组代表具有完全系统访问权限的站点管理员。
...
#groups #group-management #权限 #access-control #用户-organization #hierarchy