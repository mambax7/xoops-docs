...
> XOOPS 遵循现代 JavaScript 标准 (ES6+)，强调可读性和可维护性。

---

## 概述

XOOPS JavaScript 标准基于：

- **ECMAScript 2015+**（ES6和现代功能）
- **Airbnb JavaScript 风格指南**（改编）
- **XOOPS约定**以保持一致性
- **辅助功能标准** (WCAG)
...
#XOOPS #javascript #es6 #编码-standards #最佳-practices