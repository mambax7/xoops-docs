---
title: "modul felépítése"
---
## Áttekintés

A jól szervezett modulstruktúra alapvető fontosságú a karbantartható XOOPS fejlesztéshez. Ez az útmutató a régi és a modern (PSR-4) modulelrendezésekre egyaránt vonatkozik.

## Szabványos modulelrendezés
...
### xoops_version.php (örökölt Manifest)
...
| `assets/` | CSS, JavaScript, képek |
| `blocks/` | Blokk renderelő függvények |
| `class/` | PHP osztályok (örökölt) |
| `config/` | Konfigurációs fájlok (modern) |
| `include/` | Megosztott fájlok |
| `language/` | Fordítási fájlok |
| `migrations/` | Adatbázis migráció |
| `sql/` | Kezdeti adatbázisséma |
| `src/` | PSR-4 forráskód |
| `templates/` | Okos sablonok |
| `tests/` | Tesztfájlok |

## Bevált gyakorlatok

1. **Külön aggályok** - Tartsa távol az üzleti logikát a sablonoktól
2. **Névterek használata** - Rendezze meg a kódot megfelelő névközökkel
3. **Kövesse a PSR-4** - Használja a szabványos automatikus betöltési szabályokat
4. **Konfiguráció külsővé tétele** – A konfigurációt tartsa elkülönítve a kódtól
5. **Dokumentum szerkezete** - Tartalmazza a README leírását

## Kapcsolódó dokumentáció

- modul-fejlesztés - Teljes fejlesztési útmutató
- Best-Practices/Code-Organization - Kódszervezési minták
- modul Manifest - Manifest konfiguráció
- Database/Database-Schema - Adatbázis tervezés
