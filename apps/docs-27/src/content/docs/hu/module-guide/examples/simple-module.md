---
title: "Egyszerű modul példa"
description: "Teljes munkamodul minden szükséges fájllal"
---
# Egyszerű modul példa - Blog

Komplett, működő egyszerű modul, amely bemutatja a XOOPS alapvető koncepcióit.
...
## Adminisztrációs felület (admin.php)
...
- A közzétett blogbejegyzések oldalszámozással jeleníthetők meg
- Egyéni bejegyzések megtekintése
- Admin felület bejegyzések létrehozásához, szerkesztéséhez, törléséhez
- Draft/Published állapot
- Időbélyegek

## Tesztelés

1. Telepítse a modult a XOOPS admin keresztül
2. Hozzáférés a frontendhez a `modules/blog/` címen
3. Keresse fel az adminisztrátort a következő címen: `modules/blog/admin.php`
4. Hozzon létre egy tesztbejegyzést, és tegye közzé

## Kapcsolódó dokumentáció

Lásd még:
- ../Patterns/MVC-Pattern mintákhoz
- ../Patterns/Repository-Pattern az adathozzáféréshez
- ../Best-Practices/Code-Organization a szerkezethez

---

Címkék: #examples #simple-module #complete-example #module-development
