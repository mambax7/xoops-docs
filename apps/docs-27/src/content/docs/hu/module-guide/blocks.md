---
title: "Blokk fejlesztés"
---
## Áttekintés

A blokkok újrafelhasználható tartalommodulok, amelyek a téma oldalsávjain és a tartalomterületeken jelennek meg. Ez az útmutató a XOOPS blokkok létrehozásával, konfigurálásával és testreszabásával foglalkozik.

## Blokkstruktúra

### Blokkdefiníció a xoops_version.php-ban
...
| Paraméter | Leírás |
|-----------|-------------|
| `file` | PHP blokkfunkciókat tartalmazó fájl |
| `name` | A blokkcím nyelvi állandója |
| `description` | A leírás nyelvi állandója |
| `show_func` | Blokktartalom megjelenítési funkció |
| `edit_func` | Funkció a blokkbeállítások űrlap megjelenítéséhez |
| `template` | Smarty sablonfájl |
| `options` | Csővel elválasztott alapértelmezett beállítások |

## Funkciók blokkolása

### Funkció megjelenítése
...
## Blokkolás klóntámogatással

A klónozható blokkok több példányt is lehetővé tesznek:
...
## Dinamikus blokktartalom

### AJAX betöltött blokkok
...
1. **Az eredmények gyorsítótárazása** – A drága lekérdezések gyorsítótárazása
2. **Lehetőségek érvényesítése** - Mindig érvényesítse a blokkolási beállításokat
3. **Escape Output** - Az összes felhasználói tartalom megtisztítása
4. **Use Criteria** – Lekérdezések létrehozása a Criteria osztály segítségével
5. **Limit Queries** - Állítson be ésszerű korlátokat a teljesítményre
6. **Reszponzív sablonok** – Győződjön meg arról, hogy a blokkok működnek mobileszközön

## Kapcsolódó dokumentáció

- modul-fejlesztés - modulkészítési útmutató
- ../02-Core-Concepts/Templates/Smarty-Templating - Sablon szintaxis
- ../04-API-Reference/Template/Template-System - XOOPS sablonmotor
- xoops_version.php - moduljegyzék
