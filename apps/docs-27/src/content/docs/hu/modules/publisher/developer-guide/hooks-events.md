...
description: "Útmutató a Publisher kiterjesztéséhez hookok, események és bővítményrendszer segítségével"
---
# Kiadói akasztók és események

> Teljes útmutató a Publisher funkcióinak kiterjesztéséhez események, hookok és bővítmények segítségével.

---

## Eseményrendszer áttekintése

### Mik azok az események?

Az események lehetővé teszik, hogy más modulok reagáljanak a megjelenítői műveletekre:
...
## Rendelkezésre álló események

### Tétel (cikk) Események

#### kiadó.elem.létrehozva

Új cikk létrehozásakor aktiválódik.
...
Amikor egy cikk frissül, aktiválódik.
...
Akkor aktiválódik, amikor a cikk állapota közzétettre változik.
...
#### publisher.item.proved

A függőben lévő cikk jóváhagyásakor aktiválódik.
...
A cikk elutasításakor aktiválódik.
...
A kategória létrehozásakor aktiválódik.
...
A kategória frissítésekor aktiválódik.
...
A kategória törlésekor aktiválódik.
...
### Események megjegyzése

#### kiadó.comment.created

A megjegyzés közzétételekor aktiválódik.
...
#### kiadó.megjegyzés.jóváhagyva

A megjegyzés jóváhagyásakor aktiválva.
...
A megjegyzés törlésekor aktiválódik.
...
### Regisztráljon Eseményfigyelőt

Az Ön moduljában vagy beépülő moduljában:
...
### 1. példa: E-mail küldése a cikk létrehozásáról
...
### 2. példa: Frissítse a keresési indexet
...
### 3. példa: Automatikus közzététel a közösségi médiában
...
### 4. példa: Szinkronizálás külső rendszerrel
...
A hookok lehetővé teszik a megjelenítői viselkedés módosítását:

#### publisher.view.article.start

Meghívás a cikk megjelenítése előtt.
...
A cikk megjelenítése után hívják.
...
Az engedélyek ellenőrzésekor hívják.
...
## Beépülő modulrendszer

### Hozzon létre egy bővítményt

A beépülő modulok kiterjesztik a Publisher funkcióit:
...
### Beépülő modul betöltése

A megjelenítő inicializálásában:
...
A szűrők módosítják az adatokat before/after feldolgozás:
...
A kód végrehajtása meghatározott pontokon:
...
## Bővítés beépülő modulokkal

### Példa beépülő modul: Kapcsolódó cikkek
...
- [Plugin fejlesztés](../../03-module-Development/module-Development.md)

---

#kiadó #kampók #események #bővítmények #kiterjesztések #testreszabás #xoops
