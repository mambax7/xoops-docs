---
title: "Kiadó – Egyéni sablonok"
description: "Útmutató a megjelenítői sablonok testreszabásához és egyéni témák létrehozásához"
---
# Egyéni sablonok a Publisherben

> Útmutató a Smarty, a CSS és a HTML felülbírálásokkal rendelkező megjelenítői sablonok létrehozásához és testreszabásához.

---

## Sablonrendszer áttekintése

### Mik azok a sablonok?

A sablonok szabályozzák, hogy a Publisher hogyan jelenítse meg a tartalmat:
...
### Sablon másolása témába

**1. módszer: Fájlkezelőn keresztül**
...
**2. módszer: a FTP/SSH-n keresztül**
...
### Egyéni sablon szerkesztése

Nyissa meg a téma másolatát a szövegszerkesztőben:
...
## A Smarty sablon alapjai

### Smarty változók

A Publisher változókat biztosít a sablonokhoz:
...
### Egyetlen cikk sablon

**Fájl: publisher_item.tpl**
...
### Kategórialista sablon

**Fájl: publisher_category.tpl**
...
### Legújabb cikkek blokkosablonja

**Fájl: publisher_block_latest.tpl**
...
Hozzon létre egyéni CSS-t a témában:

```
/themes/yourtheme/modules/publisher/css/custom.css
```

### Alapsablon szerkezete
...
## Speciális sablontechnikák

### Más sablonok hozzáadása
...
### Változók hozzárendelése a sablonban
...
### Smarty változók megjelenítése

Hibakereséshez (éles verzióban történő eltávolítás):
...
A `/modules/publisher/xoops_version.php` vagy a rendszergazdai beállításokban:
...
### A régi kiadói verzióból

Ha frissít a régebbi verzióról:

1. Hasonlítsa össze a régi és az új sablonfájlokat
2. Egyesítse az egyéni változtatásokat
3. Használjon új változóneveket
4. Tesztelje alaposan
5. A régi sablonok biztonsági mentése
...
- [XOOPS sablon útmutató](../../02-Core-Concepts/Templates/Smarty-Basics.md)

---

#kiadó #sablonok #okos #testreszabás #tematika #xoops
