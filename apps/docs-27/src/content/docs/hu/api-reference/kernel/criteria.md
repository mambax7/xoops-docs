---
title: "Criteria API referencia"
description: "Teljes API hivatkozás a XOOPS Criteria lekérdezésépítő rendszerhez"
---
> Töltse ki a API dokumentációt a XOOPS Criteria lekérdező épületrendszerhez.
...
## CriteriaCompo osztály

### Konstruktor és módszerek
...
## A SQL vizualizáció kritériumai
...
1. **Mindig állítsa be a LIMIT** értéket nagy asztalokhoz
2. **Használjon indexeket** a feltételekben használt oszlopokon
3. **Kerülje a kezdő helyettesítő karaktereket** a LIKE-ban (`'%term'` lassú)
4. **Előszűrő a PHP-ban**, ha lehetséges összetett logikához
5. **A COUNT-t takarékosan használja** – az eredmények gyorsítótárazása, ha lehetséges
...
- SQL befecskendezés megelőzés

---

#xoops #api #kritériumok #adatbázis #lekérdezés #referencia
