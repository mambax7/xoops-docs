---
title: "XOOPSmodule API referencia"
description: "Teljes API-referencia a XOOPSmodule-hoz és a modulrendszerosztályokhoz"
---
> Teljes API dokumentáció a XOOPS modulrendszerhez.

---

## modul rendszerarchitektúra
...
|----------|------|--------------|
| `mid` | int | modul ID |
| `name` | húr | Megjelenítési név |
| `version` | húr | Verziószám |
| `dirname` | húr | Könyvtár neve |
| `isactive` | int | Aktív állapot (0/1) |
| `hasmain` | int | Fő területe |
| `hasadmin` | int | Rendelkezik adminisztrátori területtel |
| `hassearch` | int | Kereső funkcióval rendelkezik |
| `hasconfig` | int | Konfigurációval rendelkezik |
| `hascomments` | int | Vannak megjegyzései |
| `hasnotification` | int | Értesítések vannak |
