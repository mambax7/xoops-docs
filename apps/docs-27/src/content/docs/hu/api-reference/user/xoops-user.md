---
title: "XOOPSUser API referencia"
description: "Teljes API hivatkozás a XOOPSUser és a felhasználókezelési osztályokhoz"
---
> Töltse ki a API dokumentációt a XOOPS felhasználói rendszerhez.
...
|----------|------|--------------|
| `uid` | int | Felhasználó ID (elsődleges kulcs) |
| `uname` | húr | Felhasználónév |
| `name` | húr | Valódi név |
| `email` | húr | E-mail cím |
| `pass` | húr | Jelszó hash |
| `url` | húr | Weboldal URL |
| `user_avatar` | húr | Avatar fájlnév |
| `user_regdate` | int | Regisztrációs időbélyeg |
| `user_from` | húr | Helyszín |
| `user_sig` | húr | Aláírás |
| `user_occ` | húr | Foglalkozás |
| `user_intrest` | húr | Érdeklődési kör |
| `bio` | húr | Életrajz |
| `posts` | int | Hozzászólások száma |
| `rank` | int | Felhasználói rang |
| `level` | int | Felhasználói szint (0=inaktív, 1=aktív) |
| `theme` | húr | Előnyben részesített téma |
| `timezone` | úszó | Időzóna eltolás |
| `last_login` | int | Utolsó bejelentkezési időbélyeg |
...
| Csoport ID | Név | Leírás |
|----------|------|--------------|
| 1 | Webmesterek | Teljes adminisztrátori hozzáférés |
| 2 | Regisztrált felhasználók | Normál regisztrált felhasználók |
| 3 | Névtelen | Nem bejelentkezett látogatók |
...
- Felhasználókezelési útmutató
- Engedélyezési rendszer
- Hitelesítés

---

#xoops #api #felhasználó #hitelesítés #hivatkozás
