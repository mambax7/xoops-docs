---
title: "Biztonsági irányelvek"
---
## Áttekintés

Ez a dokumentum a XOOPS fejlesztésre vonatkozó legjobb biztonsági gyakorlatokat ismerteti, beleértve a bemeneti ellenőrzést, a kimenet kódolását, a hitelesítést, az engedélyezést és a gyakori webes sebezhetőségek elleni védelmet.
...
### Kritériumobjektumok használata
...
- [ ] Paraméterezett lekérdezések minden adatbázis-művelethez
- [ ] Kimeneti kódolás minden felhasználó által generált tartalomhoz
- [ ] CSRF tokenek minden állapotváltoztató űrlapon
- [ ](Argon2id) Biztonságos jelszókivonat
- [ ] A munkamenet biztonsága konfigurálva
- [ ] Fájlfeltöltés ellenőrzése
- [ ] Biztonsági fejlécek beállítva
- [ ] Díjkorlátozás bevezetve
- [ ] Az auditnaplózás engedélyezve
- [ ] A hibaüzenetek nem szivárogtatnak ki érzékeny információkat
