---
title: "Egyéni űrlap-megjelenítők"
---
## Áttekintés

A XOOPS lehetővé teszi az űrlap-megjelenítés testreszabását egyéni megjelenítőkön keresztül. Ez lehetővé teszi a témaspecifikus stílust, a kisegítő lehetőségek fejlesztését, valamint az olyan frontend keretrendszerekkel való integrációt, mint a Bootstrap vagy a Tailwind CSS.

## Alapértelmezett renderelés

Alapértelmezés szerint a XOOPS űrlapok a `XOOPSFormRenderer` osztályt használják, amely alapvető HTML-t ad ki:
...
## Egyéni renderer létrehozása

### Alap renderelő osztály
...
## Specifikus elemek megjelenítése

### Egyéni Renderer kiválasztása
...
1. **Örlés az alap renderertől** - A `XOOPSFormRenderer` kiterjesztése a konzisztencia érdekében
2. **Minden elemtípus támogatása** - Szöveg kezelése, kijelölés, jelölőnégyzet, rádió stb.
3. **Hozzáférhetőség** – Tartalmazzon megfelelő címkéket, ARIA attribútumokat
4. **Érvényesítési stílusok** - A hibaállapotok megfelelő megjelenítése
5. **Reszponzív dizájn** – Győződjön meg arról, hogy az űrlapok mobilon is működnek
