---
title: "Intelligens sablonok XOOPS-ban"
---
## Áttekintés

A XOOPS a Smarty sablonmotort használja a prezentáció és a logika elválasztására. Ez az útmutató a Smarty szintaxissal, a XOOPS-specifikus funkciókkal és a sablonok bevált módszereivel foglalkozik.
...
1. **Escape Output** – Mindig elkerülje a felhasználó által generált tartalmat
2. **Módosítók használata** - Alkalmazza a megfelelő átalakításokat
3. **Tartsa minimális logikát** – A komplex logika a PHP-ba tartozik
4. **Részleges elemek használata** – A gyakori sablontöredékek újrafelhasználása
5. **Szemantikus HTML** - Használjon megfelelő HTML5 elemeket
6. **Hozzáférhetőség** – Szükség esetén adja meg a ARIA attribútumokat

## Kapcsolódó dokumentáció

- Téma-fejlesztés - Témaalkotás
- ../../04-API-Reference/Template/Template-System - XOOPS sablon API
- ../../03-module-Development/Block-Development - Blokksablonok
- ../Forms/Form-Elements - Űrlap-megjelenítés
