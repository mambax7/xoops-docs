---
title: "Csoportrendszer"
description: "Átfogó útmutató a XOOPS csoportkezeléshez, alapértelmezett csoportokhoz, egyéni csoportokhoz és csoporthierarchiához"
---
# Csoportos rendszer a XOOPS-ban

A XOOPS csoportrendszer hierarchikus keretrendszert biztosít a felhasználók rendszerezéséhez és a kollektív engedélyek kezeléséhez. Ez a dokumentum az alapértelmezett csoportokat, az egyéni csoportok létrehozását, a hierarchiát és a gyakorlati megvalósítást tárgyalja.

## Alapértelmezett csoportok

A XOOPS három alapvető csoportot tartalmaz, amelyek a rendszer telepítése során jönnek létre:

### Webmestercsoport (ID: 1)

A Webmesterek csoport a teljes rendszer-hozzáféréssel rendelkező webhelyadminisztrátorokat képviseli.

**Jellemzők:**
- ID csoport: 1
- Legmagasabb privilégium szint
- Nem törölhető
- Teljes hozzáférés az összes modulhoz és funkcióhoz
...
### Regisztrált felhasználók csoportja (ID: 2)

A Regisztrált felhasználók csoportba tartozik minden hitelesített felhasználó, aki nem névtelen.

**Jellemzők:**
- ID csoport: 2
- Az új regisztrációk alapértelmezett csoportja
- Hozzáférhet a felhasználó-specifikus funkciókhoz
- Csoportalapú engedélyek függvényében
- Szabványos felhasználói funkciókhoz szabható
...
### Névtelen csoport (ID: 3)

Az Anonymous csoport az oldal nem hitelesített látogatóit képviseli.

**Jellemzők:**
- ID csoport: 3
- Alapértelmezett csoport a be nem jelentkezett felhasználók számára
- Általában korlátozott, csak olvasható hozzáférés
- A tartalom nem módosítható
- Nyilvános megtekintési engedélyek
...
### XOOPSGroup osztálytulajdonságok
...
## Csoportengedély hozzárendelése

### Engedélyek hozzárendelése a csoportokhoz
...
### Felhasználói csoportok ellenőrzése
...
1. **Egyértelmű elnevezés**: Használjon leíró, egyértelmű csoportneveket
2. **Dokumentáció**: Dokumentumcsoportok céljai és engedélyei
3. **A legkisebb jogosultság elve**: Minimális szükséges engedélyek biztosítása
4. **Rendszeres ellenőrzések**: Rendszeresen ellenőrizze a csoporttagságokat és engedélyeket
5. **Alapértelmezett csoportok**: Az alapértelmezett csoportok megőrzése (webmesterek, regisztrált, névtelen)
...
#csoportok #csoportkezelés #jogosultságok #hozzáférés-vezérlés #felhasználói szervezet #hierarchia
