---
title: "A téma felépítése"
---
## Áttekintés

A XOOPS témák szabályozzák webhelye vizuális megjelenítését. A téma szerkezetének megértése elengedhetetlen a testreszabáshoz és az új témák létrehozásához.
...
A fő elrendezési sablon, amely az összes tartalmat becsomagolja:
...
| Változó | Leírás |
|----------|-------------|
| `$xoops_sitename` | Webhely neve |
| `$xoops_url` | Webhely URL |
| `$xoops_theme` | Jelenlegi téma neve |
| `$xoops_langcode` | Nyelvkód |
| `$xoops_charset` | Karakterkódolás |
| `$xoops_pagetitle` | Oldal címe |
| `$xoops_dirname` | Jelenlegi modulnév |

### Felhasználói változók

| Változó | Leírás |
|----------|-------------|
| `$xoops_isuser` | Be van jelentkezve |
| `$xoops_isadmin` | Rendszergazda |
| `$xoops_userid` | Felhasználó ID |
| `$xoops_uname` | Felhasználónév |

### Elrendezési változók

| Változó | Leírás |
|----------|-------------|
| `$xoops_showlblock` | Bal oldali blokkok megjelenítése |
| `$xoops_showrblock` | Jobb oldali blokkok megjelenítése |
| `$xoops_showcblock` | Középső blokkok megjelenítése |
| `$xoops_lblocks` | Bal oldali blokkok tömb |
| `$xoops_rblocks` | Jobb blokkok tömb |
| `$xoops_contents` | Főoldal tartalma |

## modulsablon felülírásai

A modulsablonok felülbírálása a témában való elhelyezésükkel:
...
- ../Templates/Smarty-Templating - Sablon szintaxis
- Theme-Development - Teljes téma útmutató
- CSS-Legjobb gyakorlatok - Stílusra vonatkozó irányelvek 
- ../../03-module-Development/Block-Development - Blokkok létrehozása
