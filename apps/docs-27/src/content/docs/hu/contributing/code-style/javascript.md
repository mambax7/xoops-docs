---
title: "JavaScript kódolási szabványok"
description: "XOOPS JavaScript kódolási szabványok és legjobb gyakorlatok"
---
# JavaScript szabványok

> A XOOPS a modern JavaScript szabványokat (ES6+) követi, az olvashatóságra és a karbantarthatóságra helyezve a hangsúlyt.

---

## Áttekintés

XOOPS A JavaScript szabványok a következőkön alapulnak:

- **ECMAScript 2015+** (ES6 és modern funkciók)
- **Airbnb JavaScript stílus útmutató** (adaptált)
- **XOOPS konvenciók** a következetesség érdekében
...
- Alapértelmezés szerint a const használata
- Használjon leíró neveket
- Használja a nyíl függvényeket a visszahívásokhoz
- Használja a async/await-t ígéretekhez
- Összetett funkciók dokumentálása
- Gyorsítótár DOM elemek
- Esemény delegálás használata
- Írjon tiszta függvényeket
- Tartsa fókuszban a funkciókat

### Ne

- Var (örökölt) használata
- Globális változók használata
- Hozzon létre hosszú függvényeket (több mint 50 sor)
- Mélyen beágyazott kód
- Használja a eval()
- Használjon beépített eseménykezelőket
- Hagyja a konzolt.log() a termelésben
- Memóriaszivárgások létrehozása
- Mutálja a függvényparamétereket
...
#xoops #javascript #es6 #kódolási szabványok #bevált gyakorlatok
