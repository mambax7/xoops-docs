---
title: „Intelligens sablonkonvenciók”
description: "XOOPS Smarty sablonkódolási szabványok és legjobb gyakorlatok"
---
> XOOPS a Smarty-t használja a sablonokhoz. Ez az útmutató a Smarty-sablonok fejlesztésének konvencióit és bevált gyakorlatait ismerteti.

---

## Áttekintés

XOOPS A Smarty sablonok a következők:

- **XOOPS sablonstruktúra** és elnevezés
- **Hozzáférhetőségi szabványok** (WCAG)
- **Szemantikus HTML5** jelölés
- **BEM-stílusú osztályelnevezés**
...
### Szakasz (elavult, használja helyette a foreach-et)
...
- Használjon szemantikus HTML5
- Tartalmazzon alternatív szöveget a képekhez
- Használjon nyelvi állandókat a szöveghez
- Escape kimenet (alapértelmezett)
- A logika legyen minimális
- Használjon értelmes változóneveket
- Fájlfejlécek szerepeltetése
- Használjon BEM stílusú osztályneveket
- Tesztelje képernyőolvasóval

### Ne

- Ne keverje össze a logikát és a prezentációt
- Ne felejtsd el az alternatív szöveget
- Ne használja a nyers HTML-t anélkül, hogy megszökne
- Ne hozzon létre globális változókat a sablonokban
- Ne használjon elavult Smarty funkciókat
- Ne fészkelje be túl mélyen a sablonokat
- Ne hagyja figyelmen kívül a hozzáférhetőséget
- Ne kódoljon kemény szöveget (konstansokat használjon)
...
#xoops #okos #sablonok #konvenciók #bevált gyakorlatok
