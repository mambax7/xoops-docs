---
title: "Halál fehér képernyője (WSOD)"
description: "A halál fehér képernyőjének diagnosztizálása és javítása XOOPS-ban"
---
> Az üres fehér oldalak diagnosztizálása és javítása a XOOPS-ban.
...
### 1. lépés: A PHP hibakijelzés engedélyezése

Ideiglenes hozzáadása a `mainfile.php`-hoz:
...
### 2. lépés: Ellenőrizze a PHP hibanaplót
...
### 3. lépés: A XOOPS Debug engedélyezése
...
### 1. Memóriakorlát túllépve

**Tünetek:**
- Üres oldal a nagy műveleteknél
- Kis adatoknál működik, nagyoknál nem működik
...
### 2. PHP szintaktikai hiba

**Tünetek:**
- WSOD a PHP fájl szerkesztése után
- Egy adott oldal meghibásodik, mások működnek
...
### 3. Hiányzik a szükséges fájl

**Tünetek:**
- WSOD upload/migration után
- Véletlenszerű oldalak sikertelenek
...
### 4. Az adatbázis-csatlakozás sikertelen

**Tünetek:**
- Minden oldalon WSOD látható
- A statikus fájlok (képek, CSS) működnek
...
### 5. Engedélyezési problémák

**Tünetek:**
- WSOD fájlok írásakor
- Cache/compile hibák
...
**Tünetek:**
- WSOD meghatározott oldalakon
- A gyorsítótár törlése után működik
...
### 7. Maximális végrehajtási idő

**Tünetek:**
- WSOD ~30 másodperc után
- A hosszú műveletek sikertelenek
...
`debug.php` létrehozása a XOOPS gyökérben:
...
1. **Mindig készítsen biztonsági másolatot** a módosítások elvégzése előtt
2. **Tesztelje helyben** a telepítés előtt
3. **Rendszeresen figyelje a hibanaplókat**
4. **Használja a git**-ot a változások követéséhez
5. **Tartsa frissítve a PHP-t** a támogatott verziókon belül
...
#xoops #hibaelhárítás #wsod #hibakeresés #hibák
