---
title: "Ray Debugger használata"
description: "XOOPS alkalmazások hibakeresése Ray debuggerrel"
---
# Ray Debugger használata a XOOPS-hoz

> Modern hibakeresés Ray segítségével: vizsgálja meg a változókat, a naplóüzeneteket, kövesse nyomon a SQL lekérdezéseket és a profil teljesítményét a XOOPS alkalmazásban.

---

## Mi az a Ray?

A Ray egy könnyű hibakereső eszköz, amely segít az alkalmazás állapotának ellenőrzésében a végrehajtás leállítása vagy töréspontok használata nélkül. Tökéletes a XOOPS fejlesztéshez.

**Jellemzők:**
- Naplóüzenetek és változók
- Vizsgálja meg a SQL lekérdezéseket
- Kövesse nyomon a teljesítményt
- Profil kód
- Csoporthoz kapcsolódó naplók
- Vizuális idővonal

**Követelmények:**
- PHP 7.4+
- Ray alkalmazás (ingyenes verzió is elérhető)
- Zeneszerző
...
### 1. lépés: Telepítse a Ray csomagot
...
### 2. lépés: Töltse le a Ray alkalmazást

Letöltés a [ray.so](https://ray.so) webhelyről:
- Mac: Ray.app
- Windows: Ray.exe
- Linux: ray (AppImage)

### 3. lépés: A tűzfal konfigurálása (ha szükséges)

A Ray alapértelmezés szerint a 23517-es portot használja:
...
### 4. Kapcsolódó naplók csoportosítása
...
### K: Ray nem fogad üzeneteket

**A:**
1. Ellenőrizze, hogy fut-e a Ray alkalmazás
2. Ellenőrizze, hogy a tűzfal engedélyezi-e a 23517-es portot
3. Ellenőrizze, hogy a Ray telepítve van:
```bash
composer require spatie/ray
```

### K: Nem látja a SQL lekérdezéseket
...
### K: A Ray hatása a teljesítményre

**V:** Raynek minimális rezsije van. Éles használathoz távolítsa el a Ray-hívásokat, vagy tiltsa le:
```php
<?php
...
#xoops #hibakeresés #ray #profilozás #figyelés
