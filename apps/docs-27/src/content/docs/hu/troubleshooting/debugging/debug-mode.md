---
title: "Hibakeresési mód engedélyezése"
description: "Az XOOPS hibakeresési mód engedélyezése és használata hibaelhárításhoz"
---
> Átfogó útmutató a XOOPS hibakereső funkciókhoz és eszközökhöz.
...
## XOOPS hibakeresési szintek

### Engedélyezés a mainfile.php-ban
...
| Szint | PHP hibák | SQL Lekérdezések | Sablon Vars | Ajánlott |
|-------|------------|-------------|---------------|------------------|
| 0 | Rejtett | Nem | Nem | Termelés |
| 1 | Megjelenítve | Nem | Nem | Gyors ellenőrzések |
| 2 | Megjelenítve | Naplózott | Nem | Fejlesztés |
| 3 | Megjelenítve | Naplózott | Megjelenítve | Mély hibakeresés |
...
## SQL Lekérdezés hibakeresés

### Lekérdezések megtekintése hibakeresési módban

Ha a `XOOPS_DEBUG_LEVEL` értéke 2 vagy 3, a SQL lekérdezések az oldalak alján jelennek meg.

### Kézi lekérdezésnaplózás
...
### A Smarty Debug Console engedélyezése
...
### Hozzárendelt változók megtekintése
...
### Adatbázis-lekérdezések hibakeresése
...
## Kimeneti folyamat hibakeresése
...
#xoops #hibakeresés #hibaelhárítás #fejlesztés #naplózás
