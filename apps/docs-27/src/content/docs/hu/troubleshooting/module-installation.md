---
title: "modul telepítési hibák"
description: "modultelepítési problémák diagnosztizálása és javítása XOOPS-ban"
---
> Gyakori problémák és megoldások a modultelepítési problémák megoldására a XOOPS-ban.
...
## 1. Fájlfeltöltési engedély megtagadva

**Tünetek:**
- A feltöltés sikertelen, ha „Engedély megtagadva”
- A modulmappa nem jött létre
- Nem lehet írni a modulok könyvtárába
...
## 2. Hiányzik a xoopsversion.php

**Tünetek:**
- A modul megjelenik a listában, de nem aktiválódik
- A telepítés elindul, majd leáll
- Nem jött létre admin oldal

**Hiba az xoops_log fájlban:**
```
...
Ellenőrizze a modulcsomag szerkezetét:
...
**Érvényes xoopsversion.php szerkezet:**
...
## 3. Adatbázis SQL végrehajtási hibák

**Tünetek:**
- A feltöltés sikeres, de az adatbázistáblák nem jöttek létre
- Az Admin oldal nem töltődik be
- "A táblázat nem létezik" hibák
...
### Ellenőrizze a SQL fájl szintaxisát
...
### Manuálisan hajtsa végre a SQL parancsot
...
## 4. Sérült modulfeltöltés

**Tünetek:**
- A fájlok részben feltöltve
- Véletlenszerű .php fájlok hiányoznak
- A modul instabillá válik a telepítés után
...
## 5. PHP verzió-kompatibilitás

**Tünetek:**
- A telepítés azonnal meghiúsul
- Elemzési hibák a xoopsversion.php-ban
- "Váratlan token" hibák
...
## 6. A modul könyvtára már létezik

**Tünetek:**
- A telepítés sikertelen, ha létezik modulkönyvtár
- Nem lehet újratelepíteni vagy frissíteni a modult
- "A könyvtár létezik" hiba
...
## 7. Az adminisztrátori oldal generálása nem sikerült

**Tünetek:**
- A modul telepítve van, de hiányzik az adminisztrációs oldal
- Az adminisztrációs panel nem mutatja a modult
- Nem lehet hozzáférni a modul beállításaihoz
...
## 8. Hiányoznak a nyelvi fájlok

**Tünetek:**
- A modul szöveg helyett változónévvel jelenik meg
- Az adminisztrációs oldalakon "[LANG_CONSTANT]" stílusú szöveg látható
- A telepítés befejeződött, de az interfész megszakadt
...
`modules/mymodule/debug_install.php` létrehozása:
...
1. **Mindig készítsen biztonsági másolatot** az új modulok telepítése előtt
2. **Tesztelje le helyben** az éles üzembe helyezés előtt
3. Feltöltés előtt **ellenőrizze a modul felépítését**
4. **Ellenőrizze az engedélyeket** közvetlenül a feltöltés után
5. **Tekintse át az xoops_log táblát** a telepítési hibákért
6. **Készítsen biztonsági másolatot** a működő modulverziókról
...
#xoops #hibaelhárítás #modulok #telepítés #hibakeresés
