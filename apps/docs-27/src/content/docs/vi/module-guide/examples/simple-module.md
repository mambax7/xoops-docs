---
title: "Ví dụ mô-đun đơn giản"
description: "Hoàn thành mô-đun làm việc với tất cả các tập tin cần thiết"
---
# Ví dụ về mô-đun đơn giản - Blog

Một mô-đun đơn giản, hoàn chỉnh, hoạt động thể hiện các khái niệm cốt lõi của XOOPS.
...
## Giao diện người dùng (index.php)
...
- Hiển thị các bài đăng trên blog đã xuất bản có phân trang
- Xem bài viết cá nhân
- Giao diện quản trị tạo, sửa, xóa bài viết
- Tình trạng bản nháp/đã xuất bản
- Dấu thời gian

## Thử nghiệm

1. Cài đặt mô-đun qua XOOPS admin
2. Truy cập giao diện người dùng tại `modules/blog/`
3. Truy cập admin tại `modules/blog/admin.php`
4. Tạo một bài đăng thử nghiệm và xuất bản nó

## Tài liệu liên quan

Xem thêm:
- ../Patterns/MVC-Pattern cho các mẫu
- ../Patterns/Repository-Pattern để truy cập dữ liệu
- ../Thực tiễn tốt nhất/Tổ chức mã cho cấu trúc
