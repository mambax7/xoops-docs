---
title: "Ví dụ về mô-đun nâng cao"
description: "Mô-đun phức tạp với nhiều bảng, mối quan hệ, giao diện admin và các khối"
---
# Ví dụ mô-đun nâng cao - Diễn đàn

Mô-đun "Diễn đàn" toàn diện thể hiện các mẫu nâng cao: nhiều loại thực thể, mối quan hệ, giao diện admin phức tạp và thông báo.
...
1. **Mối quan hệ thực thể** - Diễn đàn chứa Chủ đề, Chủ đề chứa Bài viết
2. **Truy vấn phức tạp** - Tham gia với thông tin và số liệu thống kê của người dùng
3. **Phối hợp dịch vụ** - Nhiều dịch vụ hoạt động cùng nhau
4. **Tổng hợp dữ liệu** - Số lượng bài đăng, số lượt xem
5. **Thông báo** - Thông báo theo sự kiện dành cho người đăng ký
6. **Hoạt động giống như giao dịch** - Tạo chủ đề với bài đăng ban đầu

## Các mẫu liên quan

Xem thêm:
- ../Patterns/Repository-Pattern cho các truy vấn phức tạp
- ../Patterns/Service-Layer để điều phối dịch vụ
- ../Patterns/DTO-Pattern để truyền dữ liệu
