---
title: "Mã có mùi trong quá trình phát triển XOOPS"
---
## Tổng quan

Mùi mã là dấu hiệu cho thấy các vấn đề tiềm ẩn trong mã. Chúng không nhất thiết có nghĩa là mã bị hỏng, nhưng chúng gợi ý các lĩnh vực có thể được hưởng lợi từ việc tái cấu trúc.
...
## Danh sách kiểm tra tái cấu trúc

Khi bạn phát hiện ra mùi mã:

1. **Nhận dạng** - Mùi gì?
2. **Đánh giá** - Tác động nghiêm trọng đến mức nào?
3. **Kế hoạch** - Áp dụng kỹ thuật tái cấu trúc nào?
4. **Thử nghiệm** - Đảm bảo tồn tại các thử nghiệm trước khi tái cấu trúc
5. **Refactor** - Thực hiện các thay đổi nhỏ, tăng dần
6. **Xác minh** - Chạy thử nghiệm sau mỗi thay đổi
