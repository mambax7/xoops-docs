---
title: "Nguyên tắc mã sạch cho XOOPS"
---
## Tổng quan

Mã sạch là mã dễ đọc, dễ hiểu và dễ bảo trì. Hướng dẫn này bao gồm các nguyên tắc mã sạch được áp dụng cụ thể cho việc phát triển mô-đun XOOPS.
...
Giữ các chức năng ngắn gọn - lý tưởng là dưới 20 dòng:
...
## Nguyên tắc KHÔ (Đừng lặp lại chính mình)
