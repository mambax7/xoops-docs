---
title: "Nhà xuất bản - Mẫu tùy chỉnh"
description: "Hướng dẫn tùy chỉnh Nhà xuất bản templates và tạo themes tùy chỉnh"
---
# Mẫu tùy chỉnh trong Nhà xuất bản

> Hướng dẫn tạo và tùy chỉnh Nhà xuất bản templates bằng cách sử dụng ghi đè Smarty, CSS và HTML.

---

## Tổng quan về hệ thống mẫu

### Mẫu là gì?

Mẫu kiểm soát cách Nhà xuất bản hiển thị nội dung:
...
### Sao chép mẫu vào chủ đề

**Phương pháp 1: Thông qua Trình quản lý tệp**
...
Mở bản sao chủ đề trong trình soạn thảo văn bản:
...
## Thông tin cơ bản về mẫu Smarty

### Biến Smarty

Nhà xuất bản cung cấp các biến cho templates:
...
### Mẫu danh sách danh mục

**Tệp: nhà xuất bản_category.tpl**
...
### Mẫu khối bài viết mới nhất

**Tệp: nhà xuất bản_block_latest.tpl**
...
Tạo CSS tùy chỉnh trong chủ đề:
...
### Kiểm tra có điều kiện thông thường
...
### Hiển thị các biến Smarty

Để gỡ lỗi (loại bỏ trong sản xuất):
...
Trong cài đặt `/modules/publisher/xoops_version.php` hoặc admin:
...
### Từ phiên bản nhà xuất bản cũ

Nếu nâng cấp từ phiên bản cũ hơn:

1. So sánh file mẫu cũ và mới
2. Hợp nhất các thay đổi tùy chỉnh
3. Sử dụng tên biến mới
4. Kiểm tra kỹ lưỡng
5. Sao lưu templates cũ
...
- [Tài liệu Smarty](https://www.smarty.net/documentation)
- [Nhà xuất bản GitHub](https://github.com/XoopsModules25x/publisher)
- [Hướng dẫn về mẫu XOOPS](../../02-Core-Concepts/Templates/Smarty-Basics.md)

---

#nhà xuất bản #templates #thông minh #tùy chỉnh #themeing #xoops