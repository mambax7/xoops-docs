---
title: "Nhà xuất bản - Tham khảo API"
description: "Tham chiếu API hoàn chỉnh cho mô-đun Nhà xuất bản với classes, các phương thức và ví dụ mã"
---
# Nhà xuất bản API Tham khảo

> Tài liệu tham khảo đầy đủ về mô-đun Nhà xuất bản classes, các phương thức, hàm và điểm cuối API.
...
`Item` class đại diện cho một bài viết/mục duy nhất trong Nhà xuất bản.
...
`ItemHandler` quản lý các hoạt động CRUD cho bài viết.
...
`Category` class đại diện cho một danh mục hoặc phần.
...
`CategoryHandler` quản lý các hoạt động của danh mục CRUD.
...
Trình trợ giúp class cung cấp các chức năng tiện ích:
...
### Chức năng JavaScript của giao diện người dùng

Nhà xuất bản includes JavaScript API dành cho tương tác giao diện người dùng:
...
Nhà xuất bản cung cấp điểm cuối AJAX cho các tương tác giao diện người dùng:
...
## REST API (Nếu được bật)

### Điểm cuối API

Nếu Nhà xuất bản hiển thị REST API:
