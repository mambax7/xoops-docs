---
title: "Tiêu chuẩn mã hóa PHP"
description: "Tiêu chuẩn mã hóa XOOPS PHP dựa trên PSR-1, PSR-4 và PSR-12"
---
# PHP-Tiêu chuẩn

> XOOPS tuân theo các tiêu chuẩn mã hóa PSR-1, PSR-4 và PSR-12 với các quy ước dành riêng cho XOOPS.
