---
title: "Hướng dẫn CSS và SCSS"
description: "Tiêu chuẩn mã hóa XOOPS CSS/SCSS và các phương pháp hay nhất"
---
> XOOPS tuân theo các tiêu chuẩn CSS hiện đại với quá trình xử lý trước SCSS, tập trung vào khả năng bảo trì và hiệu suất.

---

## Tổng quan

Các tiêu chuẩn XOOPS CSS nhấn mạnh:

- **Tiền xử lý SCSS** cho tổ chức
- **Phương pháp BEM** để đặt tên
- **Thiết kế đáp ứng đầu tiên trên thiết bị di động**
- **Khả năng truy cập và ngữ nghĩa HTML**
...
- Sử dụng các biến SCSS cho màu sắc, khoảng cách, phông chữ
- Tuân theo quy ước đặt tên BEM
- Thiết kế đáp ứng đầu tiên trên thiết bị di động
- Sắp xếp tập tin theo mục đích
- Viết mixin có thể tái sử dụng
- Giữ bộ chọn đơn giản (sâu tối đa 3 cấp độ)
- Sử dụng ngữ nghĩa HTML
- Giảm thiểu tính đặc hiệu
- Bình luận các phần phức tạp

### Đừng

- Sử dụng kiểu nội tuyến
- Sử dụng !important (hầu như không bao giờ)
- Tạo bộ chọn quá cụ thể
- Sử dụng bộ chọn ID để tạo kiểu
- Lồng quá sâu (tối đa 3-4 cấp)
- Sử dụng px cho cỡ chữ (dùng rem)
- Tạo số ma thuật (sử dụng biến)
- Để lại CSS chưa sử dụng
- Quên khả năng tiếp cận
