---
title: "Quy ước mẫu Smarty"
description: "Tiêu chuẩn mã hóa mẫu XOOPS Smarty và các phương pháp hay nhất"
---
...
XOOPS Smarty templates theo dõi:
...
### Phần (không được dùng nữa, thay vào đó hãy sử dụng foreach)
...
## Các phương pháp hay nhất về HTML
