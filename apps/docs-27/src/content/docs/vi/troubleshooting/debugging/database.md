---
title: "Gỡ lỗi cơ sở dữ liệu"
description: "Gỡ lỗi SQL và các sự cố cơ sở dữ liệu trong XOOPS"
---
# Kỹ thuật gỡ lỗi cơ sở dữ liệu

> Các phương pháp và công cụ để gỡ lỗi các truy vấn SQL và các vấn đề về cơ sở dữ liệu trong các ứng dụng XOOPS.
...
## Kích hoạt tính năng ghi nhật ký truy vấn

### Cách 1: Chế độ gỡ lỗi XOOPS
...
### Cách 2: Nhật ký truy vấn chậm MySQL

Kích hoạt trong `/etc/mysql/my.cnf`:
...
### Cách 3: Nhật ký truy vấn chung

Bật cho tất cả truy vấn (cẩn thận: tệp nhật ký lớn):
...
## Gỡ lỗi SQL trong Code

### Thực thi truy vấn nhật ký
...
Sử dụng EXPLAIN để phân tích việc thực hiện truy vấn:
...
### 3. Điều kiện WHERE không hiệu quả
...
## Gỡ lỗi các vấn đề cụ thể

### Vấn đề: Truy vấn trả về kết quả sai
...
## Danh sách kiểm tra tối ưu hóa cơ sở dữ liệu
