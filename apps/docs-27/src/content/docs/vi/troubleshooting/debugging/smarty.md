---
title: "Gỡ lỗi mẫu Smarty"
description: "Kỹ thuật gỡ lỗi và khắc phục sự cố mẫu nâng cao cho XOOPS"
---
...
## Kích hoạt Chế độ gỡ lỗi Smarty

### Cách 1: Bảng quản trị

Quản trị viên XOOPS > Cài đặt > Hiệu suất:
...
### Cách 3: Gỡ lỗi Popup trên trình duyệt
...
Điều này hiển thị một cửa sổ bật lên với tất cả các biến được chỉ định.

---

## Các kỹ thuật gỡ lỗi Smarty phổ biến

### Kết xuất tất cả các biến
...
## Xem các mẫu đã biên dịch

Smarty biên dịch templates thành PHP để tăng hiệu suất. Gỡ lỗi bằng cách xem mã đã biên dịch:
...
## Phân tích quá trình biên dịch mẫu
...
### Vấn đề 2: Không tìm thấy khóa mảng
...
### Vấn đề 3: Không tìm thấy Plugin/Modifier
...
### Vấn đề 4: Hiển thị mảng lồng nhau
