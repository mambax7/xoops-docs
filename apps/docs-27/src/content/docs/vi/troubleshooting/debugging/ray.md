---
title: "Sử dụng trình gỡ lỗi Ray"
description: "Gỡ lỗi ứng dụng XOOPS bằng trình gỡ lỗi Ray"
---
# Sử dụng Trình gỡ lỗi Ray cho XOOPS

> Gỡ lỗi hiện đại với Ray: kiểm tra các biến, thông báo nhật ký, theo dõi các truy vấn SQL và hiệu suất hồ sơ trong ứng dụng XOOPS của bạn.

---

## Ray là gì?

Ray là một công cụ gỡ lỗi nhẹ giúp bạn kiểm tra trạng thái ứng dụng mà không cần dừng thực thi hoặc sử dụng các điểm ngắt. Nó hoàn hảo cho sự phát triển XOOPS.
...
### Bước 2: Tải ứng dụng Ray

Tải xuống từ [ray.so](https://ray.so):
- Mac: Ray.app
- Windows: Ray.exe
- Linux: tia (AppImage)
...
Ray sử dụng cổng 23517 theo mặc định:
...
### Hỏi: Ray không nhận được tin nhắn

**Đ:**
1. Kiểm tra ứng dụng Ray đang chạy
2. Kiểm tra tường lửa cho phép cổng 23517
3. Xác minh Ray đã được cài đặt:
```bash
composer require spatie/ray
```

### Hỏi: Không thấy truy vấn SQL
...
### Hỏi: Tác động đến hiệu năng của Ray

**A:** Ray có chi phí hoạt động tối thiểu. Để sản xuất, hãy xóa cuộc gọi Ray hoặc tắt:
```php
<?php
