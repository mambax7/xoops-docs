...
description: "Tạo và tùy chỉnh XOOPS themes với kế thừa mẫu Smarty"
---
<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

Hướng dẫn này bao gồm cách tạo XOOPS themes, bao gồm cấu trúc chủ đề, kế thừa mẫu và các phương pháp hay nhất để xây dựng themes hiện đại, đáp ứng.
...
Chủ đề XOOPS bao gồm cấu trúc thư mục sau:
...
Kế thừa mẫu của Smarty cho phép bạn tạo themes con kế thừa từ chủ đề gốc.
...
Tạo nhiều biến thể chủ đề từ một chủ đề cơ bản:
...
## Băng chuyền/Thanh trượt tùy chỉnh

Ví dụ về băng chuyền nội dung động:
...
### CSS đầu tiên trên thiết bị di động
...
#themes #thông minh #xoops #css #thiết kế #đáp ứng