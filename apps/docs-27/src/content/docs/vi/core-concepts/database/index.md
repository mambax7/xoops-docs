---
title: "Lớp cơ sở dữ liệu"
description: "Hướng dẫn toàn diện về trừu tượng hóa cơ sở dữ liệu XOOPS, XoopsObject, trình xử lý và hệ thống Tiêu chí"
---
# 🗄️ Lớp cơ sở dữ liệu
...
:::tip[Đảm bảo quyền truy cập dữ liệu của bạn trong tương lai]
Mẫu xử lý/Tiêu chí hoạt động ở cả hai phiên bản. Để chuẩn bị cho XOOPS 4.0, hãy xem xét gói các trình xử lý trong [Kho lưu trữ classes](../../03-Module-Development/Patterns/Repository-Pattern.md) để có khả năng kiểm tra tốt hơn. Xem [Chọn mẫu truy cập dữ liệu](../../03-Module-Development/Choosing-Data-Access-Pattern.md).
:::
...
Lớp cơ sở dữ liệu XOOPS cung cấp khả năng trừu tượng hóa mạnh mẽ trên MySQL/MariaDB, bao gồm:
...
Mẫu nhà máy đảm bảo một kết nối cơ sở dữ liệu duy nhất được sử dụng lại:
...
| `XOBJ_DTYPE_EMAIL` | Email | Địa chỉ email |
...
Trình xử lý class quản lý các hoạt động CRUD cho các phiên bản XoopsObject.
...
Hệ thống Tiêu chí cung cấp một cách mạnh mẽ, hướng đối tượng để xây dựng các mệnh đề SQL WHERE.
...
### CriteriaCompo (Tiêu chí kết hợp)
...
Đối với các truy vấn phức tạp không thể thực hiện được bằng Tiêu chí, hãy sử dụng SQL trực tiếp.### Truy vấn an toàn (Đọc)
...
## ⚠️ Các phương pháp bảo mật tốt nhất

### Luôn thoát khỏi thao tác nhập của người dùng
...
### Sử dụng truy vấn được tham số hóa (XMF)
...
## 📊 Ví dụ về lược đồ cơ sở dữ liệu
...
- [Hệ thống tiêu chí chuyên sâu](../../04-API-Reference/Kernel/Criteria.md)
- [Mẫu thiết kế - Nhà máy](../Architecture/Design-Patterns.md)
- [Ngăn chặn tiêm SQL](../Security/SQL-Injection-Prevention.md)
- [Tham khảo XoopsDatabase API](../../04-API-Reference/Database/XoopsDatabase.md)
