---
title: "Tiêu chí API Tham khảo"
description: "Tham chiếu API hoàn chỉnh cho hệ thống xây dựng truy vấn tiêu chí XOOPS"
---
...
| Nhà điều hành | Ví dụ | Đầu ra SQL |
|----------|----------|-------------|
...
1. **Luôn đặt GIỚI HẠN** cho các bảng lớn
2. **Sử dụng chỉ mục** trên các cột được sử dụng trong tiêu chí
3. **Tránh các ký tự đại diện đứng đầu** trong THÍCH (`'%term'` chậm)
4. **Lọc trước trong PHP** khi có thể đối với logic phức tạp
5. **Sử dụng COUNT một cách tiết kiệm** - lưu kết quả vào bộ nhớ đệm khi có thể
