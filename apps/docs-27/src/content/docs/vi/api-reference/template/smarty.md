---
title: "Tham khảo Smarty API"
description: "Tham chiếu API hoàn chỉnh cho việc tạo khuôn mẫu Smarty trong XOOPS"
---
...
1. **Bật bộ nhớ đệm mẫu** trong quá trình sản xuất
2. **Chỉ gán các biến cần thiết** - không truyền toàn bộ đối tượng
3. **Sử dụng ít công cụ sửa đổi** - định dạng trước trong PHP khi có thể
4. **Tránh vòng lặp lồng nhau** - cơ cấu lại dữ liệu trong PHP
5. **Cache các khối đắt tiền** - sử dụng bộ nhớ đệm khối cho các truy vấn phức tạp

---

## Tài liệu liên quan

- Thông tin cơ bản về Smarty
- Phát triển chủ đề
- Di chuyển Smarty 4
