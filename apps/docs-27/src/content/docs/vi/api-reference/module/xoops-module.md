---
title: "Tham khảo XoopsModule API"
description: "Tham khảo API hoàn chỉnh cho XoopsModule và hệ thống mô-đun classes"
---
> Hoàn thành tài liệu API cho hệ thống mô-đun XOOPS.
...
| `dirname` | chuỗi | Tên thư mục |
| `isactive` | int | Trạng thái hoạt động (0/1) |
| `hasmain` | int | Có diện tích chính |
| `hasadmin` | int | Có diện tích admin |
| `hassearch` | int | Có chức năng tìm kiếm |
| `hasconfig` | int | Có cấu hình |
| `hascomments` | int | Có ý kiến ​​|
| `hasnotification` | int | Có thông báo |
