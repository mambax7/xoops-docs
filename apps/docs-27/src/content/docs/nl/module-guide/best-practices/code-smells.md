---
title: "Code ruikt in XOOPS-ontwikkeling"
---
## Overzicht

Codegeuren zijn indicatoren voor potentiële problemen in de code. Ze betekenen niet noodzakelijkerwijs dat de code kapot is, maar ze suggereren gebieden die baat zouden kunnen hebben bij refactoring.

## Gemeenschappelijke code ruikt
...
## Misbruikers van objectoriëntatie

### Wissel van verklaring
...
## Veranderingsvoorkomers

### Uiteenlopende verandering
...
## Controlelijst voor refactoring

Wanneer je een codegeur opmerkt:

1. **Identificeer** - Welke geur is het?
2. **Beoordeel** - Hoe ernstig is de impact?
3. **Plan** - Welke refactoringtechniek is van toepassing?
4. **Test** - Zorg ervoor dat er tests bestaan voordat u refactoring uitvoert
5. **Refactor** - Breng kleine, stapsgewijze wijzigingen aan
6. **Verifiëren** - Voer tests uit na elke wijziging

## Gerelateerde documentatie

- Schone codeprincipes
- Codeorganisatie
