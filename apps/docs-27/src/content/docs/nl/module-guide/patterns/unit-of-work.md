---
title: "Eenheid van werkpatroon"
---
## Overzicht

Het Unit of Work-patroon houdt een lijst bij van objecten die door een zakelijke transactie worden beïnvloed en coördineert het uitschrijven van wijzigingen. Het zorgt ervoor dat alle gerelateerde wijzigingen samen worden vastgelegd of worden teruggedraaid bij een mislukking.

## Doel

1. **Transactiebeheer** - Groepsgerelateerde activiteiten
2. **Wijzigingen bijhouden** - Volg gewijzigde entiteiten
3. **Batchbewerkingen** - Optimaliseer databaseschrijfbewerkingen
4. **Consistentie** - Zorg voor gegevensintegriteit

## Implementatie

### Werkeenheid-interface
...
1. **Korte transacties** - Houd transacties kort
2. **Eén verantwoordelijkheid** - Eén werkeenheid per bedrijfsactiviteit
3. **Duidelijke grenzen** - Definieer de reikwijdte van de transactie duidelijk
4. **Foutafhandeling** - Handel altijd terugdraaiscenario's af
5. **Vermijd geneste**: nest geen werkeenheden

## Gerelateerde documentatie

- Repository-laag - Repository-patroon
