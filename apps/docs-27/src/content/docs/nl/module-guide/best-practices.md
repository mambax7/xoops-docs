---
title: "Beste praktijken voor moduleontwikkeling"
---
## Overzicht

Dit document consolideert best practices voor het ontwikkelen van hoogwaardige XOOPS-modules. Het volgen van deze richtlijnen garandeert onderhoudbare, veilige en performante modules.

## Architectuur

### Volg schone architectuur

Organiseer code in lagen:
...
Elke klasse zou één reden moeten hebben om te veranderen:
...
Voeg afhankelijkheden toe, maak ze niet:
...
Gebruik strikte typen en typedeclaraties:
...
### Gebruik criteria voor zoekopdrachten
...
- Clean-Code - Schone codeprincipes
- Code-organisatie - Projectstructuur
- Testen - Testgids
- ../02-Core-Concepts/Security/Security-Best-Practices - Beveiligingsgids