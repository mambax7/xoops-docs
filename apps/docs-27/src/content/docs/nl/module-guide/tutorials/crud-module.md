---
title: "Een CRUD-module bouwen"
description: "Volledige tutorial voor het bouwen van een CRUD-module met databasebewerkingen, formulieren en beheerdersinterface"
---
# Een CRUD-module-zelfstudie bouwen

In deze zelfstudie leert u hoe u een volledige CRUD-module (maken, lezen, bijwerken, verwijderen) voor XOOPS bouwt. We zullen een module "Notities" maken waarmee gebruikers persoonlijke notities kunnen beheren.

## Vereisten

- Voltooide Hello-World-Module-tutorial
- Begrip van PHP OOP-concepten
- Basiskennis SQL

## Moduleoverzicht

**Opmerkingen Module Kenmerken:**
- Notities maken, bekijken, bewerken en verwijderen
- Beheerinterface voor beheerders
- Gebruikerspecifieke opmerkingen
- Categorie organisatie
- Zoekfunctionaliteit

## Stap 1: Directorystructuur

Maak de volgende structuur in `/modules/notes/`:
...
## Stap 2: Databaseschema

`sql/mysql.sql` aanmaken:
...
## Stap 4: Entiteitsklassen

### Opmerking Entiteit

`class/Note.php` aanmaken:
...
`class/NoteHandler.php` aanmaken:
...
`class/CategoryHandler.php` aanmaken:
...
## Stap 5: Algemeen inclusief bestand

`include/common.php` aanmaken:
...
### Pagina bewerken (maken/bijwerken)
...
`templates/notes_index.tpl` aanmaken:
...
`templates/notes_view.tpl` aanmaken:
...
`templates/notes_edit.tpl` aanmaken:
...
### Beheer van beheerdersnotities

`admin/notes.php` aanmaken:
...
Gefeliciteerd! Je hebt een complete CRUD-module gebouwd. Belangrijke concepten die aan bod komen:

1. **Databaseontwerp** - Tabellen met relaties
2. **Entiteitsklassen** - XoopsObject met getypte eigenschappen
3. **Handler-klassen** - XoopsPersistableObjectHandler met aangepaste methoden
4. **Voorpagina's** - Lijst-, weergave- en bewerkingsfunctionaliteit
5. **Formulierverwerking** - CSRF-bescherming en validatie
6. **Beheerinterface** - Beheerschermen
7. **Sjablonen** - Slimme sjablonen met logica

## Volgende stappen

- Voeg meer geavanceerde functies toe (opmerkingen, beoordelingen, delen)
- Implementeer de ../Patterns/Repository-Pattern voor schonere gegevenstoegang
- Pas ../Patterns/MVC-Pattern toe voor een betere code-organisatie
- Voeg ../Best-Practices/Testing toe met PHPUnit

Zie ook: ../Module-ontwikkeling | ../Patronen/MVC-Patroon | ../Patronen/Repository-patroon