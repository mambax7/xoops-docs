---
title: "Sjabloonfouten"
description: "Fouten opsporen en oplossen van Smarty-sjabloonfouten in XOOPS"
---
# Sjabloonfouten (Smarty Debugging)

> Veelvoorkomende Smarty-sjabloonproblemen en foutopsporingstechnieken voor XOOPS-thema's en modules.
...
## Veelvoorkomende Smarty-sjabloonfouten
...
**Symptomen:**
- Berichten over "Smarty-syntaxisfout".
- Sjablonen kunnen niet worden gecompileerd
- Lege pagina zonder uitvoer
...
### Veelvoorkomende problemen met de syntaxis

**Ontbrekende afsluitende tag:**
```smarty
{* WRONG *}
{if $user}
User: {$user.name}
...
**Niet-overeenkomende aanhalingstekens:**
```smarty
{* WRONG *}
...
## 2. Ongedefinieerde variabele fouten

**Symptomen:**
- "Ongedefinieerde variabele" waarschuwingen
- Variabele wordt weergegeven als leeg
- PHP-melding in het foutenlogboek
...
## 3. Ontbrekende of onjuiste modificaties

**Symptomen:**
- Gegevens worden niet correct geformatteerd
- Tekst wordt weergegeven als HTML
- Onjuiste hoofdletter/codering
...
**Gemeenschappelijke modificatoren:**
...
**Aangepaste modificator registreren:**
...
**Symptomen:**
- Sjabloonwijzigingen verschijnen niet
- Oude inhoud wordt nog steeds weergegeven
- Verouderd omvat of bronnen
...
## 5. Fouten met plug-in niet gevonden

**Symptomen:**
- "Onbekende modifier" of "Onbekende plug-in"
- Aangepaste functies werken niet
- Compilatiefouten met plug-ins
...
## 6. Sjabloon omvat/uitbreidt problemen

**Symptomen:**
- Opgenomen sjablonen worden niet geladen
- Bovenliggende sjabloon niet gevonden
- CSS/JS laadt niet
...
## 7. Toegang tot variabele arrays/objecten

**Symptomen:**
- Geen toegang tot arraywaarden
- Objecteigenschappen worden niet weergegeven
- Complexe variabelen mislukken
...
## 8. Problemen met tekencodering

**Symptomen:**
- Onleesbare tekst in sjablonen
- Speciale tekens worden onjuist weergegeven
- UTF-8 tekens gebroken

**Oplossingen:**

**Sjabloonbestandcodering:**
...
## Configuratie van debugmodus

**Schakel foutopsporing in sjablonen in:**
...
1. **Schakel foutopsporing in** tijdens de ontwikkeling
2. **Sjablonen valideren** voordat u ze implementeert
3. **Cache wissen** na wijzigingen
4. **Gebruik git** om sjabloonwijzigingen bij te houden
5. **Test in meerdere browsers** op coderingsproblemen
6. **Documenteer aangepaste plug-ins** en modifiers
7. **Gebruik sjabloonovererving** voor consistentie

---

## Gerelateerde documentatie

- Smarty-foutopsporingsgids
- Slimme sjablonen
