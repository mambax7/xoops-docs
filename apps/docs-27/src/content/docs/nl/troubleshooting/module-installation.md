---
title: "Fouten bij het installeren van modules"
description: "Diagnose en oplossing van module-installatieproblemen in XOOPS"
---
> Veelvoorkomende problemen en oplossingen voor het oplossen van module-installatieproblemen in XOOPS.
...
## 1. Toestemming voor het uploaden van bestanden geweigerd

**Symptomen:**
- Uploaden mislukt met 'Toestemming geweigerd'
- Modulemap niet gemaakt
- Kan niet naar de modulesmap schrijven
...
## 2. xoopsversion.php ontbreekt

**Symptomen:**
- Module verschijnt in de lijst, maar wordt niet geactiveerd
- De installatie begint en stopt vervolgens
- Geen beheerderspagina gemaakt
...
Controleer de structuur van het modulepakket:
...
**Geldige xoopsversion.php-structuur:**
...
## 3. Uitvoeringsfouten van database SQL

**Symptomen:**
- Upload succesvol, maar databasetabellen zijn niet gemaakt
- Beheerderspagina laadt niet
- "Tabel bestaat niet"-fouten
...
### Controleer de bestandssyntaxis van SQL
...
## 4. Beschadigde module-upload

**Symptomen:**
- Bestanden gedeeltelijk geüpload
- Er ontbreken willekeurige .PHP-bestanden
- Module wordt instabiel na installatie
...
## 5. PHP-versie-incompatibiliteit

**Symptomen:**
- Installatie mislukt onmiddellijk
- Parseerfouten in xoopsversion.php
- "Onverwachte token"-fouten
...
## 6. Modulemap bestaat al

**Symptomen:**
- Installatie mislukt wanneer de modulemap bestaat
- Kan de module niet opnieuw installeren of updaten
- Foutmelding 'Map bestaat'
...
## 7. Genereren van beheerderspagina mislukt

**Symptomen:**
- Module wordt geïnstalleerd, maar de beheerderspagina ontbreekt
- Beheerderspaneel toont de module niet
- Geen toegang tot module-instellingen
...
## 8. Taalbestanden ontbreken

**Symptomen:**
- Module wordt weergegeven met variabelenamen in plaats van tekst
- Beheerpagina's tonen tekst in de stijl "[LANG_CONSTANT]".
- Installatie voltooid, maar interface defect
...
`modules/mymodule/debug_install.php` aanmaken:
...
1. **Maak altijd een back-up** voordat u nieuwe modules installeert
2. **Test lokaal** voordat u het in productie neemt
3. **Verifieer de modulestructuur** voordat u uploadt
4. **Controleer de rechten** onmiddellijk na het uploaden
5. **Bekijk de tabel xoops_log** op installatiefouten
6. **Bewaar back-ups** van werkende moduleversies
