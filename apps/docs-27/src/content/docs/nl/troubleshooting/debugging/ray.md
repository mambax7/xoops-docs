---
title: "Ray Debugger gebruiken"
description: "Foutopsporing in XOOPS-applicaties met Ray debugger"
---
# Ray Debugger gebruiken voor XOOPS

> Modern debuggen met Ray: inspecteer variabelen, log berichten, volg SQL-query's en profileer de prestaties in uw XOOPS-applicatie.

---

## Wat is Ray?

Ray is een lichtgewicht debugging-tool waarmee u de applicatiestatus kunt inspecteren zonder de uitvoering te stoppen of breekpunten te gebruiken. Het is perfect voor de ontwikkeling van XOOPS.

**Kenmerken:**
- Log berichten en variabelen
- Inspecteer SQL-query's
- Houd de prestaties bij
- Profielcode
- Groepsgerelateerde logboeken
- Visuele tijdlijn

**Vereisten:**
- PHP 7.4+
- Ray-applicatie (gratis versie beschikbaar)
- Componist
...
### Stap 2: Download de Ray-app

Downloaden van [ray.so](https://ray.so):
- Mac: Ray.app
- Windows: Ray.exe
- Linux: ray (AppImage)

### Stap 3: Firewall configureren (indien nodig)

Ray gebruikt standaard poort 23517:
...
### 3. Voorwaardelijke foutopsporing
...
### 4. Gerelateerde logboeken groeperen
...
## XOOPS-specifieke foutopsporing

### Foutopsporing in modules
...
## Foutopsporing in workflows

### Foutopsporing module-installatie
...
## Problemen oplossen Ray

### V: Ray ontvangt geen berichten

**EEN:**
1. Controleer of de Ray-app actief is
2. Controleer of de firewall poort 23517 toestaat
3. Controleer of Ray is geïnstalleerd:
```bash
composer require spatie/ray
```

### V: Kan SQL-query's niet zien
...
### V: Prestatie-impact van Ray

**A:** Ray heeft minimale overhead. Voor productie verwijdert u Ray-oproepen of schakelt u het volgende uit:
```php
<?php
