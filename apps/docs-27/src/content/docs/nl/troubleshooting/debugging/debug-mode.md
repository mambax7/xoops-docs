---
title: "Schakel de foutopsporingsmodus in"
description: "Hoe u de foutopsporingsmodus XOOPS inschakelt en gebruikt voor probleemoplossing"
---
> Uitgebreide gids voor de foutopsporingsfuncties en -hulpmiddelen van XOOPS.
...
## XOOPS Foutopsporingsniveaus

### Inschakelen in mainfile.php
...
| Niveau | PHP-fouten | SQL-query's | Sjabloonvars | Aanbevolen voor |
|-------|------------|-------------|--------------|----------------|
| 0 | Verborgen | Nee | Nee | Productie |
| 1 | Weergegeven | Nee | Nee | Snelle controles |
| 2 | Weergegeven | Gelogd | Nee | Ontwikkeling |
| 3 | Weergegeven | Gelogd | Weergegeven | Diepgaande foutopsporing |
...
## SQL Foutopsporing bij query's

### Bekijk zoekopdrachten in de foutopsporingsmodus

Als `XOOPS_DEBUG_LEVEL` is ingesteld op 2 of 3, verschijnen SQL-query's onderaan de pagina's.

### Handmatige registratie van zoekopdrachten
...
### Smarty Debug-console inschakelen
...
### Toegewezen variabelen bekijken
...
## Aangepaste foutopsporingshelper
...
## Foutopsporing in uitvoerstroom
