---
title: "Thema Ontwikkeling"
description: "XOOPS-thema's maken en aanpassen met Smarty-sjabloonovererving"
---
<span class="version-badge versie-25x">2.5.x ✅</span> <span class="version-badge versie-40x">4.0.x ✅</span>

In deze handleiding wordt beschreven hoe u XOOPS-thema's maakt, inclusief de themastructuur, het overnemen van sjablonen en best practices voor het bouwen van responsieve, moderne thema's.
...
Een XOOPS-thema bestaat uit de volgende directorystructuur:
...
Het themaconfiguratiebestand definieert thema-eigenschappen:
...
Met de sjabloonovererving van Smarty kunt u onderliggende thema's maken die overnemen van een bovenliggend thema.
...
### Themavariaties creëren

Maak meerdere themavariaties op basis van een basisthema:
...
Dit bestand wordt automatisch uitgevoerd en kan worden gebruikt om gegevens voor sjablonen voor te bereiden:
...
Een Bootstrap 5-themavoorbeeld:
...
## Aangepaste carrousel/schuifregelaar

Voorbeeld van een dynamische inhoudscarrousel:
