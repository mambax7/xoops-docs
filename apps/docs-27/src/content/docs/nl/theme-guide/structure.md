---
title: "Themastructuur"
---
## Overzicht

XOOPS-thema's bepalen de visuele presentatie van uw site. Het begrijpen van de themastructuur is essentieel voor maatwerk en het creëren van nieuwe thema’s.
...
De hoofdlay-outsjabloon die alle inhoud omvat:
...
|----------|------------|
| `$xoops_sitename` | Sitenaam |
| `$xoops_url` | Site URL |
| `$xoops_theme` | Huidige themanaam |
| `$xoops_langcode` | Taalcode |
| `$xoops_charset` | Tekencodering |
| `$xoops_pagetitle` | Paginatitel |
| `$xoops_dirname` | Huidige modulenaam |

### Gebruikersvariabelen

| Variabel | Beschrijving |
|----------|------------|
| `$xoops_isuser` | Is ingelogd |
| `$xoops_isadmin` | Is beheerder |
...
| Variabel | Beschrijving |
|----------|------------|
| `$xoops_showlblock` | Toon linkerblokken |
| `$xoops_showrblock` | Toon juiste blokken |
| `$xoops_showcblock` | Middenblokken weergeven |
| `$xoops_lblocks` | Linkerblokkenreeks |
| `$xoops_rblocks` | Rechter blokkenreeks |
| `$xoops_contents` | Inhoud hoofdpagina |

## Modulesjabloonoverschrijvingen

Overschrijf modulesjablonen door ze in uw thema te plaatsen:
...
- ../Sjablonen/Smarty-Templating - Sjabloonsyntaxis
- Thema-ontwikkeling - Volledige themagids
- CSS-Beste Praktijken - Stylingrichtlijnen 
- ../../03-Module-Development/Block-Development - Blokken maken