---
title: "CSS Best practices voor XOOPS-thema's"
---
## Overzicht

Deze handleiding behandelt de CSS-organisatie, moderne lay-outtechnieken en prestatie-optimalisatie voor de ontwikkeling van XOOPS-thema's.
...
### CSS Raster voor pagina-indeling
...
1. **Minimaliseer de specificiteit** - Vermijd diepe nesten
2. **Gebruik moderne eigenschappen** - `gap` in plaats van marges
3. **Verminder opnieuw schilderen** - Gebruik `transform` voor animaties
4. **Lazy load** - Laad module CSS alleen wanneer dat nodig is
...
- Themastructuur - Organisatie van themabestanden
- Thema-ontwikkeling - Volledige themagids
- ../Templates/Smarty-Templating - Sjabloonintegratie
- ../../03-Module-Ontwikkeling/Blok-Ontwikkeling - Blokstyling