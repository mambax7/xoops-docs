---
title: "Toestemmingshulp"
description: "XOOPS-groepsrechten beheren met de XMF Permission Helper"
---
...
Het XOOPS-machtigingssysteem koppelt groepen aan:
- Module-ID
- Toestemmingsnaam
- Artikel-ID
...
De helper gebruikt automatisch de huidige gebruikersgroepen en de opgegeven module-ID.

## Machtigingen controleren

### Heeft de gebruiker toestemming?

Controleer of de huidige gebruiker specifieke rechten heeft voor een item:
...
### Controleer met omleiding

Gebruikers die geen toestemming hebben automatisch omleiden:
...
Standaard hebben beheerders altijd toestemming. Om zelfs voor beheerders te controleren:
...
### Toegestane artikel-ID's verkrijgen

Haal alle item-ID's op waarvoor specifieke groepen toestemming hebben:
...
### Groepen voor een item ophalen

Ontdek welke groepen een specifiek recht hebben:
...
Toestemming verlenen aan specifieke groepen:
...
Alle machtigingen voor een item verwijderen (meestal bij het verwijderen van het item):
...
Voor meerdere machtigingstypen:
...
### Toestemmingsselectie toevoegen aan formulieren

De helper kan een formulierelement maken voor het selecteren van groepen:
...
### Opties voor formulierelementen

De volledige handtekening van de methode:
...
De helper genereert consistente veldnamen:
...
## Volledig voorbeeld: met toestemming beveiligde items

### Een item met machtigingen maken
...
### Bekijken met toestemmingscontrole
...
### Verwijderen met toestemmingsopschoning
...
- ../Basics/XMF-Module-Helper - Documentatie voor modulehelper
