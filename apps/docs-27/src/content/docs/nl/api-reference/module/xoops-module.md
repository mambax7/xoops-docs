---
title: "XoopsModule API-referentie"
description: "Volledige API-referentie voor XoopsModule- en modulesysteemklassen"
---
> Volledige API-documentatie voor het XOOPS-modulesysteem.

---

## Modulesysteemarchitectuur
...
|----------|------|-------------|
| `mid` | int | Module-ID |
| `name` | tekenreeks | Weergavenaam |
| `version` | tekenreeks | Versienummer |
| `dirname` | tekenreeks | Directorynaam |
| `isactive` | int | Actieve status (0/1) |
| `hasmain` | int | Heeft hoofdgebied |
| `hasadmin` | int | Heeft beheerdersgebied |
| `hassearch` | int | Heeft zoekfunctie |
| `hasconfig` | int | Heeft configuratie |
| `hascomments` | int | Heeft opmerkingen |
| `hasnotification` | int | Heeft meldingen |
...
#xoops #API #module #xoopsmodule #referentie