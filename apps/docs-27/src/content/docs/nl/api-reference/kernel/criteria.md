---
title: "Criteria API Referentie"
description: "Volledige API-referentie voor het XOOPS Criteria-querybouwsysteem"
---
> Volledige API-documentatie voor het XOOPS Criteria-querybouwsysteem.

---

## Criteria Systeemarchitectuur
...
## Criteria voor SQL-visualisatie
...
1. **Stel altijd LIMIT in** voor grote tafels
2. **Gebruik indexen** voor kolommen die in criteria worden gebruikt
3. **Vermijd voorafgaande jokertekens** in LIKE (`'%term'` is traag)
4. **Voorfilter in PHP** indien mogelijk voor complexe logica
5. **Gebruik COUNT spaarzaam** - cache resultaten indien mogelijk
...
#xoops #API #criteria #database #query #referentie