---
title: "XoopsGebruiker API Referentie"
description: "Volledige API-referentie voor XoopsUser- en gebruikersbeheerklassen"
---
> Volledige API-documentatie voor het XOOPS-gebruikerssysteem.
...
|----------|------|-------------|
| `uid` | int | Gebruikers-ID (primaire sleutel) |
| `uname` | tekenreeks | Gebruikersnaam |
| `name` | tekenreeks | Echte naam |
| `email` | tekenreeks | E-mailadres |
| `pass` | tekenreeks | Wachtwoordhash |
| `url` | tekenreeks | Website URL |
| `user_avatar` | tekenreeks | Avatar-bestandsnaam |
| `user_regdate` | int | Registratietijdstempel |
| `user_from` | tekenreeks | Locatie |
| `user_sig` | tekenreeks | Handtekening |
| `user_occ` | tekenreeks | Beroep |
| `user_intrest` | tekenreeks | Interesses |
| `bio` | tekenreeks | Biografie |
| `posts` | int | Aantal berichten |
| `rank` | int | Gebruikersrang |
| `level` | int | Gebruikersniveau (0=inactief, 1=actief) |
| `theme` | tekenreeks | Voorkeursthema |
| `timezone` | zweven | Tijdzoneverschuiving |
| `last_login` | int | Tijdstempel laatste aanmelding |
...
| Groeps-ID | Naam | Beschrijving |
|----------|------|-------------|
| 1 | Webmasters | Volledige administratieve toegang |
| 2 | Geregistreerde gebruikers | Standaard geregistreerde gebruikers |
| 3 | Anoniem | Niet-ingelogde bezoekers |
...
- Handleiding voor gebruikersbeheer
- Toestemmingssysteem
- Authenticatie

---

#xoops #API #user #authenticatie #referentie