---
title: "Uitgever - Hooks en Evenementen"
description: "Handleiding voor het uitbreiden van Publisher met behulp van hooks, evenementen en plug-insystemen"
---
# Publisher Hooks en evenementen

> Volledige gids voor het uitbreiden van de Publisher-functionaliteit met behulp van evenementen, hooks en plug-ins.

---

## Gebeurtenissensysteemoverzicht

### Wat zijn evenementen?

Met gebeurtenissen kunnen andere modules reageren op uitgeversacties:
...
### Artikel (artikel) Evenementen

#### uitgever.item.gemaakt

Wordt geactiveerd wanneer een nieuw artikel wordt gemaakt.
...
#### uitgever.item.bijgewerkt

Wordt geactiveerd wanneer een artikel wordt bijgewerkt.
...
#### uitgever.item.verwijderd

Wordt geactiveerd wanneer een artikel wordt verwijderd.
...
#### uitgever.item.gepubliceerd

Wordt geactiveerd wanneer de artikelstatus verandert in Gepubliceerd.
...
#### uitgever.item.goedgekeurd

Wordt geactiveerd wanneer het in behandeling zijnde artikel wordt goedgekeurd.
...
#### uitgever.item.afgewezen

Wordt ontslagen wanneer artikel wordt afgewezen.
...
#### uitgever.categorie.gemaakt

Wordt geactiveerd wanneer de categorie wordt gemaakt.
...
#### uitgever.categorie.bijgewerkt

Wordt geactiveerd wanneer de categorie wordt bijgewerkt.
...
#### uitgever.categorie.verwijderd

Wordt geactiveerd wanneer de categorie wordt verwijderd.
...
### Commentaargebeurtenissen

#### uitgever.commentaar.gemaakt

Wordt geactiveerd wanneer een reactie wordt geplaatst.
...
#### uitgever.commentaar.goedgekeurd

Wordt geactiveerd wanneer reactie is goedgekeurd.
...
#### uitgever.commentaar.verwijderd

Wordt geactiveerd wanneer reactie wordt verwijderd.
...
### Registreer gebeurtenislistener

In uw module of plug-in:
...
### Voorbeeld 1: E-mail verzenden bij het maken van artikelen
...
### Voorbeeld 2: Zoekindex bijwerken
...
### Voorbeeld 3: Automatisch posten op sociale media
...
### Voorbeeld 4: Synchroniseren met extern systeem
...
Hooks maken wijzigingen in het gedrag van Publisher mogelijk:

#### uitgever.view.article.start

Gebeld voordat het artikel wordt weergegeven.
...
#### uitgever.view.article.end

Wordt gebeld nadat het artikel is weergegeven.
...
#### uitgever.permissie.check

Gebeld bij het controleren van machtigingen.
...
Plug-ins breiden de Publisher-functionaliteit uit:
...
Filters wijzigen gegevens voor/na verwerking:
...
Voer code uit op specifieke punten:
...
## Uitbreiden met plug-ins

### Voorbeeldplug-in: gerelateerde artikelen
...
### Richtlijnen voor gebeurtenislisteners
...
- [XOOPS-gebeurtenissensysteem](../../03-Module-Development/Module-Development.md)
- [Plug-inontwikkeling](../../03-Module-Development/Module-Development.md)

---

#publisher #hooks #events #plugins #extensions #maatwerk #xoops