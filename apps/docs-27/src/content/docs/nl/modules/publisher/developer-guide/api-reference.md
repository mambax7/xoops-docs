---
title: "Uitgever - API-referentie"
description: "Volledige API-referentie voor de Publisher-module met klassen, methoden en codevoorbeelden"
---
# Uitgever API Referentie

> Volledige referentie voor Publisher-moduleklassen, methoden, functies en API-eindpunten.
...
De klasse `Item` vertegenwoordigt één artikel/item in Publisher.

**Naamruimte:** `XoopsModules\Publisher\`

**Bestand:** `modules/publisher/class/Item.php`
...
De `ItemHandler` beheert CRUD-bewerkingen voor artikelen.

**Bestand:** `modules/publisher/class/ItemHandler.php`
...
De klasse `Category` vertegenwoordigt een categorie of sectie.

**Bestand:** `modules/publisher/class/Category.php`
...
## CategoryHandler-klasse

### Overzicht

De `CategoryHandler` beheert categorie CRUD-bewerkingen.

**Bestand:** `modules/publisher/class/CategoryHandler.php`
...
De klasse Helper biedt hulpprogrammafuncties:

**Bestand:** `modules/publisher/class/Helper.php`
...
### Frontend JavaScript-functies

Uitgever bevat JavaScript API voor frontend-interacties:
...
Publisher biedt AJAX-eindpunten voor frontend-interacties:
...
## REST API (indien ingeschakeld)

### API-eindpunten

Als Publisher REST API openbaar maakt:
...
## Evenementen en haken

### Uitgeversevenementen
...
### Ontvang artikelen per categorie
...
- Sjablonen en blokken in Publisher
- Artikelcreatie
- Categoriebeheer
