---
title: "CSS- en SCSS-richtlijnen"
description: "XOOPS CSS/SCSS coderingsstandaarden en best practices"
---
> XOOPS volgt de moderne CSS-standaarden met SCSS-voorverwerking, waarbij de nadruk ligt op onderhoudbaarheid en prestaties.

---

## Overzicht

XOOPS CSS-normen benadrukken:

- **SCSS voorverwerking** voor organisatie
- **BEM-methodologie** voor naamgeving
- **Mobiel-eerst responsief ontwerp**
- **Toegankelijkheid en semantische HTML**
...
- Gebruik SCSS-variabelen voor kleuren, spatiëring en lettertypen
- Volg de naamgevingsconventie BEM
- Mobiel-eerst responsief ontwerp
- Organiseer bestanden op doel
- Schrijf herbruikbare mixins
- Houd de selectors eenvoudig (max. 3 niveaus diep)
- Gebruik semantische HTML
- Minimaliseer de specificiteit
- Commentaar op complexe secties

### Niet doen

- Gebruik inlinestijlen
- Gebruik !belangrijk (bijna nooit)
- Maak te specifieke selectors
- Gebruik ID-kiezers voor styling
- Nest te diep (max. 3-4 niveaus)
- Gebruik px voor lettergroottes (gebruik rem)
- Creëer magische getallen (gebruik variabelen)
- Laat CSS ongebruikt liggen
- Vergeet toegankelijkheid
...
### Minimaliseer opnieuw schilderen
