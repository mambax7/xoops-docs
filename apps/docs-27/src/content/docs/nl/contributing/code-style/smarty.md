---
title: "Smarty-sjabloonconventies"
description: "XOOPS Smarty-sjablooncoderingsstandaarden en best practices"
---
> XOOPS gebruikt Smarty voor sjablonen. Deze gids behandelt conventies en best practices voor het ontwikkelen van Smarty-sjablonen.

---

## Overzicht

XOOPS Smarty-sjablonen volgen:

- **XOOPS sjabloonstructuur** en naamgeving
- **Toegankelijkheidsnormen** (WCAG)
- **Semantische HTML5** opmaak
- **BEM-stijl klassenaamgeving**
...
### Naamgevingsconventie voor variabelen
...
### Sectie (verouderd, gebruik in plaats daarvan foreach)
...
- Gebruik semantische HTML5
- Voeg alt-tekst toe voor afbeeldingen
- Gebruik taalconstanten voor tekst
- Escape-uitgang (standaard)
- Houd de logica minimaal
- Gebruik betekenisvolle namen van variabelen
- Voeg bestandskoppen toe
- Gebruik klassennamen in BEM-stijl
- Test met schermlezers

### Niet doen

- Meng logica en presentatie niet
- Vergeet de alt-tekst niet
- Gebruik geen onbewerkte HTML zonder te ontsnappen
- Maak geen globale variabelen in sjablonen
- Gebruik geen verouderde Smarty-functies
- Nest sjablonen niet te diep
- Negeer de toegankelijkheid niet
- Geen tekst hardcoderen (gebruik constanten)

---

## Sjabloonvoorbeelden

### Volledige modulesjabloon
...
#xoops #Smarty #templates #conventies #best-practices