---
title: "Toestemmingssysteem"
description: "Volledige gids voor XOOPS-machtigingssysteem, typen, controle, hiërarchie en toegangscontrole"
---
# Toestemmingssysteem in XOOPS

Het XOOPS-machtigingssysteem is een gedetailleerd raamwerk voor toegangscontrole dat beheert wie welke acties op welke bronnen kan uitvoeren. Dit document behandelt machtigingstypen, controlemechanismen, hiërarchie en implementatievoorbeelden.

## Toestemmingstypen

### Machtigingen op moduleniveau

Machtigingen op moduleniveau regelen de toegang tot volledige modules of modulefuncties.

**Gemeenschappelijke toestemmingsnamen:**
- `module_view` - Module-inhoud bekijken
- `module_read` - Modulebronnen lezen
- `module_submit` - Verzend inhoud naar module
- `module_edit` - Module-inhoud bewerken
- `module_admin` - Beheermodule
...
### Machtigingen op itemniveau

Machtigingen op itemniveau bepalen de toegang tot specifieke bronnen binnen een module.

**Voorbeelden:**
- Artikel-ID: Kan een groep een specifiek artikel bekijken/bewerken?
- Categorie-ID: heeft een groep toegang tot de categorie?
- Pagina-ID: kan een groep een specifieke pagina bekijken/wijzigen?
...
Blokpermissies bepalen de zichtbaarheid en interactie met blokken die op pagina's worden weergegeven.
...
Machtigingen die het groepsbeheer en de administratie regelen.
...
De klasse `XoopsGroupPermHandler` biedt methoden voor het controleren en beheren van machtigingen.
...
## Toestemmingscontrole van implementatie

### Controle van toestemming voor één gebruiker
...
### Toestemmingscontrole beheerderspaneel
...
## Toestemming in cache plaatsen

### Geoptimaliseerde toestemmingscontrole
...
### Toewijzingsregels voor machtigingen

1. **Privilegeprincipe**: wijs alleen noodzakelijke machtigingen toe
2. **Op rollen gebaseerde toegang**: gebruik groepen voor op rollen gebaseerde machtigingen
3. **Regelmatige audits**: Controleer regelmatig de machtigingen
4. **Scheiding van taken**: scheid beheerders- en gebruikersrechten
5. **Expliciet weigeren**: standaard weigeren, expliciet toestaan
