---
title: "Groepssysteem"
description: "Uitgebreide gids voor XOOPS groepsbeheer, standaardgroepen, aangepaste groepen en groepshiërarchie"
---
# Groepssysteem in XOOPS

Het XOOPS-groepssysteem biedt een hiërarchisch raamwerk voor het organiseren van gebruikers en het beheren van collectieve machtigingen. Dit document behandelt standaardgroepen, het maken van aangepaste groepen, hiërarchie en praktische implementatie.

## Standaardgroepen

XOOPS bevat drie fundamentele groepen die worden gemaakt tijdens de systeeminstallatie:

### Webmastersgroep (ID: 1)

De groep Webmasters vertegenwoordigt sitebeheerders met volledige systeemtoegang.

**Kenmerken:**
- Groeps-ID: 1
- Hoogste privilegeniveau
- Kan niet worden verwijderd
- Volledige toegang tot alle modules en functies
- Toegang tot administratiepaneel
...
### Geregistreerde gebruikersgroep (ID: 2)

De groep Geregistreerde gebruikers omvat alle geverifieerde gebruikers die niet anoniem zijn.

**Kenmerken:**
- Groeps-ID: 2
- Standaardgroep voor nieuwe registraties
- Heeft toegang tot gebruikersspecifieke functies
- Onder voorbehoud van groepsgebaseerde machtigingen
- Kan worden aangepast voor standaard gebruikersfuncties
...
De Anonieme groep vertegenwoordigt niet-geverifieerde bezoekers van de site.

**Kenmerken:**
- Groeps-ID: 3
- Standaardgroep voor niet-ingelogde gebruikers
- Normaal gesproken beperkte alleen-lezen toegang
- Kan de inhoud niet wijzigen
- Publieke kijkrechten
...
### XoopsGroup-klasse-eigenschappen
...
### Handler voor het maken van groepen
...
## Toewijzing van groepsmachtigingen
...
### Toewijzing van meerdere groepen
...
1. **Duidelijke naamgeving**: gebruik beschrijvende, duidelijke groepsnamen
2. **Documentatie**: Doelen en machtigingen voor documentgroepen
3. **Privilegeprincipe**: Verleen minimaal vereiste machtigingen
4. **Regelmatige audits**: Controleer regelmatig groepslidmaatschappen en machtigingen
5. **Standaardgroepen**: standaardgroepen behouden (webmasters, geregistreerd, anoniem)
...
- Toestemming System.md
-Authentication.md
- ../../Security/Security-Guidelines.md

## Tags

#groepen #groepsbeheer #permissies #toegangscontrole #gebruikersorganisatie #hiërarchie