---
title: "Αναφορά XoopsModule API"
description: "Πλήρης αναφορά API για τάξεις συστήματος XoopsModule και module"
---

> Ολοκληρώστε την τεκμηρίωση API για το σύστημα μονάδων XOOPS.

---

## Αρχιτεκτονική Συστήματος Ενοτήτων
...
|----------|------|-------------|
| `mid` | int | Αναγνωριστικό ενότητας |
| `name` | χορδή | Εμφανιζόμενο όνομα |
| `version` | χορδή | Αριθμός έκδοσης |
| `dirname` | χορδή | Όνομα καταλόγου |
| `isactive` | int | Ενεργή κατάσταση (0/1) |
| `hasmain` | int | Έχει κύριο χώρο |
| `hasadmin` | int | Έχει περιοχή διαχείρισης |
| `hassearch` | int | Διαθέτει λειτουργία αναζήτησης |
| `hasconfig` | int | Έχει διαμόρφωση |
| `hascomments` | int | Έχει σχόλια |
| `hasnotification` | int | Έχει ειδοποιήσεις |
