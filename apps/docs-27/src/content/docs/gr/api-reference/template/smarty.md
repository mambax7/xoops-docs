---
title: "Πρότυπο Smarty API Αναφορά"
description: "Πλήρης αναφορά API για πρότυπο Smarty στο XOOPS"
---

> Ολοκληρώστε την τεκμηρίωση API για το πρότυπο Smarty στο XOOPS.

---

## Πρότυπο Αρχιτεκτονική Μηχανής
...
| Μέθοδος | Παράμετροι | Περιγραφή |
|--------|------------|-------------|
| `assign ` | ` string $name, mixed $value` | Αντιστοίχιση μεταβλητής στο πρότυπο |
| `assignByRef ` | ` string $name, mixed &$value` | Εκχώρηση με αναφορά |
| `append ` | ` string $name, mixed $value, bool $merge = false` | Προσθήκη στη μεταβλητή πίνακα |
| `display ` | ` string $template` | Πρότυπο απόδοσης και εξόδου |
| `fetch ` | ` string $template` | Πρότυπο απόδοσης και επιστροφής |
| `clearAssign ` | ` string $name` | Διαγραφή εκχωρημένης μεταβλητής |
| `clearAllAssign` | - | Εκκαθάριση όλων των μεταβλητών |
| `getTemplateVars ` | ` string $name = null` | Λάβετε εκχωρημένες μεταβλητές |
| `templateExists ` | ` string $template` | Ελέγξτε αν υπάρχει πρότυπο |
| `isCached ` | ` string $template` | Ελέγξτε εάν το πρότυπο είναι αποθηκευμένο στην κρυφή μνήμη |
| `clearCache ` | ` string $template = null` | Εκκαθάριση προσωρινής μνήμης προτύπου |
...
## XOOPS-Συγκεκριμένες συναρτήσεις

## # Αποκλεισμός απόδοσης
...
## # Χειρισμός εικόνας και περιουσιακών στοιχείων
...
## Προσαρμοσμένα Smarty Plugins

## # Πρόσθετο λειτουργίας
...
1. **Ενεργοποιήστε την προσωρινή αποθήκευση προτύπων** στην παραγωγή
2. **Εκχωρήστε μόνο τις απαραίτητες μεταβλητές** - μην περνάτε ολόκληρα αντικείμενα
3. **Χρησιμοποιήστε τροποποιητές με φειδώ** - προ-μορφοποιήστε σε PHP όταν είναι δυνατόν
4. **Αποφύγετε τους ένθετους βρόχους** - αναδιάρθρωση δεδομένων στο PHP
5. **Αποθηκεύστε προσωρινά ακριβά μπλοκ** - χρησιμοποιήστε την προσωρινή αποθήκευση μπλοκ για πολύπλοκα ερωτήματα
