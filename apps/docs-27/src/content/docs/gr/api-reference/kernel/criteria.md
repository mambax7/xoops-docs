---
title: "ΚριτήριαAPIΑναφορά"
description: "ΠλήρηςAPIαναφορά για τοXOOPSΣύστημα δόμησης ερωτημάτων κριτηρίων"
---

> ΟλοκληρώθηκεAPIτεκμηρίωση για τηνXOOPSΣύστημα δόμησης ερωτημάτων κριτηρίων.

---

## Κριτήρια Αρχιτεκτονική Συστήματος
...
| Χειριστής | Παράδειγμα |SQLΈξοδος |
|----------|---------|-------------|
...
## Κατηγορία CriteriaCompo

## # Κατασκευαστής & Μέθοδοι
...
## # Αναζήτηση με πολλαπλές συνθήκες
...
1. **Πάντα ρυθμισμένοLIMIT** για μεγάλα τραπέζια
2. **Χρησιμοποιήστε ευρετήρια** σε στήλες που χρησιμοποιούνται στα κριτήρια
3. **Αποφύγετε τους οδηγούς μπαλαντέρ** μέσαLIKE (`'%term'` είναι αργός)
4. **ΠροφιλτράρετεPHP** όταν είναι δυνατόν για σύνθετη λογική
5. **ΧρήσηCOUNTμε φειδώ** - αποτελέσματα προσωρινής αποθήκευσης όταν είναι δυνατόν
...
- XoopsObjectHandlerAPI
- SQLΠρόληψη ενέσεων

---

# XOOPS #api #criteria #βάση δεδομένων #ερώτημα #αναφορά
