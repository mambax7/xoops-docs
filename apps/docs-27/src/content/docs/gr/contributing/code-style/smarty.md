...
description: "XOOPS Πρότυπα και βέλτιστες πρακτικές κωδικοποίησης έξυπνων προτύπων"
---

> Το XOOPS χρησιμοποιεί το Smarty για πρότυπα. Αυτός ο οδηγός καλύπτει συμβάσεις και βέλτιστες πρακτικές για την ανάπτυξη προτύπων Smarty.

---

## Επισκόπηση

XOOPS Ακολουθούν τα έξυπνα πρότυπα:

- **XOOPS δομή προτύπου** και ονομασία
- **Πρότυπα προσβασιμότητας** (WCAG)
- **Σημασιολογική σήμανση HTML5**
- **BEM ονομασία τάξης**
...
## # Διάστημα γύρω από τις ετικέτες
...
## # Ενότητα (καταργήθηκε, χρησιμοποιήστε το foreach)
...
- Χρησιμοποιήστε σημασιολογικό HTML5
- Συμπεριλάβετε εναλλακτικό κείμενο για εικόνες
- Χρησιμοποιήστε σταθερές γλώσσας για κείμενο
- Έξοδος διαφυγής (προεπιλογή)
- Διατηρήστε τη λογική ελάχιστη
- Χρησιμοποιήστε ουσιαστικά ονόματα μεταβλητών
- Συμπεριλάβετε κεφαλίδες αρχείων
- Χρησιμοποιήστε ονόματα κλάσεων τύπου BEM
- Δοκιμή με προγράμματα ανάγνωσης οθόνης

## # Μην

- Μην ανακατεύετε λογική και παρουσίαση
- Μην ξεχνάτε το εναλλακτικό κείμενο
- Μην χρησιμοποιείτε ακατέργαστο HTML χωρίς διαφυγή
- Μην δημιουργείτε καθολικές μεταβλητές σε πρότυπα
- Μην χρησιμοποιείτε καταργημένες λειτουργίες Smarty
- Μην τοποθετείτε τα πρότυπα πολύ βαθιά
- Μην αγνοείτε την προσβασιμότητα
- Μην κάνετε σκληρό κώδικα κειμένου (χρησιμοποιήστε σταθερές)

---

## Παραδείγματα προτύπων

## # Πλήρες πρότυπο ενότητας
