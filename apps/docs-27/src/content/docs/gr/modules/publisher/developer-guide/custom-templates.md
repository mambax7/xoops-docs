---
title: "Εκδότης - Προσαρμοσμένα Πρότυπα"
description: "Οδηγός για την προσαρμογή των προτύπων του Publisher και τη δημιουργία προσαρμοσμένων θεμάτων"
---

# Προσαρμοσμένα πρότυπα στον Publisher

> Οδηγός για τη δημιουργία και την προσαρμογή προτύπων Publisher χρησιμοποιώντας παρακάμψεις Smarty, CSS και HTML.

---

## Επισκόπηση συστήματος προτύπου

## # Τι είναι τα πρότυπα;

Τα πρότυπα ελέγχουν τον τρόπο με τον οποίο ο Publisher εμφανίζει περιεχόμενο:
...
## # Αντιγραφή προτύπου στο θέμα

**Μέθοδος 1: Μέσω Διαχείριση αρχείων**
...
## # Επεξεργασία προσαρμοσμένου προτύπου

Ανοίξτε το αντίγραφο θέματος στο πρόγραμμα επεξεργασίας κειμένου:
...
## Βασικά στοιχεία του Smarty Template

## # Έξυπνες μεταβλητές

Ο Publisher παρέχει μεταβλητές σε πρότυπα:
...
## # Πρότυπο μεμονωμένου άρθρου

**Αρχείο: publisher_item.tpl**
...
## # Πρότυπο καταχώρισης κατηγορίας

**Αρχείο: publisher_category.tpl**
...
## # Πρότυπο μπλοκ πιο πρόσφατων άρθρων

**Αρχείο: publisher_block_latest.tpl**
...
## # Προσαρμοσμένα αρχεία CSS

Δημιουργήστε προσαρμοσμένο CSS στο θέμα:
...
## Αναφορά μεταβλητών προτύπου

## # Αντικείμενο αντικειμένου (άρθρο).
...
## Προϋποθέσεις προτύπου

## # Κοινοί έλεγχοι υπό όρους
...
## Προηγμένες τεχνικές προτύπων

## # Συμπεριλάβετε άλλα πρότυπα
...
## # Εκχώρηση μεταβλητών στο Πρότυπο
...
## # Εμφάνιση έξυπνων μεταβλητών

Για εντοπισμό σφαλμάτων (κατάργηση στην παραγωγή):
...
Στις ρυθμίσεις `/modules/publisher/xoops_version.php` ή διαχειριστή:
...
## Μετεγκατάσταση προτύπου

## # Από την παλιά έκδοση του Publisher

Σε περίπτωση αναβάθμισης από παλαιότερη έκδοση:

1. Συγκρίνετε παλιά και νέα αρχεία προτύπων
2. Συγχώνευση προσαρμοσμένων αλλαγών
3. Χρησιμοποιήστε νέα ονόματα μεταβλητών
4. Δοκιμάστε σχολαστικά
5. Δημιουργία αντιγράφων ασφαλείας παλαιών προτύπων
...
- [XOOPS Οδηγός προτύπου](../../02-Core-Concepts/Templates/Smarty-Basics.md)
