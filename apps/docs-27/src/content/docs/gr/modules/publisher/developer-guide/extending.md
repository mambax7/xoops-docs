---
title: "Επέκταση εκδότη"
description: "Οδηγός προγραμματιστή για επέκταση και προσαρμογή της ενότητας Publisher"
---

> Ένας οδηγός προγραμματιστή για την προσαρμογή και την επέκταση της ενότητας Publisher.
...
Δημιουργήστε προσαρμοσμένα πρότυπα στο θέμα σας:
...
## # Δημιουργία προσαρμοσμένου μπλοκ
...
## # Εγγραφή Αποκλεισμός στο xoops_version.php
