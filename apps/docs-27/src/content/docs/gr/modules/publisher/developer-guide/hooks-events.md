---
title: "Εκδότης - Hooks and Events"
description: "Οδηγός για την επέκταση του Publisher με χρήση αγκίστρων, συμβάντων και συστήματος προσθηκών"
---

# Publisher Hooks and Events

> Πλήρης οδηγός για την επέκταση της λειτουργικότητας του Publisher χρησιμοποιώντας συμβάντα, άγκιστρα και προσθήκες.
...
Τα συμβάντα επιτρέπουν σε άλλες λειτουργικές μονάδες να αντιδρούν στις ενέργειες του Publisher:
...
## # Στοιχείο (Άρθρο) Εκδηλώσεις

### # publisher.item.created

Ενεργοποιήθηκε όταν δημιουργείται ένα νέο άρθρο.
...
Ενεργοποιήθηκε όταν ενημερώνεται ένα άρθρο.
...
Ενεργοποιείται όταν διαγράφεται ένα άρθρο.
...
Ενεργοποιήθηκε όταν η κατάσταση του άρθρου αλλάζει σε δημοσιευμένο.
...
Πυροδοτήθηκε όταν εγκριθεί το εκκρεμές άρθρο.
...
Πυροδοτήθηκε όταν το άρθρο απορρίπτεται.
...
## # Εκδηλώσεις κατηγορίας

### # publisher.category.created

Ενεργοποιήθηκε όταν δημιουργείται η κατηγορία.
...
Ενεργοποιήθηκε όταν ενημερωθεί η κατηγορία.
...
Ενεργοποιήθηκε όταν διαγραφεί η κατηγορία.
...
Ενεργοποιήθηκε όταν δημοσιεύτηκε σχόλιο.
...
Ενεργοποιήθηκε όταν εγκρίνεται το σχόλιο.
...
Ενεργοποιήθηκε όταν διαγραφεί το σχόλιο.
...
## Ακούγοντας Εκδηλώσεις

## # Εγγραφή ακρόασης εκδήλωσης

Στη λειτουργική μονάδα ή την προσθήκη:
...
## # Παράδειγμα 1: Αποστολή email για τη δημιουργία άρθρου
...
## # Παράδειγμα 2: Ενημέρωση ευρετηρίου αναζήτησης
...
## # Παράδειγμα 3: Αυτόματη ανάρτηση στα μέσα κοινωνικής δικτύωσης
...
## # Παράδειγμα 4: Συγχρονισμός με εξωτερικό σύστημα
...
Τα άγκιστρα επιτρέπουν τροποποιήσεις στη συμπεριφορά του Publisher:

### # publisher.view.article.start

Κλήση πριν από την απόδοση του άρθρου.
...
Καλείται μετά την απόδοση του άρθρου.
...
Κλήση κατά τον έλεγχο των αδειών.
...
## # Δημιουργήστε ένα πρόσθετο

Οι προσθήκες επεκτείνουν τη λειτουργικότητα του Publisher:
...
Στην προετοιμασία του Publisher:
...
Τα φίλτρα τροποποιούν την επεξεργασία δεδομένων before/after:
...
Εκτέλεση κώδικα σε συγκεκριμένα σημεία:
...
## Επέκταση με πρόσθετα

## # Παράδειγμα προσθήκης: Σχετικά άρθρα
...
## Εντοπισμός σφαλμάτων συμβάντων
...
- [XOOPS Σύστημα συμβάντων](../../03-Module-Development/Module-Development.md)
- [Ανάπτυξη προσθηκών](../../03-Module-Development/Module-Development.md)
