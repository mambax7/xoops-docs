---
title: "Παράδειγμα απλής ενότητας"
description: "Ολοκληρωμένη λειτουργική μονάδα με όλα τα απαραίτητα αρχεία"
---

# Παράδειγμα απλής ενότητας - Blog

Μια ολοκληρωμένη, λειτουργική απλή ενότητα που δείχνει βασικές έννοιες XOOPS.
...
- Εμφάνιση δημοσιευμένων αναρτήσεων ιστολογίου με σελιδοποίηση
- Δείτε μεμονωμένες αναρτήσεις
- Διεπαφή διαχειριστή για δημιουργία, επεξεργασία, διαγραφή αναρτήσεων
- Κατάσταση Draft/Published
- Χρονοσήμανση

## Δοκιμή

1. Εγκαταστήστε τη μονάδα μέσω του XOOPS διαχειριστή
2. Πρόσβαση στο frontend στο `modules/blog/`
3. Επισκεφτείτε τον διαχειριστή στο `modules/blog/admin.php`
4. Δημιουργήστε μια δοκιμαστική ανάρτηση και δημοσιεύστε την

## Σχετική τεκμηρίωση

Δείτε επίσης:
- ../Patterns/MVC-Μοτίβο για μοτίβα
- ../Patterns/Repository-Pattern για πρόσβαση σε δεδομένα
- ../Best-Practices/Code-Organization για δομή

---

Ετικέτες: #παραδείγματα #απλή-ενότητα #πλήρες-παράδειγμα #ανάπτυξη ενότητας
