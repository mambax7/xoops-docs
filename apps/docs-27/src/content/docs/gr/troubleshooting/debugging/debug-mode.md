---
title: "Ενεργοποιήστε τη λειτουργία εντοπισμού σφαλμάτων"
description: "Πώς να ενεργοποιήσετε και να χρησιμοποιήσετε τη λειτουργία εντοπισμού σφαλμάτων XOOPS για την αντιμετώπιση προβλημάτων"
---

> Πλήρης οδηγός για XOOPS δυνατότητες και εργαλεία εντοπισμού σφαλμάτων.

---

## Αρχιτεκτονική εντοπισμού σφαλμάτων
...
## XOOPS Επίπεδα εντοπισμού σφαλμάτων

## # Ενεργοποίηση στο mainfile.php
...
| Επίπεδο | PHP Σφάλματα | SQL Ερωτήματα | Πρότυπο Vars | Συνιστάται για |
|-------|------------|-------------|---------------|-----------------|
| 0 | Κρυφό | Όχι | Όχι | Παραγωγή |
| 1 | Εμφανίζεται | Όχι | Όχι | Γρήγοροι έλεγχοι |
| 2 | Εμφανίζεται | Εγγεγραμμένος | Όχι | Ανάπτυξη |
| 3 | Εμφανίζεται | Εγγεγραμμένος | Εμφανίζεται | Βαθιά αποσφαλμάτωση |

---

## PHP Εμφάνιση σφαλμάτων
...
## SQL Εντοπισμός σφαλμάτων ερωτήματος

## # Προβολή ερωτημάτων σε λειτουργία εντοπισμού σφαλμάτων

Με το `XOOPS_DEBUG_LEVEL` ρυθμισμένο σε 2 ή 3, τα ερωτήματα SQL εμφανίζονται στο κάτω μέρος των σελίδων.

## # Μη αυτόματη καταγραφή ερωτημάτων
...
## Έξυπνος εντοπισμός σφαλμάτων προτύπου

## # Ενεργοποίηση Smarty Debug Console
...
## # Προβολή εκχωρημένων μεταβλητών
...
## PHP Γραμμή εντοπισμού σφαλμάτων
...
## Βοηθός προσαρμοσμένου εντοπισμού σφαλμάτων
...
## Ροή εξόδου εντοπισμού σφαλμάτων
