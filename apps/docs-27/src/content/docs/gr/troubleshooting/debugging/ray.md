---
title: "Χρησιμοποιώντας το Ray Debugger"
description: "Εντοπισμός σφαλμάτων XOOPS εφαρμογών με τον εντοπισμό σφαλμάτων Ray"
---

# Χρήση Ray Debugger για XOOPS

> Σύγχρονος εντοπισμός σφαλμάτων με το Ray: επιθεώρηση μεταβλητών, μηνυμάτων καταγραφής, παρακολούθηση ερωτημάτων SQL και απόδοση προφίλ στην εφαρμογή XOOPS.

---

## Τι είναι το Ray;

Το Ray είναι ένα ελαφρύ εργαλείο εντοπισμού σφαλμάτων που σας βοηθά να επιθεωρήσετε την κατάσταση της εφαρμογής χωρίς να σταματήσετε την εκτέλεση ή να χρησιμοποιήσετε σημεία διακοπής. Είναι ιδανικό για ανάπτυξη XOOPS.

** Χαρακτηριστικά: **
- Καταγραφή μηνυμάτων και μεταβλητών
- Επιθεωρήστε τα ερωτήματα SQL
- Απόδοση κομματιού
- Κωδικός προφίλ
- Ομαδοποίηση σχετικών αρχείων καταγραφής
- Οπτικό χρονοδιάγραμμα

**Απαιτήσεις:**
- PHP 7,4+
- Εφαρμογή Ray (διατίθεται δωρεάν έκδοση)
- Composer
...
## # Βήμα 1: Εγκαταστήστε το πακέτο Ray
...
## # Βήμα 2: Κατεβάστε την εφαρμογή Ray

Λήψη από [ray.so](https://ray.so):
- Mac: Ray.app
- Windows: Ray.exe
- Linux: ray (AppImage)

## # Βήμα 3: Διαμόρφωση τείχους προστασίας (αν χρειάζεται)

Το Ray χρησιμοποιεί τη θύρα 23517 από προεπιλογή:
...
## # 1. SQL Παρακολούθηση ερωτημάτων
...
## # 3. Εντοπισμός σφαλμάτων υπό όρους
...
## # 4. Ομαδοποίηση σχετικών αρχείων καταγραφής
...
## XOOPS-Συγκεκριμένος εντοπισμός σφαλμάτων

## # Εντοπισμός σφαλμάτων ενότητας
...
## Προσαρμοσμένες Λειτουργίες Ray

## # Δημιουργία βοηθητικών συναρτήσεων
...
## Ροές εργασιών εντοπισμού σφαλμάτων

## # Εντοπισμός σφαλμάτων εγκατάστασης μονάδας
...
## # Σφάλμα προτύπου Εντοπισμός σφαλμάτων
...
## Αντιμετώπιση προβλημάτων Ray

## # Ε: Ο Ray δεν λαμβάνει μηνύματα

**Α:**
1. Ελέγξτε ότι η εφαρμογή Ray εκτελείται
2. Ελέγξτε το τείχος προστασίας που επιτρέπει τη θύρα 23517
3. Βεβαιωθείτε ότι το Ray είναι εγκατεστημένο:
```bash
composer require spatie/ray
```

## # Ε: Δεν μπορώ να δω SQL ερωτήματα
...
## # Ε: Επίδραση απόδοσης του Ray

**Α:** Το Ray έχει ελάχιστο κόστος. Για παραγωγή, καταργήστε τις κλήσεις Ray ή απενεργοποιήστε:
```php
<?php
