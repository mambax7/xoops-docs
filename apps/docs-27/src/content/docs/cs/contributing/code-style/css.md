---
title: "Pokyny CSS a SCSS"
description: "XOOPS CSS/SCSS kódovací standardy a osvědčené postupy"
---

> XOOPS se řídí moderními standardy CSS s předzpracováním SCSS se zaměřením na udržovatelnost a výkon.

---

## Přehled

Normy XOOPS CSS zdůrazňují:

- **Předběžné zpracování SCSS** pro organizaci
- **Metodika BEM** pro pojmenování
- **Design citlivý na mobil**
- **Přístupnost a sémantika HTML**
- **Optimalizace výkonu**
...
### Pojmenování osvědčených postupů
...
- Použijte proměnné SCSS pro barvy, mezery, fonty
- Dodržujte konvenci pojmenování BEM
- Design reagující na mobily
- Uspořádejte soubory podle účelu
- Napište opakovaně použitelné mixiny
- Udržujte voliče jednoduché (maximálně 3 úrovně hloubky)
- Použijte sémantický HTML
- Minimalizujte specifičnost
- Komentujte složité sekce

### Ne

- Používejte inline styly
- Používejte !important (téměř nikdy)
- Vytvořte příliš specifické selektory
- Pro styling použijte selektory ID
- Vnořte se příliš hluboko (max 3-4 úrovně)
- Pro velikosti písma použijte px (použijte rem)
- Vytvořte magická čísla (použijte proměnné)
- Nechte nepoužitý CSS
- Zapomeňte na dostupnost
