---
title: "Konvence šablony Smarty"
description: "Standardy a osvědčené postupy kódování šablon XOOPS Smarty"
---

> XOOPS používá Smarty pro vytváření šablon. Tato příručka obsahuje konvence a osvědčené postupy pro vývoj šablon Smarty.

---

## Přehled

Následující šablony XOOPS Smarty:

- **Struktura šablony XOOPS** a pojmenování
- **Standardy přístupnosti** (WCAG)
- **Sémantické označení HTML5**
- **Pojmenování třídy ve stylu BEM**
- **Optimalizace výkonu**
...
### Sekce (zastaralé, místo toho použijte foreach)
...
- Použijte sémantický HTML5
- Zahrnout alternativní text pro obrázky
- Používejte jazykové konstanty pro text
- Escape výstup (výchozí)
- Udržujte minimální logiku
- Používejte smysluplné názvy proměnných
- Zahrnout záhlaví souborů
- Použijte názvy tříd ve stylu BEM
- Test s čtečkami obrazovky

### Ne

- Nesměšujte logiku a prezentaci
- Nezapomeňte na alternativní text
- Nepoužívejte raw HTML bez escapování
- Nevytvářejte globální proměnné v šablonách
- Nepoužívejte zastaralé funkce Smarty
- Nevkládejte šablony příliš hluboko
- Neignorujte dostupnost
- Nekódujte text napevno (použijte konstanty)

---

## Příklady šablon

### Kompletní šablona modulu
...
#xoops #chytré #šablony #konvence #osvědčené postupy