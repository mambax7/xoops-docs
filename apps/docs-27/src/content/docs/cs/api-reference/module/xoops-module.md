...
description: "Kompletní reference API pro XoopsModule a třídy modulového systému"
---

> Kompletní dokumentace API pro modulový systém XOOPS.

---

## Architektura modulového systému
...
|----------|------|-------------|
| `mid` | int | ID modulu |
| `name` | řetězec | Zobrazovaný název |
| `version` | řetězec | Číslo verze |
| `dirname` | řetězec | Název adresáře |
| `isactive` | int | Aktivní stav (0/1) |
| `hasmain` | int | Má hlavní prostor |
| `hasadmin` | int | Má oblast administrátora |
| `hassearch` | int | Má vyhledávací funkci |
| `hasconfig` | int | Má konfiguraci |
| `hascomments` | int | Má komentáře |
| `hasnotification` | int | Má oznámení |
...
#xoops #api #modul #xoopsmodule #reference