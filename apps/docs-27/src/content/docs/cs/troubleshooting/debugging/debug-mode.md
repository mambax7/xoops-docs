---
title: "Povolit režim ladění"
description: "Jak povolit a používat režim ladění XOOPS pro odstraňování problémů"
---

> Komplexní průvodce funkcemi a nástroji ladění XOOPS.
...
| Úroveň | PHP Chyby | SQL Dotazy | Šablona Vars | Doporučeno pro |
|-------|------------|-------------|---------------|-----------------|
| 0 | Skryté | Ne | Ne | Výroba |
| 1 | Zobrazeno | Ne | Ne | Rychlé kontroly |
| 2 | Zobrazeno | Přihlášeno | Ne | Vývoj |
| 3 | Zobrazeno | Přihlášeno | Zobrazeno | Hluboké ladění |
...
### Zobrazení dotazů v režimu ladění

S nastavením `XOOPS_DEBUG_LEVEL` na 2 nebo 3 se dotazy SQL zobrazí ve spodní části stránek.

### Ruční protokolování dotazů
...
#xoops #ladění #řešení problémů #vývoj #protokolování