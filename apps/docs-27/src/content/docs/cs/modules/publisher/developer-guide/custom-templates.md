---
title: "Vydavatel – Vlastní šablony"
description: "Průvodce přizpůsobením šablon aplikace Publisher a vytvářením vlastních motivů"
---

# Vlastní šablony v Publisheru

> Průvodce vytvářením a přizpůsobením šablon aplikace Publisher pomocí přepisů Smarty, CSS a HTML.

---

## Přehled systému šablon

### Co jsou šablony?

Šablony řídí, jak Publisher zobrazuje obsah:
...
### Kopírovat šablonu do motivu

**Metoda 1: Přes Správce souborů**
...
### Upravit vlastní šablonu

Otevřete kopii motivu v textovém editoru:
...
## Základy šablony Smarty

### Proměnné Smarty

Publisher poskytuje šablonám proměnné:
...
### Šablona jednoho článku

**Soubor: publisher_item.tpl**
...
### Šablona výpisu kategorie

**Soubor: publisher_category.tpl**
...
### Šablona bloku nejnovějších článků

**Soubor: publisher_block_latest.tpl**
...
Vytvořte vlastní CSS v motivu:

```
/themes/yourtheme/modules/publisher/css/custom.css
```

### Struktura základní šablony

Pochopte strukturu HTML:
...
## Odkaz na proměnné šablony

### Položka (článek) Objekt
...
### Zobrazení proměnných Smarty

Pro ladění (odstranění ve výrobě):
...
V `/modules/publisher/xoops_version.php` nebo nastavení správce:
...
### Ze staré verze vydavatele

Pokud upgradujete ze starší verze:

1. Porovnejte staré a nové soubory šablon
2. Sloučit vlastní změny
3. Použijte nové názvy proměnných
4. Důkladně otestujte
5. Zálohujte staré šablony
...
- [Dokumentace Smarty](https://www.smarty.net/documentation)
- [Vydavatel GitHub](https://github.com/XOOPSModules25x/publisher)
- [Příručka šablony XOOPS](../../02-Core-Concepts/Templates/Smarty-Basics.md)

---

#vydavatel #šablony #chytré #přizpůsobení #téma #xoops