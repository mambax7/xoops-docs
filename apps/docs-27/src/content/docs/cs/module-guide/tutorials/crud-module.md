---
title: "Vytvoření modulu CRUD"
description: "Kompletní návod pro sestavení modulu CRUD s databázovými operacemi, formuláři a administrátorským rozhraním"
---

# Vytvoření výukového programu modulu CRUD

Tento tutoriál vás provede vytvořením kompletního modulu CRUD (Vytvoření, čtení, aktualizace, mazání) pro XOOPS. Vytvoříme modul „Poznámky“, který uživatelům umožní spravovat osobní poznámky.

## Předpoklady

- Dokončený výukový program Hello-World-Module
- Pochopení konceptů PHP OOP
- Základní znalosti SQL

## Přehled modulu

**Funkce modulu Notes:**
- Vytvářejte, prohlížejte, upravujte a mažte poznámky
- Administrativní rozhraní pro správu
- Poznámky specifické pro uživatele
- Organizace kategorií
- Funkce vyhledávání

## Krok 1: Struktura adresáře

Vytvořte následující strukturu v `/modules/notes/`:
...
## Krok 2: Schéma databáze

Vytvořit `sql/mysql.sql`:
...
Vytvořit `class/NoteHandler.php`:
...
### Obslužný program kategorie

Vytvořit `class/CategoryHandler.php`:
...
## Krok 5: Common Include File

Vytvořit `include/common.php`:
...
Vytvořit `templates/notes_index.tpl`:
...
Vytvořit `templates/notes_view.tpl`:
...
Vytvořit `templates/notes_edit.tpl`:
...
## Krok 9: Administrátorské rozhraní
...
### Správa poznámek správce

Vytvořit `admin/notes.php`:
...
Gratulujeme! Postavili jste kompletní modul CRUD. Klíčové pojmy:

1. **Návrh databáze** - Tabulky se vztahy
2. **Třídy entit** – XOOPSObject s typovanými vlastnostmi
3. **Třídy Handler** – XOOPSPersitableObjectHandler s vlastními metodami
4. **Frontend Pages** – Seznam, zobrazení a úpravy
5. **Manipulace s formuláři** – ochrana a ověření CSRF
6. **Rozhraní správce** – Obrazovky správy
7. **Šablony** - Smarty šablony s logikou

## Další kroky

- Přidejte další pokročilé funkce (komentáře, hodnocení, sdílení)
- Implementujte ../Patterns/Repository-Pattern pro čistší přístup k datům
- Použijte ../Patterns/MVC-Pattern pro lepší organizaci kódu
- Přidejte ../Best-Practices/Testing pomocí PHPUnit

Viz také: ../Vývoj modulů | ../Patterns/MVC-Pattern | ../Patterns/Repository-Pattern