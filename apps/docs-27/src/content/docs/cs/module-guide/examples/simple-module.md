---
title: "Příklad jednoduchého modulu"
description: "Kompletní pracovní modul se všemi potřebnými soubory"
---

# Příklad jednoduchého modulu - Blog

Kompletní, funkční jednoduchý modul, který demonstruje základní koncepty XOOPS.
...
## Administrátorské rozhraní (admin.php)
...
- Zobrazte publikované blogové příspěvky se stránkováním
- Zobrazit jednotlivé příspěvky
- Administrátorské rozhraní pro vytváření, úpravu a mazání příspěvků
- Stav Draft/Published
- Časová razítka

## Testování

1. Nainstalujte modul pomocí správce XOOPS
2. Přístup k frontendu na `modules/blog/`
3. Navštivte správce na adrese `modules/blog/admin.php`
4. Vytvořte testovací příspěvek a publikujte jej

## Související dokumentace

Viz také:
- ../Patterns/MVC-Pattern pro vzory
- ../Patterns/Repository-Pattern pro přístup k datům
- ../Best-Practices/Code-Organization pro strukturu

---

Tagy: #examples #simple-module #complete-example #module-development