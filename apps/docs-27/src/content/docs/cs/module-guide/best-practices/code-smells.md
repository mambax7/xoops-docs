---
title: "Kód voní ve vývoji XOOPS"
---

## Přehled

Vůně kódu jsou indikátory potenciálních problémů v kódu. Neznamená to nutně, že kód je rozbitý, ale naznačují oblasti, kterým by refaktoring mohl prospět.
...
## Zneužívající objektové orientace
...
Když zaznamenáte zápach kódu:

1. **Identifikujte** – Jaká vůně to je?
2. **Posuďte** – Jak závažný je dopad?
3. **Plán** – Jaká technika refaktoringu se používá?
4. **Test** – Před refaktorizací se ujistěte, že existují testy
5. **Refaktor** – Provádějte malé, postupné změny
6. **Ověřit** – Spusťte testy po každé změně
