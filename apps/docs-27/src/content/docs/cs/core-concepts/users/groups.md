---
title: "Skupinový systém"
description: "Komplexní příručka pro správu skupin XOOPS, výchozí skupiny, vlastní skupiny a hierarchii skupin"
---

# Skupinový systém v XOOPS

Skupinový systém XOOPS poskytuje hierarchický rámec pro organizaci uživatelů a správu kolektivních oprávnění. Tento dokument popisuje výchozí skupiny, vytváření vlastních skupin, hierarchii a praktickou implementaci.

## Výchozí skupiny

XOOPS zahrnuje tři základní skupiny, které se vytvářejí během instalace systému:

### Skupina webmasterů (ID: 1)

Skupina Webmasters zastupuje administrátory webu s plným přístupem k systému.

**Charakteristika:**
- ID skupiny: 1
- Nejvyšší úroveň oprávnění
- Nelze smazat
- Plný přístup ke všem modulům a funkcím
- Přístup do administračního panelu
...
### Skupina registrovaných uživatelů (ID: 2)

Skupina Registrovaní uživatelé zahrnuje všechny ověřené uživatele, kteří nejsou anonymní.

**Charakteristika:**
- ID skupiny: 2
- Výchozí skupina pro nové registrace
- Má přístup k funkcím specifickým pro uživatele
- Podléhá skupinovým oprávněním
- Lze přizpůsobit pro standardní uživatelské funkce
...
### Anonymní skupina (ID: 3)

Skupina Anonymous zastupuje neověřené návštěvníky webu.

**Charakteristika:**
- ID skupiny: 3
- Výchozí skupina pro nepřihlášené uživatele
- Typicky omezený přístup pouze pro čtení
- Nelze upravit obsah
- Oprávnění k veřejnému prohlížení
...
### Obslužný program pro vytváření skupin
...
1. **Jasné pojmenování**: Použijte popisné a jasné názvy skupin
2. **Dokumentace**: Účely a oprávnění skupiny dokumentů
3. **Princip nejmenšího privilegia**: Udělte minimální požadovaná oprávnění
4. **Pravidelné audity**: Pravidelně kontrolujte členství ve skupinách a oprávnění
5. **Výchozí skupiny**: Zachovat výchozí skupiny (Webmasteři, Registrovaní, Anonymní)
...
#skupiny #správa skupin #oprávnění #kontrola přístupu #uspořádání uživatelů #hierarchie