---
title: "Esempio di Modulo Semplice"
description: "Modulo completo e funzionante con tutti i file necessari"
---

# Esempio di Modulo Semplice - Blog

Un modulo semplice completo e funzionante che dimostra i concetti XOOPS di base.
...
- Visualizza post di blog pubblicati con paginazione
- Visualizza post individuali
- Interfaccia admin per creare, modificare, eliminare post
- Stato bozza/pubblicato
- Timestamp

## Testing

1. Installa il modulo tramite admin XOOPS
2. Accedi al frontend a `modules/blog/`
3. Visita l'admin a `modules/blog/admin.php`
4. Crea un post di test e pubblicalo

## Documentazione Correlata

Vedi anche:
- ../Patterns/MVC-Pattern per i pattern
- ../Patterns/Repository-Pattern per l'accesso ai dati
- ../Best-Practices/Code-Organization per la struttura
