---
title: "Utilizzo di Ray Debugger"
description: "Debug delle applicazioni XOOPS con Ray debugger"
---

# Utilizzo di Ray Debugger per XOOPS

> Debug moderno con Ray: ispeziona variabili, registra messaggi, traccia query SQL e profila le prestazioni nella tua applicazione XOOPS.

---

## Che cos'è Ray?

Ray è uno strumento di debug leggero che ti aiuta a ispezionare lo stato dell'applicazione senza arrestare l'esecuzione o utilizzare breakpoint. È perfetto per lo sviluppo di XOOPS.

**Caratteristiche:**
- Registra messaggi e variabili
- Ispeziona query SQL
- Traccia le prestazioni
- Profila il codice
- Raggruppa log correlati
- Timeline visiva

**Requisiti:**
- PHP 7.4+
- Applicazione Ray (versione gratuita disponibile)
- Composer
...
### Passaggio 1: Installa il pacchetto Ray
...
### Passaggio 2: Scarica l'app Ray

Scarica da [ray.so](https://ray.so):
- Mac: Ray.app
- Windows: Ray.exe
- Linux: ray (AppImage)

### Passaggio 3: Configura il firewall (se necessario)

Ray utilizza la porta 23517 per impostazione predefinita:
...
### 1. Tracciamento delle query SQL
...
### 4. Raggruppamento di log correlati
...
### Debug dell'installazione del modulo
...
### Debug degli errori del template
...
## Risoluzione dei problemi di Ray

### D: Ray non riceve messaggi

**R:**
1. Controlla che l'app Ray sia in esecuzione
2. Controlla che il firewall consenta la porta 23517
3. Verifica che Ray sia installato:
```bash
composer require spatie/ray
```

### D: Impossibile visualizzare le query SQL
...
### D: Impatto sulle prestazioni di Ray

**R:** Ray ha un overhead minimo. Per la produzione, rimuovi le chiamate Ray o disabilita:
```php
<?php
