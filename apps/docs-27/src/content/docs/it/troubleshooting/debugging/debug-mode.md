---
title: "Abilita modalità debug"
description: "Come abilitare e utilizzare la modalità debug XOOPS per la risoluzione dei problemi"
---

> Guida completa alle funzionalità di debug e agli strumenti XOOPS.

---

## Architettura del debug
...
## Livelli di debug XOOPS

### Abilita in mainfile.php
...
| Livello | Errori PHP | Query SQL | Variabili Template | Consigliato per |
|---------|------------|-----------|-------------------|-----------------|
| 0 | Nascosti | No | No | Produzione |
| 1 | Visualizzati | No | No | Controlli rapidi |
| 2 | Visualizzati | Registrate | No | Sviluppo |
| 3 | Visualizzati | Registrate | Visualizzate | Debug approfondito |
...
## Debug delle query SQL

### Visualizza query in modalità debug

Con `XOOPS_DEBUG_LEVEL` impostato su 2 o 3, le query SQL appaiono in fondo alle pagine.

### Registrazione manuale delle query
...
## Debug del template Smarty

### Abilita Smarty Debug Console
...
### Visualizza variabili assegnate
...
## Assistente debug personalizzato
