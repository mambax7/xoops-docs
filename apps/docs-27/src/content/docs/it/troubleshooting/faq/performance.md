---
title: "FAQ prestazioni"
description: "Domande frequenti sull'ottimizzazione delle prestazioni di XOOPS"
---

# Domande frequenti sulle prestazioni

> Domande e risposte comuni sull'ottimizzazione delle prestazioni di XOOPS e sulla diagnosi di siti lenti.

---

## Prestazioni generali

### D: Come posso dire se il mio sito XOOPS è lento?

**R:** Usa questi strumenti e metriche:
...
### D: Quali sono i problemi di prestazioni più comuni?
...
### D: Dove dovrei concentrare i miei sforzi di ottimizzazione?

**R:** Segui la priorità di ottimizzazione:
...
### D: Come abilito il caching in XOOPS?

**R:** XOOPS ha il caching integrato. Configura in Admin > Settings > Performance:
...
### D: Che tipo di caching dovrei usare?
...
### D: Come cancello la cache di XOOPS?
...
### D: Per quanto tempo devo memorizzare i dati nella cache?

**R:** Dipende dai requisiti di freschezza dei dati:
...
### D: Come posso trovare query di database lente?

**R:** Abilita la registrazione delle query:
...
### D: Come ottimizzole le query del database?
...
### D: Come riduco il carico del database?
...
### D: Come ottimizzole CSS e JavaScript?
...
### D: Come ottimizzole le immagini?
...
### D: Come verifico le prestazioni del server?
...
### D: Come ottimizzole PHP per XOOPS?

**R:** Modifica `/etc/php/8.x/fpm/php.ini`:
...
### D: Come abilito HTTP/2 e la compressione?

**R:** Per Apache (.htaccess):
```apache
...
### D: Come monitorole le prestazioni di XOOPS nel tempo?
...
### D: Come identifico le perdite di memoria?
