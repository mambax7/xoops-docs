---
title: "Riferimento API XoopsModule"
description: "Riferimento API completo per XoopsModule e classi sistema moduli"
---

> Documentazione API completa per il sistema moduli XOOPS.

---

## Architettura Sistema Moduli
...
{
    // Proprietà
    public $modinfo;      // Array info modulo
    public $adminmenu;    // Voci menu admin
...
|----------|------|-------------|
| `mid` | int | ID Modulo |
| `name` | string | Nome visualizzazione |
| `version` | string | Numero versione |
| `dirname` | string | Nome directory |
| `isactive` | int | Stato attivazione (0/1) |
| `hasmain` | int | Ha area principale |
| `hasadmin` | int | Ha area admin |
| `hassearch` | int | Ha funzione ricerca |
| `hasconfig` | int | Ha configurazione |
| `hascomments` | int | Ha commenti |
| `hasnotification` | int | Ha notifiche |
...
// Verifica se modulo ha funzionalità
