---
title: "CSS और SCSS दिशानिर्देश"
description: "XOOPS CSS/SCSS कोडिंग मानक और सर्वोत्तम अभ्यास"
---
> XOOPS SCSS प्रीप्रोसेसिंग के साथ आधुनिक CSS मानकों का पालन करता है, रखरखाव और प्रदर्शन पर ध्यान केंद्रित करता है।

---

## अवलोकन

XOOPS CSS मानक इस पर जोर देते हैं:

- **SCSS संगठन के लिए प्रीप्रोसेसिंग**
- नामकरण के लिए **बीईएम पद्धति**
- **मोबाइल-प्रथम प्रतिक्रियाशील डिज़ाइन**
- **पहुंच-योग्यता और अर्थ HTML**
- **प्रदर्शन अनुकूलन**
...
- रंग, रिक्ति, फ़ॉन्ट के लिए SCSS वेरिएबल का उपयोग करें
- बीईएम नामकरण परंपरा का पालन करें
- मोबाइल-प्रथम प्रतिक्रियाशील डिज़ाइन
- उद्देश्य के अनुसार फ़ाइलें व्यवस्थित करें
- पुन: प्रयोज्य मिश्रण लिखें
- चयनकर्ताओं को सरल रखें (अधिकतम 3 स्तर गहरा)
- सिमेंटिक HTML का प्रयोग करें
- विशिष्टता कम करें
- जटिल अनुभागों पर टिप्पणी करें

### मत करो

- इनलाइन शैलियों का प्रयोग करें
- उपयोग करें !महत्वपूर्ण (लगभग कभी नहीं)
- अत्यधिक विशिष्ट चयनकर्ता बनाएं
- स्टाइलिंग के लिए आईडी चयनकर्ताओं का उपयोग करें
- बहुत गहराई तक घोंसला बनाएं (अधिकतम 3-4 स्तर)
- फ़ॉन्ट आकार के लिए px का उपयोग करें (rem का उपयोग करें)
- जादुई संख्याएँ बनाएँ (चर का उपयोग करें)
- अप्रयुक्त CSS छोड़ें
- पहुंच को भूल जाओ
...
#xoops #css #scss #स्टाइलिंग #कोडिंग-मानक #सर्वोत्तम अभ्यास