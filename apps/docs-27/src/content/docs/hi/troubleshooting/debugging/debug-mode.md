---
title: "डिबग मोड सक्षम करें"
description: "समस्या निवारण के लिए XOOPS डिबग मोड को कैसे सक्षम और उपयोग करें"
---
> XOOPS डिबगिंग सुविधाओं और उपकरणों के लिए व्यापक मार्गदर्शिका।
...
| स्तर | PHP त्रुटियाँ | SQL प्रश्न | टेम्प्लेट वार्स | के लिए अनुशंसित |
|-------|---|---|-------|---|---|
| 0 | छिपा हुआ | नहीं | नहीं | उत्पादन |
| 1 | प्रदर्शित | नहीं | नहीं | त्वरित जांच |
| 2 | प्रदर्शित | लॉग किया गया | नहीं | विकास |
| 3 | प्रदर्शित | लॉग किया गया | प्रदर्शित | डीप डिबगिंग |
...
### डिबग मोड में क्वेरीज़ देखें

`XOOPS_DEBUG_LEVEL` को 2 या 3 पर सेट करने पर, SQL क्वेरीज़ पेजों के नीचे दिखाई देती हैं।

### मैनुअल क्वेरी लॉगिंग
...
#xoops #डिबगिंग #समस्या निवारण #विकास #लॉगिंग