---
title: "Smarty टेम्पलेट डिबगिंग"
description: "XOOPS के लिए उन्नत टेम्पलेट डिबगिंग और समस्या निवारण तकनीक"
---
> XOOPS थीम और मॉड्यूल में Smarty टेम्प्लेट डीबग करने की उन्नत तकनीकें।
...
## Smarty डिबग मोड सक्षम करें

### विधि 1: व्यवस्थापक पैनल

XOOPS एडमिन > सेटिंग्स > प्रदर्शन:
- "डीबग आउटपुट" सक्षम करें
- "डीबग लेवल" को 2 पर सेट करें

---

### विधि 2: कोड कॉन्फ़िगरेशन
...
### विधि 3: ब्राउज़र में पॉपअप डीबग करें
...
यह सभी निर्दिष्ट चरों के साथ एक पॉपअप दिखाता है।

---

## सामान्य Smarty डिबग तकनीकें

### सभी वेरिएबल्स को डंप करें
...
### टेम्पलेट में वेरिएबल की जाँच करें
...
## संकलित टेम्पलेट्स देखें

Smarty प्रदर्शन के लिए टेम्पलेट्स को PHP में संकलित करता है। संकलित कोड देखकर डीबग करें:
...
## टेम्पलेट संकलन का विश्लेषण करें
...
## विशिष्ट मुद्दों को डीबग करें

### अंक 1: वेरिएबल खाली के रूप में दिखाता है
...
## कैश साफ़ करें और पुनर्निर्माण करें
...
#xoops #टेम्प्लेट्स #Smarty #डिबगिंग #समस्या निवारण