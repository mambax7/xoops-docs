---
title: "XoopsForm API संदर्भ"
description: "XoopsForm के लिए पूर्ण API संदर्भ और तत्व वर्ग बनाएं"
---
> XOOPS फॉर्म जनरेशन सिस्टम के लिए संपूर्ण API दस्तावेज़ीकरण।
...
|--------|---|---|---|
| `addElement` | `XoopsFormElement $element, bool $required = false` | `void` | प्रपत्र में तत्व जोड़ें |
| `getElements` | - | `array` | सभी तत्व प्राप्त करें |
| `getElement` | `string $name` | `XoopsFormElement|null` | नाम से तत्व प्राप्त करें |
| `setExtra` | `string $extra` | `void` | अतिरिक्त HTML विशेषताएँ सेट करें |
| `getExtra` | - | `string` | अतिरिक्त विशेषताएँ प्राप्त करें |
| `getTitle` | - | `string` | प्रपत्र शीर्षक प्राप्त करें |
| `setTitle` | `string $title` | `void` | प्रपत्र शीर्षक सेट करें |
| `getName` | - | `string` | फॉर्म का नाम प्राप्त करें |
| `getAction` | - | `string` | कार्रवाई URL प्राप्त करें |
| `render` | - | `string` | फॉर्म HTML प्रस्तुत करें |
| `display` | - | `void` | प्रतिध्वनि प्रतिपादित रूप |
| `insertBreak` | `string $extra = ''` | `void` | विज़ुअल ब्रेक डालें |
| `setRequired` | `XoopsFormElement $element` | `void` | आवश्यक तत्व चिह्नित करें |

---

## XoopsThemeForm

सबसे अधिक इस्तेमाल किया जाने वाला फॉर्म क्लास, थीम-अवेयर स्टाइल के साथ प्रस्तुत करता है।
...
अनेक तत्वों को एक साथ समूहित करें।
