---
title: "XoopsModule API संदर्भ"
description: "XoopsModule और मॉड्यूल सिस्टम कक्षाओं के लिए पूर्ण API संदर्भ"
---
> XOOPS मॉड्यूल सिस्टम के लिए पूर्ण API दस्तावेज़ीकरण।

---

## मॉड्यूल सिस्टम आर्किटेक्चर
...
|---|------|----|
| `mid` | int | मॉड्यूल आईडी |
| `name` | स्ट्रिंग | प्रदर्शन नाम |
| `version` | स्ट्रिंग | संस्करण संख्या |
| `dirname` | स्ट्रिंग | निर्देशिका का नाम |
| `isactive` | int | सक्रिय स्थिति (0/1) |
| `hasmain` | int | मुख्य क्षेत्र है |
| `hasadmin` | int | व्यवस्थापक क्षेत्र है |
| `hassearch` | int | खोज फ़ंक्शन है |
| `hasconfig` | int | कॉन्फ़िगरेशन है |
| `hascomments` | int | टिप्पणियाँ हैं |
| `hasnotification` | int | सूचनाएं हैं |
...
#xoops #api #मॉड्यूल #xoopsmodule #संदर्भ