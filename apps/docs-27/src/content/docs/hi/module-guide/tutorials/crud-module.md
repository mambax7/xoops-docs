---
title: "CRUD मॉड्यूल का निर्माण"
description: "डेटाबेस संचालन, प्रपत्र और व्यवस्थापक इंटरफ़ेस के साथ CRUD मॉड्यूल बनाने के लिए संपूर्ण ट्यूटोरियल"
---
# CRUD मॉड्यूल ट्यूटोरियल का निर्माण

यह ट्यूटोरियल आपको XOOPS के लिए संपूर्ण CRUD (बनाएं, पढ़ें, अपडेट करें, हटाएं) मॉड्यूल बनाने के बारे में बताता है। हम एक "नोट्स" मॉड्यूल बनाएंगे जो उपयोगकर्ताओं को व्यक्तिगत नोट्स प्रबंधित करने की अनुमति देगा।

## पूर्वावश्यकताएँ

- हैलो-वर्ल्ड-मॉड्यूल ट्यूटोरियल पूरा किया
- PHP OOP अवधारणाओं की समझ
- बुनियादी SQL ज्ञान

## मॉड्यूल अवलोकन

**नोट्स मॉड्यूल विशेषताएं:**
- नोट्स बनाएं, देखें, संपादित करें और हटाएं
- व्यवस्थापक प्रबंधन इंटरफ़ेस
- उपयोगकर्ता-विशिष्ट नोट्स
- श्रेणी संगठन
- खोज कार्यक्षमता

## चरण 1: निर्देशिका संरचना

`/modules/notes/` में निम्नलिखित संरचना बनाएं:
...
`class/CategoryHandler.php` बनाएं:
...
## चरण 5: सामान्य फ़ाइल शामिल करें

`include/common.php` बनाएं:
...
### पृष्ठ संपादित करें (बनाएं/अद्यतन करें)
...
`templates/notes_index.tpl` बनाएं:
...
`templates/notes_view.tpl` बनाएं:
...
`templates/notes_edit.tpl` बनाएं:
...
### व्यवस्थापक नोट्स प्रबंधन

`admin/notes.php` बनाएं:
...
बधाई हो! आपने एक संपूर्ण CRUD मॉड्यूल बनाया है। मुख्य अवधारणाएँ शामिल:

1. **डेटाबेस डिज़ाइन** - रिश्तों के साथ तालिकाएँ
2. **इकाई वर्ग** - XoopsObject टाइप की गई संपत्तियों के साथ
3. **हैंडलर क्लासेस** - XoopsPersistableObjectHandler कस्टम तरीकों के साथ
4. **फ्रंटेंड पेज** - कार्यक्षमता की सूची बनाएं, देखें और संपादित करें
5. **फॉर्म हैंडलिंग** - CSRF सुरक्षा और सत्यापन
6. **एडमिन इंटरफ़ेस** - प्रबंधन स्क्रीन
7. **टेम्पलेट्स** - Smarty तर्क के साथ टेम्प्लेट

## अगले चरण

- अधिक उन्नत सुविधाएँ जोड़ें (टिप्पणियाँ, रेटिंग, साझाकरण)
- स्वच्छ डेटा एक्सेस के लिए ../पैटर्न/रिपोजिटरी-पैटर्न लागू करें
- बेहतर कोड संगठन के लिए ../पैटर्न/एमवीसी-पैटर्न लागू करें
- PHPUnit के साथ ../सर्वोत्तम अभ्यास/परीक्षण जोड़ें

यह भी देखें: ../मॉड्यूल-विकास | ../पैटर्न/एमवीसी-पैटर्न | ../पैटर्न/रिपॉजिटरी-पैटर्न