...
تم های XOOPS نمایش بصری سایت شما را کنترل می کنند. درک ساختار تم برای سفارشی سازی و ایجاد تم های جدید ضروری است.
...
قالب اصلی چیدمان که تمام محتوا را در بر می گیرد:
...
| متغیر | توضیحات |
|----------|-------------|
| `$xoops_sitename` | نام سایت |
| `$xoops_url` | آدرس سایت |
| `$xoops_theme` | نام موضوع فعلی |
| `$xoops_langcode` | کد زبان |
| `$xoops_charset` | رمزگذاری کاراکتر |
| `$xoops_pagetitle` | عنوان صفحه |
| `$xoops_dirname` | نام ماژول فعلی |

### متغیرهای کاربر

| متغیر | توضیحات |
|----------|-------------|
| `$xoops_isuser` | وارد شده است |
| `$xoops_isadmin` | مدیر است |
...
| متغیر | توضیحات |
|----------|-------------|
| `$xoops_showlblock` | نمایش بلوک های سمت چپ |
| `$xoops_showrblock` | نمایش بلوک های سمت راست |
| `$xoops_showcblock` | نمایش بلوک های مرکزی |
| `$xoops_lblocks` | آرایه بلوک های چپ |
| `$xoops_rblocks` | آرایه بلوک های راست |
| `$xoops_contents` | محتوای صفحه اصلی |

## لغو الگوی ماژول

الگوهای ماژول را با قرار دادن آنها در موضوع خود لغو کنید:
...
- ../Templates/Smarty-Templating - نحو الگو
- تم-توسعه - راهنمای تم کامل
- CSS-Best-Practices - دستورالعمل های یک ظاهر طراحی 
- ../../03-Module-Development/Block-Development - ایجاد بلوک