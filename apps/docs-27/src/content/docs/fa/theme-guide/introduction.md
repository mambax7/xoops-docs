---
title: "توسعه تم"
description: "ایجاد و سفارشی کردن تم های XOOPS با وراثت قالب Smarty"
---
<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

این راهنما نحوه ایجاد تم‌های XOOPS، از جمله ساختار تم، وراثت قالب، و بهترین شیوه‌ها برای ساخت تم‌های واکنش‌گرا و مدرن را پوشش می‌دهد.
...
یک تم XOOPS از ساختار دایرکتوری زیر تشکیل شده است:
...
فایل پیکربندی تم ویژگی های تم را تعریف می کند:
...
وراثت الگوی Smarty به شما امکان می دهد تم های فرزند ایجاد کنید که از یک موضوع اصلی به ارث می برند.
...
چندین تنوع تم را از یک موضوع پایه ایجاد کنید:
...
این فایل به صورت خودکار اجرا می شود و می توان از آن برای آماده سازی داده ها برای قالب ها استفاده کرد:
...
## سفارشی Carousel/Slider

نمونه ای از چرخ فلک محتوای پویا:
...
#تم #هوشمند #xoops #css #طراحی #پاسخگو