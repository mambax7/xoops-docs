---
title: "خرابی های نصب ماژول"
description: "تشخیص و رفع مشکلات نصب ماژول در XOOPS"
---
> مسائل و راه حل های رایج برای حل مشکلات نصب ماژول در XOOPS.
...
## 1. اجازه آپلود فایل رد شد

**علائم:**
- آپلود با "مجوز رد شد" ناموفق بود
- پوشه ماژول ایجاد نشده است
- نمی توان در پوشه ماژول ها نوشت
...
## 2. xoopsversion.php وجود ندارد

**علائم:**
- ماژول در لیست ظاهر می شود اما فعال نمی شود
- نصب شروع می شود و سپس متوقف می شود
- هیچ صفحه مدیریتی ایجاد نشده است
...
## 3. خطاهای اجرای SQL پایگاه داده

**علائم:**
- آپلود موفقیت آمیز اما جداول پایگاه داده ایجاد نشده است
- صفحه مدیریت بارگیری نمی شود
- خطاهای "جدول وجود ندارد".
...
**علائم:**
- فایل ها تا حدی آپلود شده اند
- تصادفی .php files missing
- Module becomes unstable پس از نصب
...
## 5. ناسازگاری نسخه PHP

**علائم:**
- نصب بلافاصله انجام نمی شود
- خطاها را در xoopsversion.php تجزیه کنید
- خطاهای "توکن غیرمنتظره".
...
## 6. دایرکتوری ماژول از قبل وجود دارد

**علائم:**
- در صورت وجود دایرکتوری ماژول، نصب با شکست مواجه می شود
- نمی توان ماژول را دوباره نصب یا به روز کرد
- خطای "دایرکتوری وجود دارد".
...
## 7. ایجاد صفحه مدیریت ناموفق بود

**علائم:**
- ماژول نصب می شود اما صفحه مدیریت وجود ندارد
- پنل مدیریت ماژول را نشان نمی دهد
- نمی توان به تنظیمات ماژول دسترسی پیدا کرد
...
## 8. فایل های زبان از دست رفته است

**علائم:**
- نمایش ماژول با نام متغیرها به جای متن
- صفحات مدیریت متن سبک "[LANG_CONSTANT]" را نشان می دهد
- نصب کامل شد اما رابط خراب است
...
`modules/mymodule/debug_install.php` را ایجاد کنید:
...
1. **همیشه قبل از نصب ماژول های جدید بک آپ بگیرید**
2. **قبل از اعزام به تولید، به صورت محلی** آزمایش کنید
3. **ساختار ماژول** را قبل از آپلود بررسی کنید
4. **بلافاصله پس از آپلود، مجوزها را بررسی کنید**
5. **جدول xoops_log** را برای خطاهای نصب مرور کنید
6. **پشتیبان گیری ** از نسخه های ماژول کار
...
#xoops #عیب یابی #ماژول ها #نصب #اشکال زدایی
