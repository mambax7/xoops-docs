---
title: "اشکال زدایی قالب هوشمند"
description: "تکنیک های پیشرفته اشکال زدایی و عیب یابی قالب برای XOOPS"
---
> تکنیک های پیشرفته برای اشکال زدایی قالب های Smarty در تم ها و ماژول های XOOPS.
...
## حالت Smarty Debug را فعال کنید

### روش 1: پنل مدیریت

XOOPS Admin > Settings > Performance:
- فعال کردن "خروجی اشکال زدایی"
- "سطح اشکال زدایی" را روی 2 تنظیم کنید
...
### روش 3: پاپ آپ را در مرورگر اشکال زدایی کنید
...
این یک پنجره با تمام متغیرهای اختصاص داده شده را نشان می دهد.

---

## تکنیک های رایج اشکال زدایی هوشمند

### همه متغیرها را تخلیه کنید
...
## مشاهده الگوهای کامپایل شده

اسمارتی قالب ها را برای عملکرد در PHP کامپایل می کند. اشکال زدایی با مشاهده کدهای کامپایل شده:
...
## مشکلات خاص اشکال زدایی

### مسئله 1: متغیر به عنوان خالی نشان داده می شود
...
### شماره 3: Plugin/Modifier یافت نشد
...
#xoops #قالب ها #هوشمند #اشکال زدایی #عیب یابی