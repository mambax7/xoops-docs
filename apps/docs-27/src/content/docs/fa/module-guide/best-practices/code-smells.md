---
title: "کد در توسعه XOOPS بو می دهد"
---
## بررسی اجمالی

بوهای کد نشانگر مشکلات احتمالی در کد هستند. آنها لزوماً به این معنی نیستند که کد شکسته شده است، اما مناطقی را پیشنهاد می کنند که می توانند از refactoring سود ببرند.
...
وقتی بوی کد را تشخیص دادید:

1. **شناسایی** - چه بویی دارد؟
2. **ارزیابی ** - تاثیر چقدر شدید است؟
3. **طرح** - چه تکنیک بازسازی مجدد اعمال می شود؟
4. **آزمایش** - از وجود تست‌ها قبل از بازسازی مجدد اطمینان حاصل کنید
5. **Refactor** - تغییرات کوچک و افزایشی ایجاد کنید
6. **تأیید ** - تست ها را بعد از هر تغییر اجرا کنید
