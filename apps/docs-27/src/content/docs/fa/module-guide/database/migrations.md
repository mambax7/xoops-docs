---
title: "مهاجرت های پایگاه داده"
---
## بررسی اجمالی

انتقال پایگاه داده تغییرات قابل برگشت و کنترل شده توسط نسخه را در طرح پایگاه داده شما ایجاد می کند. آنها وضعیت های پایگاه داده منسجم را در محیط های توسعه، مرحله بندی و تولید تضمین می کنند.
...
1. **یک تغییر در هر مهاجرت ** - مهاجرت ها را متمرکز نگه دارید
2. **روش ها را همیشه یادداشت کنید** - بازگشت به عقب را فعال کنید
3. **هر دو جهت را تست کنید** - بررسی up() و down()
4. ** از تراکنش ها استفاده کنید ** - مهاجرت های پیچیده را بپیچید
5. ** مهاجرت های قدیمی را تغییر ندهید ** - به جای آن موارد جدید ایجاد کنید
6. **پشتیبان گیری قبل از اجرا ** - به خصوص در تولید

## مستندات مرتبط

- پایگاه داده-شما - طراحی طرحواره
- پایگاه داده-عملیات - اجرای پرس و جو
- ../xoops_version.php - مانیفست ماژول
- ../../07-XOOPS-4.0/XOOPS-4.0-Architecture - معماری مدرن