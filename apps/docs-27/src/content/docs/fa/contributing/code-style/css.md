---
title: "دستورالعمل های CSS و SCSS"
description: "استانداردهای کدنویسی و بهترین شیوه های XOOPS CSS/SCSS"
---
> XOOPS از استانداردهای CSS مدرن با پیش پردازش SCSS پیروی می کند و بر قابلیت نگهداری و عملکرد تمرکز دارد.

---

## بررسی اجمالی

استانداردهای XOOPS CSS تاکید دارند:

- **پیش پردازش SCSS** برای سازمان
- **متدولوژی BEM** برای نامگذاری
- **طراحی پاسخگو اولین موبایل**
- **دسترسی و HTML معنایی**
- **بهینه سازی عملکرد**
...
- از متغیرهای SCSS برای رنگ ها، فاصله ها، فونت ها استفاده کنید
- از قرارداد نامگذاری BEM پیروی کنید
- طراحی پاسخگو اولین موبایل
- سازماندهی فایل ها بر اساس هدف
- میکس های قابل استفاده مجدد بنویسید
- انتخابگرها را ساده نگه دارید (حداکثر 3 سطح عمیق)
- از HTML معنایی استفاده کنید
- ویژگی را به حداقل برسانید
- بخش های پیچیده را نظر دهید

### نکن

- از استایل های درون خطی استفاده کنید
- از !important استفاده کنید (تقریبا هرگز)
- انتخابگرهای بسیار خاص ایجاد کنید
- از انتخابگرهای ID برای یک ظاهر طراحی شده استفاده کنید
- لانه سازی بیش از حد عمیق (حداکثر 3-4 سطح)
- از px برای اندازه فونت استفاده کنید (از rem استفاده کنید)
- ایجاد اعداد جادویی (استفاده از متغیرها)
- CSS را بدون استفاده بگذارید
- دسترسی را فراموش کنید
...
### رنگ های مجدد را به حداقل برسانید
...
#xoops #css #scss #استایلینگ #استانداردهای کدنویسی #بهترین روشها