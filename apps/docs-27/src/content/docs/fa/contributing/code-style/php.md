---
title: "استانداردهای کدنویسی PHP"
description: "استانداردهای کد نویسی XOOPS PHP بر اساس PSR-1، PSR-4 و PSR-12"
---
# PHP-Standards

> XOOPS از استانداردهای کدگذاری PSR-1، PSR-4 و PSR-12 با قراردادهای خاص XOOPS پیروی می کند.
