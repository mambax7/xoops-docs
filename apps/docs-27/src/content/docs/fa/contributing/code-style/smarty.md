---
title: "کنوانسیون های قالب هوشمند"
description: "استانداردها و بهترین شیوه های کدنویسی قالب XOOPS Smarty"
---
> XOOPS از Smarty برای قالب بندی استفاده می کند. این راهنما قراردادها و بهترین شیوه ها برای توسعه قالب های Smarty را پوشش می دهد.

---

## بررسی اجمالی

قالب های XOOPS Smarty به شرح زیر است:

- ** ساختار قالب XOOPS ** و نامگذاری
- ** استانداردهای دسترسی ** (WCAG)
- ** نشانه گذاری معنایی HTML5 **
- **نامگذاری کلاس به سبک BEM**
- **بهینه سازی عملکرد**
...
بخش ### (منسوخ شده، به جای آن از foreach استفاده کنید)
...
- شامل متن جایگزین برای تصاویر
- از ثابت های زبان برای متن استفاده کنید
- خروجی فرار (پیش‌فرض)
- منطق را حداقل نگه دارید
- از نام متغیرهای معنی دار استفاده کنید
- شامل سرصفحه فایل
- از نام کلاس های به سبک BEM استفاده کنید
- تست با صفحه خوان

### نکن

- منطق و ارائه را با هم مخلوط نکنید
- متن جایگزین را فراموش نکنید
- از HTML خام بدون فرار استفاده نکنید
- متغیرهای سراسری را در قالب ها ایجاد نکنید
- از ویژگی های منسوخ Smarty استفاده نکنید
- قالب ها را خیلی عمیق تودرتو نکنید
- دسترسی را نادیده نگیرید
- متن هاردکد نکنید (از ثابت استفاده کنید)
...
#xoops #smarty #قالب ها #کنوانسیون ها #بهترین شیوه ها