---
title: "استانداردهای کدنویسی جاوا اسکریپت"
description: "استانداردها و بهترین شیوه های کدنویسی جاوا اسکریپت XOOPS"
---
# استانداردهای جاوا اسکریپت

> XOOPS از استانداردهای مدرن جاوا اسکریپت (ES6+) با تأکید بر خوانایی و قابلیت نگهداری پیروی می کند.

---

## بررسی اجمالی

استانداردهای جاوا اسکریپت XOOPS بر اساس موارد زیر است:

- **ECMAScript 2015+** (ES6 و ویژگی های مدرن)
- **راهنمای سبک جاوا اسکریپت Airbnb** (اقتباس شده)
- ** کنوانسیون های XOOPS ** برای سازگاری
...
- به طور پیش فرض از const استفاده کنید
- از نام های توصیفی استفاده کنید
- از توابع پیکان برای پاسخ به تماس ها استفاده کنید
- از async/await برای وعده ها استفاده کنید
- توابع پیچیده را مستند کنید
- عناصر DOM کش
- از نمایندگی رویداد استفاده کنید
- توابع خالص را بنویسید
- عملکردها را متمرکز نگه دارید

### نکن

- استفاده از var (میراث)
- از متغیرهای سراسری استفاده کنید
- ایجاد توابع طولانی (بیش از 50 خط)
- کد لانه عمیق
- استفاده از eval()
- از کنترل کننده رویداد درون خطی استفاده کنید
- console.log() را در مرحله تولید بگذارید
- ایجاد نشت حافظه
- تغییر پارامترهای تابع
...
#xoops #javascript #es6 #استانداردهای کدنویسی #بهترین شیوه ها