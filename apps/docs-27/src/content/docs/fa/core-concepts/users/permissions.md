---
title: "سیستم مجوز"
description: "راهنمای کامل سیستم مجوز XOOPS، انواع، بررسی، سلسله مراتب و کنترل دسترسی"
---
# سیستم مجوز در XOOPS

سیستم مجوز XOOPS یک چارچوب کنترل دسترسی دانه بندی است که مدیریت می کند چه کسی می تواند چه اقداماتی را بر روی چه منابعی انجام دهد. این سند انواع مجوزها، مکانیسم های بررسی، سلسله مراتب و نمونه های پیاده سازی را پوشش می دهد.

## انواع مجوز

### مجوزهای سطح ماژول

مجوزهای سطح ماژول دسترسی به کل ماژول ها یا عملکردهای ماژول را کنترل می کنند.

**نام های مجوز مشترک:**
- `module_view` - مشاهده محتوای ماژول
- `module_read` - منابع ماژول را بخوانید
- `module_submit` - محتوا را به ماژول ارسال کنید
- `module_edit` - محتوای ماژول را ویرایش کنید
- `module_admin` - مدیریت ماژول
...
مجوزهای سطح آیتم دسترسی به منابع خاص را در یک ماژول کنترل می کنند.

**مثال:**
- شناسه مقاله: آیا می توان مقاله خاص view/edit را گروه بندی کرد؟
- شناسه دسته: آیا گروه می تواند به دسته دسترسی داشته باشد؟
- شناسه صفحه: آیا می توان صفحه خاصی view/modify را گروه بندی کرد؟
...
### مجوزها را مسدود کنید

مجوزهای بلوک، دید و تعامل با بلوک های نمایش داده شده در صفحات را کنترل می کند.
...
مجوزهای کنترل مدیریت و مدیریت گروه.
...
کلاس `XoopsGroupPermHandler` روش هایی را برای بررسی و مدیریت مجوزها ارائه می دهد.
...
1. **اصل حداقل امتیاز**: فقط مجوزهای لازم را اختصاص دهید
2. **دسترسی مبتنی بر نقش**: از گروه ها برای مجوزهای مبتنی بر نقش استفاده کنید
3. **ممیزی های منظم **: به طور دوره ای مجوزها را بررسی کنید
4. **تفکیک وظایف**: ادمین را از مجوزهای کاربر جدا کنید
5. **تکذیب صریح**: پیش فرض انکار، رویکرد مجاز صریح
...
#مجوزها #دسترسی-کنترل #امنیت #مجوز #acl #بررسی مجوز