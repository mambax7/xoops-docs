---
title: "احراز هویت"
description: "راهنمای کامل سیستم احراز هویت XOOPS، جریان ورود به سیستم، مدیریت جلسه، امنیت و ویژگی‌های پیشرفته"
---
# احراز هویت در XOOPS

سیستم احراز هویت XOOPS تأیید امن کاربر، مدیریت جلسه و ویژگی‌های امنیتی پیشرفته از جمله احراز هویت دو مرحله‌ای و ادغام OAuth را فراهم می‌کند. این سند جریان های احراز هویت، پیاده سازی و بهترین شیوه ها را پوشش می دهد.
...
## عملکرد مرا به خاطر بسپار

### پیاده سازی ورود مداوم
...
#احراز هویت #ورود #جلسات #امنیت #رمز رمز عبور #2fa #oauth #مدیریت جلسه