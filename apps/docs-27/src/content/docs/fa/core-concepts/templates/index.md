---
title: "قالب هوشمند در XOOPS"
---
## بررسی اجمالی

XOOPS از موتور قالب Smarty برای جداسازی ارائه از منطق استفاده می کند. این راهنما نحو Smarty، ویژگی‌های خاص XOOPS و بهترین شیوه‌های الگو را پوشش می‌دهد.
...
1. ** خروجی فرار ** - همیشه از محتوای تولید شده توسط کاربر فرار کنید
2. **استفاده از Modifiers ** - اعمال تبدیل مناسب
3. **منطق را حداقل نگه دارید** - منطق پیچیده متعلق به PHP است
4. **استفاده از جزئی** - استفاده مجدد از قطعات قالب معمولی
5. ** HTML معنایی ** - از عناصر HTML5 مناسب استفاده کنید
6. **دسترسی** - در صورت نیاز ویژگی های ARIA را درج کنید
