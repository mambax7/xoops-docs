---
title: "لایه پایگاه داده"
description: "راهنمای جامع انتزاع پایگاه داده XOOPS، XoopsObject، هندلرها و سیستم معیارها"
---
# 🗄️ لایه پایگاه داده
...
:::tip [دسترسی به داده های خود را اثبات کنید]
الگوی handler/Criteria در هر دو نسخه کار می کند. برای آماده شدن برای XOOPS 4.0، دسته‌های بسته بندی را در [کلاس‌های مخزن](../../03-Module-Development/Patterns/Repository-Pattern.md) برای آزمایش‌پذیری بهتر در نظر بگیرید. [انتخاب الگوی دسترسی به داده](../../03-Module-Development/Choosing-Data-Access-Pattern.md) را ببینید.
:::
...
لایه پایگاه داده XOOPS یک انتزاع قوی بر روی MySQL/MariaDB ارائه می دهد که شامل:
...
الگوی کارخانه تضمین می کند که از یک اتصال پایگاه داده واحد استفاده مجدد می شود:
...
کلاس handler عملیات CRUD را برای نمونه های XoopsObject مدیریت می کند.
...
سیستم Criteria روشی قدرتمند و شی گرا برای ساخت بندهای SQL WHERE ارائه می دهد.
...
برای پرس و جوهای پیچیده که با معیارها امکان پذیر نیست، از SQL مستقیم استفاده کنید.
...
### همیشه از ورودی کاربر فرار کنید
...
### استفاده از پرس و جوهای پارامتری (XMF)
...
### انواع ورودی را اعتبارسنجی کنید
...
- [شیرج عمیق سیستم معیار](../../04-API-Reference/Kernel/Criteria.md)
- [الگوهای طراحی - کارخانه](../Architecture/Design-Patterns.md)
- [پیشگیری از تزریق SQL](../Security/SQL-Injection-Prevention.md)
- [XoopsDatabase مرجع API](../../04-API-Reference/Database/XoopsDatabase.md)

---

#xoops #پایگاه داده #orm #معیارها #handlers #mysql