---
title: "گسترش دهنده ناشر"
description: "راهنمای توسعه دهنده برای گسترش و سفارشی سازی ماژول Publisher"
---
> راهنمای توسعه دهنده برای سفارشی سازی و گسترش ماژول Publisher.
...
`preloads/core.php` را ایجاد کنید:
...
قالب های سفارشی را در موضوع خود ایجاد کنید:
...
- راهنمای کاربر - شروع به کار
- الگوی MVC
- XoopsObject API

---

#xoops #ناشر #توسعه دهنده #توسعه #api