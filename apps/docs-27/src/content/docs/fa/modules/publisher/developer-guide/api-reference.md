---
title: "ناشر - مرجع API"
description: "مرجع کامل API برای ماژول Publisher با کلاس‌ها، روش‌ها و نمونه‌های کد"
---
# مرجع API ناشر

> مرجع کامل برای کلاس های ماژول ناشر، روش ها، توابع، و نقاط پایانی API.
...
کلاس `Item` یک article/item را در Publisher نشان می دهد.

** فضای نام:** `XoopsModules\Publisher\`

**فایل:** `modules/publisher/class/Item.php`
...
`ItemHandler` عملیات CRUD را برای مقالات مدیریت می کند.

**فایل:** `modules/publisher/class/ItemHandler.php`

### موارد را بازیابی کنید
...
کلاس `Category` یک دسته یا بخش را نشان می دهد.

**فایل:** `modules/publisher/class/Category.php`
...
## کلاس CategoryHandler

### بررسی اجمالی

`CategoryHandler` عملیات دسته بندی CRUD را مدیریت می کند.

**فایل:** `modules/publisher/class/CategoryHandler.php`

### دسته ها را بازیابی کنید
...
کلاس Helper توابع کاربردی را ارائه می دهد:

**فایل:** `modules/publisher/class/Helper.php`
...
### توابع JavaScript Frontend

ناشر شامل JavaScript API برای تعاملات ظاهری است:
...
Publisher نقاط پایانی AJAX را برای تعاملات frontend فراهم می کند:
...
## REST API (در صورت فعال بودن)

### نقاط پایانی API

اگر ناشر REST API را افشا کند:
...
### مقاله به صورت برنامه نویسی ایجاد کنید
...
### مقالات را بر اساس دسته دریافت کنید
...
### وضعیت مقاله را به‌روزرسانی کنید
...
- قالب ها و بلوک ها در Publisher
- ایجاد مقاله
- مدیریت دسته
...
- [اسناد PHP](https://www.php.net/docs.php)

---

#ناشر #api #مرجع #کد #کلاسها #روشها #xoops