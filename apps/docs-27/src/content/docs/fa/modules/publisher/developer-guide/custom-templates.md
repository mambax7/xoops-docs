---
title: "ناشر - قالب های سفارشی"
description: "راهنمای سفارشی سازی قالب های Publisher و ایجاد تم های سفارشی"
---
# قالب های سفارشی در Publisher

> راهنمای ایجاد و سفارشی کردن الگوهای Publisher با استفاده از Smarty، CSS، و HTML.
...
الگوها نحوه نمایش محتوا توسط Publisher را کنترل می‌کنند:
...
### الگو را در قالب کپی کنید

**روش 1: از طریق مدیریت فایل**
...
### قالب سفارشی را ویرایش کنید

باز کردن کپی تم در ویرایشگر متن:
...
## اصول اولیه قالب هوشمند

### متغیرهای هوشمند

ناشر متغیرهایی را برای قالب ها فراهم می کند:
...
### الگوی فهرست بندی دسته

**فایل: publisher_category.tpl**
...
### آخرین قالب بلوک مقالات

**فایل: publisher_block_latest.tpl**
...
### متغیرها را در قالب اختصاص دهید
...
### متغیرهای هوشمند را نمایش دهید

برای رفع اشکال (حذف در تولید):
...
در تنظیمات `/modules/publisher/xoops_version.php` یا مدیریت:
...
در صورت ارتقاء از نسخه قدیمی:

1. فایل های قالب قدیمی و جدید را با هم مقایسه کنید
2. تغییرات سفارشی را ادغام کنید
3. از نام متغیرهای جدید استفاده کنید
4. به طور کامل تست کنید
5. از قالب های قدیمی بک آپ بگیرید
...
- [اسناد هوشمند](https://www.smarty.net/documentation)
- [Publisher GitHub](https://github.com/XoopsModules25x/publisher)
- [راهنمای الگوی XOOPS](../../02-Core-Concepts/Templates/Smarty-Basics.md)

---

#ناشر #قالب‌ها #هوشمند #سفارشی‌سازی #موضوع #xoops