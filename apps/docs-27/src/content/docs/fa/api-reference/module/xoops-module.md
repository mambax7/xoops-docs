---
title: "مرجع XoopsModule API"
description: "مرجع کامل API برای XoopsModule و کلاس های سیستم ماژول"
---
> اسناد API کامل برای سیستم ماژول XOOPS.
...
|----------|------|-------------|
| `mid` | int | شناسه ماژول |
| `name` | رشته | نام نمایشی |
| `version` | رشته | شماره نسخه |
| `dirname` | رشته | نام دایرکتوری |
| `isactive` | int | وضعیت فعال (0/1) |
| `hasmain` | int | دارای مساحت اصلی |
| `hasadmin` | int | دارای قسمت مدیریت |
| `hassearch` | int | دارای عملکرد جستجو |
| `hasconfig` | int | دارای پیکربندی |
| `hascomments` | int | نظرات دارد |
| `hasnotification` | int | دارای اطلاعیه |
...
#xoops #api #module #xoopsmodule #مرجع