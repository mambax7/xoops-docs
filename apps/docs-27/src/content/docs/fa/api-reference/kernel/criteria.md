---
title: "مرجع API معیارها"
description: "مرجع کامل API برای سیستم ساخت پرس و جو معیارهای XOOPS"
---
> مستندات API کامل برای سیستم ساخت پرس و جوی معیارهای XOOPS.
...
1. **همیشه LIMIT** را برای میزهای بزرگ تنظیم کنید
2. **از شاخص ها** در ستون های مورد استفاده در معیارها استفاده کنید
3. **از عجایب پیشرو** در LIKE اجتناب کنید (`'%term'` کند است)
4. **پیش‌افیلتر در PHP** در صورت امکان برای منطق پیچیده
5. **از COUNT کم استفاده کنید** - در صورت امکان نتایج حافظه پنهان را ذخیره کنید
...
#xoops #api #معیار #پایگاه داده #پرس و جو #مرجع