---
title: "Grup Sistemi"
description: "XOOPS grup yönetimi, varsayılan gruplar, özel gruplar ve grup hiyerarşisine ilişkin kapsamlı kılavuz"
---
# XOOPS'de Grup Sistemi

XOOPS Grup Sistemi, kullanıcıları düzenlemek ve toplu izinleri yönetmek için hiyerarşik bir çerçeve sağlar. Bu belge, varsayılan grupları, özel grup oluşturmayı, hiyerarşiyi ve pratik uygulamayı kapsar.

## Varsayılan Gruplar

XOOPS, sistem kurulumu sırasında oluşturulan üç temel grubu içerir:

### Web Yöneticileri Grubu (ID: 1)

Web Yöneticileri grubu, tam sistem erişimine sahip site yöneticilerini temsil eder.

**Özellikler:**
- Grup Kimliği: 1
- En yüksek ayrıcalık seviyesi
- Silinemez
- Tüm modüllere ve işlevlere tam erişim
...
```
### Kayıtlı users Grubu (ID: 2)

Kayıtlı users grubu, kimliği doğrulanmış ve anonim olmayan tüm kullanıcıları içerir.

**Özellikler:**
- Grup Kimliği: 2
- Yeni kayıtlar için varsayılan grup
- Kullanıcıya özel özelliklere erişebilir
- Grup bazlı izinlere tabidir
- Standart user özelliklerine göre özelleştirilebilir
```php
<?php
/**
...
Anonim grup, siteye gelen kimliği doğrulanmamış ziyaretçileri temsil eder.

**Özellikler:**
- Grup Kimliği: 3
- Oturum açmamış users için varsayılan grup
- Genellikle sınırlı salt okunur erişim
- İçerik değiştirilemiyor
- Herkese açık görüntüleme izinleri
```php
<?php
/**
...
1. **Anlaşılır Adlandırma**: Açıklayıcı, anlaşılır grup adları kullanın
2. **Belgeler**: Belge grubu amaçları ve izinleri
3. **En Az Ayrıcalık Prensibi**: Gerekli minimum izinleri verin
4. **Düzenli Denetimler**: Grup üyeliklerini ve izinlerini periyodik olarak gözden geçirin
5. **Varsayılan Gruplar**: Varsayılan grupları koruyun (Web Yöneticileri, Kayıtlı, Anonim)
...
#gruplar #grup yönetimi #permissions #erişim kontrolü #user organizasyonu #hiyerarşi