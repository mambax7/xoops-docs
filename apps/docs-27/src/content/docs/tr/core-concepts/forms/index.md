---
title: "XOOPS Formlar"
description: "Tüm form öğeleri, doğrulama ve işleme dahil olmak üzere XOOPS form oluşturma sistemine ilişkin eksiksiz kılavuz"
---
# 📝 XOOPS Form Sistemi

> XOOPS modülleri için kapsamlı form oluşturma, doğrulama ve işleme.

---

## Genel Bakış

XOOPS form sistemi, HTML formları oluşturmaya yönelik güçlü, nesne yönelimli bir yaklaşım sağlar. Form oluşturmayı, doğrulamayı, CSRF korumasını ve çeşitli CSS çerçevelerini destekleyen esnek oluşturmayı yönetir.
...
### XoopsForm (Temel Sınıf)

Tüm formlar için soyut temel sınıf.
```php
...
En sık kullanılan form sınıfı, theme stiliyle oluşturulur.
```php
...
```
### Eleman Tepsisi (Grup Elemanları)
```php
...
Her zaman gizli jetonu ekleyin:
```php
$form->addElement(new XoopsFormHiddenToken());
...
#xoops #formlar #doğrulama #güvenlik #ui #elements