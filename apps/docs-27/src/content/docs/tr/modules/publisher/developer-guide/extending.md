---
title: "Yayıncıyı Genişletme"
description: "Publisher modülünü genişletmek ve özelleştirmek için geliştirici kılavuzu"
---
> Publisher modülünü özelleştirmeye ve genişletmeye yönelik geliştirici kılavuzu.
...
### Şablonu Geçersiz Kılma

Temanızda özel templates oluşturun:
```
...
```
### xoops_version.php dosyasında Bloğu Kaydet
```php
$modversion['blocks'][] = [
...
- Kullanım Kılavuzu - Başlarken
- MVC Desen
- XoopsObject API

---

#xoops #Publisher #geliştirici #extending #api