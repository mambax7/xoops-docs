---
title: "database Geçişleri"
---
## Genel Bakış

database geçişleri, database şemanızda sürüm kontrollü, geri döndürülebilir değişiklikler sağlar. Geliştirme, hazırlama ve üretim ortamlarında tutarlı database durumları sağlarlar.
...
1. **Taşıma Başına Bir Değişiklik** - Taşıma işlemlerine odaklanın
2. **Her Zaman Yöntemleri Yaz** - Geri almaları etkinleştirin
3. **Her İki Yönü de Test Edin** - up() ve down()'yi doğrulayın
4. **İşlemleri Kullanın** - Karmaşık taşıma işlemlerini tamamlayın
5. **Eski Taşıma İşlemlerini Değiştirmeyin** - Bunun yerine yenilerini oluşturun
6. **Çalıştırmadan Önce Yedekleyin** - Özellikle üretimde

## İlgili Belgeler

- database Şeması - Şema tasarımı
- database İşlemleri - Sorgu yürütme
- ../xoops_version.php - module bildirimi
- ../../07-XOOPS-4.0/XOOPS-4.0-Architecture - Modern mimari