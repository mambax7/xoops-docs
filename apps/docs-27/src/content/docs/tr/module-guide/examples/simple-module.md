---
title: "Basit module Örneği"
description: "Gerekli tüm dosyalarla çalışma modülünü tamamlayın"
---
# Basit module Örneği - Blog

Temel XOOPS kavramlarını gösteren eksiksiz, çalışan basit bir module.
...
- Yayınlanan blog gönderilerini sayfalandırmayla görüntüleyin
- Bireysel gönderileri görüntüleyin
- Gönderileri oluşturmak, düzenlemek ve silmek için yönetici arayüzü
- Draft/Published durumu
- Zaman damgaları

## Test etme

1. Modülü XOOPS admin aracılığıyla yükleyin
2. `modules/blog/` adresinden ön uca erişin
3. `modules/blog/admin.php` adresinden admin'i ziyaret edin
4. Bir test gönderisi oluşturun ve yayınlayın

## İlgili Belgeler

Ayrıca bakınız:
- ../Patterns/MVC-Pattern desenler için
- ../Patterns/Repository-Pattern veri erişimi için
- ../Best-Practices/Code-Organization yapı için

---

Etiketler: #örnekler #basit-module #tam-örnek #module-geliştirme