---
title: "CSS ve SCSS Kılavuzları"
description: "XOOPS CSS/SCSS kodlama standartları ve en iyi uygulamalar"
---
> XOOPS, SCSS ön işlemeyle modern CSS standartlarını takip eder ve sürdürülebilirlik ve performansa odaklanır.

---

## Genel Bakış

XOOPS CSS standartları şunları vurgular:

- Organizasyon için **SCSS ön işleme**
- **BEM adlandırma metodolojisi**
- **Mobil öncelikli duyarlı tasarım**
- **Erişilebilirlik ve anlam HTML**
...
- Renkler, aralıklar ve yazı tipleri için SCSS değişkenlerini kullanın
- BEM adlandırma kuralını izleyin
- Mobil öncelikli duyarlı tasarım
- Dosyaları amaca göre düzenleyin
- Yeniden kullanılabilir karışımlar yazın
- Seçicileri basit tutun (en fazla 3 seviye derinliğinde)
- Semantik kullanın HTML
- Spesifikliği en aza indirin
- Karmaşık bölümleri yorumlayın

### Yapma

- Satır içi stilleri kullanın
- !important kullanın (neredeyse hiçbir zaman)
- Aşırı spesifik seçiciler oluşturun
- Stil oluşturmak için kimlik seçicileri kullanın
- Çok derine yuva yapın (maks. 3-4 seviye)
- Yazı tipi boyutları için px kullanın (rem kullanın)
- Sihirli sayılar oluşturun (değişkenleri kullanın)
- Kullanılmayan bırakın CSS
- Erişilebilirliği unutun
...
```
### Yeniden Boyamaları En Aza İndirin
```scss
// Group animations
.component {
...
#xoops #css #scss #styling #kodlama standartları #en iyi uygulamalar