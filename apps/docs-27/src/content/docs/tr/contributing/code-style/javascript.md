---
title: "JavaScript Kodlama Standartları"
description: "XOOPS JavaScript kodlama standartları ve en iyi uygulamalar"
---
# JavaScript Standartlar

> XOOPS, okunabilirlik ve sürdürülebilirliğe önem vererek modern JavaScript standartlarını (ES6+) takip eder.

---

## Genel Bakış

XOOPS JavaScript standartları aşağıdakileri temel alır:

- **ECMAScript 2015+** (ES6 ve modern özellikler)
- **Airbnb JavaScript Stil Kılavuzu** (uyarlanmış)
- Tutarlılık için **XOOPS kuralları**
...
- Varsayılan olarak const'ı kullanın
- Açıklayıcı adlar kullanın
- callbacks için ok işlevlerini kullanın
- Vaatler için async/await kullanın
- Karmaşık işlevleri belgeleyin
- DOM öğelerini önbelleğe alın
- Etkinlik delegasyonunu kullan
- Saf fonksiyonları yazın
- İşlevlere odaklanın

### Yapma

- var (eski) kullanın
- Global değişkenleri kullanın
- Uzun işlevler oluşturun (50 satırın üzerinde)
- Derinlemesine yuva kodu
- eval()'yi kullanın
- Satır içi olay işleyicilerini kullanın
- Console.log()'ü üretimde bırakın
- Bellek sızıntıları oluşturun
- Fonksiyon parametrelerini değiştirin
...
#xoops #javascript #es6 #kodlama standartları #en iyi uygulamalar