---
title: "Layar Putih Kematian (WSOD)"
description: "Mendiagnosis dan memperbaiki layar putih kematian di XOOPS"
---

> Cara mendiagnosis dan memperbaiki halaman putih kosong di XOOPS.
...
### Langkah 1: Aktifkan Tampilan Kesalahan PHP

Tambahkan ke `mainfile.php` untuk sementara:
...
### Langkah 2: Periksa Log Kesalahan PHP
...
### Langkah 3: Aktifkan Debug XOOPS
...
### 1. Batas Memori Terlampaui

**Gejala:**
- Halaman kosong pada operasi besar
- Berfungsi untuk data kecil, gagal untuk data besar
...
### 2. Kesalahan Sintaks PHP

**Gejala:**
- WSOD setelah mengedit file PHP
...
### 3. File yang Diperlukan Tidak Ada

**Gejala:**
- WSOD setelah upload/migration
- Halaman acak gagal
...
### 4. Koneksi Basis Data Gagal

**Gejala:**
- Semua halaman menampilkan WSOD
- File statis (gambar, CSS) berfungsi
...
**Gejala:**
- WSOD saat menulis file
- Kesalahan Cache/compile
...
### 6. Kesalahan template Smarty

**Gejala:**
- WSOD pada halaman tertentu
- Bekerja setelah membersihkan cache
...
### 7. Waktu Eksekusi Maksimal

**Gejala:**
- WSOD setelah ~30 detik
- Operasi panjang gagal
...
1. **Selalu backup** sebelum melakukan perubahan
2. **Uji secara lokal** sebelum diterapkan
3. **Pantau log kesalahan** secara teratur
4. **Gunakan git** untuk melacak perubahan
5. **Terus perbarui PHP** dalam versi yang didukung
...
#xoops #pemecahan masalah #wsod #debugging #errors
