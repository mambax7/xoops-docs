...
description: "Men-debug dan memperbaiki kesalahan template Smarty di XOOPS"
---

# Kesalahan template (Smarty Debugging)

> Masalah umum template Smarty dan teknik debugging untuk theme dan module XOOPS.
...
## Kesalahan Umum template Smarty
...
## 2. Kesalahan Variabel Tidak Terdefinisi
...
## 5. Kesalahan Plugin Tidak Ditemukan
...
## 6. Masalah template Include/Extends
...
**Aktifkan Proses Debug template:**
...
## Daftar Periksa Validasi template
...
1. **Aktifkan debugging** selama pengembangan
2. **Validasi template** sebelum diterapkan
3. **Hapus cache** setelah perubahan
4. **Gunakan git** untuk melacak perubahan template
5. **Uji di beberapa browser** untuk masalah pengkodean
6. **Dokumentasi plugin khusus** dan pengubah
7. **Gunakan warisan template** untuk konsistensi

---

## Dokumentasi Terkait

- Panduan Proses Debug Smarty
- template Smarty
- Aktifkan Mode Debug
- FAQ theme
