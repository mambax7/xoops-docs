---
title: "Menggunakan Ray Debugger"
description: "Men-debug aplikasi XOOPS dengan Ray debugger"
---

# Menggunakan Ray Debugger untuk XOOPS

> Debugging modern dengan Ray: memeriksa variabel, mencatat pesan, melacak kueri SQL, dan kinerja profil di aplikasi XOOPS Anda.

---

## Apa itu Ray?

Ray adalah alat debugging ringan yang membantu Anda memeriksa status aplikasi tanpa menghentikan eksekusi atau menggunakan breakpoint. Ini sempurna untuk pengembangan XOOPS.

**Fitur:**
- Catat pesan dan variabel
- Periksa pertanyaan SQL
- Lacak kinerja
- Kode profil
- Log terkait grup
- Garis waktu visual
...
**Persyaratan:**
- PHP 7.4+
- Aplikasi Ray (tersedia versi gratis)
- Komposer
...
### Langkah 2: Unduh Aplikasi Ray

Unduh dari [ray.so](https://ray.so):
- Mac: Ray.app
- Windows: Ray.exe
- Linux: sinar (AppImage)

### Langkah 3: Konfigurasikan Firewall (jika diperlukan)

Ray menggunakan port 23517 secara default:
...
### Kesalahan template Saat Men-debug
...
## Mengatasi Masalah Ray

### Q: Ray tidak menerima pesan

**J:**
1. Periksa aplikasi Ray sedang berjalan
2. Periksa firewall mengizinkan port 23517
3. Pastikan Ray sudah terinstal:
```bash
composer require spatie/ray
```

### T: Tidak dapat melihat kueri SQL
...
### T: Dampak performa Ray

**A:** Ray memiliki overhead minimal. Untuk produksi, hapus panggilan Ray atau nonaktifkan:
```php
<?php
