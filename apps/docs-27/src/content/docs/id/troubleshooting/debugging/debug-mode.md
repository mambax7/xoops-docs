...
description: "Cara mengaktifkan dan menggunakan mode debug XOOPS untuk pemecahan masalah"
---

> Panduan komprehensif untuk fitur dan alat debugging XOOPS.
...
| Tingkat | Kesalahan PHP | Pertanyaan SQL | Var template | Direkomendasikan Untuk |
|-------|------------|-------------|---------------|-----------------|
| 0 | Tersembunyi | Tidak | Tidak | Produksi |
| 1 | Ditampilkan | Tidak | Tidak | Pemeriksaan cepat |
| 2 | Ditampilkan | Dicatat | Tidak | Pembangunan |
| 3 | Ditampilkan | Dicatat | Ditampilkan | Proses debug mendalam |

---

## Tampilan Kesalahan PHP
...
## Proses Debug Kueri SQL

### Lihat Kueri dalam Mode Debug

Dengan `XOOPS_DEBUG_LEVEL` diatur ke 2 atau 3, kueri SQL muncul di bagian bawah halaman.

### Pencatatan Kueri Manual
...
### Lihat Variabel yang Ditugaskan
...
#xoops #debugging #pemecahan masalah #pengembangan #logging
