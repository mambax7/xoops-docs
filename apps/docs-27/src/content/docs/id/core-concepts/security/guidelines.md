---
title: "Pedoman Keamanan"
---

## Ikhtisar

Dokumen ini menguraikan praktik terbaik keamanan untuk pengembangan XOOPS, yang mencakup validasi masukan, pengkodean keluaran, autentikasi, otorisasi, dan perlindungan terhadap kerentanan web umum.
...
- [ ] Kueri berparameter untuk semua operasi basis data
- [ ] Pengodean keluaran untuk semua konten buatan pengguna
- [ ] Token CSRF pada semua bentuk perubahan status
- [ ] Pencirian kata sandi yang aman (Argon2id)
- [ ] Keamanan sesi dikonfigurasi
- [ ] Validasi unggahan file
- [ ] Header keamanan disetel
- [ ] Pembatasan tarif diterapkan
