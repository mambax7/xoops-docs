---
title: "Smarty Templating di XOOPS"
---

## Ikhtisar

XOOPS menggunakan mesin template Smarty untuk memisahkan presentasi dari logika. Panduan ini mencakup sintaks Smarty, fitur khusus XOOPS, dan praktik terbaik template.
...
1. **Escape Output** - Selalu keluar dari konten buatan pengguna
2. **Gunakan Pengubah** - Terapkan transformasi yang sesuai
3. **Jaga Logika Minimal** - Logika kompleks termasuk dalam PHP
4. **Gunakan Sebagian** - Gunakan kembali fragmen template umum
5. **Semantik HTML** - Gunakan elemen HTML5 yang tepat
6. **Aksesibilitas** - Sertakan atribut ARIA jika diperlukan

## Dokumentasi Terkait

- Pengembangan theme - Pembuatan theme
