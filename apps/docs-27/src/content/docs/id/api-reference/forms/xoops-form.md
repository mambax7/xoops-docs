---
title: "Referensi XoopsForm API"
description: "Lengkapi referensi API untuk XoopsForm dan kelas elemen formulir"
---

> Lengkapi dokumentasi API untuk sistem pembuatan formulir XOOPS.
...
|--------|------------|---------|-------------|
| `addElement` | `XoopsFormElement $element, bool $required = false` | `void` | Tambahkan elemen ke formulir |
| `getElements` | - | `array` | Dapatkan semua elemen |
| `getElement` | `string $name` | `XoopsFormElement|null` | Dapatkan elemen berdasarkan nama |
| `setExtra` | `string $extra` | `void` | Tetapkan atribut HTML tambahan |
| `getExtra` | - | `string` | Dapatkan atribut tambahan |
| `getTitle` | - | `string` | Dapatkan judul formulir |
| `setTitle` | `string $title` | `void` | Tetapkan judul formulir |
| `getName` | - | `string` | Dapatkan nama formulir |
| `getAction` | - | `string` | Dapatkan tindakan URL |
| `render` | - | `string` | Render formulir HTML |
| `display` | - | `void` | Bentuk gema yang diberikan |
| `insertBreak` | `string $extra = ''` | `void` | Masukkan jeda visual |
| `setRequired` | `XoopsFormElement $element` | `void` | Tandai elemen diperlukan |

---

## Formulir theme Xoops

Kelas formulir yang paling umum digunakan, dirender dengan gaya yang peka terhadap theme.
...
Kotak centang atau grup kotak centang.
...
Kirim, setel ulang, atau tombol khusus.
...
Label hanya tampilan (bukan masukan).
...
Mengelompokkan beberapa elemen menjadi satu.
