---
title: "Referensi XoopsModule API"
description: "Lengkapi referensi API untuk XoopsModule dan kelas sistem module"
---

> Lengkapi dokumentasi API untuk sistem module XOOPS.

---

## Arsitektur Sistem module
...
|----------|------|-------------|
| `mid` | ke dalam | ID module |
| `name` | tali | Nama tampilan |
| `version` | tali | Nomor versi |
| `dirname` | tali | Nama direktori |
| `isactive` | ke dalam | Status aktif (0/1) |
| `hasmain` | ke dalam | Memiliki area utama |
| `hasadmin` | ke dalam | Memiliki area admin |
| `hassearch` | ke dalam | Memiliki fungsi pencarian |
| `hasconfig` | ke dalam | Memiliki konfigurasi |
| `hascomments` | ke dalam | Memiliki komentar |
| `hasnotification` | ke dalam | Memiliki notifikasi |
