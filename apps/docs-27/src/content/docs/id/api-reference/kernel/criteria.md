---
title: "Kriteria Referensi API"
description: "Lengkapi referensi API untuk sistem pembuatan kueri Kriteria XOOPS"
---

> Lengkapi dokumentasi API untuk sistem pembuatan kueri Kriteria XOOPS.

---

## Arsitektur Sistem Kriteria
...
### Pencarian dengan Berbagai Kondisi
...
1. **Selalu tetapkan LIMIT** untuk tabel besar
2. **Gunakan indeks** pada kolom yang digunakan dalam kriteria
3. **Hindari wildcard utama** di LIKE (`'%term'` lambat)
4. **Pra-filter di PHP** bila memungkinkan untuk logika kompleks
5. **Gunakan COUNT secukupnya** - hasil cache bila memungkinkan
...
#xoops #api #kriteria #database #query #reference
