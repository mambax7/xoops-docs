---
title: "Penerbit - Kait dan Acara"
description: "Panduan untuk memperluas Publisher menggunakan hook, event, dan sistem plugin"
---

# Kait dan Acara Penerbit

> Panduan lengkap untuk memperluas fungsionalitas Publisher menggunakan acara, kait, dan plugin.
...
Peristiwa memungkinkan module lain bereaksi terhadap tindakan Penerbit:
...
#### penerbit.item.dibuat

Dipecat saat artikel baru dibuat.
...
#### penerbit.item.diperbarui

Dipecat saat artikel diperbarui.
...
#### penerbit.item.dihapus

Dipecat ketika sebuah artikel dihapus.
...
#### penerbit.item.diterbitkan

Diaktifkan ketika status artikel berubah menjadi diterbitkan.
...
#### penerbit.item.disetujui

Dipecat ketika artikel yang tertunda disetujui.
...
#### penerbit.item.ditolak

Dipecat ketika artikel ditolak.
...
#### penerbit.kategori.dibuat

Diaktifkan saat kategori dibuat.
...
#### penerbit.kategori.diperbarui

Diaktifkan ketika kategori diperbarui.
...
#### penerbit.kategori.dihapus

Diaktifkan ketika kategori dihapus.
...
#### penerbit.komentar.dibuat

Dipecat ketika komentar diposting.
...
#### penerbit.komentar.disetujui

Dipecat ketika komentar disetujui.
...
#### penerbit.komentar.dihapus

Dipecat ketika komentar dihapus.
...
### Daftarkan Pendengar Acara

Di module atau plugin Anda:
...
### Contoh 1: Kirim Email tentang Pembuatan Artikel
...
### Contoh 2: Perbarui Indeks Pencarian
...
### Contoh 3: Posting Otomatis ke Media Sosial
...
### Contoh 4: Sinkronisasi dengan Sistem Eksternal
...
Kait memungkinkan modifikasi pada perilaku Penerbit:

#### penerbit.view.artikel.mulai

Dipanggil sebelum artikel dirender.
...
#### penerbit.view.artikel.akhir

Dipanggil setelah artikel dirender.
...
#### penerbit.izin.periksa

Dipanggil saat memeriksa izin.
...
Plugin memperluas fungsionalitas Publisher:
...
Filter mengubah pemrosesan data before/after:
...
Jalankan kode pada titik tertentu:
...
- [Sistem Acara XOOPS](../../03-Module-Development/Module-Development.md)
- [Pengembangan Plugin](../../03-Module-Development/Module-Development.md)
