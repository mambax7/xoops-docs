---
title: "Pola Model Domain"
---

## Ikhtisar

Pola Model Domain mewakili konsep bisnis, aturan, dan logika aplikasi Anda. Dalam pengembangan module XOOPS, model domain merangkum entitas bisnis core dan perilakunya.

## Entitas vs Objek Nilai

### Entitas

Entitas memiliki identitas dan siklus hidup:
...
Objek Nilai tidak dapat diubah dan dibandingkan berdasarkan nilai:
...
Agregat adalah kelompok objek domain yang diperlakukan sebagai satu unit:
...
Tangkap kejadian domain penting:
...
Gunakan enum PHP 8.2+ untuk nilai status aman tipe:
...
Lindungi aturan domain dalam entitas:
...
1. **Model Domain Kaya** - Masukkan perilaku dalam entitas, bukan layanan
2. **Objek Nilai Abadi** - Objek nilai tidak boleh berubah
3. **Metode Pabrik** - Gunakan metode pabrik statis untuk konstruksi kompleks
4. **Klausul Penjaga** - Validasi input pada batas entitas
5. **Peristiwa Domain** - Menangkap perubahan status yang signifikan
6. **Bahasa yang Ada di Mana-Mana** - Gunakan terminologi bisnis dalam kode

## Dokumentasi Terkait

- Lapisan Layanan - Layanan aplikasi
