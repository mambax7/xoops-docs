---
title: "Migrasi Basis Data"
---

## Ikhtisar

Migrasi database memberikan perubahan yang dikontrol versi dan dapat dibalik pada skema database Anda. Mereka memastikan status database yang konsisten di seluruh lingkungan pengembangan, staging, dan produksi.
...
1. **Satu Perubahan Per Migrasi** - Jaga agar migrasi tetap fokus
2. **Selalu Tuliskan Metode** - Aktifkan rollback
3. **Uji Kedua Arah** - Verifikasi up() dan down()
4. **Gunakan Transaksi** - Selesaikan migrasi yang rumit
5. **Jangan Ubah Migrasi Lama** - Buat yang baru
6. **Back Up Sebelum Berjalan** - Terutama dalam produksi

## Dokumentasi Terkait

- Skema Basis Data - Desain skema
- Operasi Basis Data - Eksekusi kueri
- ../xoops_version.php - Manifes module
- ../../07-XOOPS-4.0/XOOPS-4.0-Architecture - Arsitektur modern
