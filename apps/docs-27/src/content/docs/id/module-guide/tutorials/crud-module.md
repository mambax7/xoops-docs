---
title: "Membangun module CRUD"
description: "Tutorial lengkap untuk membuat module CRUD dengan operasi database, formulir, dan antarmuka admin"
---

# Tutorial Membangun module CRUD

Tutorial ini memandu Anda membuat module CRUD (Buat, Baca, Perbarui, Hapus) lengkap untuk XOOPS. Kami akan membuat module "Catatan" yang memungkinkan pengguna mengelola catatan pribadi.

## Prasyarat

- Menyelesaikan tutorial module Halo-Dunia
- Pemahaman konsep OOP PHP
- Pengetahuan dasar SQL

## Ikhtisar module

**Fitur module Catatan:**
...
Buat struktur berikut di `/modules/notes/`:
...
Selamat! Anda telah membuat module CRUD yang lengkap. Konsep-konsep utama yang dibahas:

1. **Desain Basis Data** - Tabel dengan hubungan
2. **Kelas Entitas** - XoopsObject dengan properti yang diketik
3. **Kelas Handler** - XoopsPersistableObjectHandler dengan metode khusus
4. **Halaman front-end** - Fungsi daftar, lihat, dan edit
5. **Penanganan Formulir** - perlindungan dan validasi CSRF
6. **Antarmuka Admin** - Layar manajemen
7. **template** - template Smarty dengan logika

## Langkah Selanjutnya

- Tambahkan lebih banyak fitur lanjutan (komentar, peringkat, berbagi)
- Menerapkan ../Patterns/Repository-Pattern untuk akses data yang lebih bersih
- Terapkan ../Patterns/MVC-Pattern untuk organisasi kode yang lebih baik
- Tambahkan ../Best-Practices/Testing dengan PHPUnit

Lihat juga: ../Module-Development | ../Patterns/MVC-Pattern | ../Patterns/Repository-Pattern
