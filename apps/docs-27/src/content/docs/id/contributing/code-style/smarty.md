---
title: "Konvensi template Smarty"
description: "XOOPS Smarty standar pengkodean template dan praktik terbaik"
---

> XOOPS menggunakan Smarty untuk pembuatan template. Panduan ini mencakup konvensi dan praktik terbaik untuk mengembangkan template Smarty.

---

## Ikhtisar

template XOOPS Smarty mengikuti:

- **Struktur template XOOPS** dan penamaannya
- **Standar aksesibilitas** (WCAG)
- Markup **Semantik HTML5**
- **Penamaan kelas ala BEM**
...
### Bagian (tidak digunakan lagi, gunakan foreach sebagai gantinya)
...
- Gunakan HTML5 semantik
- Sertakan teks alternatif untuk gambar
- Gunakan konstanta bahasa untuk teks
- Keluaran escape (default)
- Pertahankan logika minimal
- Gunakan nama variabel yang bermakna
- Sertakan header file
- Gunakan nama kelas bergaya BEM
- Uji dengan pembaca layar

### Jangan

- Jangan mencampurkan logika dan presentasi
- Jangan lupa teks alternatif
- Jangan gunakan HTML mentah tanpa keluar
- Jangan membuat variabel global di template
- Jangan gunakan fitur Smarty yang tidak digunakan lagi
- Jangan membuat sarang template terlalu dalam
- Jangan abaikan aksesibilitas
- Jangan melakukan hardcode teks (gunakan konstanta)

---

## Contoh template

### template module Lengkap
