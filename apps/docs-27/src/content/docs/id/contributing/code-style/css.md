---
title: "Pedoman CSS dan SCSS"
description: "XOOPS CSS/SCSS standar pengkodean dan praktik terbaik"
---

> XOOPS mengikuti standar CSS modern dengan prapemrosesan SCSS, dengan fokus pada pemeliharaan dan kinerja.

---

## Ikhtisar

Standar XOOPS CSS menekankan:

- **Pemrosesan awal SCSS** untuk organisasi
- **Metodologi BEM** untuk penamaan
- **Desain responsif yang mengutamakan seluler**
- **Aksesibilitas dan semantik HTML**
...
- Gunakan variabel SCSS untuk warna, spasi, font
- Mengikuti konvensi penamaan BEM
- Desain responsif yang mengutamakan seluler
- Atur file berdasarkan tujuan
- Tulis mixin yang dapat digunakan kembali
- Buat penyeleksi tetap sederhana (kedalaman maksimal 3 level)
- Gunakan semantik HTML
- Minimalkan kekhususan
- Komentari bagian yang kompleks

### Jangan

- Gunakan gaya sebaris
- Gunakan !important (hampir tidak pernah)
- Buat penyeleksi yang terlalu spesifik
- Gunakan pemilih ID untuk penataan gaya
- Sarang terlalu dalam (maks 3-4 level)
- Gunakan px untuk ukuran font (gunakan rem)
- Buat angka ajaib (gunakan variabel)
- Tinggalkan CSS yang tidak digunakan
- Lupakan aksesibilitas
...
#xoops #css #scss #styling #coding-standards #praktik terbaik
