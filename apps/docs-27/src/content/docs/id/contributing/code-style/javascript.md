---
title: "Standar Pengkodean JavaScript"
description: "XOOPS JavaScript standar pengkodean dan praktik terbaik"
---

# Standar JavaScript

> XOOPS mengikuti standar JavaScript modern (ES6+) dengan penekanan pada keterbacaan dan pemeliharaan.

---

## Ikhtisar

Standar XOOPS JavaScript didasarkan pada:

- **ECMAScript 2015+** (ES6 dan fitur modern)
- **Panduan Gaya Airbnb JavaScript** (diadaptasi)
- **Konvensi XOOPS** untuk konsistensi
...
- Gunakan fungsi panah untuk panggilan balik
- Gunakan async/await untuk janji
- Dokumentasikan fungsi yang kompleks
- Cache elemen DOM
- Gunakan delegasi acara
- Tulis fungsi murni
- Jaga agar fungsi tetap fokus

### Jangan

- Gunakan var (warisan)
- Gunakan variabel global
- Buat fungsi panjang (lebih dari 50 baris)
- Kode yang sangat bersarang
- Gunakan eval()
- Gunakan pengendali acara sebaris
- Tinggalkan console.log() dalam produksi
