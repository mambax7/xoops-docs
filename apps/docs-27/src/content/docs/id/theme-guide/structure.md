---
title: "Struktur theme"
---

## Ikhtisar

theme XOOPS mengontrol presentasi visual situs Anda. Memahami struktur theme sangat penting untuk penyesuaian dan pembuatan theme baru.
...
template tata letak utama yang menggabungkan semua konten:
...
| Variabel | Deskripsi |
|----------|-------------|
| `$xoops_sitename` | Nama situs |
| `$xoops_url` | Situs URL |
| `$xoops_theme` | Nama theme saat ini |
| `$xoops_langcode` | Kode bahasa |
| `$xoops_charset` | Pengkodean karakter |
| `$xoops_pagetitle` | Judul halaman |
| `$xoops_dirname` | Nama module saat ini |

### Variabel Pengguna

| Variabel | Deskripsi |
|----------|-------------|
| `$xoops_isuser` | Sudah masuk |
| `$xoops_isadmin` | Apakah administrator |
...
| Variabel | Deskripsi |
|----------|-------------|
| `$xoops_showlblock` | Tampilkan block kiri |
| `$xoops_showrblock` | Tampilkan block kanan |
| `$xoops_showcblock` | Tampilkan block tengah |
| `$xoops_lblocks` | Array block kiri |
| `$xoops_rblocks` | Array block kanan |
| `$xoops_contents` | Konten halaman utama |

## Penggantian template module

Ganti template module dengan menempatkannya di theme Anda:
...
- ../Templates/Smarty-Templating - Sintaks template
- Pengembangan theme - Panduan theme lengkap
- CSS-Praktik Terbaik - Pedoman penataan gaya 
- ../../03-Module-Development/Block-Development - Membuat block
