---
title: "Pengembangan theme"
description: "Membuat dan menyesuaikan theme XOOPS dengan warisan template Smarty"
---

<span class="version-badge version-25x">2.5.x ✅</span> <span class="version-badge version-40x">4.0.x ✅</span>

Panduan ini mencakup cara membuat theme XOOPS, termasuk struktur theme, pewarisan template, dan praktik terbaik untuk membuat theme modern dan responsif.
...
theme XOOPS terdiri dari struktur direktori berikut:
...
File konfigurasi theme mendefinisikan properti theme:
...
Warisan template Smarty memungkinkan Anda membuat theme anak yang mewarisi theme induk.

### theme Induk (base.tpl)
...
### Membuat Variasi theme

Buat beberapa variasi theme dari theme dasar:
...
File ini dijalankan secara otomatis dan dapat digunakan untuk menyiapkan data untuk template:
...
## Kustom Carousel/Slider

Contoh carousel konten dinamis:
...
## Tip Desain Responsif

### CSS yang Mobile-Pertama
