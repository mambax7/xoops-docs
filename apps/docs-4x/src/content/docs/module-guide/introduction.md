---
title: Module Development — XOOPS 4.x
description: Build XOOPS 4.x modules using PSR-4 namespaces and Composer.
---
...
the foundational concepts — the domain model is the same.
